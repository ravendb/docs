...
* Patching time series data (Append or Delete entries) can be performed via [Operations](../../../../../client-api/operations/what-are-operations.mdx).
  * Use [PatchOperation](../../../../../documents/patching-documents/patch-a-single-document/api-overview.mdx) to patch data on a **single** document.
  * Use [PatchByQueryOperation](../../../../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx) to patch data on **multiple** documents.
...
* The detailed syntax of `PatchOperation` is listed under this [syntax section](../../../../../documents/patching-documents/patch-a-single-document/api-overview.mdx#operations-api-syntax).

* The detailed syntax of `PatchRequest` is listed under this [syntax section](../../../../../documents/patching-documents/patch-a-single-document/api-overview.mdx#session-api-using-defer-syntax).
...
* The detailed syntax of `PatchByQueryOperation` is listed under this [syntax section](../../../../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx#patchbyqueryoperation-syntax).
