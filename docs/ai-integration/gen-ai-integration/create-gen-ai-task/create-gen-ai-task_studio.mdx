...
* In this article:
    * [The GenAI Task wizard](#the-genai-task-wizard)  
    * [Add a GenAI Task](#add-a-genai-task)
    * [Configure basic settings](#configure-basic-settings)
    * [Generate context objects](#generate-context-objects)
    * [Define Prompt and JSON schema](#define-prompt-and-json-schema)
    * [Provide update script](#provide-update-script)
    * [Review configuration and Save task](#review-configuration-and-save-task)
...
3. <a id="generate-context-objects-playground"/>**Playground**  
    ...
    * **Select a document from the source collection**  
       ...
       * To use the same sample document we're using to demonstrate the process, 
         add [posts/1](#sample-data) and select it here.  
...
4. **Controls**  
    ...
    * **Back**  
      Click to return to the previous step, [Configure basic settings](#configure-basic-settings).  
    * **Test Context**  
    ...
    * **Next**  
      Click to advance to the next step, [Define prompt & JSON schema](#define-prompt-and-json-schema).  
...
4. **Controls**  
    * **Cancel**  
      Click to cancel any changes made in the task.  
    * **Back**  
      Click to return to the previous step, [Generate context objects](#generate-context-objects).  
    * **Test Context**  
      Click to test the prompt and JSON schema you define above, on the context objects generated from the 
      document you provided.  
    * **Next**  
      Click to advance to the next step, [Provide update script](#provide-update-script).  
...
3. **Controls**  
    * **Cancel**  
      Click to cancel any changes made in the task.  
    * **Back**  
      Click to return to the previous step, [Define Prompt and JSON schema](#define-prompt-and-json-schema).  
    * **Test Context**  
    ...
    * **Next**  
      Click to advance to the next step, [Review configuration and Save task](#review-configuration-and-save-task).  
...
3. **Controls**  
    * **Cancel**  
      Click to cancel any changes made in the task.  
    * **Back**  
      Click to return to the previous step, [Provide update script](#provide-update-script).  
    * **Save**  
