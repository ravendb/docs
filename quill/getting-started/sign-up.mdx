...
**signing up**, **starting Quill**, **connecting the source database**, **mapping the tables
...
* The signing-up routine includes a form for your contact details and a verification of your email address,
  followed by these wizard stages:
...
* Next step: [Start Quill](start-quill.mdx)
...
3. **Continue**  
   Click for the next wizard stage: [Review and confirm](sign-up.mdx#review-and-confirm)
...
1. **Edit**  
   Click to reopen the [Name your Quill domain](sign-up.mdx#name-your-quill-domain) stage and modify its details.
...
3. **Docker command**  
   ...
   **bash** or **PowerShell** form.  
   ...
   See more about the Docker command in [Start Quill](start-quill.mdx).
