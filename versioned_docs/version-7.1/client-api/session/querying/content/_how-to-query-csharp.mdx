...
* Queries defined with `Query` or `DocumentQuery` are translated by the RavenDB client to [RQL](../what-is-rql.mdx)  
...
* The entities returned by the query are 'loaded' and **tracked** by the [Session](../../what-is-a-session-and-how-does-it-work.mdx).  
  Entities will Not be tracked when:  
    * Query returns a [projection](../how-to-project-query-results.mdx)  
    * Tracking is [disabled](../../configuration/how-to-disable-tracking.mdx#disable-tracking-query-results)  

* Query results are **cached** by default. To disable query caching see [NoCaching](../how-to-customize-query.mdx#nocaching).
...
* In this page:
  ...
  * [Session.Advanced.DocumentQuery](#sessionadvanceddocumentquery)  
  * [Session.Advanced.RawQuery](#sessionadvancedrawquery)
  * [Custom methods and extensions for LINQ](#custom-methods-and-extensions-for-linq)  
  * [Syntax](#syntax)  
...
We differentiate between the following **3 query scenarios**:  
   ...
   1. [Index query](#indexQuery)  
   2. [Dynamic query](#dynamicQuery)  
   3. [Full collection query](#collectionQuery)
...
* Example RQL: &nbsp; `from Employees where FirstName == "Laura"`  
  See more examples [below](#sessionquery).
...
* Querying can be enhanced using these [extension methods](#custom-methods-and-extensions-for-linq).
...
* Below is a simple _DocumentQuery_ usage.  
  For a full description and more examples see:  
    ...
    * [Query -vs- DocumentQuery](../document-query/query-vs-document-query.mdx)
...
* Queries defined with [Query](#sessionquery) or [DocumentQuery](#sessionadvanceddocumentquery) are translated by the RavenDB client to [RQL](../what-is-rql.mdx)  
  when sent to the server.
...
* Available custom methods and extensions for the session's [Query](#sessionquery) method:

   * [AggregateBy](../how-to-perform-a-faceted-search.mdx)
   * AnyAsync
   * [Count](../how-to-count-query-results.mdx)
   * [CountLazily](../how-to-perform-queries-lazily.mdx)
   * [Customize](../how-to-customize-query.mdx)
   * FirstAsync
   * FirstOrDefaultAsync
   ...
   * [Highlight](../text-search/highlight-query-results.mdx)
   * [Include](../../../how-to/handle-document-relationships.mdx)
   * [Intersect](../how-to-use-intersect.mdx)
   * [Lazily](../how-to-perform-queries-lazily.mdx)
   * [LazilyAsync](../how-to-perform-queries-lazily.mdx)
   * [LongCount](../how-to-count-query-results.mdx)
   * [MoreLikeThis](../how-to-use-morelikethis.mdx)
   * [OfType](../how-to-project-query-results.mdx#oftype-(as)---simple-projection)
   * [OrderByDistance](../how-to-make-a-spatial-query.mdx#orderbydistance)
   * [OrderByDistanceDescending](../how-to-make-a-spatial-query.mdx#orderbydistancedesc)
   * [OrderByScore](../sort-query-results.mdx#order-by-score)
   * [OrderByScoreDescending](../sort-query-results.mdx#order-by-score)
   * [ProjectInto](../how-to-project-query-results.mdx)
   * [Search](../text-search/full-text-search.mdx)
   * SingleAsync
   * SingleOrDefaultAsync
   * [Spatial](../how-to-make-a-spatial-query.mdx)
   * [Statistics](../how-to-get-query-statistics.mdx)
...
| Return Value | |
| - | - |
| `IRavenQueryable`<br/>`IDocumentQuery`<br/>`IRawDocumentQuery` | Instances exposing additional query methods and [extensions](#custom-methods-and-extensions-for-linq) |
