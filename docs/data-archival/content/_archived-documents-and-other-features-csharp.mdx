...
* **Full collection queries**:  
  ...
  * Learn more about full collection queries in [Full collection query](../../querying/overview.mdx#collectionQuery).  
...
* **Dynamic queries (auto-indexes)**:
  ...
  * Learn more about dynamic queries in [Query a collection - with filtering](../../querying/overview.mdx#dynamicQuery).
