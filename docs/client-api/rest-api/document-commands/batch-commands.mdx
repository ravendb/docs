...
2. Execute a [patch](../../../documents/patching-documents/patch-a-single-document/api-overview.mdx) on that same document.  
...
Update a document. A [patch](../../../documents/patching-documents/patch-a-single-document/api-overview.mdx) is executed on the server side and 
