...
* In this page:  
  ...
  * [Licensing a RavenDB docker image](#licensing-a-ravendb-docker-image)  
     ...
     * [Providing a License in `settings.json`](#providing-a-license-in-settingsjson)  
     * [Setting a `RAVEN_License` Environment Variable](#setting-a--environment-variable)  
...
* Add `settings.json` the **full license string** as the value of the "License" key 
  ...
  Mount `settings.json` as [explained above](#passing-a-path-to-the-license-file-via-cli), 
