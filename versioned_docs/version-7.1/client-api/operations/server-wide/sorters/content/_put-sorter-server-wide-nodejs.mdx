...
* To deploy a custom sorter that will apply only to the database scoped to your [Document Store](../../../../setting-up-default-database.mdx),  
  see [put custom sorter](../../../maintenance/sorters/put-sorter.mdx).

* A custom sorter can also be uploaded server-wide from the [Studio](../../../../../studio/database/settings/custom-sorters.mdx).

* In this page:
    * [Put custom sorter server-wide](#put-custom-sorter-server-wide)
    * [Syntax](#syntax)
