...
* The execution of a running backup operation can be [delayed](./create/periodic-tasks/database-backup.mdx#delaying-or-aborting-a-running-backup-operation) if needed. For example, while performing maintenance operations on the server.

[Learn to define a periodic backup task using the client API](./create/periodic-tasks/database-backup.mdx#creating-and-managing-periodic-backups-using-the-client-api)  
[Learn to define a periodic backup task via Studio](./create/periodic-tasks/database-backup.mdx#creating-and-managing-periodic-backups-via-studio)  
...
[Learn to create a one-time backup using the client API](./create/one-time-backup.mdx#running-a-one-time-backup-operation-using-the-client-api)  
[Learn to create a one-time backup via Studio](./create/one-time-backup.mdx#running-a-one-time-backup-operation-using-studio)  
...
| [Change Vector data](../server/clustering/replication/change-vector.mdx#after-restoring-a-database-from-backup) | Change Vectors are not preserved,<br />but recreated after [restoring](./restore.mdx). | ✔ |
...
| [Indexes](../indexes/creating-and-deploying.mdx) | Indexes are not preserved,<br />but rebuilt after [restoring](./restore.mdx)<br />from backed up index definitions. | ✔ |
...
- When set to **Default**, backups are **stored locally** and exported from the local directory.  
  ...
  <Admonition type="note" title="">
  * If a [local folder](./create/periodic-tasks/database-backup.mdx#e-choosing-where-to-store-the-backups) was selected as one of the storage destinations, RavenDB will use it to store both the temporary backup files created during the upload process and the permanent backup files.  
...
[Learn to encrypt your backups using the client API](./create/periodic-tasks/database-backup.mdx#setting-encryption)  
[Learn to encrypt your backups via Studio](./create/periodic-tasks/database-backup.mdx#d-setting-backup-encryption-options)  
...
[Learn to set a retention policy using the client API](./create/periodic-tasks/database-backup.mdx#setting-retention-policy)  
[Learn to set a retention policy via Studio](./create/periodic-tasks/database-backup.mdx#c-setting-backups-retention-policy)  
...
The configuration you set for a server-wide backup task is similar to the configuration of a [regular database backup task](./create/periodic-tasks/database-backup.mdx), with the following changes:  
...
[Learn to create and manage server-wide backup tasks using the client API](./create/periodic-tasks/server-wide-backup.mdx#creating-and-managing-server-wide-backup-tasks-using-the-client-api)  
[Learn to create and manage server-wide backup tasks via Studio](./create/periodic-tasks/server-wide-backup.mdx#creating-and-managing-server-wide-backup-tasks-via-studio)  
...
You can retrieve a backup task's **status**, which reflects the task's **most recent completed backup run** (whether scheduled or [triggered manually](./create/periodic-tasks/database-backup.mdx#triggering-an-immediate-backup-operation)).
...
[Learn to retrieve the status of a database backup task](./create/periodic-tasks/database-backup.mdx#getting-backup-task-status)  
[Learn to retrieve the status of a server-wide derived backup task](./create/periodic-tasks/server-wide-backup.mdx#getting-a-derived-backup-task-status)  
...
[Learn how to restore a database from backup using the client API](./restore.mdx#restoring-from-backup-using-the-client-api)  
[Learn how to restore a database from backup via Studio](./restore.mdx#restoring-from-backup-using-studio)
</ContentFrame>
...
[Learn how to restore from backup to multiple cluster nodes](./restore.mdx#restoring-a-database-to-multiple-cluster-nodes)  
