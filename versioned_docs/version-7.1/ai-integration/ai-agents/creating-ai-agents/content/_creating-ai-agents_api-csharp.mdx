...
* `Conversation` Properties
  ...
  | conversationId | `string` | The [conversation ID](../../../../ai-integration/ai-agents/creating-ai-agents/creating-ai-agents_api.mdx#setting-a-conversation) |
  ...
  | Return value | Description |
  |--------------|-------------|
  | `IAiConversationOperations` | The conversation operations interface for conversation management.<br />Methods of this interface like `Run`, `StreamAsync`, `Handle`, and others, allow you to send messages, receive responses, handle action tools, and manage various other aspects of the conversation lifecycle. |
