...
Entra ID application credentials, or a managed identity.  
...
<TabItem value="passwordless" label="Managed identity">
...
The `BrokerType` property uses the `QueueBrokerType` enum:
...
Set exactly one of these properties:
