...
* In this article:
  ...
  * [Creating a Kafka ETL task using the Client API](../../../../server/ongoing-tasks/etl/queue-etl/kafka.mdx#creating-a-kafka-etl-task-using-the-client-api)
    * [Add a Kafka connection string](../../../../server/ongoing-tasks/etl/queue-etl/kafka.mdx#add-a-kafka-connection-string)
      * [Example: connecting to a secure Kafka cluster](../../../../server/ongoing-tasks/etl/queue-etl/kafka.mdx#example-connecting-to-a-secure-kafka-cluster)
  ...
  * [Prerequisites for a secure Kafka server](../../../../server/ongoing-tasks/etl/queue-etl/kafka.mdx#prerequisites-for-a-secure-kafka-server)
    ...
    * [SSL/TLS required for encrypted RavenDB databases](../../../../server/ongoing-tasks/etl/queue-etl/kafka.mdx#ssl-tls-for-encrypted-databases)
...
* A Kafka ETL task uses a **Kafka connection string** to connect to its destination Kafka cluster.  
...
* A Kafka connection string can be created in any of these ways:
  ...
  * **From Studio**:
    ...
    or while creating a [Kafka ETL task](../../../../studio/database/tasks/ongoing-tasks/kafka-etl-task.mdx#define-kafka-etl-task).
...
{
    // The name used by the Kafka ETL task configuration
...
See [Prerequisites for a secure Kafka server](#prerequisites-for-a-secure-kafka-server) for the matching cluster-side ACL setup.
...
| **ConnectionOptions** | `Dictionary<string, string>` | Optional Kafka client configuration keys, passed through to the Kafka producer. |
