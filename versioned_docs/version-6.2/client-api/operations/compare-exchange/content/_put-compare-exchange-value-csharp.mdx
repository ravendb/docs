...
* For an overview of the 'Compare Exchange' feature see: [Compare Exchange Overview](../overview.mdx).

* In this page:  
  * [Syntax](#syntax)  
  * [Example I - Create a new key](#example-i---create-a-new-key)  
  * [Example II - Update an existing key](#example-ii---update-an-existing-key)  
  * [Example III - Try to create an item with a non-zero index](#example-iii---try-to-create-an-item-with-a-non-zero-index)  
