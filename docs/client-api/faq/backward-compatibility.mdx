...
description: "RavenDB client-server version compatibility rules covering major and minor version interoperability and upgrade guidance."
sidebar_position: 2
---
...
are [compatible with servers of versions higher than theirs](#compatibility---ravendb-42-and-higher).  
