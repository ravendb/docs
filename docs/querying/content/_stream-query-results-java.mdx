...
| Parameters | | |
| ------------- | ------------- | ----- |
| **query** | [IDocumentQuery](../overview.mdx#session-advanced-documentquery) or [IRawDocumentQuery](../overview.mdx#session-advanced-rawquery) | Query to stream results for. |
