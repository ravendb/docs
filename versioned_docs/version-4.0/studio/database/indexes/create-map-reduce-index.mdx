...
* Learn more about using Artificial Documents from the client code in [Reduce Results as Artificial Documents](../../../indexes/map-reduce-indexes.mdx#reduce-results-as-artificial-documents)  
</Admonition>
