...
* Learn [here](./api-admin.mdx) how to manage 
...
5. **Set nodes layout manually**  
   ...
   nodes can function as [orchestrators](../overview.mdx#client-server-communication).  
...
6. **Backups view**  
   Click to manage [backup tasks](../../backup/create/periodic-tasks/database-backup.mdx#creating-and-managing-periodic-backups-via-studio) and restore existing backups.  
7. **Manage group**  
...
[orchestrators](../overview.mdx#client-server-communication) 
and add or remove [shards](../overview.mdx#shards) and 
shard [replicas](../overview.mdx#shard-replication).  
