...
description: "View and manage RavenDB cluster nodes in Studio, including node states, database distribution, and cluster operation logs."
sidebar_position: 1
---
...
* **Leader**
  ...
  * [Cluster-wide operations](cluster-view.mdx#cluster-wide-operation--vs--database-operations) can't be done when the Leader is down.  
