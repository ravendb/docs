...
description: "Extend RavenDB documents with attachments, counters, time series, and revisions — stored separately to avoid modifying parent documents on updates."
...
* In this article:  
   * [Document extensions](../document-extensions/overview.mdx#document-extensions)  
   * [Document extensions in Studio](../document-extensions/overview.mdx#document-extensions-in-studio)  
...
<Panel heading="Document extensions in Studio">
