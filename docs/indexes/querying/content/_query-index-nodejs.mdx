...
* In this page:  
   * [Query an index by `Query`](#query-an-index-by-query) (using API)
...
* Queries defined with [query](#sessionquery) are translated by the RavenDB client to [RQL](../../../querying/rql/what-is-rql.mdx) when sent to the server.
