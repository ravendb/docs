...
* [Add Elasticsearch ETL](../../../../client-api/operations/maintenance/etl/add-etl.mdx#add-elasticsearch-etl-task)  
    * [Creating a Connection String for Elasticsearch ETL](../../../../client-api/operations/maintenance/etl/add-etl.mdx#creating-a-connection-string-for-elasticsearch-etl)  
    * [Code Sample to Add Elasticsearch ETL](../../../../client-api/operations/maintenance/etl/add-etl.mdx#code-sample-for-elasticsearch-etl)  
...
[SQL ETL](../../../../server/ongoing-tasks/etl/sql.mdx) tasks enable ongoing Extract, Transform, Load functionality from RavenDB to SQL databases. 
...
To connect to a cloud instance, see the [Olap ETL article](../../../../server/ongoing-tasks/etl/olap.mdx#section-1).  
...
[Elasticsearch ETL Task](../../../../server/ongoing-tasks/etl/elasticsearch.mdx#add-an-elasticsearch-etl-task) tasks enable ongoing 
