...
* In this article:
    ...
    * [Licensing an Embedded server](../licensing/overview#licensing-an-embedded-server)
       * [TestDriver server license](../licensing/overview#testdriver-server-license)
    * [Studio license management](../licensing/overview#studio-license-management)
...
* The license types that can be applied to an [embedded server](../server/embedded) are the same as those of a regular RavenDB server, providing the same feature sets.  
...
* TestDriver, used for unit tests, runs an embedded server that can be licensed [in the same way](../server/embedded#embedded-server-licensing) as a regular embedded server.  
