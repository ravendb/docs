...
There is also the ability to handle distributed [Compare Exchange](../../compare-exchange/overview) operations and manage [Attachments](../../client-api/operations/attachments/get-attachment.mdx) and [Counters](../../client-api/operations/counters/counter-batch.mdx).
