...
* Use `ConfigureRevisionsOperation` to apply the following [revisions configuration](../../../../../studio/database/settings/document-revisions.mdx#revisions-configuration) to the database:  
  ...
  * To apply a configuration for conflict document revisions see [configure conflict revisions](../conflict-revisions-configuration.mdx).  
...
* To create a revision when there is no configuration defined (or enabled) see: [force revision creation](../../../overview.mdx#force-revision-creation)
...
* In this page:  
  * [Replace configuration](#replace-configuration)  
