...
* Create and manage Counters using API methods, or through [Studio](../../../studio/database/document-extensions/counters.mdx).  
...
Counters are very easy to manage, using simple API methods or through Studio.  
