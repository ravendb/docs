...
is set to [SubscriptionOpeningStrategy.Concurrent](../consumption/how-to-consume-data-subscription.mdx#multiple-workers-per-subscription-strategy).  
...
* To define a concurrent worker:  
   ...
   * Pass it a [SubscriptionWorkerOptions](../consumption/api-overview.mdx#subscriptionworkeroptions) instance.  
