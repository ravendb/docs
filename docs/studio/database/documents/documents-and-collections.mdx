...
description: "Browse RavenDB documents and collections in Studio with filtering, sorting, column selection, and bulk document operations."
sidebar_position: 1
---
...
* For more information about documents, see [Document View](../../../studio/database/documents/document-view.mdx)  
</Admonition>
...
* For more information see [What is a Collection](../../../client-api/faq/what-is-a-collection.mdx)  
</Admonition>

<Admonition type="note" title="">

* In this page:  
  * [The Documents View](../../../studio/database/documents/documents-and-collections.mdx#the-documents-view)  
  * [The @hilo Collection](../../../studio/database/documents/documents-and-collections.mdx#the-@hilo-collection)  
  * [The @empty Collection](../../../studio/database/documents/documents-and-collections.mdx#the-@empty-collection)  
</Admonition>
## The Documents View  
...
3.  
  ...
  * **Conflicts**: View and resolve conflicting documents. See [Conflicts](../../../studio/database/documents/conflicts-view.mdx).  
  * **Compare Exchange**: Manage compare exchange values for this database. See [Compare Exchange](../../../compare-exchange/overview.mdx).  
...
* Documents in the _@hilo_ collection are created when documents are created from the [RavenDB client](../../../client-api/session/storing-entities.mdx) (Not from the studio) **without an explicit ID**.  
...
* For more information, see [HiLo Algorithm](../../../client-api/document-identifiers/hilo-algorithm.mdx).  
...
* For more information about the various documents identifiers that can be generated, 
  see [Create New Document](../../../studio/database/documents/create-new-document.mdx).  
