...
* A Replication Sink is an ongoing task, designed to replicate documents to and/or 
   ...
   * Hub/Sink connections are secure, and require [certification](./overview.mdx#accesses-and-certificates).  
...
* While defining a Sink task using the Studio, you can -  
   ...
   * Use [Filtered Replication](./overview.mdx#filtered-replication) to choose which documents are to be replicated  

* In this page:
   * [Create an Ongoing Replication Sink Task](#create-an-ongoing-replication-sink-task)  
   * [Import Configuration From Hub](#import-configuration-from-hub)  
   * [Sink Configuration](#sink-configuration)  
   * [Access Configuration](#access-configuration)  
   * [Definining Filtered Replication](#defining-filtered-replication)  
...
2. **Certificate Source**  
   ...
   ([Import Hub configuration](#import-configuration-from-hub) 
