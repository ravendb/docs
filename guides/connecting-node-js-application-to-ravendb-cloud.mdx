...
see_also:
  - title: "What is a Document Store"
    link: "https://ravendb.net/docs/article-page/nodejs/client-api/what-is-a-document-store"
    source: "external"
    path: "Client API > What is a Document Store"
  - title: "Creating a Document Store"
    link: "https://ravendb.net/docs/article-page/nodejs/client-api/creating-document-store"
    source: "external"
    path: "Client API > Creating a Document Store"
  - title: "Security Overview"
    link: "https://ravendb.net/docs/article-page/nodejs/server/security/overview"
    source: "external"
    path: "Server > Security > Overview"
  - title: "What is a Session and How Does it Work"
    link: "https://ravendb.net/docs/article-page/nodejs/client-api/session/what-is-a-session-and-how-does-it-work"
    source: "external"
    path: "Client API > Session > What is a Session"
