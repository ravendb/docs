...
* In this page: 
   * [Creating Map Reduce Indexes](#creating-map-reduce-indexes)  
   * [Creating Multi-Map-Reduce Indexes](#creating-multi-map-reduce-indexes)  
   * [Reduce Results as Artificial Documents](#reduce-results-as-artificial-documents)  
   * [Remarks](#remarks)  
...
[creating and deploying](../creating-and-deploying.mdx) article.  
#### Example I - Count
...
The index in [Example I](#example-i) might generate an output document 
ID like this:  
...
The index in [Example I](#example-i) has this pattern for reference documents:  
...
[Artificial documents](#reduce-results-as-artificial-documents) 
...
* Read [here](../../sharding/indexing.mdx#map-reduce-indexes-in-a-sharded-database) 
