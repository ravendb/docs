...
![The Pay Now widget](./assets/portal-billing-costs-pay-now.png)

![The Pay Now widget - confirmation](./assets/portal-billing-costs-pay-now-modal.png)
...
![The Current Billing Period widget](./assets/portal-billing-costs-current-billing-period.png)
...
![The Current Billing Period Costs widget](./assets/portal-billing-costs-current-period-costs.png)
...
![The Account Benefits widget](./assets/portal-billing-costs-account-benefits.png)

The *Account benefits* widget shows information about current and expired benefits, their scope, validity dates and amounts.

### Billing history

![The Billing History widget](./assets/portal-billing-costs-billing-history.png)
...
![The Spending widget](./assets/portal-billing-costs-spending.png)
