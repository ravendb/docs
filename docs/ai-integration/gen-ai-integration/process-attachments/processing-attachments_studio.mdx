...
* In this article:
    * [Include attachments in the Context generation script](#include-attachments-in-the-context-generation-script)
       * [Conditional attachment](#conditional-attachment)
       * [Multiple attachments](#multiple-attachments)
       * [Embedding base64-encoded images in the context object](#embedding-base64-encoded-images-in-the-context-object)
       * [Embedding text in the context object](#embedding-text-in-the-context-object)
    * [Set task Prompt and JSON schema](#set-task-prompt-and-json-schema)
    * [Set task Update script](#set-task-update-script)
