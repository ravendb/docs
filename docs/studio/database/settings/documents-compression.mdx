...
* To see the contents and size details of your database storage go to the [Storage Report](../../../monitoring/performance-views/storage-reports.mdx) view in the Studio.  
