...
* A debug package is a `.zip` archive of diagnostic data collected from a server or cluster, created in the [Create a Debug Package](../../../server/troubleshooting/debug-package/create-debug-package.mdx) view or received from a customer.

* The **Debug Package Analyzer** is a Studio tool that inspects a debug package and reports the state of the cluster, its nodes, and its databases, along with the issues it detects.  
...
* In this article:
  ...
  * [Open the Debug Package Analyzer](../../../server/troubleshooting/debug-package/debug-package-analyzer.mdx#open-the-debug-package-analyzer)
  * [Review the analysis results](../../../server/troubleshooting/debug-package/debug-package-analyzer.mdx#review-the-analysis-results)
