...
* In this page:  
  * [Spatial data in documents](#spatial-data-in-documents)  
  * [Running a dynamic spatial query](#running-a-dynamic-spatial-query)  
  * [Spatial map view](#spatial-map-view)  
  * [Examples](#examples)  
     * [Circular region example](#circular-region-example)  
     * [Polygonal region example](#polygonal-region-example)  
     * [Mixed shapes intersection example](#mixed-shapes-intersection-example)  
</Admonition>
