...
* Queries defined with `query` or `document_query` are translated by the RavenDB client to [RQL](../../querying/what-is-rql.mdx)  
...
* Queries defined with [query](../../querying/overview.mdx#session-query) or [document_query](../../querying/overview.mdx#session-advanced-document_query) are translated by the RavenDB client to [RQL](../../querying/what-is-rql.mdx)  
  when sent to the server.
