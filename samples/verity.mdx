...
challenges_solutions_tags: [regulated-document-workflows, auditable-data-history, ai-governance, lifecycle-governance, azure-native-integration]
feature_tags: [gen-ai-tasks, ai-agents, remote-attachments, azure-storage-queues-etl, revisions, data-subscriptions, hub-sink-replication, document-expiration, data-archival]
...
related_resources:
  ...
  - type: documentation
    documentation_type: docs
    subtitle: "Remote Attachments"
    article_key: "document-extensions/attachments/store-attachments/store-attachments-remote"
  - type: documentation
    documentation_type: docs
    subtitle: "Data Archival"
    article_key: "data-archival/overview"
  - type: documentation
    documentation_type: docs
    subtitle: "Data Subscriptions"
    article_key: "client-api/data-subscriptions/what-are-data-subscriptions"
  - type: documentation
    documentation_type: docs
    subtitle: "Azure Queue Storage ETL"
    article_key: "server/ongoing-tasks/etl/queue-etl/azure-queue"
  - type: guide
    subtitle: "Processing Invoices Using Data Subscriptions"
    article_key: "processing-invoices-using-data-subscriptions-in-ravendb"
  - type: guide
