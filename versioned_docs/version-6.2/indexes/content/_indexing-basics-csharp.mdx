...
You can also create queries manually by using  [DocumentQuery](../client-api/session/querying/document-query/what-is-document-query.mdx) or [RawQuery](../querying/overview.mdx#session-advanced-rawquery), both available as a part of advanced session operations:
