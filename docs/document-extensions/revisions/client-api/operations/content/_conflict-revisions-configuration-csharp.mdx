...
* In this page:  
  * [Configure revisions for conflicts - Example](#configure-revisions-for-conflicts---example)
  * [Syntax](#syntax)
...
* See properties explanation and default values [here](../configure-revisions.mdx#revisions-collection-configuration-object).
...
* Revisions are purged upon [modification of their parent documents](../../../overview.mdx#revisions-configuration-execution).  
