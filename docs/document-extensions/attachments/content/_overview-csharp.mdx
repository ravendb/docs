...
* Attachments can be stored **locally** on your RavenDB server,
  ...
  * **LOCAL storage**:  
    ...
    See [Store attachments in local storage](../store-attachments/store-attachments-local.mdx).
  * **REMOTE storage**:  
    ...
    See [Store attachments in remote storage](../store-attachments/store-attachments-remote.mdx).
...
3. **Viewing the full metadata**:  
   ...
   * [The attachment metadata - local](../store-attachments/store-attachments-local.mdx#the-attachment-metadata)
   * [The attachment metadata - remote](../store-attachments/store-attachments-remote.mdx#the-attachment-metadata)
...
5. **Add attachment to local storage**:  
    ...
    Learn more in [Store attachments in local storage](../store-attachments/store-attachments-local.mdx).
...
6. **Add attachment to remote storage**:  
    ...
    Learn more in [Store attachments in remote storage](../store-attachments/store-attachments-remote.mdx).
...
11. **Delete attachment**:  
    ...
    Learn more in [Delete attachments](../delete-attachment.mdx).    
...
3. **Attachments details**:  
   ...
   `unique`:  
    ...
    Learn more in [Deduplicating local attachments](../store-attachments/store-attachments-local.mdx#deduplicating-local-attachments).  
   `remote`:  
