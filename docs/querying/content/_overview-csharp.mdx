...
* Queries defined with `Query` or `DocumentQuery` are **translated by the RavenDB client to [RQL](../../querying/rql/what-is-rql.mdx)** when sent to the server.
...
* Below is a simple _DocumentQuery_ usage.  
  For a full description and more examples see:  
    ...
    * [Query -vs- DocumentQuery](../../querying/document-query/query-vs-document-query.mdx)
...
* The available methods for the session's [DocumentQuery](../../querying/overview.mdx#session-advanced-documentquery) method
  are listed in [Custom methods and extensions](../../querying/document-query/what-is-document-query.mdx#custom-methods-and-extensions).    
