...
and [restored from backup](../../../../studio/server/databases/create-new-database/from-backup#create-a-database-from-backup), so no special backup procedure is needed for it.  

You can [replicate your database](../../../../studio/database/tasks/ongoing-tasks/pull-replication) so that there is a live version available 
