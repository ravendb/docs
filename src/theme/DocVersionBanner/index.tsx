...
function LatestVersionSuggestionLabel({ to, onClick }: { to: string; onClick: () => void; versionLabel: string }) {
    return (
        <div>
            <Button url={to} onClick={onClick} variant="outline" size="sm" className="self-start sm:self-center">
                <Translate
