...
description: "Set up HTTP and TCP networking for RavenDB containers, including port mapping, DNS resolution, and cluster node communication."
sidebar_position: 2
---
...
- RavenDB nodes within a cluster use both HTTP and TCP ports to perform clustering and replication. See more here: [Clustering Overview](../../../server/clustering/overview.mdx)
...
See more in [Requirements &gt; Security](./security.mdx)
