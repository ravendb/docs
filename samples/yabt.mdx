...
challenges_solutions_tags: [enterprise-app-architecture, multi-tenant-data-access, testable-data-access, document-reference-updates]
...
related_resources:
  ...
  - type: documentation
    documentation_type: docs
    subtitle: "Set-Based Patching"
    article_key: "client-api/operations/patching/set-based"
  - type: documentation
    documentation_type: docs
    subtitle: "Creating and Deploying Indexes"
    article_key: "indexes/creating-and-deploying"
  - type: documentation
    documentation_type: docs
