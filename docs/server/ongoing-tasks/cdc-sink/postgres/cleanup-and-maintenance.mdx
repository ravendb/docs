---
title: "Server: Ongoing Tasks: CDC Sink: PostgreSQL: Cleanup and Maintenance"
sidebar_label: Cleanup and Maintenance
description: "How to find and drop orphaned PostgreSQL replication slots and publications after deleting a CDC Sink task or changing task configuration."
sidebar_position: 6
---
...
# Server: Ongoing Tasks: CDC Sink: PostgreSQL: Cleanup and Maintenance
