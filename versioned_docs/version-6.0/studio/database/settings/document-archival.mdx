...
* RavenDB documents can be [archived](../../../server/extensions/archival.mdx); 
...
2. Provide the archival time (`UTC` time) as a value (see an example [here](../../../server/extensions/archival.mdx#scheduling-document-archival)).  
...
Open the [Database Settings](../../../studio/database/settings/database-settings.mdx) 
...
1. Click to enter text  
   ...
   [Auto Indexing Handling of Archived Documents](../../../server/extensions/archival.mdx#section)  
   [Static Indexing Handling of Archived Documents](../../../server/extensions/archival.mdx#section-1)  
   [Data Subscriptions Handling of Archived Documents](../../../server/extensions/archival.mdx#section-2)  
...
server/database configuration), open the [Index List view](../../../studio/database/indexes/indexes-list-view.mdx) 
...
server/database configuration), open the [Subscription Task view](../../../studio/database/indexes/indexes-list-view.mdx) 
