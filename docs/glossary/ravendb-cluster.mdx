...
description: "Definition of a RavenDB cluster — a group of server nodes coordinated via Raft consensus for high availability and distributed database hosting."
