...
* In this article:  
  ...
  - [Prepare the namespace and Secrets](#prepare-the-namespace-and-secrets)
  - [Define `RavenDBCluster`](#define-ravendbcluster)
  - [Apply the cluster](#apply-the-cluster)
  - [Use the cluster](#use-the-cluster)
  - [Observe and troubleshoot](#observe-and-troubleshoot)
  - [Upgrade the cluster](#upgrade-the-cluster)
  - [Current limitation: topology changes after bootstrap](#current-limitation-topology-changes-after-bootstrap)
...
For certificate-based access, see [Client certificate usage](../../server/security/authentication/client-certificate-usage.mdx).
...
For RavenDB clustering background, see [Clustering Overview](../../server/clustering/overview.mdx).
...
- [Containers: General Guide](./general-guide.mdx)
