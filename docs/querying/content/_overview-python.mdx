...
* Queries defined with [query](#session-query) or [document_query](#session-advanced-document_query) are translated by the RavenDB client to [RQL](../../querying/rql/what-is-rql.mdx)  
