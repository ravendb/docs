...
* In this page:  
   ...
   * [Get subscriptions](#get-subscription-state)
...
See [examples](../../creation/examples.mdx#update-existing-subscription) 
and [API description](../../creation/api-overview.mdx#update-subscription).  
