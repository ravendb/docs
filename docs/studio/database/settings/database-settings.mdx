...
* Once you save the changes made in this view, all modifications are saved into the 
  [database record](./database-record.mdx).  
...
3. Disable and then re-enable the database from the [Database List View](../databases-list-view.mdx) in the Studio, see image below.  
