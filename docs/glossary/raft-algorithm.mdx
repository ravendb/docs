...
description: "Definition of the Raft consensus algorithm as used in RavenDB clusters for leader election, log replication, and consistent distributed decisions."
