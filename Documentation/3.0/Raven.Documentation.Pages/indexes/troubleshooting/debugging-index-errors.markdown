...
RavenDB surfaces index execution errors in two places, the first is the database statistics. Accessible for programmatic access at `/stats` or in human readable form at [studio](../../studio/overview/status/index-errors).
