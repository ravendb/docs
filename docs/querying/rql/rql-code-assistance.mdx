...
* **RQL Code Assistance** is available whenever you write a query in the following Studio views:
  ...
  * [Patch view](../../documents/patching-documents/patch-multiple-documents/patch-view.mdx#patch-view)  
  * [Subscription task view](../../data-subscriptions/creating-subscription/creating-subscription_studio.mdx#defining-the-subscription-task)   
