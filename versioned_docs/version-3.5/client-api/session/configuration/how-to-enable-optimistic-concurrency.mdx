...
To enable it, you can [supply an ETag to Store](../storing-entities.mdx). If you don't supply an ETag or if the ETag is null, then optimistic concurrency will be disabled. 
