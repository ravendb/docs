...
* If you only need to backfill a specific property on existing documents,  
  you can also use a RavenDB [patch by query](../../../documents/patching-documents/patch-multiple-documents/client-api.mdx) to update existing documents independently of the CDC Sink task.
