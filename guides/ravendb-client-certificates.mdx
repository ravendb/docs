...
<Image img={require("./assets/cert1.png")} alt="RavenDB Studio upload client certificate dialog showing Name, Security Clearance, and certificate file fields" />
...
<Image img={require("./assets/cert2.png")} alt="RavenDB Studio certificate management view showing two certificate entries with different thumbprints under the same identity" />
