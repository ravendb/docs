...
* Once loaded to the session, there are no additional trips to the server when accessing the included revisions.  
...
<Tabs>
<TabItem value="patch_the_document" label="path_the_document">
```js
