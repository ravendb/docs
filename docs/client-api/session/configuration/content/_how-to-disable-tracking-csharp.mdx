...
* In this article:
  * [Disable tracking changes for a specific entity](#disable-tracking-changes-for-a-specific-entity)
  * [Disable tracking all entities in session](#disable-tracking-all-entities-in-session)
  * [Disable tracking query results](#disable-tracking-query-results)
  * [Customize tracking in conventions](#customize-tracking-in-conventions)
  * [Using 'Include' in a NoTracking session will throw](#using-include-in-a-notracking-session-will-throw)
  * [Using optimistic concurrency modes in a NoTracking session will throw](#using-optimistic-concurrency-modes-in-a-notracking-session-will-throw)

</Admonition>

<Panel heading="Disable tracking changes for a specific entity">
...
<Panel heading="Disable tracking all entities in session">
...
<Panel heading="Disable tracking query results">
...
<Panel heading="Customize tracking in conventions">
...
<Panel heading="Using 'Include' in a NoTracking session will throw">
...
<Panel heading="Using optimistic concurrency modes in a NoTracking session will throw">
...
* Learn more in [Configure optimistic concurrency - Constraints](../how-to-enable-optimistic-concurrency.mdx#constraints).
