...
* **Mitigation: Audit logging**  
  RavenDB [admin logs](../../monitoring/logging/admin-logs.mdx) track the creation, modification, and deletion of AI agents, as well as agent interactions with the database.  
