...
![Manage product](./portal/assets/portal-product-list-manage-button.png)
...
In the figure above, the **Instance Throughput** is lower than the **Disk Throughput**, so the instance type - not the
disk - is what limits IO.
...
![Scaling instance type](./portal/assets/portal-product-details-edit-tier.png)
...
![Email notification about an instance type change](./assets/email-instance-type-changed.png)
...
![Scaling storage](./portal/assets/portal-product-details-edit-storage.png)
...
![Azure Premium SSD v2 storage edit form with editable IOPS and Throughput](./assets/portal-product-details-edit-storage-premium-ssd-v2.png)
...
![Upgrade to Azure Premium SSD v2 modal with IOPS and Throughput fields](./assets/portal-product-details-upgrade-to-premium-v2-modal.png)
...
![Migrate to data disk modal showing Premium SSD v2 information](./assets/portal-product-details-migrate-to-data-disk-premium-v2.png)
