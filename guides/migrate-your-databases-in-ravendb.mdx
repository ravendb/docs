...
Now, if any [Subscriptions](/7.2/data-subscriptions/overview) are active on your database and their processing routines are idempotent, you need to create a delay for your app, allowing it to switch to the target database without losing any data.
