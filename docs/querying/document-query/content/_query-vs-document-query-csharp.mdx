...
* Queries in RavenDB can be written using `Query`, `DocumentQuery`, `RawQuery`, or directly with [RQL](../../rql/what-is-rql.mdx).    
...
* The available _Query_ methods and extensions are listed in [here](../../overview.mdx#custom-methods-and-extensions-for-linq).
...
* The available _DocumentQuery_ methods and extensions are listed [here](../what-is-document-query.mdx#custom-methods-and-extensions).
...
See [Convert between DocumentQuery and Query](../what-is-document-query.mdx#convert-between-documentquery-and-query).
