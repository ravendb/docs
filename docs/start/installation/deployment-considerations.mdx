...
description: "Plan RavenDB deployments with guidance on performance tuning, network configuration, storage optimization, and production best practices."
sidebar_position: 2
---
...
* In this page:
   * [Deployment Considerations](#deployment-considerations)  
      ...
      * [Running RavenDB](#running-ravendb)  
   * [When the Database Grows Bigger](#when-the-database-grows-bigger)  
...
[Setup Wizard](./setup-wizard/choose-security-option.mdx) for the details on how to do that. 
