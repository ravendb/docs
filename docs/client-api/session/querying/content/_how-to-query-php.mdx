...
* Queries defined using `query` or `documentQuery` are translated by the RavenDB client 
  to [RQL](../../../../querying/rql/what-is-rql.mdx) when sent to the server.  
...
* In this page:
  ...
  * [session.query](../../../../querying/overview.mdx#sessionquery)  
  * [session.advanced.documentQuery](../../../../querying/overview.mdx#sessionadvanceddocumentquery)  
  * [session.advanced.rawQuery](../../../../querying/overview.mdx#sessionadvancedrawquery)
...
* RQL Example: &nbsp; `from Employees where FirstName == "Laura"`  
  See more examples [below](../../../../querying/overview.mdx#sessionquery).
...
* Queries defined with [query](../../../../querying/overview.mdx#sessionquery) 
  or [documentQuery](../../../../querying/overview.mdx#sessionadvanceddocumentquery) 
...
Available custom methods for session's [query](../../../../querying/overview.mdx#sessionquery) method:
