...
* In this page:
    ...
    * [Setting the revisions bin cleaner - from Studio](../../document-extensions/revisions/revisions-bin-cleaner.mdx#setting-the-revisions-bin-cleaner---from-studio)
...
* The cleaner task can be managed from:  
  * The [Revisions bin cleaner view](../../document-extensions/revisions/revisions-bin-cleaner.mdx#setting-the-revisions-bin-cleaner---from-studio) in Studio
...
## Setting the revisions bin cleaner - from Studio
