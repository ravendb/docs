...
| Parameters | | |
| ------------- | ------------- | ----- |
| **query** | [IDocumentQuery](../how-to-query.mdx#sessionadvanceddocumentquery) or [IRawDocumentQuery](../how-to-query.mdx#sessionadvancedrawquery) | Query to stream results for. |
