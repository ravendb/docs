...
* In this article:
    * [GenAI Task](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#genai-task)  
    * [Add a GenAI Task](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#add-a-genai-task)
    * [Configure basic settings](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#configure-basic-settings)
    * [Generate context objects](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#generate-context-objects)
    * [Define Prompt and JSON schema](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#define-prompt-and-json-schema)
    * [Provide update script](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#provide-update-script)
    * [Review configuration and Save task](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#review-configuration-and-save-task)
...
2. <a id="unique-identifier"/>**Identifier**  
    ...
    * When you complete creating the task and run it, the task will add a metadata property 
      ...
      See an example [here](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#run-time).  
...
5. <a id="studio_connection-string"/>**Connection string**  
    ...
    * You can create the connection string either here or in the dedicated 
      [AI Connection Strings](../../ai-integration/connection-strings/connection-strings-overview.mdx) view.  
...
3. <a id="generate-context-objects-playground"/>**Playground**  
    ...
    * **Select a document from the source collection**  
       ...
       * To use the same sample document we're using to demonstrate the process, 
         add [posts/1](../../.mdx) and select it here.  
...
4. **Controls**  
    ...
    * **Back**  
      Click to return to the previous step, [Configure basic settings](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#configure-basic-settings).  
    * **Test Context**  
    ...
    * **Next**  
      Click to advance to the next step, [Define prompt & JSON schema](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#define-prompt-and-json-schema).  
...
4. **Controls**  
    * **Cancel**  
      Click to cancel any changes made in the task.  
    * **Back**  
      Click to return to the previous step, [Generate context objects](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#generate-context-objects).  
    * **Test Context**  
      Click to test the prompt and JSON schema you define above, on the context objects generated from the 
      document you provided.  
    * **Next**  
      Click to advance to the next step, [Provide update script](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#provide-update-script).  
...
3. **Controls**  
    * **Cancel**  
      Click to cancel any changes made in the task.  
    * **Back**  
      Click to return to the previous step, [Define Prompt and JSON schema](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#define-prompt-and-json-schema).  
    * **Test Context**  
    ...
    * **Next**  
      Click to advance to the next step, [Review configuration and Save task](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#review-configuration-and-save-task).  
...
2. **Controls**  
    * **Cancel**  
      Click to cancel any changes made in the task.  
    * **Back**  
      Click to return to the previous step, [Provide update script](../../ai-integration/gen-ai-integration/gen-ai-studio.mdx#provide-update-script).  
    * **Save**  
      Save your task
