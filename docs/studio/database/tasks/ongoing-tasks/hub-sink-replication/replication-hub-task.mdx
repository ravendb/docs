...
description: "Create a RavenDB replication hub task in Studio that distributes documents to connected sink databases with access certificate management."
sidebar_position: 1
---
...
* In this page:
   * [Create an Ongoing Replication Hub Task](#create-an-ongoing-replication-hub-task)  
   * [Hub Configuration](#hub-configuration)  
   * [Access Configuration](#access-configuration)  
   * [Viewing and Editing Existing Accesses](#viewing-and-editing-existing-accesses)  
   * [Defining Filtered Replication](#defining-filtered-replication)  
