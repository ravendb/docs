...
* Queries defined with `query` or `document_query` are translated by the RavenDB client to [RQL](../../../../querying/rql/what-is-rql.mdx)  
...
* In this page:
  ...
  * [session.advanced.document_query](../../../../querying/overview.mdx#sessionadvanceddocument_query)  
  * [session.advanced.raw_query](../../../../querying/overview.mdx#sessionadvancedraw_query)
...
* Queries defined with [query](../../../../querying/overview.mdx#sessionquery) or [document_query](../../../../querying/overview.mdx#sessionadvanceddocument_query) are translated by the RavenDB client to [RQL](../../../../client-api/session/querying/what-is-rql.mdx)  
  when sent to the server.
