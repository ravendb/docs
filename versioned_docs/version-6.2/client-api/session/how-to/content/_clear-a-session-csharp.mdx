...
* To remove only a **single entity** from tracking, see [Evict a single entity](../evict-entity-from-a-session.mdx).

* In this article:
  * [Clear the session's state](#clear-the-sessions-state)
  * [Syntax](#syntax)  
