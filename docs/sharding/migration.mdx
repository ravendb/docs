...
can then be [imported](./import-and-export.mdx#import) into 
...
* Read about export and import in a sharded database [here](./import-and-export.mdx).  

* Data can also be 
  [imported from backup files](./import-and-export.mdx#importing-data-from-backup-files).  
  ...
  <Admonition type="note" title="">
  Note that this opposes [restoring](./backup-and-restore/restore.mdx) 
...
[ongoing tasks](../backup/overview.mdx) 
...
[imported](./import-and-export.mdx#importing-data-from-backup-files) 
into a new or an existing sharded database.  

<Admonition type="note" title="">
A backup created for a non-sharded database **cannot** be 
[restored](./backup-and-restore/restore.mdx) as a sharded database.  
...
and [create a live replica of its data on a sharded database](./external-replication.mdx#non-sharded-database-to-sharded-database).  
