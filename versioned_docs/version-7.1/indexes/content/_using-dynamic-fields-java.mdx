...
Dynamic fields can be indexed for [Full-text search](../querying/searching.mdx) by setting `indexing: 'Search'` in the `createField` options object (`AbstractJavaScriptIndexCreationTask`)
