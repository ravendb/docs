...
* Queries are written in [RQL](../../../indexes/querying/what-is-rql.mdx), our user friendly SQL-like query language.  
...
| **explain** | Used for queries on [Auto Indexes](../../../indexes/creating-and-deploying.mdx#auto-indexes).
