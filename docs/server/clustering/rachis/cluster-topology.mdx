...
description: "Manage RavenDB cluster topology including member, promotable, and watcher node types with their roles and voting behavior."
sidebar_position: 1
---
...
| **Watcher**    | A non-voting node that is still fully managed by the cluster. <br/> Can be assigned with databases and tasks. See more [below](../../../server/clustering/rachis/cluster-topology.mdx#watcher). |
