...
<Image img={require("./assets/zabbix1.webp")} alt="" />

You should be greeted with a sight like this:

<Image img={require("./assets/zabbix2.webp")} alt="" />
...
<Image img={require("./assets/zabbix3.webp")} alt="" />
...
<Image img={require("./assets/zabbix4.webp")} alt="" />
...
<Image img={require("./assets/zabbix5.webp")} alt="" />
...
<Image img={require("./assets/zabbix6.webp")} alt="" />
...
<Image img={require("./assets/zabbix7.webp")} alt="" />
...
<Image img={require("./assets/zabbix8.webp")} alt="" />
...
<Image img={require("./assets/zabbix9.webp")} alt="" />
...
<Image img={require("./assets/zabbix10.webp")} alt="" />
...
<Image img={require("./assets/zabbix11.webp")} alt="" />
...
<Image img={require("./assets/zabbix12.webp")} alt="" />
...
<Image img={require("./assets/zabbix13.webp")} alt="" />
