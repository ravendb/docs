...
Cluster-wide transactions have the notion of [atomic guards](../session/cluster-transaction/atomic-guards.mdx) to prevent an overwrite of a document modified in a cluster transaction by a change made in another cluster transaction.
