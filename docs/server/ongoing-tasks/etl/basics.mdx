...
* The destination address and access options are set using a pre-defined **connection string**, simplifying deployment across different environments. 
  ...
  Learn more in the [Connection Strings - Overview](../../../integrations/connection-strings/overview.mdx) article.  
...
ETL errors and warnings are [logged to files](../../../monitoring/logging/overview.mdx) and displayed in the [notification center](../../../monitoring/alerts-and-notifications/notification-center.mdx) panel.  
