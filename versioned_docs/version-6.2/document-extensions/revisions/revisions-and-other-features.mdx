...
* Revisions are transferred during [replication](../../server/clustering/replication/replication.mdx) from one database instance to another.
...
* Revisions can [help keep data consistency](../../server/clustering/replication/replication.mdx#how-revisions-replication-help-data-consistency).  
