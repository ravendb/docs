...
<Image img={require("./assets/fromzero1.webp")} alt="Architecture diagram showing the complete RavenDB Kubernetes deployment built throughout the guide series" />
...
<Image img={require("./assets/fromzero6.webp")} alt="Azure Load Balancer architecture diagram showing zone-redundant public IPs routing to Kubernetes services" />
...
<Image img={require("./assets/fromzero9.webp")} alt="Architecture diagram showing DNS resolution configured for RavenDB nodes within the Kubernetes cluster" />
...
<Image img={require("./assets/fromzero12.webp")} alt="Architecture diagram showing the operator reconciliation loop creating StatefulSets, Services, and other resources" />
...
<Image img={require("./assets/fromzero13.webp")} alt="Architecture diagram showing completed cluster initialization with all nodes registered and cluster fully formed" />
...
<Image img={require("./assets/fromzero15.webp")} alt="Architecture diagram showing the fully operational RavenDB cluster with certificates and bootstrap completed" />
...
<Image img={require("./assets/fromzero19.webp")} alt="RavenDB Studio About tab showing the updated server version after the rolling upgrade completed" />
...
<Image img={require("./assets/fromzero20.webp")} alt="RavenDB Studio showing a healthy replicated database across all three nodes before sabotage" />
After Sabotage:

<Image img={require("./assets/fromzero21.webp")} alt="RavenDB Studio showing the database in a degraded state after sabotaging nodes A and C" />
