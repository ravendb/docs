...
description: "Revert all documents in a RavenDB database to their state at a specific point in time using stored revisions and the revert operation."
...
* To revert a single document (or multiple documents) to a specific revision,  
  see [Revert documents to specific revisions](./revert-documents-to-specific-revisions.mdx).
...
* In this article:  
   * [The revisions settings view](#the-revisions-settings-view)
   * [Revert documents](#revert-documents)
     * [Point in time](#point-in-time)
     * [Time Window](#time-window)
     * [Content reverted](#content-reverted)
...
1. **The revisions settings view**:  
   ...
   * [Revert](#revert-documents) documents to revisions
...
3. **Revert documents**:  
   ...
   Learn more [below](#revert-documents).
...
1. Enter the **Point in Time** to which you would like to revert the documents. Learn more [below](#point-in-time).  

2. Enter the **Time Window**. Learn more [below](#time-window).  
...
* Document extensions:  
  * **Time series**  
    Time series data is Not reverted. Learn more [here](../revisions-and-other-features.mdx#reverted-data-1).  
  * **Attachments**   
