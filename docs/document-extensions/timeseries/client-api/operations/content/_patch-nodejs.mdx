...
* Patching time series data (Append or Delete entries) can be performed via [Operations](../../../../../client-api/operations/what-are-operations.mdx).
  ...
  * Use [PatchByQueryOperation](../../../../../documents/patching-documents/patch-multiple-documents/client-api.mdx) to patch data on **multiple** documents.
...
* The detailed syntax of `PatchByQueryOperation` is listed under this [syntax section](../../../../../documents/patching-documents/patch-multiple-documents/client-api.mdx#patchbyqueryoperation-syntax).
