...
title: "Vector Search"
sidebar_label: Start
description: "Search by meaning and context using RavenDB vector search, which compares embeddings to find semantically similar content."
sidebar_position: 0
---
...
<ColGrid colCount={2}>
    <CardWithImage title="Vector search - Overview" 
                   description="Learn about vector search in RavenDB." 
...
<ColGrid colCount={2}>
    <CardWithImage
        ...
        description="Automate embedding generation and easily query vectorized data to find results by meaning rather than keywords, by Paweł Lachowski."
        url="https://ravendb.net/articles/semantic-search-with-ravendb-python-and-fastapi" 
        imgIcon="vector-search"
    />
    <CardWithImage
