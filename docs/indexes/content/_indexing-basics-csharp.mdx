...
You can also create queries manually by using  [DocumentQuery](../../querying/document-query/what-is-document-query.mdx) or [RawQuery](../../querying/how-to-query.mdx#sessionadvancedrawquery), both available as a part of advanced session operations:
