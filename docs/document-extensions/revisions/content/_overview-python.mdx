...
* Managed via the Client API or from Studio, revisions can be created **automatically** or **manually**:
...
* Via Studio:
    ...
    * Inspect existing revisions and manually create a new revision in the [Revisions tab](../../../studio/database/document-extensions/revisions/revisions-overview.mdx#revisions-tab) in Studio's Document View.
* Via Client API:
...
1. **Enable Revisions** so we can experiment with the feature.  
   Revisions can be enabled from [Studio](../../../studio/database/settings/document-revisions.mdx)
...
2. **Create a new document in the `Users` collection**.  
   ...
   You can create the document in [Studio](../../../studio/database/documents/create-new-document.mdx#create-new-document)
...
3. **Inspect the new document's [Revisions Tab](../../../studio/database/document-extensions/revisions/revisions-overview.mdx#revisions-tab)** in Studio.  
...
5. **Delete the document**.  
   ...
   including a new revision (called "Delete Revision"), created to indicate that the document was deleted.
     ...
     * Open the `Documents > Revisions Bin` section in Studio  
...
* You can force the creation of a revision via [Studio](../../../document-extensions/revisions/overview.mdx#force-revision-creation-via-studio)
...
To create a revision manually via Studio,  
