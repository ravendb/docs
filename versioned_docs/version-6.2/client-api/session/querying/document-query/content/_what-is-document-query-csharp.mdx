...
* Unlike the `Query` method, the `DocumentQuery` method does Not support LINQ.  
  ...
  as it provides low-level querying capabilities. See [Query -vs- DocumentQuery](../query-vs-document-query.mdx) for all differences.

* In this page:
  * [DocumentQuery examples](#documentquery-examples)
  * [Convert between DocumentQuery and Query](#convert-between-documentquery-and-query)
  * [Custom Methods and Extensions](#custom-methods-and-extensions)
  * [Syntax](#syntax)
...
The available `DocumentQuery` overloads are listed in this [Syntax section](../../how-to-query.mdx#syntax) in the [Query Overview](../../how-to-query.mdx).
