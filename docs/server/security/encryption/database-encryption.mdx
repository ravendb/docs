...
description: "Encrypt RavenDB databases at rest using XChaCha20-Poly1305 encryption with master key protection and per-database encryption keys."
sidebar_position: 1
---
...
See [Secret Key Management](./secret-key-management.mdx) for more information.  
