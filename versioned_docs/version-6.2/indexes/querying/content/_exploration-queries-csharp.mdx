...
* **Exploration Queries** form an additional layer of filtering that can be applied
  to a dataset after its retrieval by [Query](../../../client-api/session/querying/how-to-query.mdx#sessionquery),
  [DocumentQuery](../../../client-api/session/querying/how-to-query.mdx#sessionadvanceddocumentquery),
  or [Raw RQL](../../../client-api/session/querying/how-to-query.mdx#sessionadvancedrawquery),
...
* Exploration queries need to be used 
  ...
  when large datasets are handled.  
    ...
    * Use [where](../filtering.mdx) in recurring queries, 
...
[where](../filtering.mdx) and can be further enhanced 
...
* Use [where](../filtering.mdx) rather than `filter` for recurring filtering.  
