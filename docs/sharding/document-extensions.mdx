...
* Document extensions are identified by the ID of their parent document, 
  and are always stored in [the same bucket](./overview.mdx#document-extensions-storage) 
  as the document.  
...
* It takes longer to retrieve related documents (and their extensions) when 
  ...
  store related documents [in the same bucket](./administration/anchoring-documents.mdx) 
  in advance.  
