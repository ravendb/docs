...
Quill doesn't give you a database, nor asks you to build one. You bring the app and its database, and Quill attaches to it, adding the AI chat layer on top. If you already run something on Postgres, SQL Server, or MySQL/MariaDB, Quill can put a conversational agent on top of it.
