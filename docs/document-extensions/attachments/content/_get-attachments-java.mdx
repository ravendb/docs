...
* In this article
  * [Get attachment via the session](../../document-extensions/attachments/get-attachments.mdx#get-attachment-via-the-session)  
  * [Get attachment via an operation](../../document-extensions/attachments/get-attachments.mdx#get-attachment-via-an-operation) 
