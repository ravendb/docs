...
* In this page:  
  ...
  * [Saving Map-Reduce Results into a Collection (Artificial Documents)](#saving-map-reduce-results-in-a-collection-artificial-documents))  
...
2. Optional: The results of the Map-Reduce index can be saved in a new collection.  
   Learn more in [Saving Map-Reduce Results in a Collection (Artificial Documents)](#saving-map-reduce-results-in-a-collection-artificial-documents))
