...
* In this article:
    * [GenAI Task](../../../ai-integration/gen-ai-integration/create-gen-ai-task/create-gen-ai-task_studio#genai-task)  
...
2. <a id="unique-identifier"/>**Unique user-defined task identifier**  
    ...
    * When you complete creating the task and run it, the task will add a metadata property to documents it processes, named after the identifier you define here.  
