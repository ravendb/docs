---
title: "Installation: Kubernetes: Azure AKS"
sidebar_label: Azure AKS
description: "Deploy a RavenDB cluster on Azure AKS with persistent volumes, load balancers, and Kubernetes-native certificate management."
sidebar_position: 1
---
