...
* If you upgrade to RavenDB 6.0, you need to upgrade your current license key 
  ...
  as explained [below](#upgrade-a-license-key-for-ravendb-6x) 
  to upgrade your key.  

* In this page:
    * [Replace license from Studio](#replace-license-from-studio)  
    * [Upgrade a License Key For RavenDB 6.x](#upgrade-a-license-key-for-ravendb-6x)  
...
[Replace](#replace-license-from-studio) your current key with the new one.  
