...
* To check what is the actual type of change made to the entities, see:  
  [Get entity changes](../check-if-entity-has-changed.mdx#get-entity-changes), or
  [Get session changes](../check-if-there-are-any-changes-on-a-session.mdx#get-session-changes).
 
* In this page:
  * [Get tracked entities](#get-tracked-entities)
  * [Syntax](#syntax)
