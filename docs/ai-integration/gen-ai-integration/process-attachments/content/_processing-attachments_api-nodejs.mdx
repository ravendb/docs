...
* A complete example of how to define and run a GenAI task that processes attachments **via Studio**  
  is available in [Processing attachments: Studio](../processing-attachments_studio.mdx).
...
* When [defining the connection string](../../create-gen-ai-task/create-gen-ai-task_api.mdx#define-a-connection-string) to the LLM,
...
* When [creating the context object](../../overview.mdx#the-elements) that will be sent to the LLM, 
...
* When [defining the task Prompt and JSON schema](../processing-attachments_studio.mdx#set-task-prompt-and-json-schema),   
...
* When [defining the task Update script](../processing-attachments_studio.mdx#set-task-update-script),   
