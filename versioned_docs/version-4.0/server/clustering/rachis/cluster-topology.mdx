...
With [Cluster Operator](../../security/authorization/security-clearance-and-permissions.mdx#operator) privileges, 
...
* [Raft Commands](../../../server/clustering/rachis/what-is-rachis.mdx#implementation-details) can't be accepted while there is no Leader or if the Leader is down.  
</Admonition>
