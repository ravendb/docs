...
Set whether [documents compression](../../server/storage/documents-compression.mdx) should be turned on by default for ALL COLLECTIONS  
...
Set whether [documents compression](../../server/storage/documents-compression.mdx) should be turned on by default for REVISIONS  
on newly created databases.  
