...
description: "Collect RavenDB server metrics using Telegraf with SNMP input plugin configuration for performance dashboards and alerting systems."
sidebar_position: 0
---
...
* In this page:  
   * [Telegraf](../../../server/administration/monitoring/telegraf.mdx#telegraf)  
   * [Monitoring Endpoints](../../../server/administration/monitoring/telegraf.mdx#monitoring-endpoints)  
   * [JSON Fields Returned by the Endpoints](../../../server/administration/monitoring/telegraf.mdx#json-fields-returned-by-the-endpoints)  
...
* `<your server URL>/admin/monitoring/v1/etls`  
* `<your server URL>/admin/monitoring/v1/ai-tasks`  
