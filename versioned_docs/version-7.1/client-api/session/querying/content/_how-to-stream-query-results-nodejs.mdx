...
* __Query limitations:__:
    ...
    * Using [include](../../loading-entities.mdx#load-with-includes) to load a related document to the session in a streaming query is Not supported.  
...
* An [include](../../loading-entities.mdx#load-with-includes) clause in a non-streamed query loads these related documents to the session  
