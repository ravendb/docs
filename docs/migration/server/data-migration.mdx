...
[NLog logging framework](../../monitoring/logs/overview.mdx) and writes all log 
data through it.  
...
[Learn more here about migration and the new logging system.](../../monitoring/logs/overview.mdx#customizing-logging-level-after-migration).  
