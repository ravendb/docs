...
* Key Characteristics of a compare-exchange item:
  * Cluster-wide - Visible and consistent across all nodes in the [database group](../studio/database/settings/manage-database-group.mdx).
...
* On this start page, you'll find:
  * [Technical documentation links](../compare-exchange/start.mdx#technical-documentation-links-)
  * [RavenDB Demo links](../compare-exchange/start.mdx#ravendb-demo-links)
  * [Related blog posts](../compare-exchange/start.mdx#related-blog-posts)
  * [Related in-depth articles](../compare-exchange/start.mdx#related-in-depth-articles)
  * [Sample use cases](../compare-exchange/start.mdx#sample-use-cases)
...
* [Overview](../compare-exchange/overview.mdx) 
* [Create Compare-Exchange Items](../compare-exchange/create-cmpxchg-items.mdx)
* [Get Compare-Exchange Item](../compare-exchange/get-cmpxchg-item.mdx)
* [Get Compare-Exchange Items](../compare-exchange/get-cmpxchg-items.mdx)
* [Delete Compare-Exchange Items](../compare-exchange/delete-cmpxchg-items.mdx)
* [Update Compare-Exchange Item](../compare-exchange/update-cmpxchg-item.mdx)
* [Include Compare-Exchange Items](../compare-exchange/include-cmpxchg-items.mdx)
* [Indexing Compare-Exchange Values](../compare-exchange/indexing-cmpxchg-values.mdx)
* [Compare-Exchange in Dynamic Queries](../compare-exchange/cmpxchg-in-dynamic-queries.mdx)
* [Compare-Exchange Expiration](../compare-exchange/cmpxchg-expiration.mdx)
