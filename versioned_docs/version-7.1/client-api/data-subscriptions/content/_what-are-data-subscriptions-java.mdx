...
1. [Subscription Creation Options](../creation/api-overview.mdx#subscriptioncreationoptions): The documents that will be received, it's filtering and projection.
