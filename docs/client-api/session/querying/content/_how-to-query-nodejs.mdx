...
* Queries defined with [query](../../../client-api/session/querying/how-to-query.mdx#sessionquery) are translated by the RavenDB client to [RQL](../../../../querying/what-is-rql.mdx) when sent to the server.  
