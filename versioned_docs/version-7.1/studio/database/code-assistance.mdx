...
* All queries addressed to the RavenDB server use [RQL](../../client-api/session/querying/what-is-rql.mdx), 
...
* Code Assistance is available in the [Query](./queries/query-view.mdx#query-view), 
  [Patch](./documents/patch-view.mdx#the-patch-view), 
  and [Subscription Task Definition](./tasks/ongoing-tasks/subscription-task.mdx#subscription-task-definition) 
  views.  
...
* RQL code assistance is available in the following views:  
   - [Query View](./queries/query-view.mdx#query-view)  
   - [Patch View](./documents/patch-view.mdx#the-patch-view)  
   - [Subscription Task View](./tasks/ongoing-tasks/subscription-task.mdx#subscription-task-definition)  
...
* [from](../../client-api/session/querying/what-is-rql.mdx#from) - to select a collection to query on  
* `from index` - to select an index to query on  
* [declare function](../../client-api/session/querying/what-is-rql.mdx#declare) - to create a JavaScript function  
