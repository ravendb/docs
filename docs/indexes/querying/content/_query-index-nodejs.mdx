...
* Queries defined with [query](../../indexes/querying/query-index.mdx#sessionquery) are translated by the RavenDB client to [RQL](../../../querying/rql/what-is-rql.mdx) when sent to the server.
