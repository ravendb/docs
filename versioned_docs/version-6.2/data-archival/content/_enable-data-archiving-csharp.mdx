...
* Once enabled, the archiving task runs periodically at the configured frequency,  
  ...
  Learn how to schedule documents for archival in [Schedule document archiving](../schedule-document-archiving.mdx).

* In this article:
  * [Enable archiving - from the Client API](#enable-archiving---from-the-client-api)
  * [Enable archiving - from the Studio](#enable-archiving---from-the-studio)  
