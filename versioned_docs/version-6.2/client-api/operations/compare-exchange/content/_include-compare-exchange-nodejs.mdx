...
* Compare-Exchange items can be included when [loading entities](../../../session/loading-entities.mdx) 
  and when making [queries](../../../session/querying/how-to-query.mdx).

* The Session [tracks](../../../session/what-is-a-session-and-how-does-it-work.mdx#tracking-changes) 
...
* In this page:
    ...
    * [Include CmpXchg items when loading](#include-cmpxchg-items-when-loading)
    * [Include CmpXchg items when querying](#include-cmpxchg-items-when-querying)
    * [Syntax](#syntax)
...
* Use the [include](../../../session/querying/what-is-rql.mdx#include) keyword followed by `cmpxchg()` to include a compare-exchange item.  
...
* Use `includes.cmpxchg()` In [javascript functions](../../../session/querying/what-is-rql.mdx#declare) within RQL queries. 
