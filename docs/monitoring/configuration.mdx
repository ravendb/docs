...
| - | - |
| Alerts and notifications (filtering out notifications) | [Notification center: Configuration](alerts-and-notifications/notification-center.mdx#configuration) |
| Integrations (SNMP, OpenTelemetry) | [Integrations: Configuration](integrations/configuration.mdx) |
| Logging | [Logging: Configuration](logging/configuration.mdx) |
...
| Traffic watch | [Traffic Watch: Configuration](traffic-watch/configuration.mdx) |
