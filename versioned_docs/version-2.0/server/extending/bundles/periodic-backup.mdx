...
To activate bundle globally just add `PeriodicBackup` to the `Raven/ActiveBundles`. More about setting up configuration can be found [here](../../../server/administration/configuration.mdx).
