...
* Configuration scope:  
  ...
  * To change the settings for a specific agent, edit its configuration using the [API](../ai-integration/ai-agents/creating-ai-agents/creating-ai-agents_api.mdx#defining-an-agent-configuration) or [Studio](../ai-integration/ai-agents/creating-ai-agents/creating-ai-agents_studio.mdx#configure-basic-settings).  
