...
* **Can the upload process be canceled?**   
  ...
  or by temporarily disabling the remote attachments feature entirely. (See [Configure remote attachments](../../../document-extensions/attachments/configure-remote-attachments)).  
...
* **Can a remote attachment be pulled back into local storage?**  
  ...
  To "un-remote" an attachment, you'll need to retrieve it from the remote storage (see [Get attachments](../../../document-extensions/attachments/get-attachments)),  
  and then store it again in the database as a local attachment (see [Store attachments in local storage](../../../document-extensions/attachments/store-attachments/store-attachments-local)).   
...
* **Why is my attachment not uploading?**  
  ...
  * Revisions are enabled for the document’s collection. See [Remote attachments and revisions](../../../document-extensions/attachments/attachments-and-other-features#attachments-revisions).    
