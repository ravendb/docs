...
* In this article:
  ...
  * [Reducing server calls (best practices)](#reducing-server-calls-best-practices)  
...
<Panel heading="Session overview">
...
<Panel heading="Unit of work pattern">
...
* Prior to saving, you can review the changes made if necessary. See:
    * [Get tracked entities](../how-to/get-tracked-entities.mdx)
    * [Check for session changes](../how-to/check-if-there-are-any-changes-on-a-session.mdx)
...
<Panel heading="Identity map pattern"> 
...
<Panel heading="Batching & Transactions">
...
<Panel heading="Concurrency control">
...
See [Enable optimistic concurrency](../configuration/how-to-enable-optimistic-concurrency.mdx) for detailed behavior and configuration options.     

</Panel>

<Panel heading="Reducing server calls (best practices)">
