...
description: "Create a new RavenDB database through Studio with replication factor, node assignment, encryption selection, and path configuration options."
sidebar_position: 0
---
...
* From Studio, the database creation options are:  
  ...
  * Create a database from a **Backup** - see [Restore from backup](../../../backup/restore#restoring-from-backup-using-studio).  
