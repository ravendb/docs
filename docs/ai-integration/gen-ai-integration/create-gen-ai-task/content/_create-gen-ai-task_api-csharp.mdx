...
* The main steps in defining a GenAI task are:  
   * Defining a [Connection string](#defining-a-connection-string) 
     to the AI model  
   * Defining a [Context generation script](../../overview.mdx#the-elements_context-objects)  
   * Defining a [Prompt](../../overview.mdx#the-elements_prompt)  
   * Defining a [JSON schema](../../overview.mdx#the-elements_json-schema)  
   * Defining an [Update script](../../overview.mdx#the-elements_update-script)  
...
* Choose the model to connect with, by what you need from your GenAI task.  
  ...
  development phase, you may prefer a local AI service like [Ollama](../../../connection-strings/ollama.mdx).  
...
* Learn more about connection strings [here](../../../connection-strings/overview.mdx).  
...
| **SampleObject** | `string` | A [sample response object](../../overview.mdx#the-elements_json-schema) to format the AI model's replies by <br/> If both a `SampleObject` and a `JsonSchema` are provided the schema takes precedence |
| **JsonSchema** | `string` | A [JSON schema](../../overview.mdx#the-elements_json-schema) to format the AI model's replies by <br/> If both a `SampleObject` and a `JsonSchema` are provided the schema takes precedence |
