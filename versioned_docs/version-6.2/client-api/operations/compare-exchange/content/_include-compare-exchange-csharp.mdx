...
* The Compare Exchange include syntax is based on the [include method](../../../how-to/handle-document-relationships.mdx#includes).  
...
In an RQL query, you can use the [`include` keyword](../../../session/querying/what-is-rql.mdx#include) 
...
In [javascript functions](../../../session/querying/what-is-rql.mdx#declare) within queries, 
