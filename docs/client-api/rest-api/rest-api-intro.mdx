...
These files can be found in the configuration Zip package you received at the end of the
setup wizard.  
The certificate and key are found at the root of the package with the names:
