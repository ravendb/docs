...
<Image img={require("./assets/zabbix1.png")} alt="" />
You should be greeted with sight like that:  

<Image img={require("./assets/zabbix2.png")} alt="" />
...
<Image img={require("./assets/zabbix3.png")} alt="" />
...
<Image img={require("./assets/zabbix4.png")} alt="" />
...
<Image img={require("./assets/zabbix5.png")} alt="" />
...
<Image img={require("./assets/zabbix6.png")} alt="" />
...
<Image img={require("./assets/zabbix7.png")} alt="" />
...
<Image img={require("./assets/zabbix8.png")} alt="" />
...
<Image img={require("./assets/zabbix9.png")} alt="" />
...
<Image img={require("./assets/zabbix10.png")} alt="" />
