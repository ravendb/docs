...
* The main steps in defining a GenAI task are:  
   * Defining a [Connection string](../../ai-integration/gen-ai-integration/gen-ai-api.mdx#defining-a-connection-string) 
     to the AI model  
   * Defining a [Context generation script](../../ai-integration/gen-ai-integration/gen-ai-overview.mdx#the-elements_context-objects)  
   * Defining a [Prompt](../../ai-integration/gen-ai-integration/gen-ai-overview.mdx#the-elements_prompt)  
   * Defining a [JSON schema](../../ai-integration/gen-ai-integration/gen-ai-overview.mdx#the-elements_json-schema)  
   * Defining an [Update script](../../ai-integration/gen-ai-integration/gen-ai-overview.mdx#the-elements_update-script)  

* In this article:
    * [Defining a Connection string](../../ai-integration/gen-ai-integration/gen-ai-api.mdx#defining-a-connection-string)
    * [Defining the GenAI task](../../ai-integration/gen-ai-integration/gen-ai-api.mdx#defining-the-genai-task)
...
* Learn more about connection strings [here](../../ai-integration/connection-strings/connection-strings-overview.mdx).  
### Example:
...
| **SampleObject** | `string` | A [sample response object](../../ai-integration/gen-ai-integration/gen-ai-overview.mdx#the-elements_json-schema) to format the AI model's replies by <br/> If both a `SampleObject` and a `JsonSchema` are provided the schema takes precedence |
| **JsonSchema** | `string` | A [JSON schema](../../ai-integration/gen-ai-integration/gen-ai-overview.mdx#the-elements_json-schema) to format the AI model's replies by <br/> If both a `SampleObject` and a `JsonSchema` are provided the schema takes precedence |
