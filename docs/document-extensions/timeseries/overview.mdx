...
* RavenDB Time series can be managed and utilized using a thorough set of 
  ...
  [Studio](../../studio/database/document-extensions/time-series.mdx), 
...
* **Full GUI Support**  
  Time series can be viewed and managed using [Studio](../../studio/database/document-extensions/time-series.mdx).
