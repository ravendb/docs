...
<ColGrid colCount={2}>
    <CardWithImage title="GenAI tasks overview" description="Learn the concepts and flow of GenAI tasks in RavenDB" url="../../ai-integration/gen-ai-integration/gen-ai-overview" imgIcon="gen-ai" ctaLabel="Read" />
