...
* Only the **database scope** configuration keys can be edited from this view.  
  ...
  [`settings.json` file](../../../server/configuration/configuration-options.mdx#settings.json) 
...
5. The lock icon indicates that this key is server scoped and can not be modified here.  
   It can be edited only from the [`settings.json` file](../../../server/configuration/configuration-options.mdx#settings.json) 
