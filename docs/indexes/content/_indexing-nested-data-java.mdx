...
RavenDB will give you a performance hint regarding high fanout ratio using the Studio's [notification center](../../monitoring/alerts-and-notifications/notification-center.mdx).
</Admonition>
