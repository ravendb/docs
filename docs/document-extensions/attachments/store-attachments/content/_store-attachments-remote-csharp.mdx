...
* This article focuses on **storing attachments in a remote storage**.  
  To learn about local storage, see [Store attachments in local storage](../store-attachments-local.mdx).
...
* **To store attachments in remote storage**, first enable the feature and configure one or more remote destinations.  
  See [Configure remote attachments](../../configure-remote-attachments.mdx).  
...
* **After a successful upload:**:
  ...
  * Any actions triggered by the document change, such as indexing or ongoing tasks configured for the document, will be executed. 
    Learn more in [Attachments and other features](../../attachments-and-other-features.mdx).
...
* **Can the upload process be canceled?**   
  ...
  or by temporarily disabling the remote attachments feature entirely. (See [Configure remote attachments](../../configure-remote-attachments.mdx)).  
...
* **Can a remote attachment be pulled back into local storage?**  
  ...
  To "un-remote" an attachment, you'll need to retrieve it from the remote storage (see [Get attachments](../../get-attachments.mdx)),  
  and then store it again in the database as a local attachment (see [Store attachments in local storage](../store-attachments-local.mdx)).   
...
* **Why is my attachment not uploading?**  
  ...
  * Configuration issues:  
    ...
    or the destination identifier is invalid or not configured. See [Configure remote attachments](../../configure-remote-attachments.mdx). 
  * The upload time has not yet arrived.
  * The server cannot connect to the remote storage destination.    
  * Revisions are enabled for the document’s collection. See [Remote attachments and revisions](../../attachments-and-other-features.mdx#attachments-revisions).    
...
* When storing remote attachments, you must specify the **destination identifier** and the **scheduled upload time**.  
  The destination identifier must be pre-configured. See [Configure remote attachments](../../configure-remote-attachments.mdx).
...
* Once patching is successful:
  ...
  * If the feature is enabled and destinations are defined (see [Configure remote attachments](../../configure-remote-attachments.mdx)),  
...
Unlike [local attachments](../store-attachments-local.mdx#deduplicating-local-attachments),
...
Please refer to [the syntax section](../store-attachments-local.mdx#syntax)
