...
* In this article: 
  * [Projecting compare-exchange values in query results](#projecting-compare-exchange-values-in-query-results)  
  * [Filtering by compare-exchange value](#filtering-by-compare-exchange-value)  
    * [Example 1 - Filtering when the compare-exchange value is a string](#example-1---filtering-when-the-compare-exchange-value-is-a-string)  
    * [Example 2 - Filtering when the compare-exchange value is an object](#example-2---filtering-when-the-compare-exchange-value-is-an-object)  
  * [Syntax](#syntax)  
...
* **Limitation**:  
  ...
  see the [next example](#example-2---filtering-when-the-compare-exchange-value-is-an-object).
