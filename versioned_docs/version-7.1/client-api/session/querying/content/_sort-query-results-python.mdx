...
* The results of a [group_by query](../how-to-perform-group-by-query.mdx) can be sorted by the `count` aggregation operation used in the query.
...
* The results of a [group_by query](../how-to-perform-group-by-query.mdx) can be sorted by the `sum` aggregation operation used in the query.
