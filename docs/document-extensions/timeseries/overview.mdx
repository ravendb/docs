...
* In this page:  
  * [Overview](#overview)  
     * [RavenDB's Time Series Implementation](#ravendbs-time-series-implementation)  
     * [Distributed Time Series](#distributed-time-series)  
     * [Time Series as Document Extensions](#time-series-as-document-extensions)  
     * [Time Series Features](#time-series-features)  
  * [Time Series Data](#time-series-data)  
  * [Separate Name and Data Storage](#separate-name-and-data-storage)  
  * [Time Series Segments](#time-series-segments)  
      * [Transactions Performance](#transactions-performance)  
      * [Common-Queries Performance](#common-queries-performance)  
  * [Time Series Entries](#time-series-entries)  
...
* **Highly-Efficient Storage Management**  
  ...
  and [segmented](#time-series-segments) to minimize storage usage and transmission time.
...
* **Time Series Querying and Aggregation**
    * [High-performance common queries](#common-queries-performance)  
...
**data** is kept [separately](#separate-name-and-data-storage).  
Time series data is **compressed** and composed of consecutive 
[segments](#time-series-segments) and 
[entries](#time-series-entries).  
