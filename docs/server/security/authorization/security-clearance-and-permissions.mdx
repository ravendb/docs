...
* **Data subscriptions access**  
  ...
  disable [data subscriptions](../../../data-subscriptions/overview.mdx).  
...
- Query the databases configured in the client certificate.
  <Admonition type="note" title="">
  If no existing index satisfies this query, an [auto-index](../../../indexes/creating-and-deploying.mdx#auto-indexes) may be built.
  </Admonition>
