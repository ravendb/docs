...
3. Remove old RavenDB binaries
    ...
    * **Avoid** overwriting your configuration files, e.g. [settings.json](../../server/configuration/configuration-options.mdx#settings.json).  
...
* If you have a license for a RavenDB version older than `6.x`, upgrading to version `6.0` will require you 
   ...
   * Read [here](../../start/licensing/replace-license.mdx#upgrade-a-license-key-for-ravendb-6.x) how to upgrade 
