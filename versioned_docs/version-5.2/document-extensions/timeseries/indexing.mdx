...
* In this page:  
  * [Syntax](../../document-extensions/timeseries/indexing.mdx#syntax)  
      ...
      * [`AbstractMultiMapTimeSeriesIndexCreationTask`](../../document-extensions/timeseries/indexing.mdx#abstractmultimaptimeseriesindexcreationtask)  
      * [`AbstractJavaScriptTimeSeriesIndexCreationTask`](../../document-extensions/timeseries/indexing.mdx#abstractjavascripttimeseriesindexcreationtask)  
...
1. Create a class that inherits from one of the abstract index creation task classes:   
  ...
  * [`AbstractMultiMapTimeSeriesIndexCreationTask`](../../document-extensions/timeseries/indexing.mdx#abstractmultimaptimeseriesindexcreationtask) for [multi-map](../../indexes/multi-map-indexes.mdx) time series indexes.  
  * [`AbstractJavaScriptTimeSeriesIndexCreationTask`](../../document-extensions/timeseries/indexing.mdx#abstractjavascripttimeseriesindexcreationtask) for static javascript indexes.  
...
See the example [below](../../document-extensions/timeseries/indexing.mdx#abstractjavascripttimeseriesindexcreationtask-1).  
Learn more about [JavaScript indexes](../../indexes/javascript-indexes.mdx).  
...
#### AbstractJavaScriptTimeSeriesIndexCreationTask  
<TabItem value="indexes_AbstractJavaScriptCreationTask" label="indexes_AbstractJavaScriptCreationTask">
<CodeBlock language="csharp">
