...
* In this article:  
  * [Create sample compare-exchange items](#create-sample-compare-exchange-items)
  * [Get compare-exchange items by list of keys](#get-compare-exchange-items-by-list-of-keys)
  * [Get compare-exchange items by prefix](#get-compare-exchange-items-by-prefix)
  * [Get compare-exchange items count](#get-compare-exchange-items-count)
  * [Syntax](#syntax)
