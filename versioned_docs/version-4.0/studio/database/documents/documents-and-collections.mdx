...
* For more information about a document, see [Document View](../../../studio/database/documents/document-view.mdx)
</Admonition>
...
* Documents in the _@hilo_ collection are created when the _RavenDB client_ (Not from the studio) is creating documents ([using a session](../../../client-api/session/storing-entities.mdx))
...
* For more information about the HiLo Algorithm, see [HiLo Algorithm](../../../client-api/document-identifiers/hilo-algorithm.mdx).  
