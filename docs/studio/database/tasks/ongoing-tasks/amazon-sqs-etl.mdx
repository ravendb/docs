...
* In this page:  
  * [Ongoing Tasks View](#ongoing-tasks-view)  
  * [Define the Amazon SQS ETL task](#define-amazon-sqs-etl-task)  
  * [Add or Edit Transformation Script](#add-or-edit-transformation-script)  
  * [Comments](#comments)  
      * [ETL message size -vs- Queue message size](#etl-message-size--vs--queue-message-size)  
</Admonition>
## Ongoing Tasks View
