---
title: "Points & Polygons: On Spatial Search in RavenDB"
tags: [python, demo, querying, indexes]
icon: "spatial-map-view"
description: "Explore Flat Finder demo with us and learn how to use spatial search in RavenDB."
...
Now that we have covered the theory, let’s look at the demo and see how to build it with RavenDB. The demo is coded in Python and is available to clone via this [link](https://github.com/poissoncorp/samples.flats).
