...
description: "Select a security option for your RavenDB server, choosing between automatic Let's Encrypt certificates, custom certificates, or unsecured mode."
sidebar_position: 3
---
...
* After entering your license as described in [Provide license key](./provide-license-key.mdx),  
...
* In this article:
  * [Choose a security method](#choose-a-security-method)  
  * [Generate Let's Encrypt certificate](#generate-let-s-encrypt-certificate)  
  * [Provide your own certificate](#provide-your-own-certificate)  
  * [Don't use certificate](#don-t-use-certificate)  
...
1. [Generate Let's Encrypt certificate](#generate-let-s-encrypt-certificate)  
2. [Provide your own certificate](#provide-your-own-certificate)    
3. [Don't use certificate](#don-t-use-certificate)  
4. After selecting a security method, click **"Continue"** to proceed with its setup steps.
5. Click **"Back"** to return to the previous step - [Provide license key](./provide-license-key.mdx).

</Panel> 

<Panel heading="Generate Let's Encrypt certificate">
 
Use this option to secure your server with a [Let's Encrypt certificate](../../../server/security/authentication/lets-encrypt-certificates.mdx).
...
To make this process as seamless as possible, **RavenDB provides a free domain name** for your cluster.  
RavenDB will automatically issue and renew a trusted HTTPS certificate for the [domain you define in the next step](#enter-a-domain-name),  
fully managing the certificate lifecycle so you don't need to provide or maintain your own. 
...
* Suitable when you want a simple, secure default configuration out-of-the-box.  
...
4. Click **"Back"** to return to the previous step - [Provide license key](./provide-license-key.mdx).
...
3. Click **"Continue"** to proceed to the next step: [Configure node addresses](./configure-node-addresses.mdx).
...
* **DNS configuration**  
  ...
  which you configure in the next step: [Configure node addresses](./configure-node-addresses.mdx).  
...
* **Using your own domain**  
  ...
  See [Provide your own certificate](#provide-your-own-certificate).
...
3. Click **"Back"** to return to the previous step - [Provide license key](./provide-license-key.mdx).
...
* If you use the Setup Wizard to construct a cluster, you must use the same certificate for all nodes.  
  If you want to use a different certificate for each node, this is only possible through [Manual setup](../manual.mdx).
...
2. Click **"Continue"** to proceed to the next step: [Configure node addresses](./configure-node-addresses.mdx).
