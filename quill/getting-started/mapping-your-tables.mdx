...
[Connecting your database](connecting-your-database.mdx) - After this step, Quill can reach your source
database, and the tables your app will work with are selected.
...
* As one document can hold data from several joined tables, not every mapped table becomes a set of documents.  
...
5. **Continue**  
   Click to leave the wizard. Loading will continue in the background.
