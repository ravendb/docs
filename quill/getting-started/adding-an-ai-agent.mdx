...
Achieved so far in [Getting Started](signing-up.mdx):  
[Signing up](signing-up.mdx) - your deployment has a name, a license key, and a dashboard API key.  
[Starting Quill](starting-quill.mdx) - Quill is running on your machine, and its management dashboard is open.  
[Connecting your database](connecting-your-database.mdx) - Quill can reach your source database, and the tables
your app will work with are selected.  
[Mapping your tables](mapping-your-tables.mdx) - your app is created, and Quill keeps its internal database
...
* The app's internal database now [holds a copy of your source data](mapping-your-tables.mdx#creating-the-app).  
...
* Quill can draft the agent's configuration from the app's [mapping](mapping-your-tables.mdx). You can also
...
* In this article:
   * [Prerequisites](adding-an-ai-agent.mdx#prerequisites)
   * [Opening the Add agent wizard](adding-an-ai-agent.mdx#opening-the-add-agent-wizard)
   * [Connecting to your LLM provider](adding-an-ai-agent.mdx#connecting-to-your-llm-provider)
   * [Drafting your agent](adding-an-ai-agent.mdx#drafting-your-agent)
      * [Accepting the AI Terms of Use](adding-an-ai-agent.mdx#accepting-the-ai-terms-of-use)
      * [Choosing a starting point](adding-an-ai-agent.mdx#choosing-a-starting-point)
   * [Reviewing your agent](adding-an-ai-agent.mdx#reviewing-your-agent)
      * [Reviewing the drafted agent](adding-an-ai-agent.mdx#reviewing-the-drafted-agent)
      * [Modifying the agent configuration](adding-an-ai-agent.mdx#modifying-the-agent-configuration)
   * [Testing and saving your agent](adding-an-ai-agent.mdx#testing-and-saving-your-agent)
      * [Chatting with the draft agent](adding-an-ai-agent.mdx#chatting-with-the-draft-agent)
      * [Saving the agent](adding-an-ai-agent.mdx#saving-the-agent)
...
* Quill offers three providers for a chat model: **OpenAI** and **Azure OpenAI**, hosted services you hold an
  ...
  well short of a hosted provider's.
...
* If you arrived here from the previous Getting Started step, you are already in the right place: you followed
  the **Add new app** wizard, clicked **[Continue](mapping-your-tables.mdx#creating-the-app)** at its last
  stage, and are now at the **Add agent** wizard.
* If you didn't arrive through the Getting Started path,
  [open Quill's management dashboard](starting-quill.mdx#signing-in-to-the-management-dashboard) and click
  the app to which you want to add an agent, on the **Apps** list.
...
2. **Next**  
   Continue to the **[Create your Agent with AI](adding-an-ai-agent.mdx#drafting-your-agent)** stage.
...
If you reached here through [Mapping your tables](mapping-your-tables.mdx) and used **AI Suggest** there, you
...
1. **AI-suggested agents based on your data**  
   Quill reads the app's [mapping](mapping-your-tables.mdx) and proposes agent configurations that suit your
...
4. **Next**  
   Continue to the **[Review & edit your agent](adding-an-ai-agent.mdx#reviewing-your-agent)** stage.
...
4. **Test agent**  
   Click to [chat with the draft agent before saving it](adding-an-ai-agent.mdx#chatting-with-the-draft-agent)

5. **Save agent**  
   Click to [create the agent and add it to the app](adding-an-ai-agent.mdx#saving-the-agent).
...
Click **Test agent** from the wizard's [Review & edit your agent](adding-an-ai-agent.mdx#reviewing-your-agent)
...
Adding a channel is optional, and is covered in the next Getting Started step.
