...
* **Querying with a limit is not supported in _patch/delete_ by query operations**  
  ...
  [PatchByQueryOperation](../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx#sending-a-patch-request) or [DeleteByQueryOperation](../client-api/operations/common/delete-by-query.mdx)  
...
* **Ordering streamed Map-Reduce results by _non-reduce-key_ fields**  
  Read more about this topic in [Streaming query results](../sharding/querying.mdx#streaming-query-results) above.
