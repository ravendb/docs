...
* In this article:  
  ...
  * [Monitoring backup tasks](../backup/overview#monitoring-backup-tasks)
...
[Learn how to access RavenDB metrics via SNMP](../server/administration/snmp/snmp-overview/)

---

### Retrieving a backup task status

You can retrieve a backup task's **status**, which reflects the task's **most recent completed backup run** (whether scheduled or [triggered manually](../backup/create/periodic-tasks/database-backup#triggering-an-immediate-backup-operation)).
...
[Learn to retrieve the status of a database backup task](../backup/create/periodic-tasks/database-backup#getting-backup-task-status)  
[Learn to retrieve the status of a server-wide derived backup task](../backup/create/periodic-tasks/server-wide-backup#getting-a-derived-backup-task-status)  
...
[Learn how to restore from backup to multiple cluster nodes](../backup/restore#restoring-a-database-to-multiple-cluster-nodes)  
