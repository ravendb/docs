---
title: "Ongoing Task Stats: RavenDB ETL Stats"
sidebar_label: RavenDB ETL Stats
description: "Monitor RavenDB-to-RavenDB ETL task performance in Studio with batch counts, document throughput, and error tracking metrics."
sidebar_position: 3
---
...
# Ongoing Task Stats: RavenDB ETL Stats
...
* See below how to read the activity track drawn for a 
  [RavenDB ETL task](../../../../studio/database/tasks/ongoing-tasks/ravendb-etl-task.mdx).  
...
* In this article:  
   * [The collapsed track](../../../../studio/database/stats/ongoing-tasks-stats/ravendb-etl-stats.mdx#the-collapsed-track)  
   * [The expanded track](../../../../studio/database/stats/ongoing-tasks-stats/ravendb-etl-stats.mdx#the-expanded-track)  

</Admonition>

<Panel heading="The collapsed track">

![The collapsed RavenDB ETL track](./assets/stats-view-09-etl-closed-view.png)
...
Expanding a RavenDB ETL track reveals the operations included in each batch.  

Hover above an operation bar of an expanded track to see the bar's properties as depicted below.  

![The expanded RavenDB ETL track](./assets/stats-view-10-etl-expanded-view.png)
...
* **RavenDB ETL** bar.  
  The topmost bar, reporting properties measured over the whole batch:  
     ...
     * **Batch complete reason**  
       The reason the batch ended, e.g., "No more items to process" or "Stopping the batch because 
...
* **Load** bar.  
  Properties measured while loading the transformed items into the destination database:  
     * **Duration**  
