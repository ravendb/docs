...
* In this article:
   * [Choosing the mapping method: AI Suggest or Manual](mapping-your-tables.mdx#choosing-the-mapping-method-ai-suggest-or-manual)
   * [Settling the mapping](mapping-your-tables.mdx#settling-the-mapping)
   * [Testing your mapping](mapping-your-tables.mdx#testing-your-mapping)
   * [Creating the app](mapping-your-tables.mdx#creating-the-app)
...
This page starts where [Connecting your database](connecting-your-database.mdx) left off: you are at the
**How would you like to map your schema?** stage of the **Add new app** wizard.

</ContentFrame>

After [Verifying your schema](connecting-your-database.mdx#verifying-your-schema), the **Add new app** wizard lets you choose the
...
4. **Next**  
   Continue to the **[Map schema](mapping-your-tables.mdx#settling-the-mapping)** stage.
...
1. **Verify tables**  
   ...
   This is the check the **[Verify your schema](connecting-your-database.mdx#verifying-your-schema)** stage ran,
...
5. **Next**  
   Continue to the **[Preview before full ingest](mapping-your-tables.mdx#testing-your-mapping)** stage.
...
4. **Export configuration**  
   ...
   **[Import configuration](connecting-your-database.mdx#naming-your-app-and-entering-the-connection-details)**
...
5. **Continue**  
   Click to advance to the next Getting Started step, [Adding an AI agent](adding-an-ai-agent.mdx).  
