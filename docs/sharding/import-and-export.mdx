...
description: "Import and export data to and from RavenDB sharded databases using smuggler with shard-aware document distribution and routing."
...
* Unlike the [restore](../backup/restore.mdx) operation, 
...
<Admonition type="note" title="">
[Incremental backups](../backup/overview.mdx#backup-scope) 
