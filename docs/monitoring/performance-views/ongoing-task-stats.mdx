...
Each bar spans the duration of one operation, positioned on the time axis at the operation's start 
time.  
...
11. **[The graph](../../monitoring/performance-views/ongoing-task-stats.mdx#activity-tracks)**  
    ...
    A collapsed track shows the operation bars side by side. Expanding the track spreads the bars
    over several rows.
