...
* This article explains how to define a connection string to the [Hugging Face's text embedding services](https://huggingface.co/docs/text-embeddings-inference/en/index),  
  enabling RavenDB to seamlessly integrate its [Embeddings generation tasks](../../generating-embeddings/overview.mdx) within your environment.
...
connectionString.name = "ConnectionStringToHuggingFace";
...
connectionString.huggingFaceSettings = new HuggingFaceSettings(
    "your-api-key",
    "sentence-transformers/all-MiniLM-L6-v2", // Name of text embedding model to use
    "https://api-inference.huggingface.co/");
