...
description: "Configure a Snowflake ETL task in RavenDB Studio to export documents to Snowflake data warehouse via Parquet staging files."
sidebar_position: 5
---
...
* In this page:  
  ...
  * [Define a Snowflake ETL Task](#define-a-snowflake-etl-task)  
  * [Add or Edit Transformation Script](#add-or-edit-transformation-script)  
