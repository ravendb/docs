...
* In this article:  
   * [Accessing Studio after setup](#accessing-studio-after-setup)  
      * [Connecting to an Unsecure server](#connecting-to-an-unsecure-server)  
      * [Connecting to a Secure server](#connecting-to-a-secure-server)  
         * [Where should the certificate be located](#where-should-the-certificate-be-located)  
