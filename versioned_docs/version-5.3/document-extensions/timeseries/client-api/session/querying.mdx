...
* In this page:  
    * [Time Series LINQ Queries](../../../../document-extensions/timeseries/client-api/session/querying.mdx#time-series-linq-queries)  
        ...
        * [Examples](../../../../document-extensions/timeseries/client-api/session/querying.mdx#examples)  
            * [Session.Query](../../../../document-extensions/timeseries/client-api/session/querying.mdx#section-1)  
            * [Session.Advanced.DocumentQuery](../../../../document-extensions/timeseries/client-api/session/querying.mdx#document-query-1)  
...
The session [Document Query](../../../../client-api/session/querying/document-query/what-is-document-query.mdx) accessible 
