---
title: "Ongoing Task Stats: Subscription Stats"
...
* Studio's [Ongoing Task Stats](../../../../monitoring/performance-views/ongoing-task-stats.mdx) 
  ...
  This page covers the track of a data subscription.  
...
* Indicators are shown in both the collapsed and the 
  [expanded](../../../../monitoring/performance-views/ongoing-task-stats.mdx#expanding-a-track) 
  task tracks.  
