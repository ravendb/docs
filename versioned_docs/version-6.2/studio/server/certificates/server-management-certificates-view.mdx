...
* In this article:
   ...
   * [View and edit certificates](#view-and-edit-certificates)  
   * [Generate a client certificate](#generate-a-client-certificate)  
   * [Enable communication between secure servers](#enable-communication-between-secure-servers)  
      * [Upload an existing client certificate](#upload-an-existing-client-certificate)
...
See the [Generate a client certificate](#generate-a-client-certificate) 
