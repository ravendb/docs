...
* In this article:
  ...
  * [Spatial API](#spatial-api)
      * [`Spatial`](#section)
      * [`DynamicSpatialFieldFactory`](#section-1)
...
| **roundFactor**              | `double`                                                                                    | A distance interval in kilometers.<br/>The distance from the point is rounded up to the nearest interval.<br/>Use `ThenBy` to apply a secondary sort to results within the same distance interval.                                                     |
