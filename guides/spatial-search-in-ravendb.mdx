...
![Flat Finder demo application initial view after startup](./assets/spatialsearch1.png)
...
![Radius search result showing two flats within the selected distance in Paris](./assets/spatialsearch2.png)
...
![Flat document detail showing coordinates and distance metadata](./assets/spatialsearch3.png)
...
![Flats_SpatialIndex definition in RavenDB Studio](./assets/spatialsearch4.png)
...
![Custom polygon drawn on the Paris map for shape-based flat search](./assets/spatialsearch5.png)
...
![Paris district overlays shown on the map for selecting arrondissement boundaries](./assets/spatialsearch6.png)
...
![Flat detail showing reverse search result identifying the 4th Arrondissement](./assets/spatialsearch7.png)

This is a reverse search. We select a point, and RavenDB returns the area it is in. Data of our districts look like this:

![District document structure showing name, population, and boundary_wkt fields](./assets/spatialsearch8.png)
...
![Districts_SpatialIndex definition with boundary field for spatial indexing](./assets/spatialsearch9.png)
