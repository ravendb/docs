...
!["Automatic Storage Extension Edit Configuration"](./assets/PLACEHOLDER-product-features-automatic-storage-extension-configuration-edit.png)

{/* TODO: Screenshot needed — capture the Automatic Storage Extension configuration modal in edit mode, showing the threshold input field (70-95%), Save and Cancel buttons */}
