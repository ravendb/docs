...
* **Index queries**:
  * Static time series indexes can be created by clients (or using Studio).  
    To learn how to create such indexes, see [indexing time series](../../indexing.mdx).  
...
* Note the generated RQL in the second tab, where the custom function is translated to a [custom JavaScript function](../../../../querying/rql/what-is-rql.mdx#declare).
