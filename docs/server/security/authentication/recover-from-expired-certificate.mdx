...
* Notifications are raised in Studio's [Notification Center](../../../monitoring/alerts-and-notifications/notification-center.mdx)
  as the expiration date nears, first as a warning and in the final days as an error.  
