...
* In this page:  
  * [Time series architecture](#time-series-architecture)  
      * [Time series as a document extension](#time-series-as-a-document-extension)
      * [The `HasTimeSeries` flag](#the--flag)
      * [The time series entry](#the-time-series-entry)
      * [Segmentation](#segmentation)
      * [Compression](#compression)
  * [Updating time series](#updating-time-series)  
      * [Document change](#document-change-event)  
...
* The document and the time series reference each another:
  ...
  * The [segments](#segmentation) containing the time series data keep a reference to the document ID.
...
* Each segment contains a number of consecutive entries from the same time series and aggregated values that RavenDB automatically updates in the segment's header. 
  See section [Segment properties](../indexing.mdx#segment-properties) for more details.
