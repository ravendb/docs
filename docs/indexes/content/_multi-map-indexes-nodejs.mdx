...
* Learn how to [index polymorphic data](../indexing-polymorphic-data.mdx)  
  Learn how to [create Multi-Map-Reduce indexes](../map-reduce-indexes.mdx#creating-multi-map-reduce-indexes)  

* In this page:
  * [Indexing multiple collections](#indexing-multiple-collections)  
  * [Searching across multiple collections](#searching-across-multiple-collections)  
  * [Remarks](#remarks)  
