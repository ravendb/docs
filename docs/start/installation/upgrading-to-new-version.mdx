...
[Backup](../../backup/create/periodic-tasks/database-backup#creating-and-managing-periodic-backups-via-studio)/[Restore](../../backup/restore#restoring-from-backup-using-studio), 
