...
description: "Resolve common issues when running RavenDB with AWS Lambda, including missing AWS region, certificate errors, and connection failures."
sidebar_position: 4
---
...
If this is the case, we recommend [using the AWS Secrets Manager](secrets-manager.mdx) 
