...
[document's metadata](../../../session/how-to/get-and-modify-entity-metadata.mdx).  

The metadata can be used to set [compare exchange expiration](../compare-exchange-expiration.mdx).  
...
[Put Compare Exchange Value operation](../put-compare-exchange-value.mdx):  
