...
To renew your license via studio, navigate to the [Studio "About" tab](../../studio/server/license-management.mdx):  

![Renew License in Studio](./assets/renew-license-studio.png)

![Paste License Renewal Key](./assets/paste-license-renewal-key.png)  
