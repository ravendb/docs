...
* Querying time series data is native to RavenDB's queries.  
  Clients can express time series queries in high-level LINQ expressions or directly in [RQL](../../../../client-api/session/querying/what-is-rql.mdx).
...
* Note the generated RQL, where the custom function is translated to a [custom JavaScript function](../../../../client-api/session/querying/what-is-rql.mdx#declare).
