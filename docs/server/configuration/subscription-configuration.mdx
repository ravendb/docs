...
description: "Configure RavenDB data subscription settings including batch sizes, connection timeout intervals, and concurrent subscription limits."
sidebar_position: 24
---
...
* In this article:
  ...
  * [Subscriptions.MaxNumberOfConcurrentConnections](#subscriptionsmaxnumberofconcurrentconnections)
