...
* These processes utilize machine resources.  
  If indexing drains system resources, it usually means that either they were defined in a way that [causes inefficient processing](../../studio/database/indexes/indexing-performance.mdx#common-indexing-issues), 
