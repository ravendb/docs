...
of logging levels, visible right away through Studio's [admin-logs view](../../monitoring/logging/admin-logs.mdx).  
Read more about Nlog [in the dedicated article](../../monitoring/logging/overview.mdx).
If you migrate to RavenDB `7.x` from an earlier version, please 
read the section related to NLog in the [migration page](../../migration/server/data-migration.mdx#migration-and-nlog).  
</ContentFrame>
