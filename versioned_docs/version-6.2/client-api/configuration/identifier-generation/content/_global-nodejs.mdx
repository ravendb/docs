...
Documents that have the same `@collection` metadata belong to the same [collection](../../../faq/what-is-a-collection.mdx) on the server side. Collection names are also used to build document identifiers. 
