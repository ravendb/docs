...
description: "Retrieve specific documents from RavenDB by their IDs using the REST API GET endpoint with optional includes and metadata."
sidebar_position: 1
---
...
* Query parameters can be used to include [related documents](../../how-to/handle-document-relationships.mdx#includes) and 
...
* In this page:  
  ...
  * [More Examples](#more-examples)  
      ...
      * [Get Document Metadata Only](#get-document-metadata-only)  
      * [Get Document Counters](#get-document-counters)  
</Admonition>  
## Basic Example
...
|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|
| **id**           | ID of a document to retrieve. <br/> If no IDs are specified, all the documents in the database are retrieved in descending order of their [change vectors](../../../server/clustering/replication/change-vector.mdx).                               | Yes; <br/> Can be used more than once |
| **include**      | Path to a field containing the ID of another, 'related' document. [See: How to Handle Document Relationships](../../how-to/handle-document-relationships.mdx#includes).                                                              | No; <br/> Can be used more than once  |
| **counter**      | Name of a [counter](../../../document-extensions/counters/overview.mdx) to retrieve. Set this parameter to `@all_counters` to retrieve all counters of the specified documents. Counters of _included_ documents, however, will not be retrieved. | No; <br/> Can be used more than once  |
