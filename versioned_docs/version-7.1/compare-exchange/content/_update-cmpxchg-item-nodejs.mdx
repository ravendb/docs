...
* In this article:  
  * [Update compare-exchange item using a **cluster-wide session**](#update-compare-exchange-item-using-a-cluster-wide-session)  
  * [Update compare-exchange item using a **store operation**](#update-compare-exchange-item-using-a-store-operation)  
  * [Update compare-exchange item using the **Studio**](#update-compare-exchange-item-using-the-studio)  
  * [Syntax](#syntax)   
