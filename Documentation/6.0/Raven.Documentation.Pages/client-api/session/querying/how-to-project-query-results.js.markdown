...
| __projectionBehavior__ | `string`    | Projection behavior is used when querying a static-index.<br>Learn more in [projection behavior with indexes](../../../indexes/querying/projections). |
