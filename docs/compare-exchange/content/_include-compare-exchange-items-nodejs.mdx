...
* Use the [include](../querying/rql/what-is-rql#include) keyword followed by `cmpxchg()` to include a compare-exchange item.  
...
* Use `includes.cmpxchg()` In [JavaScript functions](../querying/rql/what-is-rql#declare) within RQL queries. 
