...
* Find a migration guide for RavenDB `5.x` and earlier versions [here](./legacy-versions-data-migration.mdx).

* In this article:
    * [Migration to RavenDB 7.x from a lower version](#migration-to-ravendb-7-x-from-a-lower-version)
       * [Migration and NLog](#migration-and-nlog)
       * [Migration and HTTP compression](#migration-and-http-compression)
