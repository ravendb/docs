...
* On this page:
   * [Embeddings configuration keys](../../server/configuration/ai-integration-configuration.mdx#embeddings-configuration-keys)  
   ...
   * [AI Agents configuration keys](../../server/configuration/ai-integration-configuration.mdx#ai-agents-configuration-keys)  
   ...
   * [Studio AI Assistant configuration keys](../../server/configuration/ai-integration-configuration.mdx#studio-ai-assistant-configuration-keys)
