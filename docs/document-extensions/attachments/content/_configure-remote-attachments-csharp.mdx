...
* In this article:  
    * [Configuring remote attachments settings - from the Studio](../../../document-extensions/attachments/configure-remote-attachments.mdx#configuring-remote-attachments-settings-from-the-studio)
