...
description: "View and modify RavenDB server configuration settings through Studio with search, category filtering, and per-key value editing options."
sidebar_position: 3
---
...
* To modify the settings of individual databases use the [Database Settings](../database/settings/database-settings.mdx) view.  
