...
* In both [single-document patches](../../../documents/patching-documents/patch-a-single-document/api-overview.mdx)
  and [patch-by-query operations](../../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx),
