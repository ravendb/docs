...
To get started, [create a data subscription using the Client API](../data-subscriptions/creating-subscription/creating-subscription_api.mdx)
and [consume it using a worker](../data-subscriptions/consuming-subscription.mdx).  
