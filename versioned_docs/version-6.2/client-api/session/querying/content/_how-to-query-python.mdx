...
* In this page:
  ...
  * [session.advanced.document_query](#sessionadvanceddocument_query)  
  * [session.advanced.raw_query](#sessionadvancedraw_query)
...
* Queries defined with [query](#sessionquery) or [document_query](#sessionadvanceddocument_query) are translated by the RavenDB client to [RQL](../what-is-rql.mdx)  
  when sent to the server.
