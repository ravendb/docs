...
* There is no need to explicitly create or delete a time series.  
   ...
   * A time series is deleted when all entries are [deleted](../../../client-api/session/delete.mdx) from it.  

* You can add a single [incremental time series entry](../../../design.mdx#time-series-entries) at a time.  
