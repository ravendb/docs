...
* In this article:
   ...
   * [Threads Runtime Info](../../monitoring/debug/advanced-debug-view.mdx#threads-runtime-info)
   * [Memory Mapped Files](../../monitoring/debug/advanced-debug-view.mdx#memory-mapped-files)
   * [Cluster Observer Log](../../monitoring/debug/advanced-debug-view.mdx#cluster-observer-log)
   * [Cluster Debug](../../monitoring/debug/advanced-debug-view.mdx#cluster-debug)
   ...
   * [Record Transaction Commands](../../monitoring/debug/advanced-debug-view.mdx#record-transaction-commands)
   * [Replay Transaction Commands](../../monitoring/debug/advanced-debug-view.mdx#replay-transaction-commands)
...
<Panel heading="Threads Runtime Info">
...
<Panel heading="Memory Mapped Files">
...
<Panel heading="Cluster Observer Log">
...
<Panel heading="Record Transaction Commands">
...
<Panel heading="Replay Transaction Commands">

Replaying a
[transaction-commands recording](../../monitoring/debug/advanced-debug-view.mdx#record-transaction-commands)
