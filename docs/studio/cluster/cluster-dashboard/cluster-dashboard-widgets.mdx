...
description: "Reference all available RavenDB cluster dashboard widgets including CPU, memory, indexing, storage, traffic, and database overview panels."
sidebar_position: 2
---
...
* Available Widgets:  
  * [Let's Get Started Widget](#let)  
  * [CPU Widget](#cpu-widget)  
  * [Memory Widget](#memory-widget)  
  * [Traffic Widget](#traffic-widget)  
  * [Traffic Per Database Widget](#traffic-per-database-widget)  
  * [Indexing Widget](#indexing-widget)  
  * [Indexing Per Database Widget](#indexing-per-database-widget)  
  * [Storage Widget](#storage-widget)  
  * [Storage Per Database Widget](#storage-per-database-widget)  
  * [License Widget](#license-widget)  
</Admonition>
...
2. **Create New Database**  
   Click to [create a new database](../../database/create-new-database/general-flow.mdx).  
3. **Setup Your Cluster**  
   Click to open Studio's [Cluster View](../cluster-view.mdx) 
...
5. **Learn more about Querying and Indexes**  
   Click to learn how [Querying](../../../querying/rql/what-is-rql.mdx) 
...
6. **Hide This Widget**  
   ...
   The operation is reversible, any widget that was removed can be [added](./cluster-dashboard-customize.mdx#add-widget) 
...
2. **License Details**  
   Click to open the [About view](../../../licensing/overview.mdx) which contains information about your 
