...
* **Configuring the subscription task behavior**:
  * **At the database level or server-wide**:  
    ...
    set the [Subscriptions.ArchivedDataProcessingBehavior](../server/configuration/subscription-configuration.mdx#subscriptionsarchiveddataprocessingbehavior) configuration key at either the database level or server-wide   
