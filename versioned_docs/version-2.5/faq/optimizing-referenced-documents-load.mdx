...
<TabItem value="optimizing_referenced_documents_load_1" label="optimizing_referenced_documents_load_1">
...
<TabItem value="optimizing_referenced_documents_load_2" label="optimizing_referenced_documents_load_2">
<CodeBlock language="csharp">
{`var order = session
	.Include("CustomerId")
	.Load<Order>("orders/1");
...
<TabItem value="optimizing_referenced_documents_load_3" label="optimizing_referenced_documents_load_3">
<CodeBlock language="csharp">
{`var order = session
...
<TabItem value="optimizing_referenced_documents_load_4" label="optimizing_referenced_documents_load_4">
<CodeBlock language="csharp">
...
<TabItem value="optimizing_referenced_documents_load_5" label="optimizing_referenced_documents_load_5">
<CodeBlock language="csharp">
{`var orders = session.Advanced.LuceneQuery<Order>("Orders/Unpaid")
...
<TabItem value="optimizing_referenced_documents_load_6" label="optimizing_referenced_documents_load_6">
<CodeBlock language="csharp">
{`var user = session
