...
description: "View and manage all AI ongoing tasks in RavenDB Studio, including embeddings generation and GenAI tasks, from a single list view."
sidebar_position: 6
---
...
* RavenDB supports the following AI tasks:
  * [Embeddings generation task](./generating-embeddings/overview.mdx)
  * [Gen AI task](./gen-ai-integration/overview.mdx)
...
* In this article:
  * [AI Tasks - list view](#ai-tasks---list-view-1)
