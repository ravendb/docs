...
To set the [Security.Certificate.Path](./security-configuration.mdx#securitycertificatepath) 
...
To set [Security.WellKnownCertificates.Admin](./security-configuration.mdx#securitywellknowncertificatesadmin), 
for example, use:  
<TabItem value="json" label="json">
<CodeBlock language="json">
{`\{
...
* Find additional details about Command Line Arguments [here](./command-line-arguments.mdx).
