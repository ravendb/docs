...
You can also create queries by using [RawQuery](../../client-api/session/querying/how-to-query.mdx#session-advanced-rawquery). It is available as a part of advanced session operations:
