...
description: "Resolve Azure load balancer idle timeout issues that cause dropped RavenDB connections by configuring keep-alive settings and timeout values."
