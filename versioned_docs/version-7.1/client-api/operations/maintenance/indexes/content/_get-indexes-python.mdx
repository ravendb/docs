...
* The operation will execute on the node defined by the [client configuration](../../../../configuration/load-balance/overview.mdx#client-logic-for-choosing-a-node).  
...
* In this page:
    * [Get Indexes example](#get-indexes-example)
    * [Syntax](#syntax)
...
| - | - |
| `IndexDefinition[]` | A list of [IndexDefinition](../put-indexes.mdx#indexdefinition) classes, <br/> ordered alphabetically by index name. |
