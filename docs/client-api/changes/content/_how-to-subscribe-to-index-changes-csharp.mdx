...
| Return value | |
| ------------- | ----- |
| IChangesObservable&lt;[IndexChange](#indexchange)&gt; | Observable that allows to add subscriptions to notifications for index with given name. |
...
| Return value | |
| ------------- | ----- |
| IChangesObservable&lt;[IndexChange](#indexchange)&gt; | Observable that allows to add subscriptions to notifications for all indexes. |
...
| ------------- | ------------- | ----- |
| **Type** | [IndexChangeTypes](#indexchangetypes) | Change type |
