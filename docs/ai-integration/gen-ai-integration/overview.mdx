...
* Tasks can be easily defined, tested and deployed using [the client API](./create-gen-ai-task/create-gen-ai-task_api.mdx) or [Studio](./create-gen-ai-task/create-gen-ai-task_studio.mdx).  
...
4. The task sends each context object to a GenAI model for processing.  
    * The task is associated with a [Connection string](./create-gen-ai-task/create-gen-ai-task_studio.mdx#studio_connection-string) 
      that defines how to connect to the AI model.
    * Each context object is sent via a separate connection to the AI model.  
      (note that the number of concurrent connections to the AI model is configurable via the [MaxConcurrency](./create-gen-ai-task/create-gen-ai-task_api.mdx#genaiconfiguration) setting.)  
...
* [Connection string](./create-gen-ai-task/create-gen-ai-task_studio.mdx#studio_connection-string)  
...
* You can use [Studio's intuitive wizard](./create-gen-ai-task/create-gen-ai-task_studio.mdx#add-a-genai-task) 
...
* Or, you can create GenAI tasks using the [client API](./create-gen-ai-task/create-gen-ai-task_api.mdx). 
...
* After creating a [context object](./create-gen-ai-task/create-gen-ai-task_studio.mdx#generate-context-objects) 
...
* The status and state of each GenAI task are visible in the
  [AI Tasks - list view](../ai-tasks-list-view.mdx).
