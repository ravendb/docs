...
* Compare-Exchange items can be created and managed on the advanced session (`session.advanced`)  
  Other options are listed in this [compare-exchange overview](../../../operations/compare-exchange/overview.mdx#how-to-create-and-manage-compare-exchange-items).

* When working with compare-exchange items from the session,  
  the session **must be opened as a [cluster-wide session](../overview.mdx#open-a-cluster-transaction)**.

* In this page:
    * [Create compare-exchange](#create-compare-exchange)
    * [Get compare-exchange](#get-compare-exchange)
    * [Delete compare-exchange](#delete-compare-exchange)
</Admonition>
