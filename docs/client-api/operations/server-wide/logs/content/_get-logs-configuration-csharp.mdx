...
* In this article:
    * [Get logs configuration](../../../../../client-api/operations/server-wide/logs/get-logs-configuration.mdx#get-logs-configuration)
    * [Syntax](../../../../../client-api/operations/server-wide/logs/get-logs-configuration.mdx#syntax)
...
See section [Logs on this view](../../../../../studio/server/debug/admin-logs.mdx#logs-on-this-view) for details.    
