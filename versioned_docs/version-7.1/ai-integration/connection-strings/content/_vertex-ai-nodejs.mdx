...
* This article explains how to define a connection string to [Vertex AI](https://cloud.google.com/vertex-ai/docs/generative-ai/embeddings/get-text-embeddings),  
  enabling RavenDB to seamlessly integrate its [Embeddings generation tasks](../../generating-embeddings/overview.mdx) with Google Cloud’s Vertex AI services.
...
connectionString.name = "ConnectionStringToVertex";
...
connectionString.vertexSettings = new VertexSettings(
    "text-embedding-005", // Name of the Vertex AI model to use
    // Contents of your service account JSON file:
    JSON.stringify({
        "type": "service_account",
        "project_id": "<GOOGLE CLOUD PROJECT ID>",
        "private_key_id": "<GOOGLE CLOUD SERVICE ACCOUNT PRIVATE KEY ID>",
        "private_key": "<GOOGLE CLOUD SERVICE ACCOUNT PRIVATE KEY>",
        "client_email": "<GOOGLE CLOUD SERVICE ACCOUNT CLIENT EMAIL>",
        "client_id": "<GOOGLE CLOUD SERVICE ACCOUNT CLIENT ID>",
        "auth_uri": "https://accounts.google.com/o/oauth2/auth",
        "token_uri": "https://oauth2.googleapis.com/token",
        "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
        "client_x509_cert_url": "<GOOGLE CLOUD SERVICE ACCOUNT CERT URL>"
    }), 
    "us-central1", // Region where the model is hosted
    "V1");         // Optional: specify "V1" or "V1_Beta"

// Optionally, override the default maximum number of query embedding batches
// that can be processed concurrently
connectionString.vertexSettings.embeddingsMaxConcurrentBatches = 10;
