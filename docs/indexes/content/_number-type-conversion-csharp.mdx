...
* In this page:
  * [Syntax](../indexes/number-type-conversion.mdx#syntax)
  * [Examples](../indexes/number-type-conversion.mdx#examples)
...
field of type [Company](../../start/about-examples.mdx). The following indexes take an `Item` 
