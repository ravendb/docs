...
* In this page:
  ...
  * [Document Format and Structure](#document-format-and-structure)
  * [Using cURL With HTTPS](#using-curl-with-https)
...
[More about how to upload documents](./document-commands/put-documents.mdx)
...
[Put Attachment Command](./document-commands/batch-commands.mdx#put-attachment-command).  
