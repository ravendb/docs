...
* Use [Session.Query](../../client-api/session/querying/how-to-query.mdx#session.query) to code queries yourself.  
...
* Use [RawQuery](../../client-api/session/querying/how-to-query.mdx#session.advanced.rawquery) to send the server raw RQL expressions for execution.  
