...
* Learn about the GenAI task's context generation script and how to set it [here](../create-gen-ai-task/create-gen-ai-task_studio.mdx#generate-context-objects).
...
* Learn about the GenAI task's Prompt and JSON schema and how to set them [here](../create-gen-ai-task/create-gen-ai-task_studio.mdx#define-prompt-and-json-schema).
...
* Learn about the GenAI task's Update script and how to set it [here](../create-gen-ai-task/create-gen-ai-task_studio.mdx#provide-update-script).
