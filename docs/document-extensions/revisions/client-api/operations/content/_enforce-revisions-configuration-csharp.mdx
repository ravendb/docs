...
* Because the handler above is attached after the operation starts,  
  the earliest progress notifications can be missed.
    
* To capture progress from the very beginning, which matters most when you rely on it to resume,  
  subscribe to operation changes via the Changes API before starting the operation.  
