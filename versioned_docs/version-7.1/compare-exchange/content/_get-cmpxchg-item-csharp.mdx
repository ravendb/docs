...
* To view existing compare-exchange items in the **Studio**, go to _Documents > Compare Exchange_,  
  as described in [Ways to manage compare-exchange items](../overview.mdx#ways-to-create-and-manage-compare-exchange-items).  

* This article shows how to get a **single** compare-exchange item by its unique _key_.  
  To get **multiple** items at once, see [Get multiple compare-exchange items](../get-cmpxchg-items.mdx).
