...
* To include SINGLE or MULTIPLE document revisions by their change vectors:   
  ...
  * When modifying the document, store its updated change vector in a property in the document.  
    This can be done by [patching](../../../../../document-extensions/revisions/client-api/session/including.mdx#patching-the-revision-change-vector) the document from the Client API or from Studio.  
...
Included revisions can be viewed in Studio's [Query View](../../../../../studio/database/queries/query-view.mdx).  
