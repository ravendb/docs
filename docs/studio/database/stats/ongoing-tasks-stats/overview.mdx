...
description: "View performance statistics for all RavenDB ongoing tasks in Studio including ETL, replication, backup, and subscription metrics."
sidebar_position: 0
---
...
* In this page:  
   * [Ongoing Tasks Stats View](#ongoing-tasks-stats-view)  
   * [The Timeline Ruler](#the-timeline-ruler)  
   * [Task Rulers](#task-rulers)  
      * [Closed View](#task-ruler-closed-view)  
      * [Expanded View](#task-ruler-expanded-view)  
      * [Time Grid](#task-rulers-time-grid)  
      * [Active and Inactive Display](#active-and-inactive-display)  
...
<Admonition type="info" title="">
Note that the [stats graph](#stats-graph) 
displays **two different time grids**.  

* The [Timeline ruler time grid](#the-timeline-ruler) 
