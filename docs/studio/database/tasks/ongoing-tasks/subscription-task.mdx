...
description: "Create and manage data subscription tasks in RavenDB Studio with RQL filtering, client connection monitoring, and batch configuration."
sidebar_position: 3
---
...
* In this page:
  * [Subscription Task Definition](#subscription-task-definition)
  * [Testing Subscriptions](#testing)
  * [Details in Task List View](#details-in-task-list-view)
