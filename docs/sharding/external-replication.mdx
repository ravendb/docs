...
* In this page:  
  ...
  * [External Replication Types](#external-replication-types)
     * [Non-Sharded Database to Sharded Database](#non-sharded-database-to-sharded-database)  
     * [Sharded Database to Sharded Database](#sharded-database-to-sharded-database)  
