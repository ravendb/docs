...
description: "Import NuGet packages and custom assemblies into RavenDB indexes to extend index functionality with external libraries and methods."
sidebar_position: 29
---
...
* This feature is similar to the [Additional Sources](../indexes/extending-indexes.mdx) feature, 
...
* In this page:  
   ...
   * [Examples](../indexes/additional-assemblies.mdx#examples)  
       * [Basic Example](../indexes/additional-assemblies.mdx#basic-example)
       * [Complex Example](../indexes/additional-assemblies.mdx#complex-example)
       * [Pre-Release Packages](../indexes/additional-assemblies.mdx#pre-release-packages)
...
<TabItem value="prerelease_assembly" label="prerelease_assembly">
<CodeBlock language="csharp">
{`AdditionalAssemblies = \{
