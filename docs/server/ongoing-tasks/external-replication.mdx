...
description: "Replicate RavenDB databases to external clusters for disaster recovery and geo-distribution with filtered or full replication modes."
sidebar_position: 0
---
...
* The External Replication task **does _not_ create a backup** of your data and indexes.  
  See more in [Backup -vs- Replication](../../backup/faq#is-an-external-replication-task-a-good-substitute-for-a-backup-task)
* In this page: 
...
* Server and cluster level features:
    ...
    * [Compare-Exchange](../../compare-exchange/overview.mdx)
    * [Subscriptions](../../data-subscriptions/overview.mdx)
    * [Identities](../../server/kb/document-identifier-generation.mdx#identity-id)
    * Ongoing tasks
        * [ETL](../../server/ongoing-tasks/etl/basics.mdx)
        * [Backup](../../backup/create/periodic-tasks/database-backup)
