...
In an RQL query, you can use the [`include` keyword](../../../indexes/querying/what-is-rql.mdx#include) 
...
In [javascript functions](../../../indexes/querying/what-is-rql.mdx#declare) within queries, 
