...
the Last Write Wins strategy so a lost update anomaly is possible with the default configuration of the [session](../../what-is-a-session-and-how-does-it-work.mdx).
...
You can also control optimistic concurrency per specific document. To enable it, [provide a Change Vector to Store](../../storing-entities.mdx).  
...
[Transaction support in RavenDB](../../../faq/transaction-support.mdx) article.
</Admonition>
