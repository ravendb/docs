...
| ---------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | --------------------- | ----------------------------------------------------------------------------- |
| Channel          | Users should ask questions in natural language and receive agent replies. | Messages are routed to the assigned agent, which can query the mirrored data when needed. | Yes                   | [Channels overview](../channels/overview.mdx)                                              |
...
For a comparison of all available channel types and their setup guides, see [Channels: Overview](../channels/overview.mdx#channel-types).
