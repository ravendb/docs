...
featureTags: [vector-search, include, document-refresh, azure-storage-queues-etl]
...
```yaml
challengesSolutionsTags: [nonexistent-tag]  # Tag doesn't exist in YAML
```

### ✅ Valid Tags

```yaml
challengesSolutionsTags: [semantic-search]  # Tag exists in samples/tags/challenges-solutions.yml
```
