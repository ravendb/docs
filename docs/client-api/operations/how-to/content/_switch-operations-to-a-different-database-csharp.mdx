...
* In this page:
    * [Common operation: `Operations.ForDatabase`](#common-operation-operationsfordatabase)
    * [Maintenance operation: `Maintenance.ForDatabase`](#maintenance-operation-maintenancefordatabase)
</Admonition>
