...
* Time series index:
    ...
    * The following items can be indexed per index-entry in a time series index:
        ...
        * Properties of the containing segment (see **[segment properties](#segment-properties)**)
...
1. Create a class that inherits from the abstract index class [`AbstractRawJavaScriptTimeSeriesIndexCreationTask`](#section).

2. Create a [`TimeSeriesIndexDefinition`](#section-1) 
