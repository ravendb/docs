...
2. **Version**  
    ...
    * **Version Number**  
      ...
      To upgrade to a newer version, see [upgrading instructions](../installation/upgrading-to-new-version.mdx).  
...
6. **Available actions**  
    * [Replace License](./replace-license.mdx) / [Force Update](./force-update.mdx) / [Renew License](./renew-license.mdx)  
