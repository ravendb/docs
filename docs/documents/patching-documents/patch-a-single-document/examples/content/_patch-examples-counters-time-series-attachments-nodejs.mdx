...
patchRequest.script = "incrementCounter(this, args.name, args.value);";
patchRequest.values = {
    name: "Likes",
    value: 20
};
...
const patchRequest = new PatchRequest();
patchRequest.script = "deleteCounter(this, args.name);";
patchRequest.values = {
    name: "Likes"
};
...
const patchRequest = new PatchRequest();
patchRequest.script = "this.LikesSnapshot = counter(this, args.name);";
patchRequest.values = {
    name: "Likes"
};
...
const patchRequest = new PatchRequest();
patchRequest.script = "timeseries(this, args.name).append(new Date(args.timestamp), args.values, args.tag);";
patchRequest.values = {
    name: "HeartRates",
...
const patchCommand = new PatchCommandData("users/1-A", null, patchRequest);
session.advanced.defer(patchCommand);
...
const patchOp = new PatchOperation("users/1-A", null, patchRequest);
await documentStore.operations.send(patchOp);
```
</TabItem>
</Tabs>
...
const patchRequest = new PatchRequest();
patchRequest.script = "timeseries(this, args.name).delete(args.from, args.to);";
patchRequest.values = {
    name: "HeartRates",
...
const patchRequest = new PatchRequest();
patchRequest.script = "attachments(this, args.name).delete();";
patchRequest.values = {
    name: "invoice.pdf"
};
...
const patchRequest = new PatchRequest();
patchRequest.script = "attachments(this, args.targetName).copyFrom(args.sourceDocId, args.sourceName);";
patchRequest.values = {
...
const patchRequest = new PatchRequest();
patchRequest.script = "attachments(this, args.name).remote(args.identifier, args.at);";
patchRequest.values = {
    name: "invoice.pdf",
