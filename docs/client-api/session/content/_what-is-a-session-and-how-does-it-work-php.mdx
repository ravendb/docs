...
* To execute an operation that both loads and updates a document within the same write transaction, use the patching feature. 
  This can be done either with the usage of a [JavaScript patch](../../../documents/patching-documents/patch-a-single-document/api-overview.mdx) syntax or [JSON Patch](../../../documents/patching-documents/patch-a-single-document/json-patch.mdx) syntax.
