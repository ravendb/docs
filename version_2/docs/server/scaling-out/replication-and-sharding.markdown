...
You need to either [handle that](http://ravendb.net/docs/server/bundles/replicationconflicts?version=2.0) or to choose to disallow writes while using the master is unavailable, and use the slave just for reads.
