...
* In this article:
    * [Set logs configuration](#set-logs-configuration)
    * [Set Microsoft logs configuration](#set-microsoft-logs-configuration)
    * [Set Admin logs configuration](#set-admin-logs-configuration)
    * [Syntax](#syntax)
