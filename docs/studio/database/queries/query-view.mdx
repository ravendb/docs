...
9. **Query Results**  
   The results area displays selected columns of results retrieved by your query (see [below](#query-results)).  
...
To modify the displayed result columns, open the Display drop-down dialog from the [Query Results](#query-results) view.  
