...
* Queries defined with [Query](../../../../querying/overview.mdx#sessionquery) or [DocumentQuery](../../../../querying/overview.mdx#sessionadvanceddocumentquery) are translated by the RavenDB client to [RQL](../../../../client-api/session/querying/what-is-rql.mdx)  
  when sent to the server.
...
* Available custom methods and extensions for the session's [Query](../../../../querying/overview.mdx#sessionquery) method:
