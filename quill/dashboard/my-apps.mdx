...
5. **Add app**  
   ...
   to connect a source database and create a new app.
...
3. **Agents**  
   ...
   See [App: Agents view](../dashboard/manage-an-app/agents-view.mdx).
...
7. **Add app**  
   Click **Add app** to open the wizard to [connect a source database](../getting-started/connecting-your-database.mdx#starting-the-add-new-app-wizard),
   [map the tables](../getting-started/mapping-your-tables.mdx) Quill will mirror,  
