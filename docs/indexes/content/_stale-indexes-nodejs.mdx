...
It can be retrieved using the [Statistics](../../client-api/session/querying/how-to-get-query-statistics.mdx) method:
...
<TabItem value="stale5" label="stale5">
<CodeBlock language="js">
{`session.advanced.waitForIndexesAfterSaveChanges(\{
    withTimeout: 5000,
...
The indexing mechanism in RavenDB is built on [a BASE model](../../client-api/faq/transaction-support.mdx#base-for-query-operations). 
