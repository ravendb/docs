...
The following configuration options allow you configure [the storage engine](../storage/storage-engine.mdx).

## Storage.TempPath

* Use this configuration option to customize the path for the temporary files of the following [directories](../storage/directory-structure.mdx):
  * `System`
  * `Configuration` 
...
* To specify a different path for the indexes temporary files go to [Indexing.TempPath](./indexing-configuration.mdx#indexingtemppath).  
