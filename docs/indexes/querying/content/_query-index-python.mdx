...
* In this page:  
   * [Query an index by `query_index_type` and `query_index`](#query-an-index-by-query_index_type-and-query_index)
   * [Query an index by `raw_query`](#query-an-index-by-rawquery) (using RQL)
