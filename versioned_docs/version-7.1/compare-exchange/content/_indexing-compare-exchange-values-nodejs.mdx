...
* In this article:  
  * [Create sample compare-exchange items](../compare-exchange/indexing-cmpxchg-values.mdx#create-sample-compare-exchange-items)
  ...
  * [Syntax](../compare-exchange/indexing-cmpxchg-values.mdx#syntax)  
