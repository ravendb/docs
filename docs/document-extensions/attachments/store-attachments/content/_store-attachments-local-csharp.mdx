...
* This article focuses on **storing attachments locally**.  
  To learn about remote storage, see [Store attachments in remote storage](../store-attachments-remote.mdx).
...
| **remoteParameters** | `RemoteAttachmentParameters` | Parameters for uploading the attachment to [Remote storage](../store-attachments-remote.mdx).<br/>Set to _null_ or omit to store the attachment **locally**. |
