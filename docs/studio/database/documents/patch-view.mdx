...
3. <a id="patch-settings"/> **Patch Settings**  
    ...
    * d. **Ignore maximum number of steps for script**  
          ...
          This limit is set by the [Patching.MaxStepsForScript](../../../server/configuration/patching-configuration.mdx#patching.maxstepsforscript) configuration key (default: 10,000).  
