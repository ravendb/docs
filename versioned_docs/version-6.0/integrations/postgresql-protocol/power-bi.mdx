...
* See below how to use Power BI Desktop to -  
   ...
   * Query RavenDB using [RQL](../../client-api/session/querying/what-is-rql.mdx).  
...
Instead of loading collections in their entirety, you can run [RQL](../../client-api/session/querying/what-is-rql.mdx) queries 
