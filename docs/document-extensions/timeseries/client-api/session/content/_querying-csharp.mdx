...
* Time series queries can be made using:  
  ...
  * Or directly through [RQL](../../../../../querying/what-is-rql.mdx),
...
* Note:  
  The RavenDB client translates the LINQ query to [RQL](../../../../../querying/what-is-rql.mdx) before transmitting it to the server for execution.
### Query examples
...
* Results will be in the form:
    ...
    * `TimeSeriesAggregationResult` for aggregated data
* Note:  
  The RavenDB client translates query to [RQL](../../../../../querying/what-is-rql.mdx) before transmitting it to the server for execution.
