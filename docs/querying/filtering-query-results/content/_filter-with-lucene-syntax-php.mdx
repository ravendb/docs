...
use [comparison operators](../filter-query-results.mdx#filter-by-numeric-value) such as `whereGreaterThan` / `whereLessThan`,
or [whereBetween](../filter-query-results.mdx#syntax).
