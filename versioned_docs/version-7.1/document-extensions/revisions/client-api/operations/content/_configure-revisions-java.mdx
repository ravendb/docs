...
* [Revisions](../../../overview.mdx) are snapshots of documents that 
...
* In this page:  
  * [Syntax](#syntax)  
      * [RevisionsCollectionConfiguration](#revisions-collection-configuration-object)  
...
[1.](#revisions-collection-configuration-object) 
...
default values listed in the table [above](#revisions-collection-configuration-object) 
are applied.  
