...
| **elasticSearchConnectionStrings** | `Map<String, ElasticSearchConnectionString>` | Define [ElasticSearch Connection Strings](../../../../server/ongoing-tasks/etl/elasticsearch.mdx#add-an-elasticsearch-connection-string), keyed by name.                                                                                       |
...
| **olapConnectionStrings**          | `Map<String, OlapConnectionString>`          | Define [OLAP Connection Strings](../../../../server/ongoing-tasks/etl/olap.mdx#add-an-olap-connection-string), keyed by name.                                                                                                         |
...
| **ravenConnectionStrings**         | `Map<String, RavenConnectionString>`         | Define [Raven Connection Strings](../../../../server/ongoing-tasks/etl/raven.mdx#add-a-ravendb-connection-string), keyed by name.                                                                                                      |
...
| **sqlConnectionStrings**           | `Map<String, SqlConnectionString>`           | Define [SQL Connection Strings](../../../../server/ongoing-tasks/etl/sql.mdx#add-an-sql-connection-string), keyed by name.                                                                                                           |
