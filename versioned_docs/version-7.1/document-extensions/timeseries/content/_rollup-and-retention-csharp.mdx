...
* In this page:  
  * [Time series policies](#time-series-policies)  
  * [Examples](#examples)  
      * [Create time series policy](#create-time-series-policies)  
      * [Retrieve rollup data](#retrieve-rollup-data)
  * [Syntax](#syntax)
...
[Querying with group-by](../querying/aggregation-and-projections.mdx) 
...
* Learn more about using `TimeSeriesFor.Get` in [Get time series entries](../client-api/session/get/get-entries.mdx).
...
Read more about time series with generic types [here](../client-api/named-time-series-values.mdx).
