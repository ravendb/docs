...
![Defining Periodic Backup](./assets/periodic-backup-definition.png)
  ...
  * **Backup**  
     * Backed Up Data: The database data in a JSON format, including documents, indexes (definitions only) & [identities](../../../server/kb/document-identifier-generation.mdx#strategy--3) 
