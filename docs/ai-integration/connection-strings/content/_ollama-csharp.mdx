...
* This article explains how to define a connection string to [Ollama](https://ollama.com/blog/embedding-models),  
  enabling RavenDB to seamlessly integrate its [embeddings generation tasks](../../../ai-integration/generating-embeddings/overview.mdx) with your Ollama setup.
...
<TabItem value="create_connection_string_ollama" label="create_connection_string_ollama">
```csharp
