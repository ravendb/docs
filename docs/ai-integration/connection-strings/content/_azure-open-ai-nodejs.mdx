...
* This article explains how to define a connection string to the [Azure OpenAI Service](https://azure.microsoft.com/en-us/products/ai-services/openai-service),  
  enabling RavenDB to use Azure OpenAI models for [Embeddings generation tasks](../../generating-embeddings/overview.mdx),
...
2. **Identifier** (optional)  
   ...
   Learn more about the identifier in the [connection string identifier](../overview.mdx#identifier) section.
