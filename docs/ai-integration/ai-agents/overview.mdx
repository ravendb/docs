...
<Admonition type="note" title="">
* [Learn to create an AI agent using the client API](./creating-ai-agents/creating-ai-agents_api.mdx)  
* [Learn to create an AI agent using Studio](./creating-ai-agents/creating-ai-agents_studio.mdx)  
</Admonition>
...
* A **connection string** to the AI model.  
  [Create a connection string using the API](./creating-ai-agents/creating-ai-agents_api.mdx#creating-a-connection-string)  
  [Create a connection string using Studio](./creating-ai-agents/creating-ai-agents_studio.mdx#configure-basic-settings)  

* An **agent configuration** that defines the agent.  
  [Define an agent configuration using the API](./creating-ai-agents/creating-ai-agents_api.mdx#defining-an-agent-configuration)  
  [Define an agent configuration using Studio](./creating-ai-agents/creating-ai-agents_studio.mdx#configure-basic-settings)  
...
* The conversation may include multiple "turns" of message exchanges between the client and the LLM, mediated by the agent.  
   ...
   * During the turn, the LLM can trigger the agent to run queries or request the client to perform actions, using [defined query and action tools](./creating-ai-agents/creating-ai-agents_api.mdx#adding-agent-tools).  
   * The turn ends with an [LLM response](./creating-ai-agents/creating-ai-agents_api.mdx#conversation-response) to the user prompt.  
...
[Initiate a conversation using the API](./creating-ai-agents/creating-ai-agents_api.mdx#managing-conversations)  
[Initiate a conversation using Studio](./creating-ai-agents/creating-ai-agents_studio.mdx#start-new-chat)  
[Read conversation history using the API](./reading-conversation-history.mdx)  
...
* **Values for agent parameters**  
  If agent parameters were defined in the agent configuration, the client is required to provide their values to the agent when starting a conversation.  
     ...
     [See an example that utilizes this agent parameter](./creating-ai-agents/creating-ai-agents_api.mdx#query-tools).  
...
When the agent has [sub-agents](./multi-agents.mdx),
...
declares it. See
[Passing parameters through the hierarchy](./multi-agents.mdx#passing-parameters-through-the-hierarchy)
...
* Optional **file attachments**, provided by the client alongside the user prompt.  
  ...
  [Learn to add attachments using the API](./creating-ai-agents/creating-ai-agents_api.mdx#adding-attachments)  
...
[Streaming LLM responses using the API](./creating-ai-agents/creating-ai-agents_api.mdx#stream-llm-responses)  
...
[Configuring chat trimming using the API](./creating-ai-agents/creating-ai-agents_api.mdx#set-chat-trimming-configuration)  
[Configuring chat trimming using Studio](./creating-ai-agents/creating-ai-agents_studio.mdx#configure-chat-trimming)  

You can also distribute work across a
[multi-agents hierarchy](./multi-agents.mdx)
...
[Creating query tools using the API](./creating-ai-agents/creating-ai-agents_api.mdx#query-tools)  
[Creating query tools using Studio](./creating-ai-agents/creating-ai-agents_studio.mdx#a-add-query-tools)  
...
[Setting iterations limit using the API](./creating-ai-agents/creating-ai-agents_api.mdx#set-maximum-number-of-iterations)  
...
[Learn more about multi-agents](./multi-agents.mdx)  
