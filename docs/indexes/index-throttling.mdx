...
* The gaps in indexing activity and the procession of 
  [larger batches](#throttling-and-batches) 
...
* In this page:  
  ...
  * [Index Throttling and Batches](#throttling-and-batches)  
  * [Setting Index Throttling](#setting-index-throttling)  
     * [Server-Wide](#server-wide-index-throttling)  
     * [Per-Database](#index-throttling-per-database)  
     * [Per-Index](#index-throttling-in-an-index-definition)  
...
Setting throttling in an index definition overrides [server-wide](#server-wide-index-throttling) 
and [database](#index-throttling-per-database) settings configuration.  
