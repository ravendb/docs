...
* In this page:
  * [Overview](#overview)
  * [The Revisions Bin view](#the-revisions-bin-view-1)
...
* **When deleting a document that has revisions**:  
  ...
  or if the [Revisions configuration](../../settings/document-revisions.mdx#revisions-configuration) is enabled.
...
* While the Revisions Bin provides access only to a deleted document's revisions,  
  the [All Revisions](./all-revisions.mdx) view provides access to ALL revisions in the database,
  where they can also be deleted.

* For a complete list of deletion options, see [All ways to delete revisions](./all-revisions.mdx#all-ways-to-delete-revisions).
**Restoring revisions**:
...
* When a new document is created with the same ID:  
  * The revisions of the deleted document are retrieved from the Revisions Bin and associated with the new document.  
    This occurs even if the [Revisions configuration](../../settings/document-revisions.mdx#revisions-configuration) is not defined or enabled for this document collection at the time.
...
3. If the [Revisions configuration](../../settings/document-revisions.mdx#revisions-configuration)
