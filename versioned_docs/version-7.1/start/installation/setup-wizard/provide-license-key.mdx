...
* After selecting the setup method as described in [Choose setup method](./choose-setup-method.mdx),
...
* The license grants legal permission to use RavenDB in production,
  ...
  Learn more about licensing in [Licensing overview](../../licensing/licensing-overview.mdx).
    
* In this article:
  * [Enter license key](#enter-license-key)  
  * [Get a free license](#get-a-free-license)  
  * [Running RavenDB without a license](#running-ravendb-without-a-license)  
...
2. If you do not have a license, select this option to obtain a free Developer or Community license.  
   Learn more below in [Get your free license](#get-your-free-license).
    
3. Click **"Continue"** to proceed to the next step in the wizard - [Choosing a security option](./choose-security-option.mdx).
    
4. Click **"Back"** to return to the previous step - [Choosing a setup method](./choose-setup-method.mdx).
...
1. Use the toggle to choose whether to obtain a free [Developer](../../licensing/licensing-overview.mdx#developer-license) or [Community](../../licensing/licensing-overview.mdx#community-license) license.
...
3. Click **"Generate license"** to receive your free license key.  
   ...
   and you can click **"Continue"** to proceed to the next step - [Choosing a security option](./choose-security-option.mdx).
