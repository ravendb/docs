...
* A session represents a single [business transaction](https://martinfowler.com/eaaCatalog/unitOfWork.html) 
  (not to be confused with an [ACID transaction](../../../faq/transaction-support.mdx)).  
...
* In this page:  
    * [Open a cluster transaction](#open-a-cluster-transaction)
    * [Cluster-wide transaction vs. Single-node transaction](#cluster-wide-transaction-vs-single-node-transaction)
...
* **Optimistic concurrency**:  
  Single-node sessions support optional [Optimistic concurrency checks](../../configuration/how-to-enable-optimistic-concurrency.mdx).
