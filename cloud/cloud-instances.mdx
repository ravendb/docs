...
- The Production cluster grades [Standard](#standard-grade-production-cluster) 
and [Performance](#performance-grade-production-cluster) are 
...
!["Production: Standard P70"](./assets/tiers-and-instances-0033-production-standard-P70.png)
