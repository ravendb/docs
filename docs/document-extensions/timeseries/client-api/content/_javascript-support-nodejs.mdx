...
* With the introduction of time series, RavenDB has extended its [JavaScript support](../../../../server/kb/javascript-engine.mdx)
  to include manipulations involving time series data when patching [single](../../../../documents/patching-documents/patch-a-single-document/api-overview.mdx)
  or [multiple](../../../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx) documents.
