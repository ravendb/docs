...
* In this article:
  ...
  * [Activate license with configuration keys](../licensing/activate-license.mdx#activate-license-with-configuration-keys)
  * [Activate license from the Studio](../licensing/activate-license.mdx#activate-license-from-the-studio)
