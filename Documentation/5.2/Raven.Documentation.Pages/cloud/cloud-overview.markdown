...
To enable MFA go to [https://cloud.ravendb.net/portal/profile/enable-authenticator](https://cloud.ravendb.net/portal/profile/enable-authenticator)
or go to your RavenDB Cloud Profile page ([https://cloud.ravendb.net/portal/profile](https://cloud.ravendb.net/portal/profile))
and click **Add authenticator app** button.
!["Add authenticator app"](images\mfa-001-add-authenticator.png "Add authenticator app")

This will take you to configuration page.

!["Configure authenticator app"](images\mfa-002-configuration.png "Configure authenticator app")

- Scan provided QR code or enter text code into authentication app of your choice.
- Type in 2FA code generated by your authentication app.
- Type in recovery phone number.

After verifying you will be provided with recovery codes. Save them in secure place.
