...
* When scheduling a **Server-Wide Backup Task**, RavenDB actually creates a 
  [regular ongoing backup task](../../studio/database/tasks/ongoing-tasks/backup-task.mdx) 
...
The settings are similar to those of a [regular backup task](../../studio/database/tasks/ongoing-tasks/backup-task.mdx#backup-task).  
...
and a [separately created backup](../../studio/database/tasks/ongoing-tasks/backup-task.mdx#backup-task).  
...
To edit or modify a Server-Wide task, navigate back to the [Server-Wide Backup view](../../studio/server/server-wide-backup.mdx#server-wide-backup-tasks-in-the-database-tasks-view).  
...
* Since defining a Server-Wide backup actually creates regular backup tasks, 
  ...
  See [Backup Task - When Cluster or Node are Down](../../studio/database/tasks/ongoing-tasks/backup-task.mdx#backup-task---when-cluster-or-node-are-down).  
