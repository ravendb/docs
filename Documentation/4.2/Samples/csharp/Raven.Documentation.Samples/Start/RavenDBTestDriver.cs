...
namespace RavenDBTestDriver
{
    public class RavenDBTestDriver : RavenTestDriver
    {
        ...
        public void TestDriveConfigureServer()
        {
            ...
            {
                FrameworkVersion = "3.1.15+", // Look for newest version on machine including 3.1.15 and any newer patches, but not major new releases (default is .NET version at time of server release).  
