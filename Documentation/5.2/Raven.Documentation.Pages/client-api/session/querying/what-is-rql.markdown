...
- [WHERE](../../../client-api/session/querying/what-is-rql#where)
    ...
    - [endsWith()](../../../client-api/session/querying/text-search/ends-with-search)
    ...
    - [exact()](../../../client-api/session/querying/text-search/exact-match-search)
    ...
    - [spatial.disjoint()](../../../client-api/session/querying/how-to-make-a-spatial-query)
