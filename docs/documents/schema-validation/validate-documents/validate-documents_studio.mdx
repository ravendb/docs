...
2. **Define the schema using JSON syntax**  
   ...
   ```json
   {
      ...
      // Define the most essential properties and their types
      "properties": {
   ...
   ```
3. **Save**  
   Click to save and activate the schema.  
   When activated, any document saved to the "Orders" collection will be validated against it.  
