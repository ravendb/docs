...
* Querying time series data is native to RavenDB's queries.  
  Clients can express time series queries in high-level LINQ expressions or directly in [RQL](../../../../querying/what-is-rql.mdx).
...
* Note the generated RQL in the second tab, where the custom function is translated to a [custom JavaScript function](../../../../querying/what-is-rql.mdx#declare).
