...
* In this article
  ...
  * [Store attachments remotely - using the **Studio**](../../../../document-extensions/attachments/store-attachments/store-attachments-remote.mdx#store-attachments-remotely-using-the-studio)  
