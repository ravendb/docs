...
description: "Troubleshoot and resolve RavenDB cluster certificate renewal failures including expired certificates and cross-node trust issues."
sidebar_position: 5
---
...
2. In case you are using your own Let's Encrypt client certificates, simply renew them 
   ...
   certificate](../../../studio/database/tasks/import-data/import-from-ravendb.mdx#step-#1:-prepare-servers-for-the-import-process-(secure-4.x-servers-only))).  
