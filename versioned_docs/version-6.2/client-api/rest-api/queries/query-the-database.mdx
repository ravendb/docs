...
* Queries are written in [RQL](../../session/querying/what-is-rql.mdx), our user friendly SQL-like query language.  
...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Query**           | A query in [RQL](../../session/querying/what-is-rql.mdx). You can insert parameters from the `QueryParameters` object with `$<parameter name>`                                                                              |
