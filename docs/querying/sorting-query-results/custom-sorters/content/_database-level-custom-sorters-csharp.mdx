...
In addition to deleting a custom sorter via [The custom sorters view](../../../../querying/sorting-query-results/custom-sorters/database-level-custom-sorters.mdx#the-custom-sorters-view) in Studio,  
