...
set the source schema/table, primary key column, and field mapping (source column &rarr; target property).

![Configure the customers table](../assets/example-simple-migration-1.png)    
