...
description: "Configure an Amazon SQS ETL task in RavenDB Studio to stream document changes to SQS queues with JavaScript transformations."
sidebar_position: 9
---
...
* This page explains how to create an Amazon SQS ETL task using Studio.  
  [Learn here](../../../../server/ongoing-tasks/etl/queue-etl/amazon-sqs.mdx) how to define 
  an Amazon SQS ETL task using the Client API.  .  
 
* In this page:  
  * [Ongoing Tasks View](../../../../studio/database/tasks/ongoing-tasks/amazon-sqs-etl.mdx#ongoing-tasks-view)  
  * [Define the Amazon SQS ETL task](../../../../studio/database/tasks/ongoing-tasks/amazon-sqs-etl.mdx#define-amazon-sqs-etl-task)  
  * [Add or Edit Transformation Script](../../../../studio/database/tasks/ongoing-tasks/amazon-sqs-etl.mdx#add-or-edit-transformation-script)  
  * [Comments](../../../../studio/database/tasks/ongoing-tasks/amazon-sqs-etl.mdx#comments)  
      * [ETL message size -vs- Queue message size](../../../../studio/database/tasks/ongoing-tasks/amazon-sqs-etl.mdx#etl-message-size--vs--queue-message-size)  
</Admonition>
## Ongoing Tasks View
...
4. **Connection string and Authentication**  
    ...
    * `C.` **Advanced**  
      ...
      Use this option to determine whether to [delete documents](../../../../server/ongoing-tasks/etl/queue-etl/amazon-sqs.mdx#delete-processed-documents) 
