...
{CODE:php session_usage_1@ClientApi\session\WhatIsSession.php /}

#### Modify document example  
* The following example modifies the content of an existing document.  

{CODE:php session_usage_2@ClientApi\session\WhatIsSession.php /}
...
{CODE:php session_usage_3@ClientApi\session\WhatIsSession.php /}
