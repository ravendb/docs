...
* By default, revisions are compressed.  
  This setting can be customized server-wide via the [CompressRevisionsDefault](../../server/configuration/database-configuration.mdx#databases.compression.compressrevisionsdefault) configuration key.
...
* **Revisions compression**
    * Revisions are compressed by default.  
      Learn [here](../../server/configuration/database-configuration.mdx#databases.compression.compressrevisionsdefault)
