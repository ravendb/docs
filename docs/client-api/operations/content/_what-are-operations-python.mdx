...
* **Target node**:  
  ...
  However, server-maintenance operations can be executed on a specific node by using the [for_node](../how-to/switch-operations-to-a-different-node.mdx) method.  
* **Target database**:  
  By default, operations work on the default database defined in the DocumentStore.  
  However, common operations & maintenance operations can operate on a different database by using the [for_database](../how-to/switch-operations-to-a-different-database.mdx) method.  
* **Transaction scope**:  
...
* All common operations implement the `IOperation` interface.  
  ...
  Use [for_database](../how-to/switch-operations-to-a-different-database.mdx) to operate on a specific database other than the default defined in the store.  
...
* All server-maintenance operations implement the `IServerOperation` interface.  
  ...
  Use [for_node](../how-to/switch-operations-to-a-different-node.mdx) to operate on a specific node other than the default defined in the client configuration.
