...
description: "Add RavenDB to an existing AWS Lambda .NET C# project with DocumentStore setup, dependency injection, and certificate configuration."
sidebar_position: 1
---
...
[Learn more about configuring AWS Secrets Manager](secrets-manager.mdx)
