...
[settings.json](../../server/configuration/configuration-options.mdx#settings.json) variables change your server's behavior in various ways.  
...
This [settings.json](../../server/configuration/configuration-options.mdx#settings.json) variable determines whether to run RavenDB with its standard 
