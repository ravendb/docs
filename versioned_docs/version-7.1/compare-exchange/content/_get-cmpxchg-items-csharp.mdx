...
* This article shows how to get **multiple** compare-exchange items.  
  To get a **single** item, see [Get compare-exchange item](../compare-exchange/get-cmpxchg-item.mdx).

* In this article:  
  * [Create sample compare-exchange items](../compare-exchange/get-cmpxchg-items.mdx#create-sample-compare-exchange-items)
  ...
  * [Syntax](../compare-exchange/get-cmpxchg-items.mdx#syntax)
