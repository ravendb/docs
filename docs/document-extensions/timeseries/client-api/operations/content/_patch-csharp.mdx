...
* The detailed syntax of `PatchByQueryOperation` is listed under this [syntax section](../../../../../documents/patching-documents/patch-multiple-documents/client-api.mdx#syntax-overview).
