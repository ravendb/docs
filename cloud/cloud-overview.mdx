...
5. **Summary**
#### 1. Email
![Registration page: Email Address](./assets/registration-page-email-address.png)

- Provide your email address.
- Read the **terms & conditions** and the **privacy policy**.
- Click the **Continue** button.
#### 2. Account information
![Registration page: Domain Name](./assets/registration-page-domain-name-and-account-type.png)
...
- Click the **Continue** button.
#### 3. Billing information
![Registration page: Billing information](./assets/registration-page-billing-information.png)
...
#### 4. Payment information
![Registration page: Payment information](./assets/registration-page-payment-information.png)

- Enter your payment information.
- Click the **Continue** button.
#### 5. Summary
![Registration page: Summary](./assets/registration-page-summary.png)
...
![Registration page: Thank you page](./assets/registration-page-thank-you.png)
...
![Login page](./assets/login-page-email.png)
...
![Login page with the single sign-on buttons](./assets/login-page-oauth-buttons.png)
...
<Admonition type="warning" title="The email address must be verified at the provider">
...
<Admonition type="info" title="Work or school Microsoft accounts">
...
![Check your inbox page](./assets/login-oauth-check-email-page.png)
...
| Production | **By CPU Priority** (Basic/Standard/Performance) <br/> **By Cluster Size**| Up to extra performance, high network and reserved NVMe | All | [Yes](../cloud/cloud-support.mdx#available-support-options) |
...
![Throttling Is Coming](./assets/studio-notification-cpu-credits-exhausted.png)
![Throttling Is Here](./assets/studio-notification-indexing-paused.png)
...
![Current Budget](./assets/browser-debug-cpu-credits-endpoint.png)
...
![Access Cloud Studio](./assets/portal-product-list-open-studio.png)
...
4. **Open Studio**  
   ...
   The example image above shows the certificate name after the node-tag "a." in the URL.
...
* [Your RavenDB clusters](../7.2/monitoring/cluster-dashboard/overview)
