...
* __Revisions__:  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [GetRevisionsOperation](../../client-api/operations/revisions/get-revisions.mdx)  
...
* __Revisions__:  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [ConfigureRevisionsOperation](../../client-api/operations/revisions/configure-revisions.mdx)  
...
|-------------|------------|-------------|
| **timeout** | `TimeSpan` | <ul><li><strong>When timespan is specified</strong> -<br/>The server throws an error if the operation has not completed within the specified time frame. No rollback action will take place.</li><li><code>null</code> -<br/>WaitForCompletion will wait for the operation to complete forever.</li></ul> |
