...
* You can set up a [RavenDB ETL Task](../../../studio/database/tasks/ongoing-tasks/ravendb-etl-task.mdx) 
  ...
  as well as other ongoing tasks such as: [SQL ETL](../../../server/ongoing-tasks/etl/sql.mdx) and [Subscriptions](../../../data-subscriptions/overview.mdx).
</Admonition>
...
* Artificial documents are _not_ sent over replication,  
  ...
  1. It is recommended to use artificial documents with [Subscriptions](../../../data-subscriptions/overview.mdx) only on a _single_ node.  
