...
* Use the below methods to set customization options on a specific [query](../overview.mdx).  
...
* Available customization methods :
  - [addBeforeQueryExecutedListener & removeBeforeQueryExecutedListener](#addbeforequeryexecutedlistener-removebeforequeryexecutedlistener)
  - [addAfterQueryExecutedListener & removeAfterQueryExecutedListener](#addafterqueryexecutedlistener-removeafterqueryexecutedlistener)
  - [noCaching](#nocaching)
