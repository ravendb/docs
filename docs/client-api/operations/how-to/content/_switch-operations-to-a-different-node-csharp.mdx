...
* By default, when working with multiple nodes,  
  ...
  (Learn more in: [Load balancing client requests](../../../configuration/load-balance/overview.mdx)).
...
* In this page:
    * [Server-maintenance operations - ForNode](#server-maintenance-operations---fornode)
</Admonition>
## Server maintenance operations - ForNode

* For reference, all server maintenance operations are listed [here](../../what-are-operations.mdx#server-maintenance-operations).
