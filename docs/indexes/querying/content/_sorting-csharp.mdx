...
* **Prior to this article**, please refer to [Sort dynamic queries results](../../../querying/sorting-query-results/sort-query-results.mdx) for dynamic-queries examples  
...
* Different ordering can be forced.  
  See section [Force ordering type](../../../querying/sorting-query-results/sort-query-results.mdx#force-ordering-type) for all available ordering types.  
