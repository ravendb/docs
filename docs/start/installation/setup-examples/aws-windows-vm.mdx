...
It's recommended to read the [Setup Wizard](../setup-wizard/overview.mdx) section where you can find a detailed 
...
We will use the [Setup Wizard](../setup-wizard/overview.mdx), but you can also configure things [manually](../manual.mdx).
...
You will need to claim your domain, read more [here](../setup-wizard/choose-security-option.mdx#generate-let-s-encrypt-certificate).
...
Connecting a few servers in a cluster is easy. Follow [these instructions](../setup-wizard/overview.mdx) to construct a cluster during setup.
