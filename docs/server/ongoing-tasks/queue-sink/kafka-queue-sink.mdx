...
* RavenDB can harness the advantages presented by message brokers like Kafka
  both as a producer (by [running ETL tasks](../etl/queue-etl/kafka.mdx))
...
* In this article:
  ...
  * [Client API](#client-api)
     * [Adding a Kafka connection string](#adding-a-kafka-connection-string)
     * [Adding a Kafka sink task](#adding-a-kafka-sink-task)
...
Read [below](#adding-a-kafka-connection-string)
...
[responsible node](../../clustering/distribution/highly-available-tasks.mdx#responsible-node).  
...
[multiple instances](../etl/queue-etl/overview.mdx#idempotence-and-message-duplication)
