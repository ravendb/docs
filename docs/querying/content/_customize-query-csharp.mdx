...
* Learn more in [how to stream query results](../../querying/stream-query-results.mdx).
...
* Supported for standard queries, lazy queries, suggestion queries, and aggregation queries.
...
<TabItem value="customize_10_5" label="customize_10_5">
<CodeBlock language="csharp">
