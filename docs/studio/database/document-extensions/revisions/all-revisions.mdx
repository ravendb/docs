...
description: "Browse all document revisions stored in a RavenDB database using Studio, with filtering by collection, date range, and change vector."
sidebar_position: 1
---
...
* The **All Revisions** view displays all [revisions](./revisions-overview.mdx) created over time for all your documents in the database.  
...
* From this view, you can manually delete selected revisions ("Regular Revisions" only).  
  Other available deletion methods are summarized in [All ways to delete revisions](#all-ways-to-delete-revisions).
...
* In this page:
  * [Opening the All Revisions view](#opening-the-all-revisions-view)  
  * [Using the All Revisions view](#using-the-all-revisions-view)
  * [All ways to delete revisions](#all-ways-to-delete-revisions)
...
3. **Revision Data**  
   ...
   * Collection - The collection this revision belongs to. Click to navigate to the [documents view](../../documents/documents-and-collections.mdx#the-documents-view) of this collection.
...
* "Regular Revisions" can be manually deleted from the All Revisions view.   
  See [using the All Revisions view](#using-the-all-revisions-view).
...
* Individual revisions can also be deleted when viewing the revision content.  
  See [Inspecting the revision](./revisions-overview.mdx#revision-inspection).
...
* "Delete Revisions" can be removed via:
    * The [Revisions Bin view](./revisions-bin.mdx) - manual deletion
...
* Revisions may be removed based on the configured revisions setting,  
  ...
  See [Default revision configuration](../../settings/document-revisions.mdx#define-default-configuration) and
  [Collection-specific configuration](../../settings/document-revisions.mdx#define-collection-specific-configuration).

* Revisions may also be deleted as a result of enforcing the current revision configuration.  
  Learn more in [Enforce configuration](../../settings/document-revisions.mdx#enforce-configuration).
