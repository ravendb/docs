...
* In this article:
   * [Ai.Embeddings.MaxBatchSize](../../server/configuration/ai-integration-configuration.mdx#ai.embeddings.maxbatchsize)  
   * [Ai.Embeddings.MaxConcurrentBatches](../../server/configuration/ai-integration-configuration.mdx#ai.embeddings.maxconcurrentbatches)  
   * [Ai.Embeddings.MaxFallbackTimeInSec](../../server/configuration/ai-integration-configuration.mdx#ai.embeddings.maxfallbacktimeinsec)  
