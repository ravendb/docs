...
description: "Understand data safety and database security considerations when sending documents to AI models through RavenDB GenAI tasks."
sidebar_position: 5
---
...
* **Send only the data you want to send**  
  ...
  task with and the [context generation script](../../ai-integration/gen-ai-integration/create-gen-ai-task/create-gen-ai-task_studio.mdx#generate-context-objects) 
...
* **Use the playgrounds**  
  ...
  [playgrounds](../../ai-integration/gen-ai-integration/create-gen-ai-task/create-gen-ai-task_studio.mdx#generate-context-objects-playground) 
...
* **Use a secure server**  
  ...
  and safety, you'd want to use a [secure server](../../start/installation/setup-wizard/choose-security-option.mdx).  
...
* **Use your update script wisely**  
  ...
  The [update script](../../ai-integration/gen-ai-integration/create-gen-ai-task/create-gen-ai-task_studio.mdx#provide-update-script) 
  ...
  using the built in Studio [playground](../../ai-integration/gen-ai-integration/create-gen-ai-task/create-gen-ai-task_studio.mdx#provide-update-script-playground).  
