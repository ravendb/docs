...
* Time series queries can be made using:  
  ...
  * Or directly through [RQL](../../../../../querying/rql/what-is-rql.mdx),
    which can be provided to a `RawQuery` or executed from Studio's [Query view](../../../../../studio/database/queries/query-view.mdx).
...
* Note:  
  The RavenDB client translates the LINQ query to [RQL](../../../../../querying/rql/what-is-rql.mdx) before transmitting it to the server for execution.
### Query examples
...
* The `session.Query` syntax is available [here](../../../../../querying/overview.mdx#syntax).
...
* Results will be in the form:
    ...
    * `TimeSeriesAggregationResult` for aggregated data
* Note:  
  The RavenDB client translates query to [RQL](../../../../../querying/rql/what-is-rql.mdx) before transmitting it to the server for execution.
...
The session [DocumentQuery](../../../../../querying/document-query/what-is-document-query.mdx),
