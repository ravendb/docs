...
* Schemas can be configured per collection using [Studio](./write-validation/write-validation_studio.mdx) or the [client API](./write-validation/write-validation_api.mdx).
...
* You can also audit documents compliance with a schema after they are stored, to identify and address any violations.  
  Auditing can be performed:  
   - By [running an audit operation](./auditing-document-compliance/auditing-document-compliance_api.mdx#running-an-audit-operation) that scans a document collection and reports validation violations.  
   - By [validating documents during indexing](./auditing-document-compliance/auditing-document-compliance_api.mdx#audit-document-compliance-by-index) and embedding validation error messages in the indexes.  
...
If the validation fails, the operation stops and a detailed [SchemaValidationException](./write-validation/write-validation_api.mdx#schemavalidationexception-message) is thrown.  
...
* [Type](./write-validation/write-validation_api.mdx#type)  
* [Required Properties](./write-validation/write-validation_api.mdx#required)  
* [Constant Value](./write-validation/write-validation_api.mdx#const)  
* [Allowed Values](./write-validation/write-validation_api.mdx#enum)  
* [String Minimum Length](./write-validation/write-validation_api.mdx#minlength)  
* [String Maximum Length](./write-validation/write-validation_api.mdx#maxlength)  
* [Pattern (Regex)](./write-validation/write-validation_api.mdx#pattern)  
* [Number Minimum Value](./write-validation/write-validation_api.mdx#minimum)  
* [Number Maximum Value](./write-validation/write-validation_api.mdx#maximum)  
* [Array Minimum Items](./write-validation/write-validation_api.mdx#minitems)  
* [Array Maximum Items](./write-validation/write-validation_api.mdx#maxitems)  
* [Properties](./write-validation/write-validation_api.mdx#properties)  
* [patternProperties](./write-validation/write-validation_api.mdx#patternproperties)  
* [Additional Properties](./write-validation/write-validation_api.mdx#additionalproperties)  
* [Items](./write-validation/write-validation_api.mdx#items)  
* [Dependencies](./write-validation/write-validation_api.mdx#dependencies)  
* [Null](./write-validation/write-validation_api.mdx#null)  
...
Learn [here](./auditing-document-compliance/auditing-document-compliance_api.mdx#running-an-audit-operation) how to launch an audit operation that scans the documents of a collection, checks their validity against a schema, and reports validation errors and related statistics.  
...
Learn [here](./auditing-document-compliance/auditing-document-compliance_api.mdx#audit-document-compliance-by-index) how to validate documents against a schema during indexing, and embed validation error messages in the indexes.  
