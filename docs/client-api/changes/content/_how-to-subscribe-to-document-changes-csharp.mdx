...
- [ForDocumentsInCollection](#fordocumentsincollection)
- [ForDocumentsStartingWith](#fordocumentsstartingwith)
...
| Return Value | |
| ------------- | ----- |
| IChangesObservable&lt;[DocumentChange](#documentchange)&gt; | Observable that allows to add subscriptions to notifications for given document. |
...
| Return Value | |
| ------------- | ----- |
| IChangesObservable&lt;[DocumentChange](#documentchange)&gt; | Observable that allows to add subscriptions to notifications for given document collection name. |
...
| Return Value | |
| ------------- | ----- |
| IChangesObservable&lt;[DocumentChange](#documentchange)&gt; | Observable that allows to add subscriptions to notifications for given document ID prefix. |
...
| Return Value | |
| ------------- | ----- |
| IChangesObservable&lt;[DocumentChange](#documentchange)&gt; | Observable that allows to add subscriptions to notifications for all documents. |
...
| ------------- | ------------- | ----- |
| **Type** | [DocumentChangeTypes](#documentchangetypes) | Document change type enum |
