...
* In this page:
  ...
  * [Client configuration overview and modification](#client-configuration-overview-and-modification)
  * [What can be configured](#what-can-be-configured)
  * [Put client configuration (for database)](#put-client-configuration-for-database))
  * [Syntax](#syntax)
...
* **What is the client configuration**:  
  ...
  See [what can be configured](#what-can-be-configured) below.  

* **Initializing the client configuration** (on the client):  
  This configuration can be initially customized from the client code when creating the Document Store via the [Conventions](../../../../configuration/conventions.mdx).
...
* **Updating the running client**:  
  ...
  * Once the client configuration is modified on the server, the running client will [receive the updated settings](../../../../configuration/load-balance/overview.mdx#keeping-the-client-topology-up-to-date)
...
* The client configuration set for the database level **overrides** the 
  [server-wide client configuration](../../../server-wide/configuration/put-serverwide-client-configuration.mdx).
...
* **Read balance behavior**:  
  ...
  Learn more in [Balancing client requests - overview](../../../../configuration/load-balance/overview.mdx) and [Read balance behavior](../../../../configuration/load-balance/read-balance-behavior.mdx).
  
* **Load balance behavior**:  
  Set the Load balance method for Read & Write requests.  
  Learn more in [Load balance behavior](../../../../configuration/load-balance/load-balance-behavior.mdx).
