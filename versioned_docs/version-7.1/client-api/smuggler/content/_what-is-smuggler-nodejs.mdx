...
Underneath the JavaScript engine is exactly the same as used for [patching operations](../../operations/patching/single-document.mdx) giving you identical syntax and capabilities with additional **ability to filter out documents by throwing a 'skip' exception**.
