...
* In this article:  
  * [Create item using a **cluster-wide session**](#create-item-using-a-cluster-wide-session)
    * [Ex.1 - Create new compare-exchange item](#ex1---create-new-compare-exchange-item)  
    * [Ex.2 - Create new compare-exchange item with metadata](#ex2---create-new-compare-exchange-item-with-metadata)
    * [Ex.3 - Create multiple items](#ex3---create-multiple-items)
  * [Create item using a **store operation**](#create-item-using-a-store-operation)  
    * [Ex.4 - Create new compare-exchange item](#ex4---create-new-compare-exchange-item)  
    * [Ex.5 - Create new compare-exchange item with metadata](#ex5---create-new-compare-exchange-item-with-metadata)
