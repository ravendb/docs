...
* On a [sharded database](../sharding/overview.mdx), document extensions 
  ...
  [dedicated to this subject](../sharding/document-extensions.mdx).  

* In this page:  
   * [Document Extensions](#document-extensions)  
   * [Studio Document Extension Views](#studio-document-extension-views)  

</Admonition>
## Document Extensions

* [Counters](./counters/overview.mdx)  
...
* [Time Series](./timeseries/overview.mdx)  
...
* [Revisions](./revisions/overview.mdx)  
