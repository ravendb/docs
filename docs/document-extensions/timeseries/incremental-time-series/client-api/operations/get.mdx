...
* **Parameters**  
    ...
    | `pageSize` | `int` | Size of each page, counted in [entries with unique timestamps](../../overview.mdx#incremental-time-series-structure) |
...
use [GetMultipleTimeSeriesOperation](../../../client-api/operations/get.mdx#getmultipletimeseriesoperation).  
