...
* In this page:
  ...
  * [Disabling an Embedded Table](#disabling-an-embedded-table)
...
- [REPLICA IDENTITY Manual Setup](./postgres/replica-identity-manual-setup.mdx)
