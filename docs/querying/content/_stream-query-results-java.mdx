...
| Parameters | | |
| ------------- | ------------- | ----- |
| **query** | [IDocumentQuery](../../querying/overview.mdx#sessionadvanceddocumentquery) or [IRawDocumentQuery](../../querying/overview.mdx#sessionadvancedrawquery) | Query to stream results for. |
