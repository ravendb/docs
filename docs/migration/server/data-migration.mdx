...
description: "Migrate your RavenDB server data between versions using the built-in migration tools, Studio import/export, or smuggler operations."
...
* In this article:
    * [Migration to RavenDB 7.x from a lower version](../../migration/server/data-migration.mdx#migration-to-ravendb-7-x-from-a-lower-version)
       * [Migration and NLog](../../migration/server/data-migration.mdx#migration-and-nlog)
       * [Migration and HTTP compression](../../migration/server/data-migration.mdx#migration-and-http-compression)
...
[NLog logging framework](../../monitoring/logging/overview.mdx) and writes all log 
data through it.  
...
[Learn more here about migration and the new logging system.](../../monitoring/logging/overview.mdx#customizing-logging-level-after-migration).  
