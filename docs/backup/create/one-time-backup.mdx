...
* In this article:  
  * [Running a one-time backup operation using the client API](../../backup/create/one-time-backup#running-a-one-time-backup-operation-using-the-client-api)
     ...
     * [Triggering a periodic backup task to run immediately](../../backup/create/one-time-backup#triggering-a-periodic-backup-task-to-run-immediately)
  ...
  * [Running a one-time backup operation using Studio](../../backup/create/one-time-backup#running-a-one-time-backup-operation-using-studio)
     ...
     * [Triggering a periodic backup task to run immediately](../../backup/create/one-time-backup#triggering-a-periodic-backup-task-to-run-immediately-1)
...
## Triggering a periodic backup task to run immediately

Each periodic backup task created for a database, including server-wide derived database backup tasks, can be executed on demand, outside of its scheduled execution times.  

[Learn to trigger a regular database backup task to run immediately](../../backup/create/periodic-tasks/database-backup#triggering-an-immediate-backup-creation)  

[Learn to trigger a server-wide derived backup task to run immediately](../../backup/create/periodic-tasks/server-wide-backup#triggering-an-immediate-backup-creation)  
...
[Learn to trigger a server-wide derived backup task to run immediately](../../backup/create/periodic-tasks/server-wide-backup#triggering-an-immediate-backup-creation-1)  
