...
Raven.Smuggler is distributed both in the RavenDB [distrubution package](http://builds.hibernatingrhinos.com/Builds/RavenDB) and in any of the shipped [nuget packages](http://ravendb.net/docs/1.0/intro/quickstart/adding-ravendb-to-your-application#installing-using-nuget). It is located under the `/Tools` folder.
