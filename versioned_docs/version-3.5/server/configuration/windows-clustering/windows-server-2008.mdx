---
title: "Configuration: Windows Clustering on Windows Server 2008"
...
1. If RavenDB isn't installed as a service, follow [this link](../../../server/installation/as-a-service.mdx) in order to do it
