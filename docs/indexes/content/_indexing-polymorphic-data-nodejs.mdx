...
* In this page:
    ...
    * [Possible solutions:](#possible-solutions)
        * [Multi-map index](#multi-map-indexes)
        * [Polymorphic index](#polymorphic-index)
        * [Customize collection](#customize-collection)
...
Writing a [Multi-map index](../multi-map-indexes.mdx) enables getting results from all collections the index was defined for.
