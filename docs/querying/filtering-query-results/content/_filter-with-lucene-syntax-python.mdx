...
use [comparison operators](../../../querying/filtering-query-results/filter-query-results.mdx#filter-by-numeric-value) such as `where_greater_than` / `where_less_than`,
or [where_between](../../../querying/filtering-query-results/filter-query-results.mdx#syntax).
