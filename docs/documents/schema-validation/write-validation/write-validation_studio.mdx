...
Manage [schema validation](../overview.mdx) using the Studio **Document Schema** view, to condition documents storage on their compliance with a defined JSON schema.  
...
2. **Define the schema using JSON syntax**  
   ...
   <Admonition type="note" title="">
   [See a list of available constraints.](../overview.mdx#available-constraints)  
   </Admonition>
...
3. **Save**  
   ...
   [See a list of operations that trigger validation](../overview.mdx#a-list-of-operations-that-trigger-validation).
   </Admonition>
