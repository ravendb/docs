...
- **MCP shifts documentation lookup off your plate.** Once Context7 is configured, the AI fetches RavenDB docs on its own when it hits an unfamiliar [client API](https://docs.ravendb.net/client-api/what-is-a-document-store). You do not need to invoke it explicitly or paste reference material into the chat.
