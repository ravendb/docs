...
RavenDB will automatically issue and renew a trusted HTTPS certificate for the [domain you define in the next step](../../../start/installation/setup-wizard/choose-security-option.mdx#enter-a-domain-name),  
