...
[activated automatically](../client-api/operations/revisions/configure-revisions#syntax) 
...
They [must be explicitly activated](../client-api/operations/revisions/configure-revisions#syntax) 
...
* Store Operations
   * [Creating a Revisions Configuration](../client-api/operations/revisions/configure-revisions)  
      * [ConfigureRevisionsOperation](../client-api/operations/revisions/configure-revisions#configurerevisionsoperation)  
        Use this operation to apply a Revisions configuration to your database.
   * [Get and Counting Revisions](../client-api/operations/revisions/get-revisions)
...
* Session Methods
   * [Load revisions and their metadata](../client-api/session/revisions/loading)  
      * [GetFor](../client-api/session/revisions/loading#getfor)  
        Use this method to retrieve all the revisions that are kept for a specified document.  
      * [GetMetadataFor](../client-api/session/revisions/loading#getmetadatafor)  
        Use this method to retrieve metadata for all revisions kept for a specified document.  
      * [Get](../client-api/session/revisions/loading#get)  
        Use this method to retrieve revisions by change vector or creation time.
   * [Counter revisions](../client-api/session/revisions/counter-revisions)
