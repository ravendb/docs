...
* RavenDB integrates **JavaScript scripting** across various features, including:  
  ...
  [Single](../../documents/patching-documents/patch-a-single-document/api-overview.mdx) or [Set based](../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx) document patches,  
...
|-------------------------------------------------------------|-------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **id(document)**                                            | `string`    | Returns the ID of the specified document<sup>[[ex]](../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx#updating-by-document-id)</sup>.                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| **del(documentId)**                                         | `void`      | Deletes the document with the specified ID. <br/> Used in [patching](../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx#updating-a-collection-name).                                                                                                                                                                                                                                                                                                                                                             |
