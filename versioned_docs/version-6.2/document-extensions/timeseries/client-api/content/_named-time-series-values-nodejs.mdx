...
* In this page:  
  * [Named values](#named-values)  
     * [Define time series class with named values](#define-time-series-class-with-named-values)  
     * [Examples](#examples)  
  * [Register time series named values](#register-time-series-named-values)  
     * [Usage](#usage)
     * [Syntax](#syntax)
