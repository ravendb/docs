...
* A task can be built in minutes, e.g. to generate automated responses to frequently asked questions, escalate support tickets, summarize lengthy documents, enhance data security by detecting anomalies, or numerous other applications.  
  See a few additional examples in the [common use cases](../../ai-integration/gen-ai-integration/overview#common-use-cases) section below.
...
* In this article:
   * [RavenDB GenAI tasks](../../ai-integration/gen-ai-integration/overview#ravendb-genai-tasks)
     * [The flow](../../ai-integration/gen-ai-integration/overview#the-flow)
     * [The elements](../../ai-integration/gen-ai-integration/overview#the-elements)
     * [How to create and run a GenAI task](../../ai-integration/gen-ai-integration/overview#how-to-create-and-run-a-genai-task)
   * [Runtime](../../ai-integration/gen-ai-integration/overview#runtime)
     * [Tracking of processed document parts](../../ai-integration/gen-ai-integration/overview#tracking-of-processed-document-parts)
   * [Licensing](../../ai-integration/gen-ai-integration/overview#licensing)
   * [Supported services](../../ai-integration/gen-ai-integration/overview#supported-services)
   * [Common use cases](../../ai-integration/gen-ai-integration/overview#common-use-cases)
...
3. The task generates context objects based on the source document data.  
   To generate these objects, the task applies a user-defined [context generation script](../../ai-integration/gen-ai-integration/overview#the-elements_context-objects) 
...
4. The task sends each context object to a GenAI model for processing.  
    ...
    * Each context object is sent along with a user-defined [Prompt](../../ai-integration/gen-ai-integration/overview#the-elements_prompt), 
      that instructs the AI model what to do with the data, and 
      a user-defined [JSON schema](../../ai-integration/gen-ai-integration/overview#the-elements_json-schema) 
      that instructs the AI model how to shape its response.  
5. When the AI model returns its response, a user-defined [Update script](../../ai-integration/gen-ai-integration/overview#the-elements_update-script) 
