...
* **Disk storage**: Proportional to request volume.  
  ...
  These limits are set by the standard [logging configuration](../../monitoring/logs/configuration.mdx):  
  [`Logs.ArchiveAboveSizeInMb`](../../monitoring/logs/configuration.mdx#logsarchiveabovesizeinmb) (default: 128 MB),  
  [`Logs.MaxArchiveDays`](../../monitoring/logs/configuration.mdx#logsmaxarchivedays) (default: 3 days),  
