...
description: "Definition of the RavenDB database ID — the unique GUID identifier assigned to each database instance within a cluster for tracking purposes."
