...
* The **scan frequency** is configurable -  
  see the [Cluster.CompareExchangeExpiredDeleteFrequencyInSec](../compare-exchange/configuration.mdx#clustercompareexchangeexpireddeletefrequencyinsec) configuration key. 
  The default is 60 seconds.  

* To manually remove a compare-exchange item, see [Delete compare-exchange items](../compare-exchange/delete-cmpxchg-items.mdx).

* Note: The compare-exchange expiration feature is not related to [document expiration](../server/extensions/expiration.mdx).  
...
* In this article:  
  ...
  * [Syntax](../compare-exchange/cmpxchg-expiration.mdx#syntax)   
...
* The syntax for **creating** a compare-exchange item is available in [Create compare-exchange item - Syntax](../compare-exchange/create-cmpxchg-items.mdx#syntax)
* The syntax for **updating** a compare-exchange item is available in [Update compare-exchange item - Syntax](../compare-exchange/update-cmpxchg-item.mdx#syntax)
