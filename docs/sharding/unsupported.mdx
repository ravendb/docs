...
| Includes and loads are not supported in streaming queries     | Learn more in [Streaming query results - Limitations](../sharding/querying.mdx#todo). |
| Ordering streamed Map-Reduce results by non-reduce-key fields | Learn more in [Streaming query results - Limitations](../sharding/querying.mdx#todo). |
