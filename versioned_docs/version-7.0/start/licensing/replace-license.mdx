...
* If you upgrade to RavenDB 6.0, you need to upgrade your current license key 
  ...
  as explained [below](../../start/licensing/replace-license.mdx#upgrade-a-license-key-for-ravendb-6.x) 
  to upgrade your key.  
...
* In this page:
    ...
    * [Upgrade a License Key For RavenDB 6.x](../../start/licensing/replace-license.mdx#upgrade-a-license-key-for-ravendb-6.x)  
