...
description: "Manage RavenDB sharded databases through the Studio UI — view shard topology, monitor shard health, and configure shard settings."
...
6. **Backups view**  
   Click to manage [backup tasks](../../backup/create/periodic-tasks/database-backup#creating-and-managing-periodic-backups-via-studio) and restore existing backups.  
7. **Manage group**  
