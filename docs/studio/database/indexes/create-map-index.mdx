...
description: "Define and deploy map indexes in RavenDB Studio with a visual editor for index fields, analyzers, and storage configuration."
sidebar_position: 2
---
...
* In this page:  
  * [Edit Index View](#edit-index-view)  
  * [Test Index](#test-index)  
  * [Index Fields & Terms](#index-fields--terms)  
  * [Index Field Options](#index-field-options)  
     * [Add Compound Field](#add-compound-field)  
  * [Configuration](#configuration)  
  * [Additional Assemblies](#additional-assemblies)  
  * [Additional Sources](#additional-sources)  
  * [Spatial Field Options](#spatial-field-options)  
</Admonition>
## Edit Index View
...
1. **Save** - Save index definition.  
   ...
   **Index History** - Open the [Index History Dialog](./index-history.mdx#index-history-dialog).  
...
2. Options available for an already saved index:  
   ...
   **Terms** - Click to see the index terms, see [below](#index-fields--terms).  
...
2. **Terms**  
   ...
   by the specified [Field Options](#index-field-options).  
   </Admonition>
...
1. **Add compound field**  
    ...
    * Learn to add a compound field using Studio [below](#add-compound-field).  
...
5. **Basic options**  
    ...
    * [Spatial](../../../indexes/querying/spatial.mdx)  
      See [below](#spatial-field-options)  
   ...
   Click to display or hide these advanced index field options:  
     ...
     * `Indexing`  
        ...
        * **Search**  
          ...
          When a [custom analyzer](../settings/custom-analyzers.mdx) 
