...
monitoring facilities ([SNMP](https://docs.ravendb.net/7.2/server/administration/snmp/snmp-overview),
[OpenTelemetry](https://docs.ravendb.net/7.2/server/administration/monitoring/open-telemetry), and others).
