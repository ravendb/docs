...
and if the [DisableAutoUpdate](../../server/configuration/license-configuration.mdx#license.disableautoupdate) configuration is Not set to true,  
...
* Set [DisableAutoUpdateFromApi](../../server/configuration/license-configuration.mdx#license.disableautoupdatefromapi) to true.
