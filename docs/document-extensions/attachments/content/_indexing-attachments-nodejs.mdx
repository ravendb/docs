...
* To index **attachments' content**, see the examples [below](../../../document-extensions/attachments/indexing-attachments.mdx#index-details--content---by-attachment-name).
...
{`class Employees_ByAttachment extends AbstractJavaScriptIndexCreationTask \{
    constructor () \{
        ...
        // It can be useful to configure Full-Text search on the attachment content index-field
