...
* [Installing](../../start/installation/setup-wizard.mdx) RavenDB as 
...
* PostgreSQL protocol support must be explicitly enabled in your [settings](../../server/configuration/configuration-options.mdx#settings.json).  
...
* PostgreSQL is an experimental feature. To enable it, enable RavenDB's 
  [Experimental Features](../../server/configuration/core-configuration.mdx#features.availability) 
