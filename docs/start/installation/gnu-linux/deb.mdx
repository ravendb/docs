...
* In this page:  
   * [Downloading and Installing RavenDB](#downloading-and-installing-ravendb)  
      * [1. Download DEB Package](#1-download-deb-package)  
      * [2. Install RavenDB](#2-install-ravendb)  
      * [3. Complete the setup](#3-complete-the-setup)  
      * [4. Entering RavenDB Studio When Setup is Complete](#4-entering-ravendb-studio-when-setup-is-complete)  
...
* [Find Here](../setup-wizard/overview.mdx) a **step by step guide** 
