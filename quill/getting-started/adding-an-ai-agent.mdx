...
The created agent is listed in the app's **Agents** table, where its configuration can be reviewed and modified at any
time. See [App: Agents view](../dashboard/manage-an-app/app-agents-view.mdx).
