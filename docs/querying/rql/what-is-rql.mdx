...
- [ORDER BY](../../querying/rql/what-is-rql.mdx#order-by)
    - [ASC | ASCENDING](../../indexes/querying/sorting.mdx#order-by-index-field-value)
    - [DESC | DESCENDING](../../indexes/querying/sorting.mdx#order-by-index-field-value)
    - [AS](../../indexes/querying/sorting.mdx#order-by-index-field-value)
        - [string](../../indexes/querying/sorting.mdx#order-by-index-field-value)
        - [long](../../indexes/querying/sorting.mdx#order-by-index-field-value)
        - [double](../../indexes/querying/sorting.mdx#order-by-index-field-value)
        - [alphaNumeric](../../client-api/session/querying/sort-query-results.mdx#order-by-alphanumeric)
    - [random()](../../client-api/session/querying/sort-query-results.mdx#order-by-random)
    - [score()](../../client-api/session/querying/sort-query-results.mdx#order-by-score)
...
To negate the `in` operator, you can check the existence of the given field name before validating it does not contain the passed values.
...
Or validate all documents where the key does not exist or is not the one provided by supplying `where true` instead.
