...
Go to the [Products tab](./portal/cloud-portal-products-tab.mdx) in the cloud [portal](./portal/cloud-portal.mdx) 
...
Operations like adding and removing cluster nodes are left for your [products administrators](./cloud-overview.mdx#ravendb-on-the-cloud-overview).  
...
<Admonition type="info" title="">
If your instance runs on a [burstable CPU](./cloud-overview.mdx#burstable-vs-reserved-clusters), especially if it is a low-end one, 
RavenDB may take a while to generate certificates and spend a lot of your [CPU credits](./cloud-overview.mdx#budget-credits-and-throttling) in the 
process.  
