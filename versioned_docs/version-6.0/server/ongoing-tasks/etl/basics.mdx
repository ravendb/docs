...
Learn more about the way ETL works on a sharded database [here](../../../sharding/etl.mdx).  
</Admonition>
...
- [OLAP ETL](../../../server/ongoing-tasks/etl/olap.mdx)
- [Elasticsearch ETL](../../../server/ongoing-tasks/etl/elasticsearch.mdx)
</Admonition>
