...
* Multi-Map indexes allow you to index data from multiple collections e.g. polymorphic data (check the [example](../indexes/indexing-polymorphic-data.mdx)) 
...
* In this page:
  ...
  * [Indexing Polymorphic Data](../indexes/multi-map-indexes.mdx#indexing-polymorphic-data)
