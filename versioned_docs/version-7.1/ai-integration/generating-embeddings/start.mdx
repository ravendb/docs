...
* Embeddings also power other AI features in RavenDB, such as [GenAI](../../ai-integration/gen-ai-integration/start) and [AI agents](../../ai-integration/ai-agents/ai-agents_start),  
