...
- [Delete node from the cluster](#delete-node-from-the-cluster)
- [Promote a watcher node](#promote-a-node)
- [Demote a watcher node](#demote-a-node)
- [Force elections](#force-elections)
- [Force timeout](#force-timeout)
- [Bootstrap the cluster](#bootstrap-cluster)
