...
You need to either [handle that](../../server/scaling-out/replication/replication-conflicts) or to choose to disallow writes while using the master is unavailable, and use the slave just for reads.
