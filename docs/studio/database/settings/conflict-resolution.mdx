...
description: "Configure automatic document conflict resolution in RavenDB Studio using built-in strategies or custom JavaScript resolver scripts."
sidebar_position: 2
---
...
* Conflicts that are created can be manually resolved in [Documents Conflicts View](../../../studio/database/documents/conflicts-view.mdx).  

* In this page:  
  * [The Conflicts Resolution View](../../../studio/database/settings/conflict-resolution.mdx#the-conflicts-resolution-view)  
  * [Script Examples](../../../studio/database/settings/conflict-resolution.mdx#script-examples)  
</Admonition>
