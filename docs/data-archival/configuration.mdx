---
title: "Configuration"
description: "Configure RavenDB data archival behavior for static indexes, auto indexes, and subscriptions using ArchivedDataProcessingBehavior settings."
sidebar_label: "Configuration"
sidebar_position: 6
see_also:
     - title: "Indexing Configuration"
       link: "server/configuration/indexing-configuration"
       source: "docs"
       path: "Server > Configuration"
     - title: "Subscription Configuration"
       link: "server/configuration/subscription-configuration"
       source: "docs"
       path: "Server > Configuration"
---
...
* The following configuration options are available for data archival:  
    ...
    * [Subscriptions.ArchivedDataProcessingBehavior](#subscriptionsarchiveddataprocessingbehavior)
