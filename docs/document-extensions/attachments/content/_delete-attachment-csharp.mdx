...
* In this article:
  * [Delete attachment using **Studio**](../../../document-extensions/attachments/delete-attachment.mdx#delete-attachment-using-studio)  
...
<Panel heading="Delete attachment using Studio">
    
In Studio, open the document view.  
...
Learn about patching in: [Patching single document](../../../documents/patching-documents/patch-a-single-document/api-overview.mdx) and [Patching multiple documents](../../../documents/patching-documents/patch-multiple-documents/client-api.mdx).
