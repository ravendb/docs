...
* **Default page size**:  
    ...
    * Querying **Corax** indexes:  
      ...
      Note: when using [Corax](../../search-engine/corax.mdx) as the search engine, 
...
* As suggested by this performance hint, you may consider using [Streaming query results](../../../querying/stream-query-results.mdx) instead of paging.
