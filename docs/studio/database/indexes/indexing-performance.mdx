...
If it is a server-wide only configuration, it must be set in the server's [settings.json](../../../server/configuration/configuration-options.mdx#settings.json).  
...
* [Low Memory](../../../server/configuration/memory-configuration.mdx#memory.lowmemorylimitinmb) resources can slow down your system and result in [batch stops](../../../studio/database/indexes/indexing-performance.mdx#common-indexing-issues). 
   * **On a local machine**  
     * You can upgrade your hardware, divide the work onto more machines in a cluster, and/or optimize your indexes.  
     * Until then, there are a number of [indexing configurations](../../../server/configuration/indexing-configuration.mdx#indexing.mapbatchsize) that you can configure
  ...
  * **Cloud server**  
    ...
    This can happen on [basic](../../../cloud/cloud-instances.mdx#basic-grade-production-cluster)-level cloud instances.  
     * Unless you're running a [production cloud tier](../../../cloud/cloud-instances.mdx#a-production-cloud-cluster) with CPU priority of [standard](../../../cloud/cloud-instances.mdx#standard-grade-production-cluster) 
    or [Performance](../../../cloud/cloud-instances.mdx#performance-grade-production-cluster), your cluster is [burstable and subject to throttling](../../../cloud/cloud-overview.mdx#budget-credits-and-throttling).  
     ...
     * On a cloud instance, you can [upgrade](../../../cloud/portal/cloud-portal-products-tab.mdx) your instance, [scale](../../../cloud/cloud-scaling.mdx), 
...
- [Limit concurrent index processes](../../../server/configuration/indexing-configuration.mdx#indexing.maxnumberofconcurrentlyrunningindexes) - 
