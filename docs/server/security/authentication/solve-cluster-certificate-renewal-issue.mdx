...
* Find [whether this issue is relevant for you](#current-situation) 
  and if so, [how to handle it](#solutions).  

* **In this page**:  
   * [Errors Relevant To This Issue](#errors-relevant-to-this-issue)  
   * [Background And Current Situation](#background-and-current-situation)  
   * [Solutions](#solutions)  
