...
| **Raven/MaxConcurrentServerRequests** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/MaxConcurrentMultiGetRequests** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
...
| **Raven/DisableDocumentPreFetching** | ![Yes](./assets/tick.png) | ![Yes](./assets/tick.png) |
...
| **Raven/Indexing/DisableMapReduceInMemoryTracking** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/MaxPrecomputedBatchTotalDocumentSizeInBytes**  | ![Yes](./assets/tick.png) | ![Yes](./assets/tick.png) |
| **Raven/BulkImport/BatchTimeout** | ![Yes](./assets/tick.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
...
| **Raven/DatabaseOperationTimeout** | ![Yes](./assets/tick.png) | ![Yes](./assets/tick.png) |
| **Raven/MaxRecentTouchesToRemember** | ![Yes](./assets/tick.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
...
| **Raven/RejectClientsModeEnabled** |![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
...
| **Raven/TurnOffDiscoveryClient** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
...
| **Raven/Replication/ReplicationPropagationDelayInSeconds** | ![Yes](./assets/tick.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
...
| &nbsp; |||
| **Raven/FileSystem/MaximumSynchronizationInterval** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/FileSystem/IndexStoragePath** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/FileSystem/DataDir** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/FileSystem/Storage** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
| **Raven/Counters/DataDir** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Counter/TombstoneRetentionTimeh** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Counter/DeletedTombstonesInBatch** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Counter/ReplicationLatency** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Counter/BatchTimeout** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
| **Raven/TimeSeries/DataDir** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/TimeSeries/ReplicationLatency** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
| **Raven/Cluster/ElectionTimeout** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Cluster/HeartbeatTimeout** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Cluster/MaxLogLengthBeforeCompaction** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Cluster/MaxEntriesPerRequest** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Cluster/MaxStepDownDrainTime** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Cluster/MaxReplicationLatency** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
| **Raven/Monitoring/Snmp/Enabled** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Monitoring/Snmp/Community** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| **Raven/Monitoring/Snmp/Port** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
| &nbsp; |||
| **Raven/WebSockets/InitialBufferPoolSize** | ![No](./assets/delete.png) | ![Yes](./assets/tick.png) |
...
In the studio you can configure global behavior for all the bundles, read [here](../../studio/management/global-configuration.mdx) for more information.
