---
title: "Dashboard: AI Connection Strings View"
sidebar_label: AI Connection Strings View
sidebar_position: 5
...
* Agents refer to connection strings by name.  
  Select a connection string when you [create](../getting-started/adding-an-ai-agent.mdx#connecting-to-your-llm-provider)
  or [edit](manage-an-app/app-agents-view.mdx#the-agent-s-configuration) an agent.
