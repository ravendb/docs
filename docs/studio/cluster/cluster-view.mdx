...
1. **Add New Node to Cluster**  
   See [Setting a Cluster](./setting-a-cluster.mdx#add-another-node-to-the-cluster)  
2. **Demote**  
...
Learn more in [Setting a Cluster](./setting-a-cluster.mdx#add-another-node-to-the-cluster).
...
* **1.** A new server/node will start as **Passive**, meaning it is _not_ part of any cluster yet.  
         Learn how to add a node to a cluster in: [Setting a Cluster](./setting-a-cluster.mdx).  
...
* i.e.:  
  ...
  * Creating/deleting/modifying/enabling/disabling an [ongoing task](../database/tasks/ongoing-tasks/general-info.mdx)  
  * Creating/deleting/modifying an [index](../database/indexes/indexes-overview.mdx)  
...
* Any such update is automatically replicated to all other nodes in the [Database Group](../database/settings/manage-database-group.mdx)  
* i.e.:  
