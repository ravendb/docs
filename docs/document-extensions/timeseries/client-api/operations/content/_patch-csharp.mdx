...
* The detailed syntax of `PatchOperation` is listed under this [syntax section](../../../../../documents/patching-documents/patch-a-single-document/api-overview.mdx#operations-api).

* The detailed syntax of `PatchRequest` is listed under this [syntax section](../../../../../documents/patching-documents/patch-a-single-document/api-overview.mdx#patchrequest).
...
* The detailed syntax of `PatchByQueryOperation` is listed under this [syntax section](../../../../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx#syntax-overview).
