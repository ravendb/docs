...
6. **[Channel creation](getting-started/adding-a-chat-widget.mdx)**  
   *The agent goes live in your site.*  
   ...
   An embed link placed in a page of your site will display the chat widget, live and answering from the mirrored data.
