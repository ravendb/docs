...
* Queries defined with the `query` method are translated by the RavenDB client to [RQL](../what-is-rql.mdx)  
...
* Queries defined with [query](#sessionquery) are translated by the RavenDB client to [RQL](../what-is-rql.mdx) when sent to the server.  
...
Available methods for the session's [query](#sessionquery) method:
...
- include
- [includeExplanations](../debugging/include-explanations.mdx)
- [intersect](../how-to-use-intersect.mdx)
- lazily
- [longCount](../how-to-count-query-results.mdx)
- [moreLikeThis](../how-to-use-morelikethis.mdx)
- negateNext
- [noCaching](../how-to-customize-query.mdx#nocaching)
- [noTracking](../how-to-customize-query.mdx#notracking)
- not
- [ofType](../how-to-project-query-results.mdx#oftype)
- [on("afterQueryExecuted")](../how-to-customize-query.mdx#on-("afterqueryexecuted"))
- [on("beforeQueryExecuted")](../how-to-customize-query.mdx#on-("beforequeryexecuted"))
- openSubclause
...
- orElse
- proximity
- [randomOrdering](../how-to-customize-query.mdx#randomordering)
- relatesToShape
- search
...
- [waitForNonStaleResults](../how-to-customize-query.mdx#waitfornonstaleresults)
- whereBetween
...
- [whereLucene](../document-query/how-to-use-lucene.mdx)
- whereNotEquals
...
| Return Value | |
| - | - |
| `object` | Instance implementing `IDocumentQuery` exposing the additional [query methods](#query-api). |
