...
![NoSQL Database Studio Backups View](./assets/backup-task-view1.png)
 ...
 4. **Restore a database from a backup**  
    To [restore a database](../../../studio/server/databases/create-new-database/from-backup.mdx) from a previously created backup.
...
![Periodic Backup View](./assets/Periodic-backup-task-view.png)
 ...
 5. **Go to server-wide backups view** to [back up all databases on the server](../../../studio/server/server-wide-backup.mdx).  
 6. **Database Group Topology**  
...
![Backup Encryption Options](./assets/backup-encryption-options.png)
 ...
 2. Choose the current encryption key or create a new one for this backup task.  
  ...
  ![Create New Encryption Key for Backup](./assets/create-new-encryption-key-for-backup.png)
