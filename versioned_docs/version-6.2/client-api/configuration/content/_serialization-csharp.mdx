...
Use the methods described in this page to customize the [conventions](../conventions.mdx)
...
* Adjust [Bulk Insert](../../bulk-insert/how-to-work-with-bulk-insert-operation.mdx)
...
* By default, if you try to store an entity with `ref` or unsafe members,
  the Client will throw an exception when [`session.SaveChanges()`](../../session/saving-changes.mdx)
  is called.  
