...
description: "Configure a Kafka queue sink task in RavenDB Studio to consume messages from Kafka topics and store them as RavenDB documents."
sidebar_position: 11
---
...
* RavenDB can collaborate with message brokers like Kafka both as a **producer**, 
  by running [ETL tasks](../../../../studio/database/tasks/ongoing-tasks/kafka-etl-task.mdx)), 
...
* This page explains how to create a Kafka queue sink task using the Studio.  
  ...
  Learn how to define a Kafka queue sink using the API [here](../../../../server/ongoing-tasks/queue-sink/kafka-queue-sink.mdx).  

* In this page:  
  * [Add a Database Task](../../../../studio/database/tasks/ongoing-tasks/kafka-queue-sink.mdx#add-a-database-task)  
  * [Define a Kafka Sink Task](../../../../studio/database/tasks/ongoing-tasks/kafka-queue-sink.mdx#define-a-kafka-sink-task)  
      * [Define and Test Task Scripts](../../../../studio/database/tasks/ongoing-tasks/kafka-queue-sink.mdx#define-and-test-task-scripts)  
  * [Task Statistics](../../../../studio/database/tasks/ongoing-tasks/kafka-queue-sink.mdx#task-statistics)  
...
4. **Responsible Node** (Optional)  
  * Select a node from the [Database Group](../../../../studio/database/settings/manage-database-group.mdx) 
...
3. **Script**: [Edit the script](../../../../server/ongoing-tasks/queue-sink/kafka-queue-sink.mdx#running-user-defined-scripts).  
...
Sink statistics are added to RavenDB's Ongoing Task Stats view, where their 
performance can be examined from various aspects. To watch these statistics, 
enter Studio's [Ongoing Task Stats](../../../../monitoring/performance-views/ongoing-task-stats.mdx) 
view.  
