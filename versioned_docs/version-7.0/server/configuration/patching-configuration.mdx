...
* In this article:
    * [Patching.AllowStringCompilation](../../server/configuration/patching-configuration.mdx#patching.allowstringcompilation)
    * [Patching.MaxStepsForScript](../../server/configuration/patching-configuration.mdx#patching.maxstepsforscript)
    * [Patching.StrictMode](../../server/configuration/patching-configuration.mdx#patching.strictmode)
