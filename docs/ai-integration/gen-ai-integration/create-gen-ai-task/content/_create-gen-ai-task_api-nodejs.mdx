...
* The main steps in defining a GenAI task are:  
   * Defining a [Connection string](#define-a-connection-string) 
     to the AI model  
...
* In this article:
    * [Define a connection string](#define-a-connection-string)
    * [Define the GenAI task](#define-the-genai-task)
