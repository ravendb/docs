...
* This article explains how to define a connection string to the [Google AI service](https://ai.google.dev/gemini-api/docs),  
  enabling RavenDB to use Google AI models for [Embeddings generation tasks](../../generating-embeddings/overview.mdx),
...
connectionString.name = "ConnectionStringToGoogle";
...
connectionString.googleSettings = new GoogleSettings(
    "text-embedding-004", // Name of text embedding model to use
    "https://language.googleapis.com/v1/documents:analyzeEntities?key=your-api-key",
    "V1"); // Google's AI API version
