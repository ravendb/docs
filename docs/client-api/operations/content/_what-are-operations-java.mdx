...
Common operations include set-based operations for [Patching](../../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx) or removal of documents by using queries (more can be read [here](../../../client-api/operations/common/delete-by-query.mdx)).  
There is also the ability to handle distributed [Compare Exchange](../../../compare-exchange/overview.mdx) operations and manage [Attachments](../../../document-extensions/attachments/get-attachments.mdx) and [Counters](../../../client-api/operations/counters/counter-batch.mdx).
...
* [GetCollectionStatisticsOperation](../../../monitoring/statistics/client-api.mdx)   
* [GetStatisticsOperation](../../../monitoring/statistics/client-api.mdx)     
