...
Live statistics can be retrieved via Studio using its **Stats** menu or [cluster dashboard](../../studio/cluster/cluster-dashboard/cluster-dashboard-overview.mdx), as well as through dedicated endpoints:
...
or via the Client API (details [here](../../client-api/operations/maintenance/get-stats.mdx)).
