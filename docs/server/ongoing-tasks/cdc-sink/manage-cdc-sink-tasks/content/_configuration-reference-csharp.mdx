...
| `CaseSensitiveKeys` | `bool`                             |          | Whether string PK values are matched case-sensitively.<br/>Set to `true` when values that differ only by letter case represent different keys. Default: `false` |
