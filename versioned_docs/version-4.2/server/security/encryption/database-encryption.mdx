...
When [creating an encrypted database using the Studio](../../../studio/server/databases/create-new-database/encrypted.mdx), you will receive a secret key which will 
