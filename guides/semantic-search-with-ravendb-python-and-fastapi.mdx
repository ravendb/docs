...
<Image img={require("./assets/semsearch1.png")} alt="" />
<Image img={require("./assets/semsearch2.png")} alt="" />
...
<Image img={require("./assets/semsearch3.png")} alt="" />
...
<Image img={require("./assets/semsearch4.png")} alt="" />
...
<Image img={require("./assets/semsearch5.png")} alt="" />
<Image img={require("./assets/semsearch6.png")} alt="" />
In the studio, RavenDB created a separate collection for embeddings and cached terms:  
<Image img={require("./assets/semsearch7.png")} alt="" />
