...
* With prefixed sharding, you only control the shard where a document is stored.  
  ...
  Learn more [below](#prefixed-sharding-vs-anchoring-documents).
  
* In this page:  
  * [Why use prefixed sharding](#why-use-prefixed-sharding)  
  * [Overview](#overview)  
  * [Bucket management](#bucket-management)  
  * [Adding prefixes via Studio](#adding-prefixes-via-studio)
  * [Adding prefixes via Client API](#adding-prefixes-via-client-api)
      * [Add prefixes when creating a database](#add-prefixes-when-creating-a-database)
      * [Add prefixes after database creation](#add-prefixes-after-database-creation)
  * [Removing prefixes](#removing-prefixes)
  * [Updating shard configurations for prefixes](#updating-shard-configurations-for-prefixes)
  * [Querying selected shards by prefix](#querying-selected-shards-by-prefix)
  * [Prefixed sharding vs Anchoring documents](#prefixed-sharding-vs-anchoring-documents)
...
* To store documents on a specific shard, define the target shard for each document ID prefix that you add.  
  ...
  Learn how to [add prefixes](#adding-prefixes-via-client-api) below.
...
* In the below example, in addition to shard **#2** that was configured in the [previous](#add-prefixes-after-database-creation) example,  
