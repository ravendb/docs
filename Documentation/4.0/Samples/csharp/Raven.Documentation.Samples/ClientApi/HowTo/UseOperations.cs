...
namespace Raven.Documentation.Samples.ClientApi.HowTo
{
    public class UseOperations
    {
        ...
        public async Task Examples()
        {
            ...
            {
                #region Client_Operations_0
                documentStore.Operations.Send(new DeleteByQueryOperation(new IndexQuery
                {
                ...
                #region Client_Operations_2
                documentStore.Operations.Send(new DeleteAttachmentOperation("users/1", "file.txt"));
                #endregion

                #region Client_Operations_2_async
                await documentStore.Operations.SendAsync(new DeleteAttachmentOperation("users/1", "file.txt"));
                #endregion

                #region Maintenance_Operations_1                
                IndexDefinition[] definitions = documentStore.Maintenance.Send(new GetIndexesOperation(0, 128));
                #endregion

                #region Maintenance_Operations_1_async                
                IndexDefinition[] indexDefinitions = await documentStore.Maintenance.SendAsync(new GetIndexesOperation(0, 128));
                #endregion

                #region Maintenance_Operations_2                
                documentStore.Maintenance.Send(new StopIndexOperation("Orders/ByCompany"));
                #endregion

                #region Maintenance_Operations_2_async                
                ...
                #region Server_Operations_2                               
                documentStore.Maintenance.Server.Send(new CreateDatabaseOperation(new DatabaseRecord("MyDB")));
                #endregion

                #region Server_Operations_2_async                               
                await documentStore.Maintenance.Server.SendAsync(new CreateDatabaseOperation(new DatabaseRecord("MyDB")));
                #endregion
