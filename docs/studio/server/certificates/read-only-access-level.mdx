...
description: "Grant read-only database access in RavenDB by assigning client certificates with restricted permissions through Studio certificate management."
sidebar_position: 1
---
...
* The [Running Queries](../../../monitoring/performance-views/running-queries.mdx) view, a live
display of queries the server is currently processing.  
