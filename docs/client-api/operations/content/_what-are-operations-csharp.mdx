...
* **Backup**:  
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [UpdatePeriodicBackupOperation](../../../backup/create/periodic-tasks/database-backup.mdx#creating-a-periodic-backup-task)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; GetPeriodicBackupStatusOperation  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [StartBackupOperation](../../../backup/create/periodic-tasks/database-backup.mdx#managing-backup-operations)  
