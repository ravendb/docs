...
* Counters interact with and can trigger other RavenDB features.  
 To find out how to use counters with other features, read [Counters and Other Features](../../document-extensions/counters/counters-and-other-features.mdx).  
...
* **Usage flow**:  
  ...
  * If you execute [Increment](../../document-extensions/counters/create-or-modify.mdx) or [Delete](../../document-extensions/counters/delete.mdx), call `session.SaveChanges` for the action to take effect on the server.  
...
* Counters interact with and can trigger other RavenDB features.  
 To find out how to use counters with other features, read [Counters and Other Features](../../../java/document-extensions/counters/counters-and-other-features.mdx).  
...
* Counters interact with and can trigger other RavenDB features.  
 To find out how to use counters with other features, read [Counters and Other Features](../../../csharp/document-extensions/counters/counters-and-other-features.mdx).  
