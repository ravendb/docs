...
* In this article:
    * [Patching.AllowStringCompilation](#patchingallowstringcompilation)
    * [Patching.MaxStepsForScript](#patchingmaxstepsforscript)
    * [Patching.StrictMode](#patchingstrictmode)
