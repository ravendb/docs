...
| - | - | - |
| **query** | [IQueryable](../overview.mdx#sessionquery), [IDocumentQuery](../overview.mdx#sessionadvanceddocumentquery) or [IRawDocumentQuery](../overview.mdx#sessionadvancedrawquery) | The query for which to stream results |
