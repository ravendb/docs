...
* [Working with document identifiers](../../../../document-identifiers/working-with-document-identifiers.mdx#identities)

</Admonition>

* In this page:

  * [Get identities operation](#get-identities-operation)
  * [Syntax](#syntax)
