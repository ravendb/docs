...
* Queries defined with [Query](#session-query) or [DocumentQuery](#session-advanced-documentquery) are translated by the RavenDB client to [RQL](../../querying/rql/what-is-rql.mdx)  
...
* Available custom methods and extensions for the session's [Query](#session-query) method:
...
* The available methods for the session's [DocumentQuery](#session-advanced-documentquery) method
