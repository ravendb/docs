...
description: "Pass configuration options to RavenDB at startup using command-line arguments, environment variables, or settings.json file entries."
sidebar_position: 1
---
...
If you are interested in hosting the server in a Docker container, find additional information in the [RavenDB Images](../../start/containers/image-usage.mdx) article and other pages in the Containers section.  
