...
* RavenDB supports connecting to the following external providers:  
  [OpenAI & OpenAI compatible providers](./open-ai.mdx),
  [Azure OpenAI](./azure-open-ai.mdx),  
  [Google AI](./google-ai.mdx),
  [Vertex AI](./vertex-ai.mdx),
  [Ollama](./ollama.mdx),
  [Hugging Face](./hugging-face.mdx),
  and [Mistral AI](./mistral-ai.mdx),  
  or to RavenDB’s [embedded model (_bge-micro-v2_)](./embedded.mdx).
...
* The AI connection strings can be created from:  
  * The **AI Connection Strings view in Studio** -  
...
* In this article:
  ...
  * [Creating an AI connection string (from Studio)](#creating-an-ai-connection-string-from-studio)
...
## Creating an AI connection string (from Studio)
...
2. **Identifier**  
   ...
   Each AI connection string in the database must have a distinct identifier.
     ...
     For exmaple, see how this identifier is used in the [embeddings cache collection](../generating-embeddings/embedding-collections.mdx#the-embeddings-cache-collection).
...
5. **Connector**  
   ...
   This opens a dialog where you can configure the connection details for the selected provider.  
       ...
       * [Azure Open AI](./azure-open-ai.mdx)
       * [Google AI](./google-ai.mdx) (_embeddings only_)
       * [Hugging Face](./hugging-face.mdx) (_embeddings only_)
       * [Ollama](./ollama.mdx)
       * [OpenAI](./open-ai.mdx)
       * [Mistral AI](./mistral-ai.mdx) (_embeddings only_)
       * [Vertex AI](./vertex-ai.mdx) (_embeddings only_)
       * [Embedded model (bge-micro-v2)](./embedded.mdx) (_embeddings only_)
