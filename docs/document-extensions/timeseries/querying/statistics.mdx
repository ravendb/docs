...
Queries that use this method must also [aggregate](./aggregation-and-projections.mdx) 
the time series, grouping the entries into whole numbers of time units.  

The difference in time is measured in milliseconds. Use [scaling](./overview-and-syntax.mdx#scaling-query-results)
