...
* To modify existing documents:
    ...
    * **Retrieve** documents from the database using [load](../loading-entities.mdx#load) or by a [query](../querying/how-to-query.mdx#sessionquery).  
...
* In this page:
    * [Load a document & update](#load-a-document--update)
    * [Query for documents & update](#query-for-documents--update)
