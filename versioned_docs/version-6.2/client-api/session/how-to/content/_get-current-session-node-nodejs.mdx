...
The client uses [this logic](../../../configuration/load-balance/overview.mdx#client-logic-for-choosing-a-node) to determine which node to send the request to.  
Learn more about load balancing the client requests in this [overview](../../../configuration/load-balance/overview.mdx).
