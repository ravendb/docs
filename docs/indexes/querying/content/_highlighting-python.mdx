...
* When making a [Full-Text Search query](../searching.mdx), 
...
* In this page:
  * [Highlight results - Map index](#highlight-results---map-index)
  * [Highlight results - Map-Reduce index](#highlight-results---map-reduce-index)
  * [Customize highlight tags](#customize-highlight-tags)
