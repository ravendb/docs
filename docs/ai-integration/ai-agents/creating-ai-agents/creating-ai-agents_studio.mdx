...
[Read more about parameters](../../../ai-integration/ai-agents/overview#query-parameters).
...
* [Find an AI agent usage flow chart here](../../../ai-integration/ai-agents/overview#ai-agent-usage-flow-chart)
...
6. **Allow model queries**  
   ...
   <Admonition type="note" title="">
   When disabled, the LLM will not be able to trigger this tool - but if the tool is set as an [initial-context query](../../../ai-integration/ai-agents/overview#initial-context-queries) the agent will still be able to execute it when it is started.  
   </Admonition>

7. **Add to initial context**  
   Enable to set the query tool as an [initial-context query](../../../ai-integration/ai-agents/overview#initial-context-queries).  
...
9. **Sample parameters object** and **Parameters JSON schema**  
   ...
   [Read more about query parameters](../../../ai-integration/ai-agents/overview#query-parameters)  
