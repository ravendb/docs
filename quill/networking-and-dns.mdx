...
Learn more in [Direct database access](../security-and-architecture/network-architecture.mdx#direct-database-access).

For details about how connections to these hostnames are routed and protected, see [The Quill hostnames](../security-and-architecture/network-architecture.mdx#the-quill-hostnames).
