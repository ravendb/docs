...
[force revision creation](../../../overview.mdx#force-revision-creation), will be deleted.
...
Each revision has its own unique [change vector](../../session/loading.mdx#get-revisions-by-change-vector).  
...
| **removeForceCreatedRevisions** | `bool`         | `true` - Include [force-created revisions](../../../overview.mdx#force-revision-creation) in the deletion.<br/>`false` - Exclude force-created revisions. |
