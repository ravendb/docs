...
* If the index is [disabled](../disable-index.mdx) 
  or [paused](../stop-index.mdx), resetting the index 
  will put it back to the **normal** running state on the local node where the action was performed.

* In this page:
    * [Reset index](../set-index-priority.mdx#set-priority---single-index)
    * [Syntax](../set-index-priority.mdx#syntax)
