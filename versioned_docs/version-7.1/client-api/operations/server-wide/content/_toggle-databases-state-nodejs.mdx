...
* In this page:
    ...
    * [Enable/Disable database from the Client API](#enabledisable-database-from-the-client-api)
        * [Enable database](#enable-database)
        * [Disable database](#disable-database)
        * [Syntax](#syntax)
    * [Disable database via the file system](#disable-database-via-the-file-system)
