...
* In this article:
  * [Unarchive documents - from the Client API](#unarchive-documents---from-the-client-api)
  * [Unarchive documents - from the Studio](#unarchive-documents---from-the-studio)
  * [Unarchiving documents with index-based patch queries](#unarchiving-documents-with-index-based-patch-queries)
...
performs the same operation as the [Client API example](#unarchive-documents---from-the-client-api) shown above.
...
1. **Configure the index to include archived documents**:  
   ...
   Use this option only if including archived documents in the index aligns with your indexing strategy.
      ...
      **For static-indexes**:  
      ...
      See [Archived documents and indexing](../archived-documents-and-other-features.mdx#archived-documents-and-indexing).
