...
description: "Migrate data from RavenDB legacy versions (3.x and earlier) to the current version using the legacy migration tools and import process."
...
* In this article:
    * [Migration from RavenDB 5.x to a higher version](../../migration/server/legacy-versions-data-migration.mdx#migration-from-ravendb-5-x-to-a-higher-version)
    * [Migration from RavenDB 4.x to a higher version](../../migration/server/legacy-versions-data-migration.mdx#migration-from-ravendb-4-x-to-a-higher-version)
    * [Migration from RavenDB 3.x to a higher version](../../migration/server/legacy-versions-data-migration.mdx#migration-from-ravendb-3-x-to-a-higher-version)
    * [Migrating data into a sharded database](../../migration/server/legacy-versions-data-migration.mdx#migrating-data-into-a-sharded-database)
