...
* To insert a document to the database using a higher-level method, see [storing entities](../../../session/storing-entities.mdx).  
  To update an existing document using a higher-level method, see [update entities](../../../session/updating-entities.mdx).
