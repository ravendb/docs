...
* **Temporary changes** can be applied at runtime using [the CLI](../../server/troubleshooting/logging.mdx#cli-customization-immediate-temporary-changes), without requiring a server restart.
