...
* Each license has a specific expiration date.  
  To renew your license, see [renew license](./renew-license.mdx).  
...
* In this article:
    * [License types](#license-types)
       ...
       * [RavenDB AI license](#ravendb-ai-license)
       * [ISV licenses](#isv-licenses)
    * [ISV Bank-of-Cores license](#isv-bank-of-cores-license)
    * [Licensing an Embedded server](#licensing-an-embedded-server)
       * [TestDriver server license](#testdriver-server-license)
    * [Studio license management](#studio-license-management)
...
* When you are ready to go into production:  
   ...
   * [Upgrade to a production license](https://ravendb.net/buy) and then [replace](./replace-license.mdx) the developer license.  
...
2. **License**  
   ![License Info](./assets/about_license-section.png)
      ...
      * **C**. **Register license**  
        Click to [submit and activate](./activate-license.mdx) your license.  
        <Admonition type="note" title="">
         ...
         * [Renew license](./renew-license.mdx)  
         ...
         * [Replace](./replace-license.mdx)  
           Use this button to replace your license with a new one.
         * [Force update](./force-update.mdx)  
