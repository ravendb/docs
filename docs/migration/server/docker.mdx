...
* In this article:  
  * [Changes Made In RavenDB `6.0` And Up](#changes-made-in-ravendb-6-0-and-up)  
  * [Migrating To RavenDB `6.0` And Up](#migrating-to-ravendb-6-0-and-up)  
     * [Permit the `ravendb` user to access the mounted data directory](#permit-the-ravendb-user-to-access-the-mounted-data-directory)  
     * [Customize the UID/GID of the RavenDB data directory owner](#customize-the-uidgid-of-the-ravendb-data-directory-owner)  
     * [Migrate files and data](#migrate-files-and-data)  
