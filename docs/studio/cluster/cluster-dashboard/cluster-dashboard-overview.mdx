...
an expanded view of the [Let's Get Started](./cluster-dashboard-widgets.mdx#lets-get-started-widget) widget.  
...
Once a cluster has been set, the dashboard displays [widgets](./cluster-dashboard-widgets.mdx) 
