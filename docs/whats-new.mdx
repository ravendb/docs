---
title: "What's New"
description: "Release notes and changelog for RavenDB — new features, improvements, bug fixes, and breaking changes across all recent server and client versions."
breadcrumbs: false
...
- `[GenAI]` added new feature. [Docs](https://ravendb.net/docs/article-page/7.1/csharp/ai-integration/gen-ai-integration/overview) | [Guide](https://ravendb.net/articles/survive-the-ai-tidal-wave-with-ravendb-genai)
