...
Live statistics can be retrieved via Studio using its **Stats** menu or [cluster dashboard](../../studio/cluster/cluster-dashboard/cluster-dashboard-overview), as well as through dedicated endpoints:
