...
* Indexing fields from multiple collections using [Multi-Map Indexes](../indexing-polymorphic-data.mdx#multi-map-indexes)  
* Indexing Multiple Collections using [Multi-Map indexes](../indexing-polymorphic-data.mdx#multi-map-indexes). 
...
- The final step is to [deploy it](../creating-and-deploying.mdx) to the server and issue a query using the session [Query](../querying/query-index.mdx) method:
