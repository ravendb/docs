...
* In order for Studio to present the time series values by their names, as can be seen [here](../../../../studio/database/document-extensions/time-series.mdx#time-series-view),  
...
This allows Studio to present time series values by name when you view and manage them.
#### Usage
...
<br/>
The time series entries will be listed in Studio under their corresponding named values:

!["Time series entries"](../assets/time-series-entries.png)

<br/>
The named values can be managed from the [Time Series Settings View](../../../../studio/database/settings/time-series-settings.mdx) in Studio:
