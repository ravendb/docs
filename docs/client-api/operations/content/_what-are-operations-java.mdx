...
Common operations include set-based operations for [Patching](../../../documents/patching-documents/patch-multiple-documents/client-api.mdx) or removal of documents by using queries (more can be read [here](../../../client-api/operations/common/delete-by-query.mdx)).  
