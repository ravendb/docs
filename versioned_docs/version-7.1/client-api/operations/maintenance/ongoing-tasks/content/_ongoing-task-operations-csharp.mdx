...
* Once an ongoing task is created, it can be managed via the Client API [Operations](../../../what-are-operations.mdx).   
...
* In this page:
  * [Get ongoing task info](#get-ongoing-task-info)
  * [Delete ongoing task](#delete-ongoing-task)
  * [Toggle ongoing task state](#toggle-ongoing-task-state)
  * [Syntax](#syntax)
