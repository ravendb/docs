...
* In this page:
    ...
    * [Include compare-exchange items when loading](#include-compare-exchange-items-when-loading)
    * [Include compare-exchange items when querying](#include-compare-exchange-items-when-querying)
    * [Syntax](#syntax)
