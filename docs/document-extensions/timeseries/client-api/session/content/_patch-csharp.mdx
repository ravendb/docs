...
* Patching multiple time series entries (append or delete entries) can be performed via the _Session_  
  using [session.Advanced.Defer](../../../../../documents/patching-documents/patch-a-single-document/api-overview.mdx#session-api-using-defer), as described below.
...
Learn more about `PatchCommandData` [here](../../../../../documents/patching-documents/patch-a-single-document/api-overview.mdx#session-api-using-defer).
**`PatchRequest`**
...
Learn more about `PatchRequest` [here](../../../../../documents/patching-documents/patch-a-single-document/api-overview.mdx#session-api-using-defer).
