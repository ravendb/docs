...
* In this page:
    * [Migration to RavenDB `7.x`](../../migration/server/data-migration.mdx#migration-to-ravendb-7.x)
    * [Migration from RavenDB 5.x to 6.x](../../migration/server/data-migration.mdx#migration-from-ravendb-5.x-to-6.x)
    * [Migration from RavenDB 4.x to RavenDB 5.x and 6.x](../../migration/server/data-migration.mdx#migration-from-ravendb-4.x-to-ravendb-5.x-and-6.x)
    * [Migration from RavenDB 3.x](../../migration/server/data-migration.mdx#migration-from-ravendb-3.x)
...
* RavenDB `5.x` product licenses **do not apply** to RavenDB `6.x`.  
  ...
  please use the **License upgrade tool** [as explained here](../../start/licensing/replace-license.mdx#upgrade-a-license-key-for-ravendb-6.x).
