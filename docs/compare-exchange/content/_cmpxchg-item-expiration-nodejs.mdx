...
* In this article:  
  * [Add expiration date using the **Client API**](#add-expiration-date-using-the-client-api)   
  * [Add expiration date using the **Studio**](#add-expiration-date-using-the-studio)  
  * [Syntax](#syntax)   
