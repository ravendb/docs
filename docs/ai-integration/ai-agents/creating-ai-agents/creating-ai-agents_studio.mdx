...
After setting an agent parameter, it can be included in query tools RQL queries.  
...
7. **Add to initial context**  
   Enable to set the query tool as an [initial-context query](../../../ai-integration/ai-agents/overview.mdx#initial-context-queries).  
