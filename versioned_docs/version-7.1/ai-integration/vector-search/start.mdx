...
* Vector search queries also empower other AI features in RavenDB such as [GenAI](../../ai-integration/gen-ai-integration/start) and [AI Agents](../../ai-integration/ai-agents/ai-agents_start).   
