...
* There are some client tasks, such as patching documents, that can be carried out either via the Session ([session.Advanced.Patch()](../patching/single-document.mdx#array-manipulation))
...
* **Attachments**:  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [PutAttachmentOperation](../../../document-extensions/attachments/store-attachments/store-attachments-local.mdx#store-attachments-via-an-operation)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [GetAttachmentOperation](../../../document-extensions/attachments/get-attachments.mdx#get-attachment---using-an-operation)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [DeleteAttachmentOperation](../../../document-extensions/attachments/delete-attachment.mdx#delete-attachment---via-an-operation)  
...
* **Compare-exchange**:  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [PutCompareExchangeValueOperation](../../../compare-exchange/create-cmpxchg-items.mdx#create-item-using-a-store-operation)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [GetCompareExchangeValueOperation](../../../compare-exchange/get-cmpxchg-item.mdx#get-item-using-a-store-operation)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [GetCompareExchangeValuesOperation](../../../compare-exchange/get-cmpxchg-items.mdx)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [DeleteCompareExchangeValueOperation](../../../compare-exchange/delete-cmpxchg-items.mdx#delete-compare-exchange-item-using-a-store-operation)
...
* **Backup**:  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [BackupOperation ](../../../backup/create/one-time-backup.mdx#defining-and-running-a-one-time-backup-operation)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [UpdatePeriodicBackupOperation](../../../backup/create/periodic-tasks/database-backup.mdx#creating-a-backup-task)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [GetPeriodicBackupStatusOperation](../../../backup/create/periodic-tasks/database-backup.mdx#getting-backup-task-status)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [StartBackupOperation](../../../backup/create/periodic-tasks/database-backup.mdx#triggering-an-immediate-backup-operation)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [DelayBackupOperation](../../../backup/create/periodic-tasks/database-backup.mdx#delaying-a-running-backup-operation)  

* **Restore**:  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [RestoreBackupOperation](../../../backup/restore.mdx#restoring-a-database-from-backup)
...
* **Remote attachments**:  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [ConfigureRemoteAttachmentsOperation](../../../document-extensions/attachments/configure-remote-attachments.mdx#configure-remote-attachments-settings)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [GetRemoteAttachmentsConfigurationOperation](../../../document-extensions/attachments/configure-remote-attachments.mdx#get-remote-attachments-settings)  
    
* **Sorters**:   
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [PutSortersOperation](../../../querying/sorting-query-results/custom-sorters/database-level-custom-sorters.mdx#add-database-level-custom-sorter-via-the-client-api)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [DeleteSorterOperation](../../../querying/sorting-query-results/custom-sorters/database-level-custom-sorters.mdx#delete-database-level-custom-sorter)  
...
* **Server-wide backup tasks**:  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [PutServerWideBackupConfigurationOperation](../../../backup/create/periodic-tasks/server-wide-backup.mdx#creating-a-server-wide-backup-task)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [GetServerWideBackupConfigurationOperation](../../../backup/create/periodic-tasks/server-wide-backup.mdx#updating-a-server-wide-backup-task)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [GetServerWideBackupConfigurationsOperation](../../../backup/create/periodic-tasks/server-wide-backup.mdx#updating-a-server-wide-backup-task)  
...
* **Server-wide sorters**:  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [PutServerWideSortersOperation](../../../querying/sorting-query-results/custom-sorters/server-wide-custom-sorters.mdx#add-server-wide-custom-sorter-via-the-client-api)  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [DeleteServerWideSorterOperation](../../../querying/sorting-query-results/custom-sorters/server-wide-custom-sorters.mdx#delete-server-wide-custom-sorter)  
