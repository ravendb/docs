...
* To use RavenDB with Power BI, your [license](./overview.mdx#license) 
...
* **Server**  
   ...
   * RavenDB's PostgreSQL port number is by default 5433, and is [configurable](./overview.mdx#postgresql-port).  
* **Database**  
...
* **Advanced options**  
   ...
   * Enter your RQL query into the **SQL Statement** field.  
      ...
      * The [PostgreSQL](./overview.mdx) library 
