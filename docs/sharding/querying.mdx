...
* **Querying with a limit is not supported in _patch/delete_ by query operations**  
  ...
  [PatchByQueryOperation](../documents/patching-documents/patch-multiple-documents/client-api.mdx#sending-a-patch-request) or [DeleteByQueryOperation](../client-api/operations/common/delete-by-query.mdx)  
