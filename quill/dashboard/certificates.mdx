---
title: "Dashboard: Certificates View"
sidebar_label: Certificates View
sidebar_position: 6
...
* RavenDB supports a **Read** access level, but the current Quill license does not include read-only certificates.  
  The Quill Dashboard therefore does not offer **Read** when generating or editing certificates.
