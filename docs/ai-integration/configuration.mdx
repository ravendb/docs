---
title: "AI features configuration options"
sidebar_label: Configuration options
description: "Configure AI-related server options in RavenDB, including connection timeouts, embedding dimensions, and model provider settings."
sidebar_position: 7
---
...
# AI features configuration options
...
* Find configuration keys related to **Studio's AI assistant** in the [Configuration options](../studio/configuration.mdx) page under the Studio documentation folder.

* On this page:
   * [Embeddings configuration keys](../ai-integration/configuration#embeddings-configuration-keys)  
      * [Ai.Embeddings.MaxBatchSize](../ai-integration/configuration#aiembeddingsmaxbatchsize)  
      * [Ai.Embeddings.MaxConcurrentBatches](../ai-integration/configuration#aiembeddingsmaxconcurrentbatches)  
      * [Ai.Embeddings.MaxFallbackTimeInSec](../ai-integration/configuration#aiembeddingsmaxfallbacktimeinsec)  
   * [AI Agents configuration keys](../ai-integration/configuration#ai-agents-configuration-keys)  
      * [Ai.Agent.Tools.TokenUsageThreshold](../ai-integration/configuration#aiagenttoolstokenusagethreshold)  
      * [Ai.Agent.Trimming.Summarization.SummarizationResultPrefix](../ai-integration/configuration#aiagenttrimmingsummarizationsummarizationresultprefix)  
      * [Ai.Agent.Trimming.Summarization.SummarizationTaskBeginningPrompt](../ai-integration/configuration#aiagenttrimmingsummarizationsummarizationtaskbeginningprompt)  
      * [Ai.Agent.Trimming.Summarization.SummarizationTaskEndPrompt](../ai-integration/configuration#aiagenttrimmingsummarizationsummarizationtaskendprompt)  
...
The following configuration keys apply to integrating **AI-powered embeddings generation** into your RavenDB server.
  ...
  * Embeddings can be generated from your document content via [AI-powered tasks](./generating-embeddings/overview.mdx) and stored in a dedicated collection in the database.  
...
* Configuration scope:  
  ...
  * To change the settings for a specific agent, edit its configuration using the [API](./ai-agents/creating-ai-agents/creating-ai-agents_api.mdx#defining-an-agent-configuration) or [Studio](./ai-agents/creating-ai-agents/creating-ai-agents_studio.mdx#configure-basic-settings).  
