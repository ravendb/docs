...
This article describes how to setup a spatial field in static index. If you are interested in an automatic approach, please visit relevant spatial querying article that can be found [here](../querying/spatial.mdx).
</Admonition>
...
<Admonition type="info" title="">
You can read more about **spatial search** in a **dedicated querying article** available [here](../querying/spatial.mdx).
</Admonition>
