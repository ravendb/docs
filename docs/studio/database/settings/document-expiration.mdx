...
description: "Enable automatic document deletion in RavenDB Studio by setting expiration policies that remove documents after a configured time."
sidebar_position: 6
---
...
* Learn more about this option [here](../../../server/extensions/expiration.mdx).  
