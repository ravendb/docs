...
* By default, all operations work on the default database defined in the [Document Store](../../../creating-document-store.mdx).
...
* In this page:
    * [Common operation: `operations.for_database`](#common-operation-operationsfordatabase)
    * [Maintenance operation: `maintenance.for_database`](#maintenance-operation-maintenancefordatabase)
</Admonition>
## Common operation: `operations.for_database`

* For reference, all common operations are listed [here](../../what-are-operations.mdx#common-operations).
...
* For reference, all maintenance operations are listed [here](../../what-are-operations.mdx#maintenance-operations).
