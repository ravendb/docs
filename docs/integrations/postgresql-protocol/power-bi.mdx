...
* In this page:  
   * [Using RavenDB From Power BI Desktop](#using-ravendb-from-power-bi-desktop)  
      * [Connect to RavenDB](#connect-to-ravendb)  
      * [Retrieve Collections Data](#retrieve-collections-data)  
      * [Query RavenDB Using RQL](#query-ravendb-using-rql)  
