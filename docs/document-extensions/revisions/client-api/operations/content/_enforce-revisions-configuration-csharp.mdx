...
* In this article:
  ...
  * [Resume an interrupted operation](#resume-an-interrupted-operation)
  * [Syntax](#syntax)
...
| Parameter                  | Type                                       | Description |
|----------------------------|--------------------------------------------|-------------|
| **IncludeForceCreated**    | `bool`                                     | `true` - [Force-created revisions](../../../overview.mdx#force-revision-creation) may also be removed by the operation.<br/>`false` (default) - Force-created revisions are not included in deletion paths that protect them. |  
...
| **ContinuationParameters** | `RevisionsOperationContinuationParameters` | Optional state used to resume an interrupted revisions operation. See [Resume an interrupted operation](#resume-an-interrupted-operation). |    
