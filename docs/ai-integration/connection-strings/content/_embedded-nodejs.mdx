...
* This article explains how to define a connection string to the [bge-micro-v2](https://huggingface.co/TaylorAI/bge-micro-v2) model.  
  ...
  [Embeddings generation tasks](../../generating-embeddings/overview.mdx) without requiring an external AI service.  
...
* In this article:
  * [Define the connection string - from the Studio](#define-the-connection-string-from-the-studio)
...
connectionString.name = "ConnectionStringToEmbedded";
...
connectionString.embeddedSettings = new EmbeddedSettings();
...
class AiConnectionString
{
    ...
    mistralAiSettings; // EmbeddedSettings
} 
