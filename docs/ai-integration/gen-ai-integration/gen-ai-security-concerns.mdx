...
* **Send only the data you want to send**  
  ...
  task with and the [context generation script](./create-gen-ai-task/create-gen-ai-task_studio.mdx#generate-context-objects) 
...
* **Use the playgrounds**  
  ...
  [playgrounds](./create-gen-ai-task/create-gen-ai-task_studio.mdx#generate-context-objects-playground) 
...
* **Use your update script wisely**  
  ...
  The [update script](./create-gen-ai-task/create-gen-ai-task_studio.mdx#provide-update-script) 
  ...
  using the built in Studio [playground](./create-gen-ai-task/create-gen-ai-task_studio.mdx#provide-update-script-playground).  
