...
|-----------------------------------------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `loadTo`                                | function | Load an object to the specified target. <br/> This command has several syntax options, <br/> see details [below](../../../server/ongoing-tasks/etl/basics.mdx#themethod). <br/> **Note:** An object will only be sent to the destination if the `loadTo` method is called. |
| **Attachments:**                        |          |                                                                                                                                                                                                             |
