...
* A [query](../how-to-query.mdx) can also be customized on the Store or Session level by subscribing to the `beforeQuery` event.  
  Learn more in [Subscribing to Events](../../how-to/subscribe-to-events.mdx).

* Customization methods available:

  - [on ("beforeQueryExecuted")](#on-("beforequeryexecuted"))
  - [on ("afterQueryExecuted")](#on-("afterqueryexecuted"))
  - [noCaching](#nocaching)
...
* Note:  
  ...
  Learn more about projections in:  
    ...
    * [How to project query results](../how-to-project-query-results.mdx)
