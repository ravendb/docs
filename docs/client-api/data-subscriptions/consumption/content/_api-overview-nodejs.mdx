...
* In this page:  
  ...
  * [Subscription worker options](#subscriptionworkeroptions)  
...
| **options**          | `object` | [Subscription worker options](#subscriptionworkeroptions) object that affect how the worker interacts with the subscription. These options do not alter the definition of the subscription itself. |
