...
* To retrieve documents using a higher-level method, see [loading entities](../../../session/loading-entities.mdx) or [query for documents](../../../session/querying/how-to-query.mdx).  

* In this page:
   - [Get single document](#get-single-document)   
   - [Get multiple documents](#get-multiple-documents)   
   - [Get metadata only](#get-metadata-only)    
   - [Get paged documents](#get-paged-documents)   
   - [Get documents - by ID prefix](#get-documents---by-id-prefix)  
   - [Get documents - with includes](#get-documents---with-includes)  
   - [Syntax](#syntax)  
