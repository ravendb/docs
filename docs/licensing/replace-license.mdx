...
If you [activated your license](../licensing/activate-license.mdx) using a configuration key, you may have used either the `License` or the `License.Path` key. Replace the value of the key you used with the new license information:
