...
* A query on a collection with some filtering condition will create an **Auto-Index** (Dynamic Query).  
  See [Index Types](../indexes/indexes-overview.mdx#index-types) for details.  
   ...
   ![Query Settings](./assets/query-view-settings.png)  
     ...
     * b. **Disable creating new Auto-Indexes**  
          ...
          * Toggling this ON will not affect Auto-Index creation in future Studio queries.
            To disable all future Auto-Index creation from Studio queries, change the default setting in [Studio Configuration](../settings/studio-configuration.mdx#disabling-auto-index-creation-on-studio-queries-or-patches)
...
2. **Document ID**  
   Click the ID to open this document in the [Document View](../documents/document-view.mdx),  
   -or-  
...
* [Time Series Query](../../../document-extensions/timeseries/overview.mdx) results provide insight 
  ...
  Learn more about it [here](../document-extensions/time-series.mdx#querying-time-series).  
* [Spatial Query](./spatial-queries-map-view.mdx) results include 
  a Spatial Map Tab that [displays geographical locations](./spatial-queries-map-view.mdx#spatial-map-view) 
  on the world map.  
