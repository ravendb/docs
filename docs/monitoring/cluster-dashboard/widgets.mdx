...
The **Databases Notifications** widget lists the alerts and performance hints raised for each
database, per node. The header shows the totals across the cluster. Only databases that are
