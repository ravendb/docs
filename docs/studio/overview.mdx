...
* Use Studio to manage your RavenDB 
  [cluster](./cluster/cluster-dashboard/cluster-dashboard-overview.mdx), 
  [servers](./server/manage-server.mdx), 
  and [databases](./database/databases-list-view.mdx). 
  You can observe, modify, and create [indexes](./database/indexes/indexes-overview.mdx), 
  issue [queries](./database/queries/query-view.mdx), 
  adjust [settings](./database/settings/database-settings.mdx), 
  view [statistics](./database/stats/ongoing-tasks-stats/overview.mdx) 
  and [logs](./server/debug/admin-logs.mdx), 
  define [ongoing tasks](./database/tasks/ongoing-tasks/general-info.mdx), 
  [import](./database/tasks/import-data/import-data-file.mdx) 
  and [export](./database/tasks/export-database.mdx) data, 
  and much more.

* Studio includes an **AI assistant** that can help you navigate the interface and leverage its capabilities. [Learn more.](./ai-assistant.mdx)  
...
* A [Let's get started](./cluster/cluster-dashboard/cluster-dashboard-widgets.mdx#let) 
...
* The dashboard is [fully customizable](./cluster/cluster-dashboard/cluster-dashboard-customize.mdx), 
...
[Learn more about the cluster dashboard](./cluster/cluster-dashboard/cluster-dashboard-overview.mdx)  
</Admonition>
...
<Admonition type="info" title="">
[Learn more about the Cluster view](./cluster/cluster-view.mdx)
</Admonition>
