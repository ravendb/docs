...
* Maximum length allowed is 2025 unicode characters
...
{WARNING Using non-sequential data as the document ID is not recommeced. In such case you might be experiencing a declining performance while searching for an existing documents and inserting new ones./}
...
In order to use this option you need to follow the convention: the key you specify during save ends with a symbol (`/`).
