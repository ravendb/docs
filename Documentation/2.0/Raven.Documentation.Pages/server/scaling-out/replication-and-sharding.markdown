...
You need to either [handle that](https://ravendb.net/docs/server/extending/bundles/replicationconflicts?version=2.0) or to choose to disallow writes while using the master is unavailable, and use the slave just for reads.
