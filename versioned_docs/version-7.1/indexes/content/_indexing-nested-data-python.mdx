...
* In this page:
  ...
  * [Simple index - SINGLE index-entry per document](#simple-index---single-index-entry-per-document)    
      * [The index](#theIndex)
      * [The index-entries](#theIndexEntries)
      * [Querying the index](#queryingTheIndex)
      * [When to use](#whenToUse)

  * [Fanout index - MULTIPLE index-entries per document](#fanout-index---multiple-index-entries-per-document)   
      * [What is a fanout index](#whatIsFanoutIndex)
      * [Fanout index - Map index example](#fanoutMapIndex)
      * [Fanout index - Map-Reduce index example](#fanoutMapReduceIndex)
...
* <a id="paging"/> **Fanout index - Paging**:
     ...
     * A fanout index has more index-entries than the number of documents in the collection indexed.  
       ...
       as can be seen in the above [index-entries](#fanoutMapIndexIndexEntries) example.
     ...
     * Please refer to [paging through tampered results](../querying/paging.mdx#paging-through-tampered-results) for further explanation and examples. 
