...
<Admonition type="note" title="">
Data subscriptions are also supported on [sharded databases](../sharding/subscriptions.mdx), where
documents from all shards are processed in a single subscription stream.
</Admonition>
...
* **Revisions**  
  ...
  act on what changed between revisions.  
