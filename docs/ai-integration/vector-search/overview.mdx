...
* ✔ **Query pre-generated TEXT embeddings (created by RavenDB embeddings tasks)**:  
   If your database already contains embeddings generated by a RavenDB [Embeddings generation task](../../ai-integration/generating-embeddings/overview.mdx),  
...
* ✔ **Index embeddings from pre-generated TEXT embeddings (via RavenDB embeddings tasks)**:  
   * <u>At indexing time</u>:  
     If your documents contain embeddings generated by a RavenDB [Embeddings generation task](../../ai-integration/generating-embeddings/overview.mdx),  
