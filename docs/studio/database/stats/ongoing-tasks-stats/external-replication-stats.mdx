...
* The **External Replication Task** replicates your database data to another RavenDB database.  
  Learn more about the External Replication Task [here](../../tasks/ongoing-tasks/external-replication-task.mdx).  
...
* In this page:  
   * [External Replication Stats Closed View](#external-replication-stats-closed-view)  
   * [External Replication Stats Expanded View](#external-replication-stats-expanded-view)  
