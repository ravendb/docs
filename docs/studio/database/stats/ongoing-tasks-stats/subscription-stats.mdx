...
description: "Monitor RavenDB data subscription performance in Studio with connection tracking, batch statistics, and client processing metrics."
sidebar_position: 2
---
...
* Learn more about data subscription tasks [here](../../tasks/ongoing-tasks/subscription-task.mdx).  

* In this page:  
   * [Subscription Stats Closed View](#subscription-stats-closed-view)  
   * [Subscription Stats Expanded View](#subscription-stats-expanded-view)  
   * [Connection Event Indicators](#connection-event-indicators)  
...
* Indicators are shown in both the [Closed](./overview.mdx#task-rulers-closed-view) 
  and the [Expanded](./overview.mdx#task-rulers-expanded-view) 
  task views.  
