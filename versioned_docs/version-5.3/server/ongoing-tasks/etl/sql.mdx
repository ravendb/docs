...
**SQL ETL** is a task that creates an [ETL](../../../server/ongoing-tasks/etl/basics.mdx) process 
for a given database where the destination is a relational database.

* In this page:  
  * [Creating a Task](../../../server/ongoing-tasks/etl/sql.mdx#creating-a-task)  
  * [Supported Databases](../../../server/ongoing-tasks/etl/sql.mdx#supported-databases)  
  * [Relational Database Setup](../../../server/ongoing-tasks/etl/sql.mdx#relational-database-setup)  
  * [SQL Tables](../../../server/ongoing-tasks/etl/sql.mdx#sql-tables)  
  * [Transformation Scripts](../../../server/ongoing-tasks/etl/sql.mdx#transformation-scripts)  
     * [`loadTo` Method](../../../server/ongoing-tasks/etl/sql.mdx#method)  
     * [Alternative Syntax](../../../server/ongoing-tasks/etl/sql.mdx#alternative-syntax)  
     * [Filtering](../../../server/ongoing-tasks/etl/sql.mdx#filtering)  
     * [Loading Other Documents](../../../server/ongoing-tasks/etl/sql.mdx#loading-other-documents)  
     * [Accessing Metadata](../../../server/ongoing-tasks/etl/sql.mdx#accessing-metadata)  
     ...
     * [Counters](../../../server/ongoing-tasks/etl/sql.mdx#counters)  
     * [Transforming to VARCHAR and NVARCHAR](../../../server/ongoing-tasks/etl/sql.mdx#transforming-to-varchar-and-nvarchar)  
  * [Transaction Processing](../../../server/ongoing-tasks/etl/sql.mdx#advanced-options)  
...
- Command timeout - number of seconds after which SQL command will timeout. It overrides value defined in [`ETL.SQL.CommandTimeoutInSec`](../../../server/configuration/etl-configuration.mdx#etlsqlcommandtimeoutinsec) setting. Default: null (use provider default).
