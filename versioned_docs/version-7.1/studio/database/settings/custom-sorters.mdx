...
* In this page:
  * [Database custom sorter view](#database-custom-sorter-view)  
  * [Server-wide custom sorter view](#server-wide-custom-sorter-view)  
  * [Add a custom sorter](#add-a-custom-sorter)  
  * [Test the custom sorter](#test-the-custom-sorter)  
