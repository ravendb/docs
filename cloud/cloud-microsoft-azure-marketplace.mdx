...
description: "Subscribe to RavenDB Cloud via the Microsoft Azure Marketplace to consolidate billing with your existing Azure account and subscriptions."
sidebar_position: 10
---
...
Countries and regions outside this list do not currently have automated tax handling through the *Azure Marketplace*, which means marketplace subscriptions cannot be offered there at this time.
...
Armenia, Australia, Austria, Bahrain, Barbados, Belarus, Belgium, Bulgaria, Cambodia, Canada, Chile, Colombia, Croatia, Cyprus, Czechia, Denmark, Egypt, Estonia, Finland, France, Georgia, Germany, Greece, Hungary, Iceland, Indonesia, Ireland, Italy, Kenya, Latvia, Liechtenstein, Lithuania, Luxembourg, Malaysia, Malta, Moldova, Monaco, Netherlands, New Zealand, Nigeria, Norway, Oman, Philippines, Poland, Portugal, Romania, Russia, Saudi Arabia, Serbia, Singapore, Slovakia, Slovenia, South Africa, South Korea, Spain, Sweden, Switzerland, Taiwan, Tajikistan, Thailand, Türkiye, Uganda, Ukraine, United Arab Emirates, United Kingdom, United States (including Puerto Rico), Uzbekistan, Vietnam.

<Admonition type="info" title="">
This list is determined by Microsoft's tax remittance support and is subject to change.
For the most up-to-date information, see [Microsoft's tax responsibilities documentation](https://learn.microsoft.com/en-us/partner-center/marketplace-offers/tax-details-marketplace).
</Admonition>
...
![RavenDB Cloud offer in Microsoft Azure Marketplace](./assets/microsoft-azure-marketplace-cloud-ravendb-offer.png)

In the main page of the offer, click **Subscribe**.

![Main page of the RavenDB Cloud offer in Microsoft Azure Marketplace](./assets/microsoft-azure-marketplace-cloud-ravendb-offer-overview.png)

Provide the necessary information required to subscribe to the offer:

![RavenDB Cloud subscription configuration panel](./assets/microsoft-azure-marketplace-cloud-ravendb-offer-configration.png)
...
The **recurring billing** option must be enabled. Otherwise, creating a *Cloud Account* **won't be possible**.
</Admonition>
...
![RavenDB Cloud subscription configuration panel - summary](./assets/microsoft-azure-marketplace-cloud-ravendb-offer-summary.png)
...
![RavenDB Cloud subscription panel - redirect to the RavenDB Cloud page](./assets/microsoft-azure-marketplace-cloud-ravendb-offer-almost-done-configuration.png)

Provide the necessary information required to end the registration process:

![RavenDB Cloud Azure Marketplace Landing Page](./assets/cloud-ravendb-azure-marketplace-landing-page.png)
...
![RavenDB Cloud Azure Marketplace Landing Page - successfully registration](./assets/cloud-ravendb-azure-marketplace-landing-page-thank-you.png)
...
![RavenDB Cloud subscription panel - cancel the subscription](./assets/microsoft-azure-marketplace-cloud-ravendb-subscription-cancel-subscription.png)
Fill the standard cancellation form and click **Cancel subscription**.

![RavenDB Cloud subscription panel - subscription cancellation form](./assets/microsoft-azure-marketplace-cloud-ravendb-subscription-cancel-subscription-reason-form.png)
...
If you would like to convert your existing *Cloud Account* to an *Azure Marketplace Account* to pay for your services using a credit card associated with your *Azure* account, please submit a support request from Cloud Account owner via the *RavenDB Cloud Portal*.
