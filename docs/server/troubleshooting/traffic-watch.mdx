...
* **Disk storage**: Proportional to request volume.  
  ...
  [`Logs.ArchiveAboveSizeInMb`](../configuration/logs-configuration.mdx#logsarchiveabovesizeinmb) (default: 128 MB),  
  [`Logs.MaxArchiveDays`](../configuration/logs-configuration.mdx#logsmaxarchivedays) (default: 3 days),  
