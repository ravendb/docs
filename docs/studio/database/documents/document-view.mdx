...
1. **Document identifier (ID)**  
   * For a detailed explanation about the possible identifiers, see [Create New Document](./create-new-document.mdx)  
...
4. **Document Extensions**  
   * Add **Document Extensions** to the document, including 
     ...
     [Counters](../document-extensions/counters.mdx), 
     [Time Series](../document-extensions/time-series.mdx) 
