...
* In this page:
    ...
    * [Set lock mode - single index](#set-lock-mode---single-index)
    * [Set lock mode - multiple indexes](#set-lock-mode---multiple-indexes)
    * [Syntax](#syntax)
...
* Your client application defines and [deploys a static-index](../put-indexes.mdx) upon application startup.
