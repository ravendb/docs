...
description: "Use RQL code assistance in RavenDB Studio for auto-completion, syntax highlighting, and real-time validation when writing queries."
sidebar_position: 1
---
...
* All queries sent to the RavenDB server use RQL, RavenDB’s rich query language.  
  To learn more about RQL, see [What is RQL](./what-is-rql.mdx).  
...
* **RQL Code Assistance** is available whenever you write a query in the following Studio views:
  ...
  * [Patch view](../../studio/database/documents/patch-view.mdx#the-patch-view)  
...
* Clicking a list item will add it to the query.  
  ...
  * [from](./what-is-rql.mdx#from) - to select a collection to query on  
  * [from index](./what-is-rql.mdx#query-an-index--from-index-index-name) - to select an index to query on  
  * [declare function](./what-is-rql.mdx#declare) - to create a JavaScript function  
