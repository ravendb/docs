...
* Using the Raft consensus protocol, the cluster distributes work among the various nodes, handles failures, recovery, and more.  
  The cluster Member nodes elect a [Leader](../../../studio/server/cluster/cluster-view.mdx#cluster-nodes-types) - a node that manages the cluster state.  
...
* In this page:  
  * [Cluster View Stats](../../../studio/server/cluster/cluster-view.mdx#cluster-view-stats)  
  * [Cluster View Operations](../../../studio/server/cluster/cluster-view.mdx#cluster-view-operations)  
  * [Reassign Cores](../../../studio/server/cluster/cluster-view.mdx#reassign-cores)  
  * [Cluster Nodes Types](../../../studio/server/cluster/cluster-view.mdx#cluster-nodes-types)  
  * [Cluster Nodes States & Types Flow](../../../studio/server/cluster/cluster-view.mdx#cluster-nodes-states-&-types-flow)  
  * [Cluster-Wide operation -vs- Database Operations](../../../studio/server/cluster/cluster-view.mdx#cluster-wide-operation--vs--database-operations)  
</Admonition>
## Cluster View Stats
...
Learn more in [Add Node to Cluster](../../../studio/server/cluster/add-node-to-cluster.mdx#add-another-node-to-the-cluster).
...
* **1.** A new server/node will start as **Passive**, meaning it is _not_ part of any cluster yet.  
         Learn how to add a node to a cluster in: [Adding a Node to a Cluster](../../../studio/server/cluster/add-node-to-cluster.mdx).  
