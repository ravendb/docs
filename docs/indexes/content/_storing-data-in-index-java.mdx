...
Once the [tokenization and analysis](../using-analyzers.mdx) process is completed, 
...
* In this page:
  * [Storing Data in Index](#storing-data-in-index)
...
[projections](../querying/projections.mdx).  
