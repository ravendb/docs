...
* RavenDB Queries can be executed using `query` or `document_query`, or by passing 
  [RQL](../../what-is-rql.mdx) directly to the server 
  via `raw_query`.  
...
* The available _Query_ methods and extensions are listed [here](../../how-to-query.mdx#custom-methods-and-extensions-for-linq).
**DocumentQuery**:
