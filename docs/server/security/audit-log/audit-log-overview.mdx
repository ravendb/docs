...
* In this page:
  * [Enabling the audit log](../../../server/security/audit-log/audit-log.mdx#enabling-the-audit-log)
  * [What is being logged](../../../server/security/audit-log/audit-log.mdx#what-is-being-logged)
  * [Things to consider](../../../server/security/audit-log/audit-log.mdx#things-to-consider)
