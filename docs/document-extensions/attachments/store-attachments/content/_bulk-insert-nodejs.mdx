...
* In this page:  
    * [Usage flow](../../../document-extensions/attachments/store-attachments/bulk-insert.mdx#usage-flow)  
    * [Usage example](../../../document-extensions/attachments/store-attachments/bulk-insert.mdx#usage-example)
