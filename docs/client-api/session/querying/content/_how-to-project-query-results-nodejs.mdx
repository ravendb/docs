...
* In this article:
    ...
    * [Projecting nested object types](#projecting-nested-object-types)  
    * [Single projection per query](#single-projection-per-query)  
    * [Syntax](#syntax)
...
* Content from inner objects and arrays can be projected in addition to [projecting the nested object types](#projecting-nested-object-types).
...
* Projections allow you to tailor the query results specifically to your needs.  
  ...
  Projection queries are also useful with [subscriptions](../../../data-subscriptions/what-are-data-subscriptions.mdx)
...
* Queries in RavenDB do not allow any computation to occur during the query phase.  
  However, you can perform any [calculations](#example-v---projection-with-calculations)
