...
* Studio's [Ongoing Task Stats](../../../../monitoring/performance-views/ongoing-task-stats.mdx) 
  view draws a track for each of a database's ongoing tasks.  
  This page covers the track of a RavenDB ETL task.  
