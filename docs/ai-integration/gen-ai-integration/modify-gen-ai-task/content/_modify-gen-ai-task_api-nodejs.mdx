...
* This _taskID_ is Not the [user-defined task identifier](../../create-gen-ai-task/create-gen-ai-task_studio.mdx#configure-basic-settings)
  ...
  but an internal identifier that RavenDB uses to manage the task (similar to how it manages ETL, backup, and other ongoing tasks).    
    ...
    * **User-defined task identifier**  
      ...
      [processed document parts](../../overview.mdx#tracking-of-processed-document-parts).   
...
The following examples modify the _spam-filter_ task that was created in the [Create GenAI task](../../create-gen-ai-task/create-gen-ai-task_api.mdx#full-example) article.  
