...
description: "Use official RavenDB Docker images based on Ubuntu and Windows NanoServer for development and production container deployments."
sidebar_position: 1
---
...
For detailed instructions on how to spin up your production, you can read our guides for specific container/orchestration platforms - search through our [articles](https://ravendb.net/articles), or go *deep* with our  that also addresses containerized RavenDB [production requirements](./requirements/compute.mdx).
...
For more options, visit this page: [Server Configuration](../../server/configuration/configuration-options.mdx)
...
To learn about statefullness and storing RavenDB data in a containers, or if you run into trouble, visit [Containers &gt; Requirements &gt; Storage](./requirements/storage.mdx).

#### **Advanced Networking**
To read more on RavenDB networking containerized environment, go to [Containers &gt; Requirements &gt; Networking](./requirements/networking.mdx).
