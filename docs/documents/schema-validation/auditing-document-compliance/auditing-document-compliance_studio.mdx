...
* Add the validation error messages field (defined in the map) to the index.  
  Set the [Store](../../../indexes/storing-data-in-index/) option for this field to **Yes**, indicating that querying the index will retrieve error messages from the index rather than from indexed documents.  
