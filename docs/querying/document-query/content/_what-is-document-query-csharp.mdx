...
* Unlike the `Query` method, the `DocumentQuery` method does Not support LINQ.  
  ...
  as it provides low-level querying capabilities. See [Query -vs- DocumentQuery](../../../querying/document-query/query-vs-document-query.mdx) for all differences.

* In this article:
  * [`DocumentQuery` examples](../../../querying/document-query/what-is-document-query.mdx#documentquery-examples)
  * [Convert between `DocumentQuery` and `Query`](../../../querying/document-query/what-is-document-query.mdx#convert-between-documentquery-and-query)
  * [Custom methods and extensions](../../../querying/document-query/what-is-document-query.mdx#custom-methods-and-extensions)
...
<Panel heading="Convert between DocumentQuery and Query">
...
Convert `DocumentQuery` to `Query` when you need to project data from a related document in a dynamic query.
...
<Panel heading="Custom methods and extensions">
...
- AddOrder
- [Query] [AfterQueryExecuted](../../../querying/customize-query.mdx#afterqueryexecuted)
- [Query] [AfterStreamExecuted](../../../querying/customize-query.mdx#afterstreamexecuted)
...
- AndAlso
- [Query] [BeforeQueryExecuted](../../../querying/customize-query.mdx#beforequeryexecuted)
...
- OrElse
- [Query] [Projection](../../../querying/customize-query.mdx#projection)
- Proximity
- [Query] [RandomOrdering](../../../querying/customize-query.mdx#randomordering)
...
- Take
- [Query] [Timings](../../../querying/customize-query.mdx#timings)
- UsingDefaultOperator
- [Query] [WaitForNonStaleResults](../../../querying/customize-query.mdx#waitfornonstaleresults)
- Where
- WhereBetween
