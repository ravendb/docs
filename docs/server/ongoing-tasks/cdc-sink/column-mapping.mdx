...
description: "How to map SQL columns to RavenDB document properties, handle unmapped columns, store binary columns as attachments, and specify source table schemas."
sidebar_position: 5
---
