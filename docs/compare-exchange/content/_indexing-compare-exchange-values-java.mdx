...
* In this page:  
  * [How to use](../compare-exchange/indexing-cmpxchg-values#how-to-use)  
  * [Examples](../compare-exchange/indexing-cmpxchg-values#examples)  
  * [Querying the Index](../compare-exchange/indexing-cmpxchg-values#querying-the-index)  
