...
description: "Patch documents matching an RQL query using the RavenDB REST API to apply JavaScript transformations to multiple documents at once."
sidebar_position: 2
---
...
* [Patching](../../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx) occurs on the server side.  
