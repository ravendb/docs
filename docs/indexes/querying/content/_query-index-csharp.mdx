...
* This article is a basic overview of how to query a **static index** using **code**.  
   ...
   * An index can also be queried from [Studio](../../../studio/database/queries/query-view.mdx) 
     using [RQL](../../../querying/rql/what-is-rql.mdx).

* In this page:  
   * [Query an index by `Query`](#query-an-index-by-query) (using LINQ)
   * [Query an index by `DocumentQuery`](#query-an-index-by-documentquery) (low-level API)
   * [Query an index by `RawQuery`](#query-an-index-by-rawquery) (using RQL)
...
* Read more about filtering [here](../../../querying/filtering-query-results/filter-query-results.mdx).
...
* Read more about paging [here](../paging.mdx).
