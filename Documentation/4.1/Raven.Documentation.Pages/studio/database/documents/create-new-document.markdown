...
{PANEL: Create New Document from Clone}
  ...
  * A new document can be created by cloning (creating a copy without attachments) from an opened [document view](../../../studio/database/documents/document-view/document-view)  
