...
* In most cases, the cloud configuration settings are similar to the on-premise settings.  
   ...
   * [Client API Configurations](../7.1/client-api/configuration/conventions) 
   * [Server Configurations](../7.1/server/configuration/configuration-options) 
...
* [Database Configurations](../7.1/studio/database/settings/database-settings)
* [Indexing Configurations](../7.1/studio/database/indexes/create-map-index#configuration)
...
* [The Complexity of calculations](../7.1/studio/database/indexes/indexing-performance#common-indexing-issues) that static indexes do.
...
Change [cloud configurations in Studio](../7.1/studio/database/indexes/create-map-index#configuration).
