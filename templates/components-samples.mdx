...
- Challenges & Solutions tags (`challenges_solutions_tags`)
- Feature tags (`feature_tags`)
- Tech stack tags (`tech_stack_tags`)
- Category (`category`) - optional, displayed in sidebar
- License (`license`) - optional, displayed in sidebar
