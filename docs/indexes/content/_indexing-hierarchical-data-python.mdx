...
* In this Page:  
   ...
   * [Index hierarchical data](#index-hierarchical-data)  
...
We can then [query the index](#query-the-index) for all blog posts that contain comments by specific authors.
