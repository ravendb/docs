...
* Queries defined with [Query](#sessionquery) or [DocumentQuery](#sessionadvanceddocumentquery) are translated by the RavenDB client to [RQL](../../../../client-api/session/querying/what-is-rql.mdx)  
  when sent to the server.
