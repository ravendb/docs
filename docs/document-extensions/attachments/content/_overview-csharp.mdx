...
* In this article:
  * [Attachments in the documents list view](../../../document-extensions/attachments/overview.mdx#attachments-in-the-documents-list-view)
  * [Attachments in the document view](../../../document-extensions/attachments/overview.mdx#attachments-in-the-document-view)
  * [Attachments stats](../../../document-extensions/attachments/overview.mdx#attachments-stats)
...
1. Open the _Documents_ section in Studio's navigation bar.  
...
2. **Document metadata**:  
   Studio does not show the full attachment metadata in the document editor.  
...
3. **Viewing the full metadata**:  
   ...
   You can also get the metadata programmatically using the Client API, see [Get entity metadata](../../../client-api/session/how-to/get-and-modify-entity-metadata.mdx).  
   For details on the structure of attachment metadata, refer to:  
   * [The attachment metadata - local](../../../document-extensions/attachments/store-attachments/store-attachments-local.mdx#the-attachment-metadata)
   * [The attachment metadata - remote](../../../document-extensions/attachments/store-attachments/store-attachments-remote.mdx#the-attachment-metadata)
...
11. **Delete attachment**:  
    ...
    Learn more in [Delete attachments](../../../document-extensions/attachments/delete-attachment.mdx).    

</Panel>

<Panel heading="Attachments stats">
    
### View attachments stats in Studio

<Admonition type="info" title="">

The attachment counts shown in this section are part of Studio's Stats view.  
Learn about the whole view in
[Stats view](../../../monitoring/statistics/stats-view.mdx).

</Admonition>

The overall number of attachments in the database can be viewed in Studio's **General Database Stats** view.
       
![Attachments stats](../assets/attachments-stats-1.png)
    
1. Go to the **Stats** section in Studio's navigation bar.
...
4. **Attachments details**:  
   ...
   `unique`:  
    ...
    Learn more in [Deduplicating local attachments](../../../document-extensions/attachments/store-attachments/store-attachments-local.mdx#deduplicating-local-attachments).  
   `remote`:  
...
For a list of all available statistics properties, see the [Client API](../../../monitoring/statistics/client-api.mdx) page. 
