...
* In this article:
    * [Indexing metadata properties](#indexing-metadata-properties)
    * [Metadata properties that can be indexed](#metadata-properties-that-can-be-indexed)
...
* The **Corax** search engine does not support indexing complex JSON properties.  
  Learn more in [Corax: Handling complex JSON objects](../search-engine/corax.mdx#handling-of-complex-json-objects).
