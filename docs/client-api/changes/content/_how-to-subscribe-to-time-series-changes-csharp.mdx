...
* In this page:  
   * [ForTimeSeries](#fortimeseries)
   * [ForTimeSeriesOfDocument](#fortimeseriesofdocument)
   * [ForAllTimeSeries](#foralltimeseries)
...
<TabItem value="timeseries_changes_1" label="timeseries_changes_1">
...
| Return Value | |
| ------------- | ----- |
| IChangesObservable&lt;[TimeSeriesChange](#timeserieschange)&gt; | Observable that allows to add subscriptions to time series notifications. |

#### Example

<TabItem value="timeseries_changes_1_1" label="timeseries_changes_1_1">
<CodeBlock language="csharp">
...
<TabItem value="timeseries_changes_2" label="timeseries_changes_2">
<CodeBlock language="csharp">
...
<TabItem value="timeseries_changes_2_1" label="timeseries_changes_2_1">
<CodeBlock language="csharp">
{`IDisposable subscription = store
    .Changes()
...
<TabItem value="timeseries_changes_3" label="timeseries_changes_3">
<CodeBlock language="csharp">
...
<TabItem value="timeseries_changes_3_1" label="timeseries_changes_3_1">
<CodeBlock language="csharp">
{`IDisposable subscription = store
    .Changes()
...
<TabItem value="timeseries_changes_4" label="timeseries_changes_4">
<CodeBlock language="csharp">
...
<TabItem value="timeseries_changes_4_1" label="timeseries_changes_4_1">
<CodeBlock language="csharp">
{`IDisposable subscription = store
    .Changes()
    .ForAllTimeSeries()
...
| ------------- | ------------- | ----- |
| **Type** | [TimeSeriesChangeTypes](#timeserieschangetypes) | Time series change type enum |
