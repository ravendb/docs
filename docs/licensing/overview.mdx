...
* In this page:
    * [License types](../licensing/overview.mdx#license-types)
        * [Developer](../licensing/overview.mdx#developer)
        * [Community](../licensing/overview.mdx#community)
        * [Professional](../licensing/overview.mdx#professional)
        * [Enterprise](../licensing/overview.mdx#enterprise)
    ...
    * [Manage license view](../licensing/overview.mdx#manage-license-view)
