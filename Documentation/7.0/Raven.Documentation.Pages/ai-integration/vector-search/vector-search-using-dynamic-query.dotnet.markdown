...
* In this article:
  ...
  * [Dynamic vector search - query TEXT](../../ai-integration/vector-search/vector-search-using-dynamic-query#dynamic-vector-search---query-text)
  ...
  * [Dynamic vector search - query NUMERICAL content](../../ai-integration/vector-search/vector-search-using-dynamic-query#dynamic-vector-search---query-numerical-content)
  * [Dynamic vector search - query for similar documents](../../ai-integration/vector-search/vector-search-using-dynamic-query#dynamic-vector-search---query-for-similar-documents)
...
{PANEL: Dynamic vector search - query TEXT}
...
{PANEL: Dynamic vector search - query NUMERICAL content}
...
{PANEL: Dynamic vector search - query for similar documents}
...
* RavenDB also allows you to search for documents whose content is similar to an **existing document**:  
   ...
   * RavenDB retrieves the embedding that was indexed for the queried field in the specified document and uses it as the basis for the similarity comparison.
...
![The index entries](images/view-auto-index-entries-3.png "The auto-index entries")
