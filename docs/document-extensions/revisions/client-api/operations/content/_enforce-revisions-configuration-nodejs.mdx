...
| Parameter               | Type       | Description                                                                                                                                                                                                          |
|-------------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **includeForceCreated** | `boolean`  | **Required when passing a parameters object** (the no-argument constructor defaults it to `false`).<br/>`true` - [Force-created revisions](../../../overview.mdx#force-revision-creation) may also be removed by the operation.<br/>`false` - Force-created revisions are not included in deletion paths that explicitly protect them. |
