...
3.  
  ...
  * **Compare Exchange**: Manage compare exchange values for this database. See [Compare Exchange](../../../client-api/operations/compare-exchange/overview.mdx).  
...
* For more information about the various documents identifiers that can be generated, 
  see [Create New Document](../../../studio/database/documents/create-new-document.mdx#create-new-document).  
