...
* In this article
    * [Store attachment via the session](../../../../document-extensions/attachments/store-attachments/store-attachments-local.mdx#store-attachment-via-the-session)  
    * [Store attachment via an operation](../../../../document-extensions/attachments/store-attachments/store-attachments-local.mdx#store-attachment-via-an-operation) 
