...
It is the Etag of the last document (or [document tombstone](../../monitoring/tombstones/overview.mdx)), from the collection(s) processed by the index, as of the query arrived to the server.
