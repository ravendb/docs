...
description: "Configure a RabbitMQ ETL task in RavenDB Studio to stream document changes to RabbitMQ exchanges with JavaScript transformations."
sidebar_position: 12
---
...
* In this page:  
  * [Open RabbitMQ ETL Task View](#open-rabbitmq-etl-task-view)  
  * [Define RabbitMQ ETL Task](#define-rabbitmq-etl-task)  
  * [Options Per Exchange](#options-per-exchange)  
