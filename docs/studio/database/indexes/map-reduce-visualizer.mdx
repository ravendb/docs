...
description: "Visualize RavenDB map-reduce index processing stages in Studio to debug reduce results and understand aggregation tree behavior."
sidebar_position: 5
---
...
* In this page:
  * [Map-Reduce Visualizer Usage Flow](#map-reduce-visualizer-usage-flow)
  * [Map-Reduce Visualizer for Big Data](#map-reduce-visualizer-for-big-data)
