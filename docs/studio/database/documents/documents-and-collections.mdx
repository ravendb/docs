...
* For more information about documents, see [Document View](./document-view.mdx)  
</Admonition>
...
3.  
  ...
  * **Conflicts**: View and resolve conflicting documents. See [Conflicts](./conflicts-view.mdx).  
...
* For more information about the various documents identifiers that can be generated, 
  see [Create New Document](./create-new-document.mdx).  
