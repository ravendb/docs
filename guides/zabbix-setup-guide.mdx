...
Setting up monitoring data with Zabbix can be a useful tool to monitor the work of your database. If you are interested in monitoring your on-premise database, you can try using Datadog. You can check the connection tutorial [here](https://ravendb.net/articles/leverage-ravendb-observability-with-datadog).
