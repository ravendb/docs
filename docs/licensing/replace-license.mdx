...
* To upgrade RavenDB from a version older than `6.x` to version `6.x` and above, you must upgrade your current license before applying it to your new RavenDB.  
  Learn [below](../licensing/replace-license.mdx#upgrade-a-license-older-than-6-x) how to do this.  
...
[Replace](../licensing/replace-license.mdx#replace-your-license-via-studio) your current license with the new one.  
