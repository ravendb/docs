---
title: "RVN009 — Unsupported method call inside index Map/Reduce expression"
sidebar_label: RVN009
sidebar_position: 9
---
...
- [RVN010](./RVN010.mdx) — equivalent rule for user-defined methods inside query lambdas.
