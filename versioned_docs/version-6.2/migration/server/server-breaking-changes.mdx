...
* In this article:  
   ...
   * [Full-text search when the analyzer splits a search term](../../migration/server/server-breaking-changes.mdx#full-text-search-when-the-analyzer-splits-a-search-term)  
