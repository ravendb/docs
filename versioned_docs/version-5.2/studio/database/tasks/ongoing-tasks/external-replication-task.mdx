---
title: "Studio: External Replication Task"
...
* For additional functionality, such as filtration and two-way (master-master) replication,  
  consider [Hub/Sink Replication](../../../../studio/database/tasks/ongoing-tasks/hub-sink-replication/overview.mdx).  

* To replicate between two separate, secure RavenDB servers, you need to [pass a client certificate](../../../../studio/database/tasks/ongoing-tasks/external-replication-task.mdx#step-by-step-guide) from the source server to the destination.
...
**What is being replicated:**  
  ...
  * All database documents and related data:  
    ...
    * [Revisions](../../../../server/extensions/revisions.mdx)  
