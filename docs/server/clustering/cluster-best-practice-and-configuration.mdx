...
description: "Follow best practices for RavenDB cluster configuration including node placement, quorum settings, and network topology recommendations."
sidebar_position: 5
---
...
* In this page:
   * [Clusters should have an odd number of at least 3 nodes](#clusters-should-have-an-odd-number-of-at-least-3-nodes)
   * [Avoid different cluster configurations among the cluster's nodes](#avoid-different-cluster-configurations-among-the-clusters-nodes)
...
For ACID guarantees, a majority of the nodes must agree on every [cluster-wide transaction](./cluster-transactions.mdx), 
...
If you must set [cluster configurations](../configuration/cluster-configuration.mdx) differently in separate nodes,  
