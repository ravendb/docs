...
* When no analyzer is explicitly assigned to an index-field in the index definition,  
  RavenDB will use its [Default Analyzers](../../indexes/using-analyzers.mdx#using-the-default-analyzer) to process and tokenize the content of a field.
...
* If you want RavenDB to use the default analyzers, see [RavenDB's default analyzers](../../indexes/using-analyzers.mdx#using-the-default-analyzer).
