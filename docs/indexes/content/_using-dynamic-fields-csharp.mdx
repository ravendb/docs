...
| `AllFields` is configured with a specific analyzer,<br/>e.g. `WhitespaceAnalyzer` | `true`  | The [Default search analyzer](../using-analyzers.mdx#using-the-default-search-analyzer) |
