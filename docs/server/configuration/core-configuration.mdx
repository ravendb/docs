...
[settings.json](./configuration-options.mdx#settingsjson) variables change your server's behavior in various ways.  
...
Learn more about RavenDB directory structure in: [Storage: Directory Structure](../storage/directory-structure.mdx).
...
This [settings.json](./configuration-options.mdx#settingsjson) variable determines whether to run RavenDB with its standard 
