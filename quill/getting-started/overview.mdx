...
* No separate server is needed to try Quill locally: you can take all the steps on your own machine, with your
  Quill domain pointing at `127.0.0.1`.

* In this article:
   * [Prerequisites](#prerequisites)
   * [The Getting Started steps](#the-getting-started-steps)
...
* **Your source database: PostgreSQL, SQL Server, or MySQL.**
   ...
   * The database must be recording its changes. Quill turns change recording on where it can.  
     For the conditions each database type must meet, see
     [Connecting your database](../getting-started/connecting-your-database.mdx#prerequisites).
...
<Panel heading="The Getting Started steps">
