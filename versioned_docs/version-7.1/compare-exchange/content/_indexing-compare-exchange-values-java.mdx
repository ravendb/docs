...
* In this page:  
  * [How to use](../../compare-exchange/indexing-cmpxchg-values.mdx#how-to-use)  
  * [Examples](../../compare-exchange/indexing-cmpxchg-values.mdx#examples)  
  * [Querying the Index](../../compare-exchange/indexing-cmpxchg-values.mdx#querying-the-index)  
