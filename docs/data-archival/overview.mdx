...
description: "Archive seldom-used RavenDB documents to reduce database size with compression while keeping them retrievable and excluding them from active indexing."
...
<Panel heading="The archived document">
...
* **Metadata property**:
   ...
   * This property is informational only -  
     you **cannot** archive a document by manually adding `"@archived": true` to its metadata.
     To archive a document, you must schedule it for archival.  
     Learn more in [Schedule document archiving](../data-archival/schedule-document-archiving.mdx).  
