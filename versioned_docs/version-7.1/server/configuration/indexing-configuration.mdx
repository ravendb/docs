...
[Default analyzer](../../indexes/using-analyzers.mdx#using-the-default-analyzer) that will be used for exact fields.
...
[Default analyzer](../../indexes/using-analyzers.mdx#using-the-default-analyzer) that will be used for search fields.
