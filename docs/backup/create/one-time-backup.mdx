...
- Set the backup type using the backup configuration [BackupType](../../backup/create/one-time-backup#classes-and-enums-used-in-the-backup-configuration) _enum_ property.  
...
- [See destinations-related syntax](../../backup/create/one-time-backup#backup-destinations-classes)
...
* [See `BackupEncryptionSettings` and `EncryptionMode` syntax](../../backup/create/one-time-backup#classes-and-enums-used-in-the-backup-configuration)
...
[Triggering a regular backup task to run a backup operation immediately](../../backup/create/periodic-tasks/database-backup#triggering-an-immediate-backup-operation)  
...
[Triggering a server-wide derived task to run a backup operation immediately](../../backup/create/periodic-tasks/server-wide-backup#running-a-backup-operation-immediately)  
