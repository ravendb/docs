...
* Queries in RavenDB can be written with either of the following:
   ...
   * Using the [document_query](../document-query/query-vs-document-query.mdx) method  
   * Using **RQL** -  
...
* Queries defined with `query` or `document_query` are translated by the RavenDB client to [RQL](../what-is-rql.mdx)  
...
* In this page:
  ...
  * [session.advanced.document_query](#sessionadvanceddocumentquery)  
  * [session.advanced.raw_query](#sessionadvancedrawquery)
...
* Queries defined with [query](#sessionquery) or [document_query](#sessionadvanceddocumentquery) are translated by the RavenDB client to [RQL](../what-is-rql.mdx)  
  when sent to the server.
...
- [aggregate_by](../how-to-perform-a-faceted-search.mdx)
- [count](../how-to-count-query-results.mdx)
- [count_lazily](../how-to-perform-queries-lazily.mdx)
...
- [long_count](../how-to-count-query-results.mdx)
- [more_like_this](../how-to-use-morelikethis.mdx)
- [of_type](../how-to-project-query-results.mdx#oftype-(as)---simple-projection)
- [order_by_distance](../how-to-make-a-spatial-query.mdx#orderbydistance)
- [order_by_distance_descending](../how-to-make-a-spatial-query.mdx#orderbydistancedesc)
- [order_by_score](../sort-query-results.mdx#order-by-score)
- [order_by_score_descending](../sort-query-results.mdx#order-by-score)
- [project_into](../how-to-project-query-results.mdx)
- [search](../text-search/full-text-search.mdx)
- [spatial](../how-to-make-a-spatial-query.mdx)
- [statistics](../how-to-get-query-statistics.mdx)
- [suggest_using](../how-to-work-with-suggestions.mdx)
