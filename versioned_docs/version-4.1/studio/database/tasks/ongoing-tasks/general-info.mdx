...
![Figure 1. Ongoing Tasks View](./assets/ongoing-tasks-general-1.png)
...
![Figure 2. Ongoing Tasks Actions](./assets/ongoing-tasks-general-2.png)
...
![Figure 3. Ongoing Tasks New Task](./assets/ongoing-tasks-general-3.png)
...
* Select the preferred task to add  
  ...
  2. Adding a [RavenDB ETL](../../../../studio/database/tasks/ongoing-tasks/ravendb-etl-task.mdx) task  
  3. Adding an [SQL ETL](../../../../server/ongoing-tasks/etl/sql.mdx) task  
  4. Adding a [Backup](../../../../studio/database/tasks/ongoing-tasks/backup-task.mdx) task  
