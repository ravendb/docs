...
* A complete example of how to define and run a GenAI task that processes attachments **via Studio**  
  is available in [Processing attachments: Studio](../../../ai-integration/gen-ai-integration/process-attachments/processing-attachments_studio.mdx).

* In this article:
  * [Sending attachments to the LLM - via the Client API](../../../ai-integration/gen-ai-integration/process-attachments/processing-attachments_api.mdx#sending-attachments-to-the-llm)
...
* When [defining the connection string](../../../ai-integration/gen-ai-integration/create-gen-ai-task/create-gen-ai-task_api.mdx#define-a-connection-string) to the LLM,
  make sure the AI model you use is capable of processing the attachment types.
  For example, use OpenAI’s `gpt-4.1-mini` to process attached image files.

* When [creating the context object](../../../ai-integration/gen-ai-integration/overview.mdx#the-elements) that will be sent to the LLM, 
...
* When [defining the task Prompt and JSON schema](../../../ai-integration/gen-ai-integration/process-attachments/processing-attachments_studio.mdx#set-task-prompt-and-json-schema),   
...
* When [defining the task Update script](../../../ai-integration/gen-ai-integration/process-attachments/processing-attachments_studio.mdx#set-task-update-script),   
