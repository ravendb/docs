...
* In this page:  
   ...
   * [Usage](../../indexes/querying/exploration-queries.mdx#usage)
...
<CodeBlock language="javascript">
{`from Employees as e 
lter e.Address.Country = 'USA'
lter_limit 500 // limit the number of filtered records
`}
</CodeBlock>
</TabItem>
...
r e.Address.Country = 'USA' // filter the retrieved dataset
r_limit 500 // limit the number of filter records
`}
</CodeBlock>
</TabItem>
...
- [What is RQL](../../client-api/session/querying/what-is-rql.mdx)  
- [Query](../../client-api/session/querying/how-to-query.mdx#sessionquery)  
- [DocumentQuery](../../client-api/session/querying/how-to-query.mdx#sessionadvanceddocumentquery)  
- [RawQuery](../../client-api/session/querying/how-to-query.mdx#sessionadvancedrawquery)  
- [Where](../../indexes/querying/filtering.mdx)  
- [Querying an Index](../../indexes/querying/query-index.mdx)  
- [Sorting](../../indexes/querying/sorting.mdx)  
