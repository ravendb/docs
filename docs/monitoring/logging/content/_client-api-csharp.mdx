...
* For the persistent logging configuration keys, see the [Configuration options](../../../monitoring/logging/configuration.mdx) page.  
  For an overview of RavenDB's logging system, see the [Overview](../../../monitoring/logging/overview.mdx) page.  

* In this article:
    * [Retrieve the logging configuration](../../../monitoring/logging/client-api.mdx#retrieve-the-logging-configuration)
    * [Change the logging configuration at runtime](../../../monitoring/logging/client-api.mdx#change-the-logging-configuration-at-runtime)
    * [Syntax](../../../monitoring/logging/client-api.mdx#syntax)
...
See the full shape of each group in the [Syntax](../../../monitoring/logging/client-api.mdx#syntax) section.
...
* The operation accepts a `persist` flag: set it to `true` to also write the new minimum
  [log level](../../../monitoring/logging/overview.mdx#available-logging-levels) to the
...
Microsoft logs must first be enabled by setting [Logs.Microsoft.Enabled](../../../monitoring/logging/configuration.mdx#logsmicrosoftenabled) to `true`, which requires a restart; you can then adjust their level at runtime as follows:
...
The admin logs are the live stream shown in Studio's [Admin Logs view](../../../monitoring/logging/overview.mdx#studio-the-admin-logs-view).  
