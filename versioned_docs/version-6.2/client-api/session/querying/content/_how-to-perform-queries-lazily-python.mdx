...
* This article contains examples for lazy queries. Prior to reading it, please refer 
  to [perform requests lazily](../../how-to/perform-operations-lazily.mdx) 
...
* In this page:
  ...
  * [Lazy count query](#lazy-count-query)  
  * [Lazy suggestions query](#lazy-suggestions-query)  
  * [Lazy facets query](#lazy-facets-query)  
  * [Syntax](#syntax)

</Admonition>
## Lazy query

To run a [regular query](../how-to-query.mdx) 
(not a [suggestions](../how-to-work-with-suggestions.mdx) 
query or a [faceted search](../how-to-perform-a-faceted-search.mdx)) 
...
To run a suggestions search lazily, use [suggest_using](../how-to-work-with-suggestions.mdx) 
...
<Admonition type="note" title="">
Learn more about facets in [perform faceted search](../how-to-perform-a-faceted-search.mdx).
</Admonition>
