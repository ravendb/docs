...
2. **Conversations**  
   ...
   A conversation is a single chat thread between a user and an agent, carried over a [channel](../../channels/overview.mdx).  
   Learn more in [App: Conversations view](conversations-view.mdx).
...
The agents themselves are added, modified and deleted in the
[App: Agents view](../../dashboard/manage-an-app/app-agents-view.mdx).
...
1. **Channel name**  
   ...
   Click the name to open the [channel's page](channels-view.mdx#the-channel-s-details-view).  
...
7. **Add channel**  
   ...
   **WhatsApp Personal** and **WhatsApp Business** are marked **Coming soon** and cannot be selected yet.  
   For a comparison of the channel types, see [Channels: Overview](../../channels/overview.mdx#channel-types);  
   for adding one from this app, see [App: Channels view](channels-view.mdx#adding-a-channel).
