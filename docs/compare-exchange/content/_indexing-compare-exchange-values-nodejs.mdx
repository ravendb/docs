...
* In this article:  
  ...
  * [Index compare-exchange values](#index-compare-exchange-values)
  * [Query the index](#query-the-index)
  * [Query the index and project compare-exchange values](#query-the-index-and-project-compare-exchange-values)
  * [Syntax](#syntax)  
