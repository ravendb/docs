...
* Time series querying is native to RavenDB's queries.  
  Clients can express time series queries in high-level queries or directly in [RQL](../../../../querying/rql/what-is-rql.mdx).
...
* You can declare and use both time series functions and [custom JavaScript function](../../../../querying/rql/what-is-rql.mdx#declare) in a query.  
