...
<TabItem value="number_of_items_in_batch_definition" label="number_of_items_in_batch_definition">
<CodeBlock language="python">
...
<TabItem value="Item_definition" label="Item_definition">
<CodeBlock language="python">
...
<TabItem value="SubscriptionBatch_definition" label="SubscriptionBatch_definition">
<CodeBlock language="python">
...
| `run`                                           | `Future[None]` | Call `run` to begin the worker's batch processing.<br/>Pass the batch processing delegates to this method<br/>(see [above](../../../client-api/data-subscriptions/consumption/api-overview.mdx#run-the-subscription-worker)). |
### Events:
