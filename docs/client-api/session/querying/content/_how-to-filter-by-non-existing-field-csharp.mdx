...
use the `Not` and `WhereExists` extension methods, accessible from the [DocumentQuery](../../../../querying/document-query/what-is-document-query.mdx) API, 
as shown below.  
...
* Use an [RQL](../../../../querying/rql/what-is-rql.mdx) expression such as:
