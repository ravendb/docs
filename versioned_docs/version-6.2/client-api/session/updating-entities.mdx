...
* To modify existing documents:
    ...
    * **Retrieve** documents from the database using [Load](../../client-api/session/loading-entities.mdx#load) or by a [Query](../../client-api/session/querying/how-to-query.mdx#session.query).  
...
* To modify existing documents:
    ...
    * **Retrieve** documents from the database using [load](../../client-api/session/loading-entities.mdx#load) 
      or by a [query](../../client-api/session/querying/how-to-query.mdx#session.query).  
      The entities loaded from the documents are added to the internal entities map that the session manages.  
