...
description: "Retrieve documents from RavenDB matching an ID prefix using the REST API GET endpoint with startsWith and paging parameters."
sidebar_position: 2
---
...
* In this page:  
  ...
  * [More Examples](#more-examples)  
      * [Get Using `matches`](#get-using)  
      * [Get Using `matches` and `exclude`](#get-usingand)  
      * [Get Using `startAfter`](#get-using-1)  
