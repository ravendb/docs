...
| Querying with limit in patch/delete by query operations       | Attempting to set a `limit` with [PatchByQueryOperation](../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx#patchbyqueryoperation) or [DeleteByQueryOperation](../client-api/operations/common/delete-by-query.mdx) will throw _NotSupportedInShardingException_. |
