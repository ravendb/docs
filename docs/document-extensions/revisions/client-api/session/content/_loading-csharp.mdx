...
* These methods can also be executed lazily, see [get revisions lazily](../../../../../client-api/session/how-to/perform-operations-lazily.mdx#get-revisions).   
  
* In this page:  
   * [Get all revisions](#get-all-revisions)  
   * [Get revisions metadata](#get-revisions-metadata)  
   * [Get revisions by creation time](#get-revisions-by-creation-time)  
   * [Get revisions by change vector](#get-revisions-by-change-vector)  
