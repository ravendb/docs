...
The identity check applies to [Tombstone](../../../glossary/tombstone.mdx) as well, and it will always resolve to the local one, since the tombstones are always considered equal.
</Admonition>
