...
description: "Build multi-map indexes in RavenDB Studio to query across multiple document collections using a unified index definition editor."
sidebar_position: 3
---
...
* In this page:  
  * [Define a Map Function](#define-a-map-function)  
  * [Add another Map Function](#add-another-map-function)  
</Admonition>
...
* [Index field options](./create-map-index.mdx#index-field-options), 
  [Configuration](./create-map-index.mdx#configuration), 
  [Assitional Assemblies](./create-map-index.mdx#additional-assemblies) 
  & [Additional Sources](./create-map-index.mdx#additional-sources) 
  can be defined for the Multi-Map index in the same way as done for a [Simple Map Index](./create-map-index.mdx#create-multi-map-index).  
</Admonition>
