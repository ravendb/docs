...
{CODE:csharp syntax@Indexes\MapReduceIndexes.cs /}
...
documents are aggregated. 
  The type of this paramater is different depending on if the index is created 
using [IndexDefinition](/indexes/creating-and-deploying#using-maintenance-operations) or 
[AbstractIndexCreationTask](../indexes/creating-and-deploying#using-abstractindexcreationtask).  
