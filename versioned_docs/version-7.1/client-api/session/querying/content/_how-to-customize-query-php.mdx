...
* Use the below methods to set customization options on a specific [query](../how-to-query.mdx).  
...
* A query can also be customized on the store or session level by 
  [subscribing to `OnBeforeQuery`](../../how-to/subscribe-to-events.mdx). 

* Available customization methods :
  - [`addBeforeQueryExecutedListener` and `removeBeforeQueryExecutedListener`](#addbeforequeryexecutedlistener-and-removebeforequeryexecutedlistener)
  - [`addAfterQueryExecutedListener` and `removeAfterQueryExecutedListener`](#addafterqueryexecutedlistener-and-removeafterqueryexecutedlistener)
  - [`noCaching`](#nocaching)
  - [`noTracking`](#notracking)
  - [Projection](#randomordering)
