...
* **Exploration Queries** form an additional layer of filtering that can be applied 
  to a dataset after its retrieval by [raw rql](../../../querying/overview.mdx#session-advanced-rawquery), 
...
* Exploration queries need to be used 
  ...
  when large datasets are handled.  
    ...
    * [Limit](#limit-the-query-and-prefer--for-recurring-queries) 
...
* In this page:  
   ...
   * [Usage examples](#usage-examples)
      ...
      * [With user-defined JavaScript functions (`declare`)](#with-user-defined-javascript-functions-declare)
...
Read [here](#with-user-defined-javascript-functions-declare) 
