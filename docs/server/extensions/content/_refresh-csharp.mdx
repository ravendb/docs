...
* The Refresh feature increments a document's [change vector](../../clustering/replication/change-vector.mdx), 
...
* In this page:  
  ...
  * [Examples](#examples)
  * [Syntax](#syntax)
  * [Configure from Studio](#configure-from-studio)
...
* This will cause the document to refresh **only once**.  
  When the refresh operation takes place, it will also remove the `@refresh` property from the document.  
     ...
     2. The way you set the [Refresh Configuration](#syntax), 
        including -  
...
* Refreshing a document causes its [change vector](../../clustering/replication/change-vector.mdx) 
  ...
  This triggers any features that react to document updating, including but not limited to:  
   ...
   - [Replication](../../ongoing-tasks/external-replication.mdx), 
     [Subscriptions](../../../client-api/data-subscriptions/what-are-data-subscriptions.mdx), 
     and [ETL](../../ongoing-tasks/etl/basics.mdx) triggering  
