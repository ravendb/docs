---
title: "Terraform"
description: "Deploy and manage RavenDB infrastructure using HashiCorp Terraform with the RavenDB Terraform provider for automated cluster provisioning."
...
* In this page:  
  * [Prerequisites](../integrations/terraform.mdx#prerequisites)  
  * [Prepare Terraform Configuration](../integrations/terraform.mdx#prepare-terraform-configuration)  
     * [Provider](../integrations/terraform.mdx#provider)  
     * [Terraform Local Parameters](../integrations/terraform.mdx#terraform-local-parameters)  
     * [RavenDB Resource](../integrations/terraform.mdx#ravendb-resource)  
     * [Terraform Output Values](../integrations/terraform.mdx#terraform-output-values)  
  * [Apply Terraform Configuration](../integrations/terraform.mdx#apply-terraform-configuration)  
</Admonition>
## Prerequisites
...
* **RavenDB license**  
   ...
   * The license you acquire will be provided to RavenDB via the 
     [Terraform configuration file](../integrations/terraform.mdx#prepare-terraform-configuration) 
...
* **Terraform Configuration File**  
   ...
   * Read [below](../integrations/terraform.mdx#prepare-terraform-configuration) 
...
defined in the [resource](../integrations/terraform.mdx#ravendb-resource) 
