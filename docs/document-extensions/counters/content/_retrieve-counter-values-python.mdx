...
* For all other `counters_for` methods see this [Overview](../overview.mdx#counter-methods-and-the--object).
...
* In this page:  
  ...
  * [Get all Counters of a document](#get-all-counters-of-a-document)  
     * [`get_all` usage](#usage-1)  
     * [`get_all` example](#example-1)  
     * [`get_all` Syntax](#syntax-1)  
