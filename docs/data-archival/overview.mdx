...
* RavenDB features can detect archived documents and handle them in different ways.
  ...
  Learn more in [Archived documents and other features](./archived-documents-and-other-features.mdx).
...
* **Enable the archiving feature**  
  * To archive documents, you must first enable the archiving feature in RavenDB.  
    Learn how in the dedicated article: [Enable data archiving](./enable-data-archiving.mdx).
...
* **Schedule documents for archival**
  * Once the feature is enabled, you can schedule any document to be archived at a specific future time.  
    ...
    Learn more in the dedicated article: [Schedule document archiving](./schedule-document-archiving.mdx).  
...
* **Unarchiving documents**  
  * An archived document can be unarchived.  
    Learn more in the dedicated article: [Unarchiving documents](./unarchiving-documents.mdx).  
...
* **Metadata property**:
   ...
   * This property is informational only -  
     ...
     Learn more in [Schedule document archiving](./schedule-document-archiving.mdx).  
...
* **Internal flag**:
  ...
  * Features like indexing and data subscriptions use this flag to detect archived documents and handle them based on the configured behavior.  
    Learn more in [Archived documents and indexing](./archived-documents-and-other-features.mdx#archived-documents-and-indexing) & 
    [Archived documents and data subscriptions](./archived-documents-and-other-features.mdx#archived-documents-and-subscriptions).
