...
description: "Configure automatic and custom backup routines for RavenDB Cloud instances, manage backup storage, encryption, and restore operations."
sidebar_position: 4
---
...
stores a [full backup](../7.2/backup/overview#backup-scope)
...
![Backup Task](./assets/studio-ongoing-tasks-server-wide-backup.png)  
...
monitoring facilities ([SNMP](https://docs.ravendb.net/7.2/monitoring/integrations/snmp/overview),
[OpenTelemetry](https://docs.ravendb.net/7.2/monitoring/integrations/open-telemetry), and others).
...
![Create Task](./assets/studio-ongoing-tasks-add-task-button.png)  
Add a Backup task  
![Backup Task](./assets/studio-ongoing-tasks-choose-task-backup.png)  
...
![Set S3 Bucket](./assets/studio-backup-task-destination-amazon-s3.png)  
...
* Click "Generate Restore Link" for the database you want to restore.  
  ...
  ![Backups List](./assets/portal-backups-database-list.png "Backups List")  
#### Restore the Database  
Clicking the **Generate Restore Link** button will show you a simple procedure. Follow it to restore your database.  

![Backup Link](./assets/portal-backups-restore-link-modal.png)  

* **A.** Create a **New Database From Backup**  
  ![New DB From Backup](./assets/studio-databases-new-database-from-backup.png)  
* **B.** Choose **Cloud** as your Source  
  ![Source Is Cloud](./assets/studio-new-database-from-backup-source-cloud.png)  
* **C.** Copy the Backup Link you've been given in the Backups Tab, to the **Backup Link** box here.  
  ![Paste Backup Link Here](./assets/studio-new-database-from-backup-backup-link.png)  
* **D.** Choose a **Restore Point**  
  ![Choose Restore Point](./assets/studio-new-database-from-backup-restore-point.png)  
* **E.** Encryption Key for an **Encrypted** Database  
  ...
  ![Encryption Key: Encrypted Database](./assets/studio-new-database-from-backup-encryption-key.png)  
* **F.**  Encryption Key for an **Unencrypted** Database  
  ...
  ![Encryption Key: Unencrypted Database](./assets/portal-backups-restore-link-modal-restore-key.png)  
