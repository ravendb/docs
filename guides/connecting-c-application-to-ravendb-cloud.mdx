...
Ensure `using` statements for correct compilation, and spin up your *DocumentStore* by calling `documentStore.Initialize()` at the bottom to finish off the code. It's a crucial part that connects to your database—without it, your code simply won't work. *DocumentStore* is the base for all RavenDB actions. It communicates with your cluster and can handle multiple databases. It's important to have a single instance of *DocumentStore* in place, to maintain a single connection definition to your database. You can learn more about *DocumentStore* [here](https://ravendb.net/docs/article-page/csharp/client-api/what-is-a-document-store) or [here](https://ravendb.net/docs/article-page/csharp/client-api/creating-document-store).
