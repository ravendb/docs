---
title: "Aspire ACA Plugin"
description: "Understand the file system incompatibility between RavenDB and Azure Container Apps (Aspire ACA plugin) and why it is not recommended for production."
---
...
- Use `azd deploy` to deploy the application to the Azure infrastructure
