...
* Resharding may result in the transfer of some documents more than 
  ...
  [detect and handle](#etl-and-resharding) such duplicates.  
* ETL tasks information is available [per database and per shard](#retrieving-shard-specific-etl-task-info).  

* In this page:  
  * [ETL](#etl)  
     * [Sharded and Non-Sharded ETL Tasks](#sharded-and-non-sharded-etl-tasks)  
     * [Non-Sharded Database ETL Tasks](#non-sharded-database-etl-tasks)  
     * [Sharded Database ETL Tasks](#sharded-database-etl-tasks)  
  * [ETL and Resharding](#etl-and-resharding)  
  * [ETL Queries](#etl-queries)  
  * [Retrieving Shard-Specific ETL Task Info](#retrieving-shard-specific-etl-task-info)  
...
[not yet implemented](./querying.mdx#unsupported-querying-features) 
...
[filer](./querying.mdx#filtering-results-in-a-sharded-database)), 
it is recommended to read the pages dedicated to [indexing](./indexing.mdx) 
and [querying](./querying.mdx) on a sharded database.  
