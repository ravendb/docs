...
Indexing attachment content is supported only for [Local attachments](../store-attachments/store-attachments-local.mdx).   
Indexing attachment content is Not supported for [Remote attachments](../store-attachments/store-attachments-remote.mdx).
