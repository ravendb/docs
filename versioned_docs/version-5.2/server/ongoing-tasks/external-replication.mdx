 ...
 * All database documents and related data:  
   ...
   * [Revisions](../../client-api/session/revisions/what-are-revisions.mdx)  
...
You can also configure external replication tasks [via RavenDB Studio](../../studio/database/tasks/ongoing-tasks/external-replication-task.mdx#definition).  
