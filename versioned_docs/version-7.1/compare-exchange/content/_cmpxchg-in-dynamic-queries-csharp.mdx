...
* The following example is based on the sample data described in: [Create sample compare-exchange items](../indexing-cmpxchg-values.mdx#create-sample-compare-exchange-items).   
