...
* Once defined, the Compare Exchange Values can be accessed via [GetCompareExchangeValuesOperation](../get-compare-exchange-values.mdx),  
...
**Atomic Guards**, read more about them [here](../../../session/cluster-transaction/atomic-guards.mdx).  
</Admonition>


* In this page:  
  * [Compare Exchange Transaction Scope](#compare-exchange-transaction-scope)  
  * [Creating a Key](#creating-a-key)  
  * [Updating a Key](#updating-a-key)  
...
* The [Put](../put-compare-exchange-value.mdx) operation will succeed only if this key doesn't exist yet.  
...
* Updating a 'Compare Exchange' key can be divided into 2 phases:
  ...
  1. [Get](../get-compare-exchange-value.mdx) the existing _Key_. The associated _Value_ and _Index_ are received.  

  2. The _Index_ obtained from the read operation is provided to the [Put](../put-compare-exchange-value.mdx) operation along with the new _Value_ to be saved.  
