...
* To create sample data, you can either empty your playground database or [create a new database](../create-new-database/general-flow.mdx).  
 
* If you plan to use [multiple nodes](../create-new-database/general-flow.mdx#3-configure-replication) 
   and/or [encryption](../create-new-database/encrypted.mdx) in production, 
...
4. **Collection**  
   Which [collection](../documents/documents-and-collections.mdx) each document is in.  
...
1. **Index** tab  
   ...
   * RavenDB's default [dynamic auto-indexes](../indexes/indexes-overview.mdx#index-types) are managed 
...
3. **Query** this index.  
   A [general query](../queries/query-view.mdx) automatically determines the best index to query and creates 
...
4. **Edit** this index.  
   ...
   Read [Modifying Index Definition](../indexes/indexes-overview.mdx#modifying-index-definition) to learn more.  
