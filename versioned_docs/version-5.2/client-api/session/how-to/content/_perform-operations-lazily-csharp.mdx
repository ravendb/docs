...
## Requests that can be executed lazily
...
* A Query can be executed __lazily__.  
  Find more lazy queries examples in [perform a lazy query](../../../client-api/session/querying/how-to-perform-queries-lazily.mdx).
