...
* **Usage tokens**  
   ...
   * When the tokens run out, assistant prompts are no longer processed by either the [backend service](../studio/ai-assistant#ravendb-backend-service) or the [LLM](../studio/ai-assistant#llm-service-provider).  
