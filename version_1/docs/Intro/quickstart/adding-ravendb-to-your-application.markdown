...
You can consume RavenDB through NuGet. Follow [this](http://ravendb.net/docs/1.0/intro/quickstart/adding-ravendb-through-nuget) article for instructions how to do that.
