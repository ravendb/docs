...
<Admonition type="info" title="Additional resources" id="additional-resources" href="#additional-resources">
...
* Another helpful resource about setup and security: [Security common errors & FAQ](../../server/security/common-errors-and-faq.mdx)  

* To learn how to **install RavenDB manually** rather than via the setup wizard: [Manual setup](../../start/installation/manual.mdx)  
</Admonition>

* In this page:
   * [Run the Setup Wizard](../../start/installation/setup-wizard.mdx#run-the-setup-wizard)  
   * [Select Setup Mode](../../start/installation/setup-wizard.mdx#select-setup-mode)  
   * [Secure Setup with a Free Let's Encrypt Certificate](../../start/installation/setup-wizard.mdx#secure-setup-with-a-free-let)  
      * [Configuring The Server Addresses](../../start/installation/setup-wizard.mdx#configuring-the-server-addresses)  
      * [Installing The Certificate](../../start/installation/setup-wizard.mdx#installing-the-certificate)  
      * [Setting Up Other Nodes](../../start/installation/setup-wizard.mdx#setting-up-other-nodes)  
      * [Next Steps](../../start/installation/setup-wizard.mdx#next-steps)
   * [Secure Setup with Your Own Certificate](../../start/installation/setup-wizard.mdx#secure-setup-with-your-own-certificate)  
      * [Configuring The Server Addresses](../../start/installation/setup-wizard.mdx#configuring-the-server-addresses-1)  
      * [Setting Up Other Nodes](../../start/installation/setup-wizard.mdx#setting-up-other-nodes-1)  
      * [Next Steps](../../start/installation/setup-wizard.mdx#next-steps)
   * [Unsecure Setup](../../start/installation/setup-wizard.mdx#unsecure-setup)  
...
you will [use your own certificates and domains](../../start/installation/setup-wizard.mdx#secure-setup-with-your-own-certificate), 
...
Each node will run in its own process and have its own data directory and [settings.json](../../server/configuration/configuration-options.mdx#settingsjson) file. 
...
A [common DNS error](../../server/security/common-errors-and-faq.mdx) is that **DNS records didn't yet update** locally.  
...
If you must move your folder at a later time, you can [reconfigure the certificate file path](../../server/security/authentication/certificate-configuration.mdx#standard-manual-setup-with-certificate-stored-locally) 
...
If you unchecked the box, before you continue, please [register the client certificate](../../server/security/authentication/client-certificate-usage.mdx) 
...
You can now [register the cluster as a service](../../start/installation/running-as-service.mdx) in your OS (it will run in the background 
...
* **To learn how to fly with RavenDB**, here are a few options:
  ...
  * [Documentation Guide](https://ravendb.net/learn/docs-guide) - In addition to this guide and the [First Steps](../../start/installation/setup-wizard.mdx#first-steps-from-our-documentation) 
...
* **Importing from Other Databases**
  * [From SQL Databases](../../studio/database/tasks/import-data/import-from-sql.mdx)
  * [From NoSQL Databases](../../studio/database/tasks/import-data/import-from-other.mdx)
  * [From CSV](../../studio/database/tasks/import-data/import-from-csv.mdx)
  * [From RavenDB file](../../studio/database/tasks/import-data/import-data-file.mdx) or from a [live RavenDB server](../../studio/database/tasks/import-data/import-from-ravendb.mdx)
* [Configure Client Certificates](../../server/security/authentication/certificate-management.mdx) to customize security access 
  permissions for each client.  
* [APIs to Integrate With Your Client](../../client-api/what-is-a-document-store.mdx) starting with the Document Store.  
* [Studio GUI Overview](../../studio/overview.mdx) to learn how the built-in RavenDB studio features can save you time and help you 
  keep things running smoothly.  
* [RavenDB Indexing](../../indexes/indexing-basics.mdx) is very sophisticated.  Auto-indexing is default and with agility in mind, it adjusts to changes immediately, 
  but you can set up static indexes manually as well.  
* [Backup Securely](../../studio/database/tasks/backup-task.mdx)  
* **Document Extensions**  
...
* We strongly recommend [setting up securely](../../start/installation/setup-wizard.mdx#secure-setup-with-a-free-let) from the 
...
3. **Create new cluster**  
   ...
   * **Unchecked** - The server will Not be created in a cluster.  
                     ...
                     [Passive State](../../../studio/cluster/cluster-view.mdx#cluster-nodes-states--types-flow) 
...
Learn more in [Adding a Node to a Cluster](../../../studio/cluster/setting-a-cluster.mdx#add-another-node-to-the-cluster).  
