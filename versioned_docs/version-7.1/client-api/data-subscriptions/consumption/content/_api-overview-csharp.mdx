...
* In this page:  
   ...
   * [SubscriptionBatch&lt;T&gt;](#subscriptionbatcht)  
   * [SubscriptionBatch&lt;T&gt;.Item](#subscriptionbatchtitem)  
   * [SubscriptionWorker&lt;T&gt;](#subscriptionworkert)  
...
Learn more about `SubscriptionOpeningStrategy` in [worker strategies](../how-to-consume-data-subscription.mdx#worker-strategies).
...
To start processing, you need to call the `Run` method of the [SubscriptionWorker](#subscriptionworkert).  
...
| Member                   | Type                              | Description                                                                                                                                                            |
|--------------------------|-----------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Items**                | `List<SubscriptionBatch<T>.Item>` | List of items in the batch.<br/>See [SubscriptionBatch&lt;T&gt;.Item](#subscriptionbatchtitem) below. |
...
| **Run (multiple overloads)**                   | `Task`        | Call `Run` to begin the worker's batch processing.<br/>Pass the batch processing delegates to this method<br/>(see [above](#run-the-subscription-worker)). |
