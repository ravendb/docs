...
description: "Set server-wide client configuration defaults in RavenDB Studio for identity parts separator, read balance, and caching behavior."
sidebar_position: 1
---
...
* To override these global values and define a separate client configuration for a specific database,  
  see: [Client configuration (for database)](../database/settings/client-configuration-per-database.mdx)    

* In this article:
  * [Set the client configuration (server-wide)](#set-the-client-configuration-server-wide)
