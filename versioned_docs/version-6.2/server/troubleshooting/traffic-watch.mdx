...
* **Disk storage**: Proportional to request volume.  
  ...
  [`Logs.MaxFileSizeInMb`](../../server/configuration/logs-configuration.mdx#logsmaxfilesizeinmb) (default: 128 MB),  
  [`Logs.RetentionTimeInHrs`](../../server/configuration/logs-configuration.mdx#logsretentiontimeinhrs) (default: 72 hours),  
  [`Logs.RetentionSizeInMb`](../../server/configuration/logs-configuration.mdx#logsretentionsizeinmb) (no limit unless set).  
