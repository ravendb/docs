...
* In this page:
    * [Requests that can be executed lazily](#operations-that-can-be-executed-lazily)
        * [Load entities](#load-entities)
        * [Load entities with include](#load-entities-with-include)
        * [Load entities starting with](#load-entities-starting-with)
    ...
    * [Multiple lazy requests](#multiple-lazy-requests)
        * [Execute all requests - implicitly](#execute-all-requests---implicitly)
        * [Execute all requests - explicitly](#execute-all-requests---explicitly)
...
[Load](../../loading-entities.mdx#load) loads a document entity from 
