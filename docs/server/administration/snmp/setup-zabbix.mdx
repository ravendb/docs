...
description: "Configure Zabbix to monitor RavenDB servers via SNMP, including template setup, host configuration, and available metrics."
sidebar_position: 1
---
...
RavenDB supports [SNMP](./snmp-overview.mdx), which means that with a few quick steps you can monitor your server using Zabbix.
