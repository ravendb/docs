...
* For more info about node types and states in the **Cluster** see [Cluster View](../../../cluster/cluster-view.mdx)  
  For more info about node types and states in the **Database Group** see [Database Group](../../../database/settings/manage-database-group.mdx)  
</Admonition>
## The Observer Log
...
2. Once the node has caught up with the state of the Database Group, fully updated with the database data and finished indexing the last data sent to it, 
   ...
   For a detailed explanation of a Member actions and tasks within a database group see [Database Group](../../../database/settings/manage-database-group.mdx)  
</Admonition>
...
2. If 'Allow Dynamic Database Distribution' is set (see [Create Database](../../../database/create-new-database/general-flow.mdx)),  
