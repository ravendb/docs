...
* For configuration options related to logging, see the [Configuration options](../../../monitoring/logging/configuration.mdx) page.  
  To learn about RavenDB's logging system, see the [Overview](../../../monitoring/logging/overview.mdx) page.  
...
The admin logs are the live stream shown in Studio's [Admin Logs view](../../../monitoring/logging/admin-logs.mdx).  
