...
You need to either [handle that](http://ravendb.net/docs/server/bundles/replicationconflicts) or to choose to disallow writes while using the master is unavailable, and use the slave just for reads.
