...
The **Getting Started** section takes you from the initial signing up for Quill to the execution of an AI
agent that handles user conversations, in six steps:  
**Signing up**, **Starting Quill**, **Connecting your database**, **Mapping your tables**, **Adding an AI agent**,
and **Adding a chat widget**.
...
* In this article:
   * [Prerequisites](signing-up.mdx#prerequisites)
   * [Signing up](signing-up.mdx#signing-up)
      * [Filling in the sign-up form](signing-up.mdx#filling-in-the-sign-up-form)
      * [Entering the verification code](signing-up.mdx#entering-the-verification-code)
   * [Registering your Quill deployment](signing-up.mdx#registering-your-quill-deployment)
      * [Naming your Quill domain](signing-up.mdx#naming-your-quill-domain)
      * [Reviewing and confirming](signing-up.mdx#reviewing-and-confirming)
   * [Saving your setup details](signing-up.mdx#saving-your-setup-details)
...
1. **The code field**  
   ...
   [register your Quill deployment](signing-up.mdx#registering-your-quill-deployment).
...
3. **Continue**  
   Click for the next wizard stage: [Reviewing and confirming](signing-up.mdx#reviewing-and-confirming)
...
1. **Edit**  
   Click to reopen the [Name your Quill](signing-up.mdx#naming-your-quill-domain) stage and modify its details.

2. **Confirm & generate**  
   Click to register the domain, generate the access keys, and
   [save your setup details](signing-up.mdx#saving-your-setup-details).
...
3. **Docker command**  
   ...
   **bash** or **PowerShell** form.  
   ...
   See more about the Docker command in [Starting Quill](starting-quill.mdx).
