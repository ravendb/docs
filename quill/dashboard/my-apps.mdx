...
5. **Add app**  
   ...
   See [Getting started: Connect your database](../getting-started/connect-your-database.mdx).
...
1. **App**  
   The app's name, above the public URL slug it was created with.  
   The slug identifies the app in its public URLs and is also the name of the app's RavenDB database.  
   It cannot be changed after the app is created.
...
7. **Add app**  
   ...
   and creating a new app. See [Getting started: Connect your database](../getting-started/connect-your-database.mdx).
