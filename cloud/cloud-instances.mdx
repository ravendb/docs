...
description: "Choose between Free, Development, and Production tiers for your RavenDB Cloud instance, each with different resource allocations and capabilities."
sidebar_position: 2
---
...
![Tiers and Instances: Free](./assets/portal-product-create-plan-tier-free.png)
...
![Tiers and Instances: Development](./assets/portal-product-create-plan-tier-development.png)
...
![Development Tier DEV10](./assets/portal-product-create-plan-instance-size-dev10.png)

![Development Tier DEV70](./assets/portal-product-create-plan-instance-size-dev70.png)
#### Select your storage  

Select your storage type and size.  

![Development Tier: Storage](./assets/portal-product-create-plan-storage-development.png)
...
![Production Tier](./assets/portal-product-create-plan-tier-production.png)
...
![Production: Basic](./assets/portal-product-create-plan-instance-basic-pb10.png)
...
![Production: Standard P10](./assets/portal-product-create-plan-instance-standard-p10.png)

![Production: Standard P70](./assets/portal-product-create-plan-instance-standard-p70.png)

![Standard Storage](./assets/portal-product-create-plan-storage-production.png)
...
![Production: Performance](./assets/portal-product-create-plan-instance-performance-pn10.png)  
