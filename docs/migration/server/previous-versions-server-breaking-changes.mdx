...
visible right away through Studio's [admin-logs view](../../monitoring/logging/admin-logs.mdx).
    
Read more about Nlog in [Logging: Overview](../../monitoring/logging/overview.mdx).
