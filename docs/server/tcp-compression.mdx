...
* With **TCP Compression** enabled, internal cluster data transfers 
  ...
  [database replication](../server/clustering/replication/replication-overview.mdx)
...
* RavenDB will compress data before [replicating](../server/clustering/replication/replication-overview.mdx) 
...
* TCP Compression can also be disabled server-wide, using the 
  server [Server.Tcp.Compression.Disable](../server/configuration/server-configuration.mdx#servertcpcompressiondisable) configuration.  
