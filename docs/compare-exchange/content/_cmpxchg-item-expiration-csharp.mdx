...
* The **scan frequency** is configurable -  
  see the [Cluster.CompareExchangeExpiredDeleteFrequencyInSec](../configuration.mdx#clustercompareexchangeexpireddeletefrequencyinsec) configuration key. 
  The default is 60 seconds.  

* To manually remove a compare-exchange item, see [Delete compare-exchange items](../delete-cmpxchg-items.mdx).
...
* The syntax for **creating** a compare-exchange item is available in [Create compare-exchange item - Syntax](../create-cmpxchg-items.mdx#syntax)
* The syntax for **updating** a compare-exchange item is available in [Update compare-exchange item - Syntax](../update-cmpxchg-item.mdx#syntax)
