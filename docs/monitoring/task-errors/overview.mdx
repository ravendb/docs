...
* In this article:
   * [What task errors are](#what-task-errors-are)
      * [Error types](#error-types)
      * [Error steps](#error-steps)
   * [Where task errors are stored](#where-task-errors-are-stored)
   * [Task health](#task-health)
      * [Health states](#health-states)
      * [How health is computed](#how-health-is-computed)
   * [Where to view and manage task errors](#where-to-view-and-manage-task-errors)
...
(see [Where to view and manage task errors](#where-to-view-and-manage-task-errors))
...
[configured thresholds](./configuration.mdx).  
</Admonition>
...
[Task errors configuration](./configuration.mdx) covers the two
...
[Inspect and manage task errors via Studio](./studio-views.mdx)  
...
* **Studio views**  
  ...
  See [Task errors Studio views](./studio-views.mdx).  
