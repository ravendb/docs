...
* This method retrieves only the **accumulated values** of incremental time series entries.  
  To retrieve the values stored by each node, use [GetTimeSeriesOperation](../operations/get.mdx).  

<Admonition type="info" title="">

* [Include](../../../client-api/session/include/overview.mdx) 
  time series data while [loading](../../../client-api/session/include/with-session-load.mdx) 
  or [querying](../../../client-api/session/include/with-session-query.mdx) 
...
* In this page:  
   * [`IncrementalTimeSeriesFor.Get`](#incrementaltimeseriesforget)  
      * [Syntax](#syntax)  
      * [Usage Flow](#usage-flow)  
      * [Code Samples](../../../client-api/session/get/get-entries.mdx#code-samples)  
...
* To retrieve multiple series' data, use the 
  [GetMultipleTimeSeriesOperation](../../../client-api/operations/get.mdx#getmultipletimeseriesoperation) 
...
* Find additional samples [here](../../../client-api/session/get/get-entries.mdx).  
