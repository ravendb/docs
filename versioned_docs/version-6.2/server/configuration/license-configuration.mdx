...
* When using this configuration key as an [environment variable](../../server/configuration/configuration-options.mdx#environment-variables) embed the JSON license key __object__.  
...
* Setting the [License](../../server/configuration/license-configuration.mdx#license) configuration
* Setting the [License.Path](../../server/configuration/license-configuration.mdx#license.path) configuration
