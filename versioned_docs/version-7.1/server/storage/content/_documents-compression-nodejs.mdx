...
* Documents compression can be set for all collections, selected collections, and revisions.  
  Default compression settings are [configurable](../../configuration/database-configuration.mdx#databasescompressioncompressallcollectionsdefault).
...
* In this page:  
  * [Overview](#overview)
  * [Compression -vs- Compaction](#compression--vs--compaction)
  * [Set compression for all collections](#set-compression-for-all-collections)  
  * [Set compression for selected collections](#set-compression-for-selected-collections)
  * [Syntax](#syntax)
