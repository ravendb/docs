...
see_also:
  - title: "Simple Migration"
    link: "server/ongoing-tasks/cdc-sink/postgres/examples/example-simple-migration"
    source: "docs"
    path: "Server > CDC Sink > PostgreSQL > Examples"
  - title: "Denormalization"
    link: "server/ongoing-tasks/cdc-sink/postgres/examples/example-denormalization"
    source: "docs"
    path: "Server > CDC Sink > PostgreSQL > Examples"
  - title: "Event Sourcing"
    link: "server/ongoing-tasks/cdc-sink/postgres/examples/example-event-sourcing"
    source: "docs"
    path: "Server > CDC Sink > PostgreSQL > Examples"
  - title: "Schema Design"
