...
* In this page:  
  * [New Database From Backup - Studio Databases View](#new-database-from-backup---studio-databases-view)  
  * [New Database From Backup - Studio Backups View](#new-database-from-backup---studio-backups-view)  
  * [Backup Source Configuration](#backup-source-configuration)  
  * [Setting Up High Availability After Restoration](#setting-up-high-availability-after-restoration)  
  * [Importing Backups into a Sharded Database](#importing-backups-into-a-sharded-database)  
...
1. [**Name** your new database](./general-flow.mdx#2-database-name).  
...
3. **Backup Directory**  
   Select the file location that you set when you [created your backup](../tasks/backup-task.mdx).  
...
4. **Disable ongoing tasks after restore**  
   Disabling will likely require [ongoing tasks](../tasks/ongoing-tasks/general-info.mdx) to be created again.  
...
using the "Add node" button in the [Manage group](../settings/manage-database-group.mdx#database-group-topology---actions) 
Studio view.
