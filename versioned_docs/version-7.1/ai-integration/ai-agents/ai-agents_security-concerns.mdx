...
* **Mitigation: Agent parameters**  
  You can use [agent parameters](../../ai-integration/ai-agents/overview#query-parameters) to limit the scope of the defined query and the dataset subsequently transferred to the AI model.  
