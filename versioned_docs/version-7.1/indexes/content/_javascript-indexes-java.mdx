...
(Read more about AbstractIndexCreationTask [here](../creating-and-deploying.mdx#Using-AbstractIndexCreationTask).)
...
Read more about map indexes [here](../map-indexes.mdx).
...
Read more about multi map indexes [here](../map-reduce-indexes.mdx).
...
Read more about map reduce indexes [here](../multi-map-indexes.mdx).
