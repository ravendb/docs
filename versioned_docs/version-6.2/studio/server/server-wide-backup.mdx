...
* Server-Wide backups are similar to their per-database equivalents.  
  You can create [Full](../../client-api/operations/maintenance/backup/backup.mdx#full-backup) 
  and [Incremental](../../client-api/operations/maintenance/backup/backup.mdx#incremental-backup) backup tasks 
  in [Logical Backup ](../../client-api/operations/maintenance/backup/backup.mdx#logical-backup) or 
  [Snapshot](../../client-api/operations/maintenance/backup/backup.mdx#snapshot) format, and store your 
...
2. **Backup type**  
   Select 'Backup' for a [logical backup](../../client-api/operations/maintenance/backup/backup.mdx#logical-backup) 
   or 'Snapshot' for a [snapshot image](../../client-api/operations/maintenance/backup/backup.mdx#snapshot).  
...
### Encryption
   ...
   * Backup files (both [logical backups](../../client-api/operations/maintenance/backup/backup.mdx#logical-backup) 
     and [snapshot images](../../client-api/operations/maintenance/backup/backup.mdx#snapshot)) 
...
To edit or modify a Server-Wide task, navigate back to the [Server-Wide Backup view](../../client-api/operations/maintenance/backup/backup.mdx#scheduling-a-server-wide-backup-task).  
