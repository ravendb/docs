...
<Admonition type="note" title="">
This article describes restoring a database using a java client. You can also restore a database using [RavenDB Studio](../../../studio/server/databases/create-new-database/from-backup.mdx).
</Admonition>
