...
* Only [logical](../../backup/overview.mdx#logical-backup) 
  backups are supported. 
  [Snapshot](../../backup/overview.mdx#snapshot-image) 
...
* In this page:  
  * [Restore](#restore)  
     ...
     * [Run `RestoreBackupOperation` with the restore configuration](#run-restorebackupoperation-with-the-restore-configuration)  
     * [Examples](#examples)  
...
[Restore Operation](../../backup/restore.mdx#restorebackupoperation) 
a **configuration object**.  

* The configuration object inherits properties from the `RestoreBackupConfigurationBase` class 
  ([discussed below](#restorebackupconfigurationbase)) and defines additional sharding-specific settings.  
...
* Parameters:
    ...
    | **LastFileNameToRestore** <br/> (Optional – omit for default) | `string` | [Last incremental backup file](../../backup/restore.mdx#lastfilenametorestore---setting-restore-points) to restore. <br/> Ignored when restoring a sharded database. <br/> `SingleShardRestoreSetting.LastFileNameToRestore` used instead, per shard. |
    ...
    | **BackupEncryptionSettings** | `BackupEncryptionSettings` | [Backup Encryption Settings](../../backup/create/periodic-tasks/database-backup.mdx#setting-encryption) |
...
* Read [here](../../backup/restore.mdx) about restoring a non-sharded database.  
* In short, restoring a non-sharded database to a selected restore point 
   ...
   * [RestoreBackupConfiguration.LastFileNameToRestore](../../backup/restore.mdx#lastfilenametorestore---setting-restore-points) with the name of the last incremental backup to restore.  
