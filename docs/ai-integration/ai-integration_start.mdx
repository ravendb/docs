...
<ColGrid colCount={3}>
    ...
    <CardWithImage title="Future-proof your tech stack" description="Where Does GenAI Truly Fit" imgIcon="genai" url="https://www.youtube.com/watch?v=OjEAWHGKyJY" imgIcon="genai" imgAlt="Future-proof your tech stack" ctaLabel="Read" />
</ColGrid>