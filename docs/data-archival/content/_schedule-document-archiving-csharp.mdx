...
<Panel heading="Schedule a SINGLE document for archiving - from the Client API">
...
<Panel heading=" Schedule a SINGLE document for archiving - from the Studio">
...
<Panel heading=" Schedule MULTIPLE documents for archiving - from the Client API">
...
To learn more about the `PatchByQueryOperation`, see [Set-based patch operations](../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx).

</Panel>

<Panel heading="Schedule MULTIPLE documents for archiving - from the Studio">
...
4. You can test the patch on a sample document before executing the whole operation.  
   Learn more in [Test patch](../../documents/patching-documents/patch-multiple-documents/patch-view.mdx#test-patch).
