...
* You can create, update, and delay periodic backup tasks using either the client API or via Studio.  
...
* In this article:  
  * [Creating and managing periodic backups using the client API](../../../backup/create/periodic-tasks/database-backup#creating-and-managing-periodic-backups-using-the-client-api)
     * [Creating a periodic backup task](../../../backup/create/periodic-tasks/database-backup#creating-a-periodic-backup-task)
        * [Key configuration settings](../../../backup/create/periodic-tasks/database-backup#key-configuration-settings)
     * [Updating a periodic backup task](../../../backup/create/periodic-tasks/database-backup#updating-a-periodic-backup-task)
     * [Managing backup operations](../../../backup/create/periodic-tasks/database-backup#managing-backup-operations)
        * [Triggering an immediate backup creation](../../../backup/create/periodic-tasks/database-backup#triggering-an-immediate-backup-creation)
     ...
     * [Syntax](../../../backup/create/periodic-tasks/database-backup#syntax)
        * [Backup configuration classes](../../../backup/create/periodic-tasks/database-backup#backup-configuration-classes)
        * [Classes and enums used in the backup configuration](../../../backup/create/periodic-tasks/database-backup#classes-and-enums-used-in-the-backup-configuration)
        * [Backup destinations classes](../../../backup/create/periodic-tasks/database-backup#backup-destinations-classes)
  * [Creating and managing periodic backups via Studio](../../../backup/create/periodic-tasks/database-backup#creating-and-managing-periodic-backups-via-studio)
     * [Creating a periodic backup task](../../../backup/create/periodic-tasks/database-backup#creating-a-periodic-backup-task-1)
      ...
      * [Creating a backup immediately](../../../backup/create/periodic-tasks/database-backup#creating-a-backup-immediately)
...
## Updating a periodic backup task
...
### Triggering an immediate backup creation
...
* To abort a backup that was triggered [manually](../../../backup/create/periodic-tasks/database-backup#triggering-an-immediate-backup-creation) using `StartBackupOperation`:  
...
![Define periodic backup task](./assets/database-periodic_define-task.png)
...
You can use a periodic backup task to create a backup immediately, outside of the tasks's defined schedule.  
