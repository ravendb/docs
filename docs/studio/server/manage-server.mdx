...
* In this page:  
   * [Manage Server menu](#manage-server-menu)  
       * [Configuration options](#1-manage-server-configuration-options)  
       * [Debug options](#2-debug-debugging-and-statistics-options)  
...
* [Cluster](../cluster/cluster-view.mdx)  
...
* [Studio Configuration](../database/settings/studio-configuration.mdx#studio-configuration---server-wide)  
  Set server-wide Studio-related options, applied to all the databases hosted by this server.  
* [Server Settings](./server-settings.mdx)  
  Display settings common to all the databases hosted by this server.  
* [Admin JS Console](./debug/admin-js-console.mdx)  
  Use this console to run JavaScript code, to execute advanced operations on the server.  
* [Certificates](./certificates/server-management-certificates-view.mdx)  
  Export, Import and Customization options for server and client certificates.  
* **Server-Wide Tasks**  
  Define server-wide 
  [External Replication](../database/tasks/ongoing-tasks/external-replication-task.mdx) 
  and [Periodic Backup](../../backup/create/periodic-tasks/database-backup.mdx#creating-and-managing-periodic-backups-via-studio) 
  tasks that apply to all the databases hosted by this server.  
* [Server-Wide Analyzers](../database/settings/custom-analyzers.mdx#server-wide-custom-analyzer-view)  
...
* [Admin Logs](./debug/admin-logs.mdx)  
...
* **Advanced**  
  ...
  [Cluster Observer](./debug/advanced/cluster-observer.mdx).  
