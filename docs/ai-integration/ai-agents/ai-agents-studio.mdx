---
title: "AI Agents Integration: Studio"
hide_table_of_contents: true
sidebar_label: Studio AI Agent Task View
sidebar_position: 1
---
...
* In this article:
   * [Create AI Agent](../../ai-integration/ai-agents/ai-agents-studio.mdx#create-ai-agent)  
   * [Configure basic settings](../../ai-integration/ai-agents/ai-agents-studio.mdx#configure-basic-settings)
   * [Set agent parameters](../../ai-integration/ai-agents/ai-agents-studio.mdx#set-agent-parameters)
   * [Define agent tools](../../ai-integration/ai-agents/ai-agents-studio.mdx#define-agent-tools)
      * [Add new query tool](../../ai-integration/ai-agents/ai-agents-studio.mdx#add-new-query-tool)
      * [Add new action tool](../../ai-integration/ai-agents/ai-agents-studio.mdx#add-new-action-tool)
   * [Set chat persistence](../../ai-integration/ai-agents/ai-agents-studio.mdx#set-chat-persistence)
   * [Configure chat trimming](../../ai-integration/ai-agents/ai-agents-studio.mdx#configure-chat-trimming)
   * [Save and Run your agent](../../ai-integration/ai-agents/ai-agents-studio.mdx#save-and-run-your-agent)
   * [Test your agent](../../ai-integration/ai-agents/ai-agents-studio.mdx#test-your-agent)
      * [Runtime view and Test results](../../ai-integration/ai-agents/ai-agents-studio.mdx#runtime-view-and-test-results)
