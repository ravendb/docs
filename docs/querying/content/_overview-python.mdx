...
* In this article:
  ...
  * [session.advanced.document_query](#session-advanced-documentquery)  
  * [session.advanced.raw_query](#session-advanced-rawquery)
  * [query API](#query-api)  
  * [Syntax](#syntax)  
...
* Queries defined with [query](#session-query) or [document_query](#session-advanced-documentquery) are translated by the RavenDB client to [RQL](../rql/what-is-rql.mdx)  
