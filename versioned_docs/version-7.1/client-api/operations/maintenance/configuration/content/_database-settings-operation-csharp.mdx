...
* In this page:  
  ...
  * [Put database settings operation](#put-database-settings-operation)

  * [Get database settings operation](#get-database-settings-operation)
...
* Note: for the changes to take effect, the database must be **reloaded**.  
  Reloading is accomplished by disabling and enabling the database using [ToggleDatabasesStateOperation](../../../server-wide/toggle-databases-state.mdx).  
