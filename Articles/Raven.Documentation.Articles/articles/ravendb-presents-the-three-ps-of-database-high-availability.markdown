...
{RAW}
<img class="floating-left" alt="RavenDB Presents The Three Ps of Database High Availability" src="/RavenFS/GetImage?filePath=docs/articles/ravendb-presents-the-three-ps-of-database-high-availability-pic1.png" />
{RAW/}
...
{RAW}
<img class="floating-right" alt="RavenDB Presents The Three Ps of Database High Availability" src="/RavenFS/GetImage?filePath=docs/articles/ravendb-presents-the-three-ps-of-database-high-availability-pic2.png" />
{RAW/}
