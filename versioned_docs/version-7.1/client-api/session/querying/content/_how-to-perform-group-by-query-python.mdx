...
* In This Page:  
   * [Group By a Single Field](#group-by-a-single-field)  
   * [Group By Multiple Fields](#group-by-multiple-fields)  
   * [Select Composite GroupBy Key](#select-composite-groupby-key)  
   * [Group By Array](#group-by-array)  
      * [By Array Values](#by-array-values)  
      * [By Array Content](#by-array-content)  
   * [Sorting](#sorting)  
      * [By Count](#by-count)  
      * [By Sum](#by-sum)  
