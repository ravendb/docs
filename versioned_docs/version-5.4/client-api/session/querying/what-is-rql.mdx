...
* In this page:  
  ...
  * [RQL keywords and methods](../../../client-api/session/querying/what-is-rql.mdx#rql-keywords-and-methods)
     ...
     * [`with`](../../../client-api/session/querying/what-is-rql.mdx#with)  
     * [`match`](../../../client-api/session/querying/what-is-rql.mdx#match)
...
- [WHERE](../../../client-api/session/querying/what-is-rql.mdx#where)
    ...
    - [spatial.within()](../../../client-api/session/querying/how-to-make-a-spatial-query.mdx)
    - [spatial.contains()](../../../client-api/session/querying/how-to-make-a-spatial-query.mdx)
    - [spatial.disjoint()](../../../client-api/session/querying/how-to-make-a-spatial-query.mdx)
    - [spatial.intersects()](../../../client-api/session/querying/how-to-make-a-spatial-query.mdx)
...
- [including related documents](../../../client-api/how-to/handle-document-relationships.mdx#includes) or counters in the query response
