...
<TabItem value="working_with_dtc_1" label="working_with_dtc_1">
...
<TabItem value="working_with_dtc_2" label="working_with_dtc_2">
<CodeBlock language="csharp">
{`using (var tx = new TransactionScope())
\{
	using (var session = documentStore.OpenSession())
...
<TabItem value="working_with_dtc_3" label="working_with_dtc_3">
<CodeBlock language="csharp">
{`using (var tx = new TransactionScope())
\{
	using (var session = documentStore.OpenSession())
