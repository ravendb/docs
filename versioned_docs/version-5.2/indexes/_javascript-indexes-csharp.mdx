...
* All other capabilities and features of RavenDB JavaScript indexes are the same as in RavenDB [C# indexes](../indexes/indexing-basics.mdx).   

* In this page:
  * [Creating  JavaScript index](../indexes/javascript-indexes.mdx#creating--javascript-index)
...
`AbstractJavaScriptIndexCreationTask` inherits from [AbstractIndexCreationTask](../indexes/creating-and-deploying.mdx#Using-AbstractIndexCreationTask)
...
Read more about [map-reduce indexes here](../indexes/map-reduce-indexes.mdx).
