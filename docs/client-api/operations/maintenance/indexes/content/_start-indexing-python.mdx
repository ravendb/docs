...
* After indexing has been paused using [StopIndexingOperation](../stop-indexing.mdx),  
...
* When resuming indexing from the **client**:  
  Indexing is resumed on the [preferred node](../../../../configuration/load-balance/overview.mdx#the-preferred-node) only, and Not on all the database-group nodes.  
...
* In this page:
  * [Resume indexing example](#resume-indexing-example)
  * [Syntax](#syntax)
