...
* [Snapshot backups](../../../client-api/operations/maintenance/backup/backup-overview.mdx#snapshot) save [change vector data](../../ongoing-tasks/backup-overview.mdx#backup-contents).
