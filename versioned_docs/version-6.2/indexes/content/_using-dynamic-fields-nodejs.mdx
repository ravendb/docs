...
Dynamic fields can be indexed for [Full-text search](../querying/searching.mdx) by setting `indexing: "Search"` in the `createField` options.
...
| options object  |                    |                                                                                   |
|-----------------|--------------------|-----------------------------------------------------------------------------------|
| **storage**     | `boolean`          | Learn about [storing data](../storing-data-in-index.mdx) in the index. |
