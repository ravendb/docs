...
* When making a [Full-Text Search query](../full-text-search.mdx),  
...
* In this page:
  * [Highlight - basic example](#highlight---basic-example)
      * [Highlight tags](#highlight-tags)
      * [Highlight results in Studio](#highlight-results-in-studio)
  * [Highlight - customize tags](#highlight---customize-tags)
  * [Highlight - projected results](#highlight---projected-results)
  * [Syntax](#syntax)
...
* The html tags that wrap the highlighted terms can be **customized** to any other tags.  
  See [customize tags](#highlight---customize-tags) below.
...
* Highlighting can also be used when [projecting query results](../../how-to-project-query-results.mdx).
