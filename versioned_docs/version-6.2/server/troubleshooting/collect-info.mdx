...
* To maintain a specific setting after a server restart, set the following configuration keys  
  in your [default configuration](../configuration/configuration-options.mdx):
  * Server logs - set [Logs.Mode](../configuration/logs-configuration.mdx#logsmode)
  * Microsoft logs - set [Logs.Microsoft.Disable](../configuration/logs-configuration.mdx#logsmicrosoftdisable)
  * Traffic Watch log - set [TrafficWatch.Mode](../configuration/traffic-watch-configuration.mdx#trafficwatchmode)
...
* Logs deletion time is controlled by the following configurations:
  * [Retention time in hours](../configuration/logs-configuration.mdx#logsretentiontimeinhrs)
  * [Retention time in megabytes](../configuration/logs-configuration.mdx#logsretentionsizeinmb)
