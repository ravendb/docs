...
* From a user's point of view, creating a data subscription is 
  done once, [just like it is done](../data-subscriptions/creating-subscription/creating-subscription_api.mdx) 
...
* [Data Subscriptions Revisions Support](../data-subscriptions/revisions-support.mdx)  
