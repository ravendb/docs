...
description: "Set up a secure RavenDB server on an AWS EC2 Windows VM with Let's Encrypt certificates, firewall rules, and domain configuration."
sidebar_position: 1
---
...
It's recommended to read the [Setup Wizard](../../../start/installation/setup-wizard/overview.mdx) section where you can find a detailed 
...
We will use the [Setup Wizard](../../../start/installation/setup-wizard/overview.mdx), but you can also configure things [manually](../../../start/installation/manual.mdx).
...
You will need to claim your domain, read more [here](../../../start/installation/setup-wizard/choose-security-option.mdx#generate-let-s-encrypt-certificate).
...
Connecting a few servers in a cluster is easy. Follow [these instructions](../../../start/installation/setup-wizard/overview.mdx) to construct a cluster during setup.
