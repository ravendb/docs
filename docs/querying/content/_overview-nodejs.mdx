...
* Queries defined with the `query` method are translated by the RavenDB client to [RQL](../../querying/what-is-rql.mdx)  
...
* Queries defined with [query](../../querying/overview.mdx#session-query) are translated by the RavenDB client to [RQL](../../querying/what-is-rql.mdx) when sent to the server.  
