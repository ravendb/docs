...
3. **Logs directory**:    
   By default, RavenDB stores logs in the `Logs` directory under the extracted `Server` folder.
     ...
     You can customize this location.  
     The value you enter will be written to the _settings.json_ file as the value of the [Logs.Path](../../../monitoring/logging/configuration.mdx#logspath) configuration key.
     ...
     Learn more about the RavenDB logging system in the [Overview](../../../monitoring/logging/overview.mdx) page.      
