...
description: "Activate your RavenDB license key through the Studio UI, configuration file, or CLI to unlock features for your server edition."
...
* In this article:
   * [Activate your license using a configuration key](#activate-your-license-using-a-configuration-key)
   * [Activate your license via Studio](#activate-your-license-via-studio)
