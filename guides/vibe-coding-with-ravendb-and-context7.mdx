...
Fast and easy to build a working prototype without much technical knowledge. But we want more functions, so we tell him the next prompt.
...
What AI created gives us information about top products, which day sells best, or which company is doing best, while also counting revenue, items sold, and orders. It is satisfactory at this point. Now last thing we want to test is sending an automated email. We prompt:
