...
* To learn how to create a new connection string, see [Add Connection String Operation](../add-connection-string.mdx).

* In this page:
  * [Get connection string by name and type](#get-connection-string-by-name-and-type)
  * [Get all connection strings](#get-all-connnection-strings)  
  * [Syntax](#syntax)
...
<Admonition type="note" title="">
A detailed syntax for each connection string type is available in article [Add connection string](../add-connection-string.mdx).
</Admonition>
