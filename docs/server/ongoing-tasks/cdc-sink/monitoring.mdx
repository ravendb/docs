---
title: "Server: Ongoing Tasks: CDC Sink: Monitoring"
sidebar_label: Monitoring
description: "How to monitor CDC Sink task state, fallback mode, runtime statistics, and notifications in RavenDB Management Studio and the Client API."
sidebar_position: 13
---
...
# Server: Ongoing Tasks: CDC Sink: Monitoring
