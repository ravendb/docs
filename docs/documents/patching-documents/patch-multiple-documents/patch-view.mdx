...
3. **Browse sample scripts and methods**  
   ...
   * **Methods** - Browse available script methods and view their signatures, descriptions, and return types.  
   For additional examples, see [Patch multiple documents using the Client API](../../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx#examples).
4. **Apply the patch**  
