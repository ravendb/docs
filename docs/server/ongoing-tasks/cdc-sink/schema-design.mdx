...
\{
    ...
    Columns = [ new() \{ Column = "id", Name = "Id" \}, new() \{ Column = "customer_name", Name = "CustomerName" \} ],
    EmbeddedTables =
    [
...
\{
    ...
    SourceTableName = "orders",
    PrimaryKeyColumns = ["id"],
    Columns = [ new() \{ Column = "id", Name = "Id" \}, new() \{ Column = "customer_id", Name = "CustomerId" \} ],
    LinkedTables =
    [
...
\{
    ...
    Columns = [ new() \{ Column = "company_id", Name = "CompanyId" \}, new() \{ Column = "name", Name = "Name" \} ],
    EmbeddedTables =
    [
        new CdcSinkEmbeddedTableConfig
        \{
            ...
            Columns = [ new() \{ Column = "dept_id", Name = "DeptId" \}, new() \{ Column = "dept_name", Name = "DeptName" \} ],
            EmbeddedTables =
            [
                new CdcSinkEmbeddedTableConfig
                \{
                    ...
                    Columns = [ new() \{ Column = "emp_id", Name = "EmpId" \}, new() \{ Column = "emp_name", Name = "EmpName" \} ]
                \}
            ]
        \}
    ]
