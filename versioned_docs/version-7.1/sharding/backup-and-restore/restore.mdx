...
* In this page:  
  * [Restore](#restore)  
     ...
     * [Define a Restore Configuration](#define-a-restore-configuration)  
         * [`RestoreBackupConfigurationBase`](#section)
     * [Run `RestoreBackupOperation` with the Restore Configuration](#run--with-the-restore-configuration)  
     * [Examples](#examples)  
