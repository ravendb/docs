...
* In this article:
  ...
  * [Client API](../../../server/ongoing-tasks/queue-sink/rabbit-mq-queue-sink.mdx#client-api)
     * [Adding a RabbitMQ connection string](../../../server/ongoing-tasks/queue-sink/rabbit-mq-queue-sink.mdx#adding-a-rabbitmq-connection-string)
     * [Adding a RabbitMQ sink task](../../../server/ongoing-tasks/queue-sink/rabbit-mq-queue-sink.mdx#adding-a-rabbitmq-sink-task)
  * [Configuration Options](../../../server/ongoing-tasks/queue-sink/rabbit-mq-queue-sink.mdx#configuration-options)
  * [Syntax](../../../server/ongoing-tasks/queue-sink/rabbit-mq-queue-sink.mdx#syntax)
     * [Classes](../../../server/ongoing-tasks/queue-sink/rabbit-mq-queue-sink.mdx#classes)
...
Read [below](../../../server/ongoing-tasks/queue-sink/rabbit-mq-queue-sink.mdx#adding-a-rabbitmq-connection-string)
...
* A RabbitMQ queue sink task uses a **RabbitMQ connection string** to connect to its source RabbitMQ broker.  
...
* A RabbitMQ connection string can be created in any of these ways:
  ...
  * **From Studio**:
    ...
    or while creating a [RabbitMQ queue sink task](../../../studio/database/tasks/ongoing-tasks/rabbitmq-queue-sink.mdx#define-a-rabbitmq-sink-task).
...
{
    // The name used by the RabbitMQ queue sink task configuration
...
<Tabs groupId="rabbitmq-sink-connection-string-syntax-gpt">
...
| **RabbitMqConnectionSettings** | `RabbitMqConnectionSettings` | The RabbitMQ-specific connection settings. |
...
| Property | Type | Description |
|---|---|---|
| **ConnectionString** | `string` | The RabbitMQ connection URI, for example `amqp://guest:guest@localhost:5672/`. |
...
[Sink task](../../../server/ongoing-tasks/queue-sink/rabbit-mq-queue-sink.mdx#sink-task)
