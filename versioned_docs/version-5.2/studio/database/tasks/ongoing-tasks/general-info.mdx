...
* Select the preferred task to add  
  ...
  6. adding an [OLAP ETL](../../../../studio/database/tasks/ongoing-tasks/olap-etl-task.mdx) task  
  7. adding a [Backup](../../../../studio/database/tasks/backup-task.mdx) task  
  8. adding a [Subscription](../../../../studio/database/tasks/ongoing-tasks/subscription-task.mdx) task  
