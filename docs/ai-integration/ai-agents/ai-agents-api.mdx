...
* In this article:
   ...
   * [Defining and running an AI agent](../../ai-integration/ai-agents/ai-agents-api.mdx#defining-and-running-an-ai-agent)
      ...
      * [Add agent tools](../../ai-integration/ai-agents/ai-agents-api.mdx#add-agent-tools)
         * [Query tools](../../ai-integration/ai-agents/ai-agents-api.mdx#query-tools)
         * [Action tools](../../ai-integration/ai-agents/ai-agents-api.mdx#action-tools)
      * [Create a Response object and the Agent](../../ai-integration/ai-agents/ai-agents-api.mdx#create-a-response-object-and-the-agent)
   * [Conversations](../../ai-integration/ai-agents/ai-agents-api.mdx#conversations)
      * [Continuous conversations](../../ai-integration/ai-agents/ai-agents-api.mdx#continuous-conversations)
      * [Stored conversations' Prefix and IDs](../../ai-integration/ai-agents/ai-agents-api.mdx#stored-conversations-prefix-and-ids)
      * [Set the conversation](../../ai-integration/ai-agents/ai-agents-api.mdx#set-the-conversation)
      * [Action tools handlers](../../ai-integration/ai-agents/ai-agents-api.mdx#action-tools-handlers)
      * [Conversation reply](../../ai-integration/ai-agents/ai-agents-api.mdx#conversation-reply)
      * [Set user prompt and run the conversation](../../ai-integration/ai-agents/ai-agents-api.mdx#set-user-prompt-and-run-the-conversation)
