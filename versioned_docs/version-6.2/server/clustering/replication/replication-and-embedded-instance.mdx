...
## Overview
[Replication](../../../server/clustering/replication/replication.mdx) works by using long-living TCP connections between cluster nodes, or in case of [External Replication](../../../server/ongoing-tasks/external-replication.mdx) instances external to the cluster. 
