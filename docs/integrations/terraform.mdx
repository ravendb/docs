...
* In this page:  
  ...
  * [Prepare Terraform Configuration](#prepare-terraform-configuration)  
     * [Provider](#provider)  
     * [Terraform Local Parameters](#terraform-local-parameters)  
     * [RavenDB Resource](#ravendb-resource)  
     * [Terraform Output Values](#terraform-output-values)  
...
* **RavenDB license**  
   ...
   * The license you acquire will be provided to RavenDB via the 
     [Terraform configuration file](#prepare-terraform-configuration) 
...
* **Terraform Configuration File**  
   ...
   * Read [below](#prepare-terraform-configuration) 
...
defined in the [resource](#ravendb-resource) 
