---
title: "Monitoring: JSON Monitoring Endpoints"
...
# Monitoring: JSON Monitoring Endpoints
...
* RavenDB also exposes a
  [Prometheus endpoint](../monitoring/integrations/prometheus.mdx#ravendb-prometheus-endpoint)
