...
* Sharded databases are backed up using user-defined periodic 
  [backup tasks](../../server/ongoing-tasks/backup-overview.mdx).  
...
* Both [Full](../../server/ongoing-tasks/backup-overview.mdx#full-backup) 
  and [Incremental](../../server/ongoing-tasks/backup-overview.mdx#incremental-backup) 
  backups can be created for a sharded database.  

* A [logical](../../server/ongoing-tasks/backup-overview.mdx#logical-backup) 
...
* After a user defines a backup task, RavenDB automatically creates 
  ...
  from the user.  
* Each shard appoints [one of its nodes](../overview.mdx#shard-replication) 
...
* **Local Backup**  
  ...
  using the node's local storage.  
    ...
    [Restoring](./restore.mdx#section-2) 
...
[database-level and cluster-level content](../../server/ongoing-tasks/backup-overview.mdx#backup-contents).  
</Admonition>
...
* Backup files created for a sharded database generally follow the same naming 
  [convention](../../server/ongoing-tasks/backup-overview.mdx#backup-name-and-folder-structure) 
...
[will fail](../../migration/client-api/client-breaking-changes.mdx#casting-smuggler-results).  
</Admonition>
...
| Create [Full](../../server/ongoing-tasks/backup-overview.mdx#full-backup) backups for sharded databases | **Yes** |  |
| Create [Incremental](../../server/ongoing-tasks/backup-overview.mdx#incremental-backup) backups for sharded databases | **Yes** |  |
| Create [Logical](../../server/ongoing-tasks/backup-overview.mdx#logical-backup) backups for sharded databases | **Yes** |  |
