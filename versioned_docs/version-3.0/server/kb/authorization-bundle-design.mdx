---
title: "KB: Bundles: Authorization Bundle Design"
sidebar_label: Bundles "":"" Authorization bundle design notes
sidebar_position: 1
---
...
This design is written before the code, it reflect the general principles of how I intend to approach the problem, but it is not a binding design, things will change.
</Admonition>
...
![Figure 1: Authorization Bundle](./assets/authorization_bundle_faq.png)
...
<TabItem value="authorization_bundle_design_1" label="authorization_bundle_design_1">
