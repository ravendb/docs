...
<TabItem value="OnBeforeRequestEvent" label="OnBeforeRequestEvent">
<CodeBlock language="csharp">
{`private void OnBeforeRequestEvent(object sender, BeforeRequestEventArgs args)
\{
...
<TabItem value="SubscribeToOnBeforeRequest" label="SubscribeToOnBeforeRequest">
<CodeBlock language="csharp">
...
<TabItem value="OnSucceedRequestEvent" label="OnSucceedRequestEvent">
<CodeBlock language="csharp">
{`private void OnSucceedRequestEvent(object sender, SucceedRequestEventArgs args)
\{
...
`}
    ...
    To subscribe to the event:  
<TabItem value="SubscribeToOnSucceedRequest" label="SubscribeToOnSucceedRequest">
<CodeBlock language="csharp">
{`// Subscribe to the event
...
<TabItem value="OnSessionCreatedEvent" label="OnSessionCreatedEvent">
<CodeBlock language="csharp">
{`private void OnSessionCreatedEvent(object sender, SessionCreatedEventArgs args)
\{
...
`}
    ...
    To subscribe to the event:  
<TabItem value="SubscribeToOnSessionCreated" label="SubscribeToOnSessionCreated">
<CodeBlock language="csharp">
{`// Subscribe to the event
...
<TabItem value="OnFailedRequestEvent" label="OnFailedRequestEvent">
<CodeBlock language="csharp">
{`private void OnFailedRequestEvent(object sender, FailedRequestEventArgs args)
\{
...
`}
    ...
    To subscribe to the event:  
<TabItem value="SubscribeToOnFailedRequest" label="SubscribeToOnFailedRequest">
<CodeBlock language="csharp">
{`// Subscribe to the event
...
<TabItem value="OnTopologyUpdatedEvent" label="OnTopologyUpdatedEvent">
<CodeBlock language="csharp">
...
`}
    ...
    To subscribe to the event:  
<TabItem value="SubscribeToOnTopologyUpdated" label="SubscribeToOnTopologyUpdated">
<CodeBlock language="csharp">
{`// Subscribe to the event
