...
* In this page:  
  ...
  * [Managing Counters](#managing-counters)  
      ...
      * [Managing Counters using `Operations`](#managing-counters-using-)
</Admonition>
## Why use Counters?
...
<Admonition type="note" title="">
Note that the Counter names are stored in the document metadata and [do impact the size of the document](#counters-cost).  
</Admonition>
