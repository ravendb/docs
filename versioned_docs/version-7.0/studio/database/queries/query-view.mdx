...
* Use the **Query View** to run [RQL](../../../client-api/session/querying/what-is-rql.mdx) queries and view their results.  
...
* A query on a collection with some filtering condition will create an **Auto-Index** (Dynamic Query).  
  See [Index Types](../../../studio/database/indexes/indexes-overview.mdx#index-types) for details.  
...
* In this page:  
  ...
  * [Query Results](../../../studio/database/queries/query-view.mdx#query-results)  
      * [Select Visible Columns](../../../studio/database/queries/query-view.mdx#select-visible-columns)  
      * [Result Columns](../../../studio/database/queries/query-view.mdx#result-columns)  
  * [Additional Query Options](../../../studio/database/queries/query-view.mdx#additional-query-options)  
...
3. **Syntax Samples**  
   Click to display [RQL](../../../client-api/session/querying/what-is-rql.mdx) syntax samples.  
4. **Query Box**  
   ...
   ![Query Settings](./assets/query-view-settings.png)  
     ...
     * b. **Disable creating new Auto-Indexes**  
          ...
          * Toggling this ON will not affect Auto-Index creation in future Studio queries.
            To disable all future Auto-Index creation from Studio queries, change the default setting in [Studio Configuration](../../../studio/database/settings/studio-configuration.mdx#disabling-auto-index-creation-on-studio-queries-or-patches)
...
9. **Query Results**  
   The results area displays selected columns of results retrieved by your query (see [below](../../../studio/database/queries/query-view.mdx#query-results)).  
...
4. **Statistics**  
    ...
    * The index used by this query.  
      ...
      used [for collection queries](../../../client-api/faq/what-is-a-collection.mdx#collection-usages).  
...
To modify the displayed result columns, open the Display drop-down dialog from the [Query Results](../../../studio/database/queries/query-view.mdx#query-results) view.  
...
2. **Document ID**  
   Click the ID to open this document in the [Document View](../../../studio/database/documents/document-view.mdx),  
   -or-  
...
* [Time Series Query](../../../document-extensions/timeseries/overview.mdx) results provide insight 
  into your time-series data, including a graph view over time.  
  Learn more about it [here](../../../studio/database/document-extensions/time-series.mdx#querying-time-series).  
* [Spatial Query](../../../studio/database/queries/spatial-queries-map-view.mdx) results include 
  a Spatial Map Tab that [displays geographical locations](../../../studio/database/queries/spatial-queries-map-view.mdx#spatial-map-view) 
  on the world map.  
* [Graph Query](../../../indexes/querying/graph/graph-queries-overview.mdx) also present query results 
  [graphically](../../../indexes/querying/graph/graph-queries-overview.mdx#creating-graph-queries) in an additional tab.  
* [Counter Query](../../../document-extensions/counters/counters-and-other-features.mdx#counters-and-queries) can be used to get counters data.  
