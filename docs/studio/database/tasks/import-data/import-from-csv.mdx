...
description: "Import CSV data into RavenDB documents through Studio with automatic field mapping, type detection, and collection assignment configuration."
sidebar_position: 2
---
...
6. **Import to Collection**  
   ...
   When running an [RQL](../../../../querying/rql/what-is-rql.mdx) query, the code `from` often refers to 
