...
The answer to that is that RavenDB contains built-in support for indexing hierarchies, and you can take advantage of the `Recurse()` method (or `recurse()` in JavaScript) to define an index using the following syntax:
