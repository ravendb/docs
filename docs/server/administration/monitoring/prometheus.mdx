...
* In this page:  
   ...
   * [RavenDB Prometheus Endpoint](#ravendb-prometheus-endpoint)  
       * [Omit or Include Selected Metrics](#omit-or-include-selected-metrics)  
       * [Metrics Provided by the Prometheus Endpoint](#metrics-provided-by-the-prometheus-endpoint)  
   * [Using the RavenDB Endpoint by a Prometheus Server](#using-the-ravendb-endpoint-by-a-prometheus-server)  
       * [Fetching Additional RavenDB Information](#fetching-additional-ravendb-information)  
...
* As prometheus handles only numeric values, the endpoint outputs all values as numbers, 
  ...
  Metrics values are also explained in the [table below](#metrics-provided-by-the-prometheus-endpoint).  
