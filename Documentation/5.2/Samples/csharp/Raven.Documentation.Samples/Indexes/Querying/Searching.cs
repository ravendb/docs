            ...
            using (var store = new DocumentStore())
            {
                using (var session = store.OpenSession())
                {
                    ...
                    List<Employee> employees = session
                        ...
                        .Query<Employees_ByNotes.IndexEntry, Employees_ByNotes>()
                         // * Query index-field 'EmployeeNotes' with a 'Where' predicate.
                         // * Search criteria can use any of the terms generated by the analyzer.
                        .Where(x => x.EmployeeNotes == "College")
                        .OfType<Employee>()
                        .ToList();
                    
                    // * Results will contain all Employee documents that have 'College' in their 'Notes' field.
                ...
                using (var session = store.OpenSession())
                {
                    ...
                    List<Employee> employees = session.Advanced
                        ...
                        .DocumentQuery<Employees_ByNotes.IndexEntry, Employees_ByNotes>()
                         // * Query index-field 'EmployeeNotes' with a 'Where' predicate.
                         // * Search criteria can use any of the terms generated by the analyzer.
                        .WhereEquals(x => x.EmployeeNotes, "College")
                        .OfType<Employee>()
                        .ToList();
                ...
                using (var session = store.OpenSession())
                {
                    ...
                    List<Employee> employees = session
                         // Query the index
                        .Query<Employees_ByNotes.IndexEntry, Employees_ByNotes>()
                         // * Query index-field 'EmployeeNotes' with 'Search' method.
                         // * Search criteria can use any of the terms generated by the analyzer.
                        .Search(x => x.EmployeeNotes, "German")
                        .OfType<Employee>()
                        .ToList();
                    
                    // * Results will contain all Employee documents that have 'German' in their 'Notes' field.
                    // * Search is case-sensitive since field was indexed using the 'WhitespaceAnalyzer'
                    //   which preserves casing.
                    #endregion
                }
