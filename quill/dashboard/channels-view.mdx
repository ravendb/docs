...
* A paused Slack bot stops answering:  
...
* A paused Discord bot stops answering, and appears offline on Discord:  
...
* A deleted Telegram bot channel stops the bot:  
  ...
  See [Channels: Telegram bot](../channels/telegram-bot.mdx#pausing-and-deleting-the-channel).
* A deleted Slack bot channel stops the bot:  
  ...
  new request URL.  
  See [Channels: Slack bot](../channels/slack-bot.mdx#pausing-and-deleting-the-channel).
* A deleted Discord bot channel stops the bot:  
