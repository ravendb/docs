...
Get a time series (e.g. [using `TimeSeriesFor.Get`](../../client-api/session/get/get-entries.mdx)), 
...
found [here](../../../../querying/stream-query-results.mdx).  
...
| Parameters | Type | Description |
| - | - | - |
| **query** | [IQueryable](../../../../querying/overview.mdx#session-query), [IDocumentQuery](../../../../querying/overview.mdx#session-advanced-documentquery) or [IRawDocumentQuery](../../../../querying/overview.mdx#session-advanced-rawquery) | Query to stream results for. |
