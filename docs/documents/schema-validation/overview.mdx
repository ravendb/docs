...
* Validation is enforced both when documents are saved directly, and when they are added or modified via [supported batch operations](#a-list-of-operations-that-trigger-validation) such as patching or ETL tasks.
...
* In this article:  
   ...
   * [A list of operations that trigger validation](#a-list-of-operations-that-trigger-validation)  
   * [Available constraints](#available-constraints)  
   * [Considerations](#considerations)
   * [Auditing schema validation](#auditing-schema-validation)  
   * [Use cases](#use-cases)
