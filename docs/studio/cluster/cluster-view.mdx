...
* Using the Raft consensus protocol, the cluster distributes work among the various nodes, handles failures, recovery, and more.  
  The cluster Member nodes elect a [Leader](#cluster-nodes-types) - a node that manages the cluster state.  
...
* In this page:  
  * [Cluster View Stats](#cluster-view-stats)  
  * [Cluster View Operations](#cluster-view-operations)  
  * [Reassign Cores](#reassign-cores)  
  * [Cluster Nodes Types](#cluster-nodes-types)  
  * [Cluster Nodes States & Types Flow](#cluster-nodes-states--types-flow)  
  * [Cluster-Wide operation -vs- Database Operations](#cluster-wide-operation--vs--database-operations)  
</Admonition>
## Cluster View Stats
