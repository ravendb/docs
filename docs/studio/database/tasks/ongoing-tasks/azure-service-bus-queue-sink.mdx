...
* In this article:  
  * [Add a Database Task](#add-a-database-task)  
  * [Define an Azure Service Bus Sink Task](#define-an-azure-service-bus-sink-task)  
...
4. **Set responsible node** (Optional)  
   * Select a node from the [Database Group](../../settings/manage-database-group.mdx) to be responsible for this task, e.g., node `A`.  
...
5. **Connection String**  
   ...
   Learn about the three authentication methods [below](#authentication-methods).  
