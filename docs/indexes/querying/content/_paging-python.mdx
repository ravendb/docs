...
* By default, if the number of returned results exceeds **2048**, the server will issue a ["Page size too big"](../../../monitoring/alerts-and-notifications/performance-hints.mdx#paging) notification (visible in Studio) with information about the query.

* This threshold can be customized by modifying the value of the [PerformanceHints.MaxNumberOfResults](../../../monitoring/alerts-and-notifications/configuration.mdx#performancehintsmaxnumberofresults) configuration key.
