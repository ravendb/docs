...
* This page explains how to pass a license to a RavenDB server that runs in a Docker container or under a Linux or a Unix system.  
...
* In this page:  
  ...
  * [Licensing a RavenDB docker image](../licensing/license-under-docker.mdx#licensing-a-ravendb-docker-image)  
     ...
     * [Passing a License via `settings.json`](../licensing/license-under-docker#passing-a-license-via-settingsjson)  
