...
Learn about patching in: [Patching single document](../../../documents/patching-documents/patch-a-single-document/api-overview.mdx) and [Patching multiple documents](../../../documents/patching-documents/patch-multiple-documents/patch-multiple-documents.mdx).
