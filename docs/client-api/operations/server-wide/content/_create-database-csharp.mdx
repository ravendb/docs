...
| **ElasticSearchConnectionStrings** | `Dictionary<string, ElasticSearchConnectionString>` | Define [ElasticSearch Connection Strings](../../../../server/ongoing-tasks/etl/elasticsearch.mdx#add-an-elasticsearch-connection-string), keyed by name.                                                                                       |
...
| **OlapConnectionStrings**          | `Dictionary<string, OlapConnectionString>`          | Define [OLAP Connection Strings](../../../../server/ongoing-tasks/etl/olap.mdx#add-an-olap-connection-string), keyed by name.                                                                                                         |
...
| **RavenConnectionStrings**         | `Dictionary<string, RavenConnectionString>`         | Define [Raven Connection Strings](../../../../server/ongoing-tasks/etl/raven.mdx#add-a-ravendb-connection-string), keyed by name.                                                                                                      |
...
| **SnowflakeConnectionStrings**     | `Dictionary<string, SnowflakeConnectionString>`     | Define [Snowflake Connection Strings](../../../../server/ongoing-tasks/etl/snowflake.mdx#add-a-snowflake-connection-string), keyed by name.                                                                                                |
...
| **SqlConnectionStrings**           | `Dictionary<string, SqlConnectionString>`           | Define [SQL Connection Strings](../../../../server/ongoing-tasks/etl/sql.mdx#add-an-sql-connection-string), keyed by name.                                                                                                           |
