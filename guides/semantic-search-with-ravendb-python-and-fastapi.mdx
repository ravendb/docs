...
<Image img={require("./assets/semsearch1.webp")} alt="" />
<Image img={require("./assets/semsearch2.webp")} alt="" />
...
<Image img={require("./assets/semsearch3.webp")} alt="" />
...
<Image img={require("./assets/semsearch4.webp")} alt="" />
...
<Image img={require("./assets/semsearch5.webp")} alt="" />
<Image img={require("./assets/semsearch6.webp")} alt="" />
In the studio, RavenDB created a separate collection for embeddings and cached terms:  
<Image img={require("./assets/semsearch7.webp")} alt="" />
