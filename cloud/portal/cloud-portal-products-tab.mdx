...
5.  **Storage**  
  ...
  Learn more about them in the [Scaling](../cloud-scaling.mdx#scaling---change-storage) page.  
  
6.  **Payment model**  
  Choose your payment model and commitment.  
  Learn more about them in the [Pricing, Payment and Billing](../cloud-pricing-payment-billing.mdx) page.  
