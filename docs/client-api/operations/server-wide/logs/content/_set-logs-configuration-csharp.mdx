...
* After the server is up and running,  
  ...
  * From the **Studio** - see: [Admin Logs view](../../../../../studio/server/debug/admin-logs.mdx).

* Learn more about RavenDB's logging system in the [Logging](../../../../../monitoring/logs/overview.mdx) article. 
    
* In this article:
    * [Set logs configuration](../../../../../client-api/operations/server-wide/logs/set-logs-configuration.mdx#set-logs-configuration)
    * [Set Microsoft logs configuration](../../../../../client-api/operations/server-wide/logs/set-logs-configuration.mdx#set-microsoft-logs-configuration)
    * [Set Admin logs configuration](../../../../../client-api/operations/server-wide/logs/set-logs-configuration.mdx#set-admin-logs-configuration)
    * [Syntax](../../../../../client-api/operations/server-wide/logs/set-logs-configuration.mdx#syntax)
...
* Setting `persist` to `true` in the operation will persist **only the minimum level** to the `settings.json` file.    
  The value will be written under the [Logs.MinLevel](../../../../../server/configuration/logs-configuration.mdx#logsminlevel) configuration key.  
...
* To learn how to use NLog for log filtering and routing, see: [Configuring and using NLog](../../../../../monitoring/logs/overview.mdx#configuring-and-using-nlog).
...
* To persist this minimum level to the _settings.json file_, set `persist` to `true`.  
  The value will be written under the [Logs.Microsoft.MinLevel](../../../../../server/configuration/logs-configuration.mdx#logsmicrosoftminlevel) configuration key.  
...
* The admin logs are displayed in the **Admin Logs view** in the Studio, under the [Logs on this view](../../../../../studio/server/debug/admin-logs.mdx#logs-on-this-view) section.  
