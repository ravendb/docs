...
* Queries defined using `query` or `documentQuery` are **translated by the RavenDB client to [RQL](../../querying/rql/what-is-rql.mdx)** when sent to the server.  
...
* The entities returned by the query are 'loaded' and **tracked** by the [session](../../client-api/session/what-is-a-session-and-how-does-it-work.mdx).  
  Entities will Not be tracked when:  
    ...
    * Tracking is [disabled](../../querying/customize-query.mdx#notracking)  

* Query results are **cached** by default.  
  To disable query caching see [NoCaching](../../querying/customize-query.mdx#nocaching).
...
* Although you can explicitly call `documentQuery`, in the **PHP** client API, the `query` and `documentQuery` methods provide **identical functionality**.
  Learn more in:  
...
* The following example shows a simple `documentQuery` and its RQL statement.        
...
$employees = $session
    ->advanced()->documentQuery(Employee::class) 
    // Query for all 'Employee' documents that match this predicate
    ->whereEquals("FirstName", "Robert")    
    // Execute the query
    ->toList();
...
* Queries defined with [query](../../querying/overview.mdx#session-query) 
  ...
  are translated by the RavenDB client to [RQL](../../querying/rql/what-is-rql.mdx)  
...
- [aggregateUsing](../../client-api/session/querying/how-to-perform-a-faceted-search.mdx)
- andAlso
...
- openSubclause
- [orderBy](../../querying/sorting-query-results/sort-query-results.mdx)
- [orderByDescending](../../querying/sorting-query-results/sort-query-results.mdx)
...
- [orderByScore](../../querying/sorting-query-results/sort-query-results.mdx#order-by-score)
- [orderByScoreDescending](../../querying/sorting-query-results/sort-query-results.mdx#order-by-score)
- orElse
...
- [relatesToShape](../../client-api/session/querying/how-to-make-a-spatial-query.mdx#search-by-shape)
...
- [whereLucene](../../querying/filtering-query-results/filter-with-lucene-syntax.mdx)
- whereNotEquals
