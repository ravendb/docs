...
description: "Use attachments, counters, time series, and revisions with RavenDB sharded databases — understand co-location rules and limitations."
...
* [Document extensions](../document-extensions/overview.mdx) are 
