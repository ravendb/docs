...
* In this page:
    * [Order by index-field value](#order-by-index-field-value)  
    * [Order results when index-field is searchable](#order-results-when-index-field-is-searchable)  
...
* **When configuring an index-field** for [full-text search](../searching.mdx), 
  the content of the index-field is broken down into terms at indexing time. 
  The specific tokenization depends on the [analyzer](../../using-analyzers.mdx) used.
