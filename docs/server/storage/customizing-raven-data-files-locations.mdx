...
* The structure of [RavenDB directories](./directory-structure.mdx) **cannot** be changed. However:  
...
* [Voron components](./directory-structure.mdx#voron-storage-environment) operate concurrently.  
...
* __System temporary files__  
  ...
  Customize the path for these files by setting the [Storage.TempPath](../configuration/storage-configuration.mdx#storagetemppath) configuration option.  
...
* __Indexes temporary files__  
  ...
  Customize the path for these files by setting the [Indexing.TempPath](../configuration/indexing-configuration.mdx#indexingtemppath) configuration option.  
...
* __Backup temporary files__  
  ...
  Customize the path for these files by setting the [Backup.TempPath](../../backup/configuration.mdx#backuptemppath) configuration option.  

<Admonition type="note" title="">

Refer to article [Configuration overview](../configuration/configuration-options.mdx) to learn how to set the configuration keys.
...
* To help automate the process, we have added the [on directory initialize](../configuration/storage-configuration.mdx#storageondirectoryinitializeexec) configuration option.  
...
* RavenDB will invoke the process with the following params:
    ...
    * Params passed by the user: 
        * User arguments - optional params, set in the [optional user arguments](../configuration/storage-configuration.mdx#storageondirectoryinitializeexecarguments) configuration option
...
After the script is run, the Indexes link will reside under the Database directory (See [Directory Structure](./directory-structure.mdx)).  
