...
* Using the Raft consensus protocol, the cluster distributes work among the various nodes, handles failures, recovery, and more.  
  The cluster Member nodes elect a [Leader](../../server/cluster/cluster-view.mdx#cluster-nodes-types) - a node that manages the cluster state.  
...
* In this page:  
  * [Cluster View Stats](../../server/cluster/cluster-view.mdx#cluster-view-stats)  
  * [Cluster View Operations](../../server/cluster/cluster-view.mdx#cluster-view-operations)  
  * [Cluster Nodes Types](../../server/cluster/cluster-view.mdx#cluster-nodes-types)  
  * [Cluster Nodes States & Types Flow](../../server/cluster/cluster-view.mdx#cluster-nodes-states-&-types-flow)  
  * [Cluster-Wide operation -vs- Database Operations](../../server/cluster/cluster-view.mdx#cluster-wide-operation--vs--database-operations)  
</Admonition>
## Cluster View Stats
...
![Figure 3. States Flow](./assets/cluster-states.png)
