...
* Queries defined with `Query` or `DocumentQuery` are translated by the RavenDB client to [RQL](../../querying/what-is-rql.mdx)  
...
* Queries defined with [Query](../../querying/overview.mdx#session-query) or [DocumentQuery](../../querying/overview.mdx#session-advanced-documentquery) are translated by the RavenDB client to [RQL](../../querying/what-is-rql.mdx)  
  when sent to the server.
