...
* Use `TimeSeriesFor.Get` to retrieve a range of entries from a **single** time series.  
  ...
  use the [GetMultipleTimeSeriesOperation](../../../operations/get.mdx#getmultipletimeseriesoperation) operation.
...
* When getting the time series entries,  
  ...
  Learn more [below](#include-parent-and-tagged-documents).
...
* Calling `TimeSeriesFor.Get` will result in a trip to the server unless the series' parent document was loaded  
  ...
  Learn more in: [Including time series](../../include/overview.mdx).

* In this page:  
  * [`Get` usage](#get-usage)
  * [Examples](#examples)
     * [Get all entries](#get-all-entries)
     * [Get range of entries](#get-range-of-entries)
     * [Get entries with multiple values](#get-entries-with-multiple-values)
  * [Include parent and tagged documents](#include-parent-and-tagged-documents)
  * [Syntax](#syntax)
...
* Since each time series entry contains multiple StockPrice values,  
  we include a sample that uses [named time series values](../../../named-time-series-values.mdx) 
...
* When retrieving time series entries using `TimeSeriesFor.Get`,  
  you can include the series' parent document and/or documents referred to by the entries [tags](../../../../overview.mdx#tags).  
...
* **`TimeSeriesEntry<TValues>[]`** - Time series values that can be referred to [by name](../../../named-time-series-values.mdx).
