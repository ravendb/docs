...
* In this page:  
  * [Syntax](#syntax)  
      * [RevisionsCollectionConfiguration](#revisionscollectionconfiguration)  
      * [RevisionsConfiguration](#revisionsconfiguration)  
      * [ConfigureRevisionsOperation](#configurerevisionsoperation)  
  * [Example](#example)  
...
[1.](#revisionscollectionconfiguration) 
...
default values listed in the table [above](#revisionscollectionconfiguration) 
are applied.  
