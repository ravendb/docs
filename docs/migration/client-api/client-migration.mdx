...
* In this article:
   * [Client migration to RavenDB `7.x`](#client-migration-to-ravendb-7x)
...
* But if you want to connect the client to a server of version `5.4` or earlier, 
  ...
  [See how to switch the algorithm to Gzip](./previous-versions-client-breaking-changes.mdx#http-compression-algorithm-is-now-zstd-by-default)
  </Admonition>
