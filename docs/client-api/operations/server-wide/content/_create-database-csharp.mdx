...
| **SnowflakeConnectionStrings**     | `Dictionary<string, SnowflakeConnectionString>`     | Define [Snowflake Connection Strings](../../../../client-api/operations/maintenance/connection-strings/add-connection-string.mdx#add-a-snowflake-connection-string), keyed by name.                                                                                                |
