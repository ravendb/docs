...
{/* TODO before publication - See RavenDB-27224:
Do not document how a.<domain> resolves publicly or inside the container until the implementation is complete and verified.
Recheck whether a.<domain> must be included in the DNS update command and the record-verification steps.
*/}
