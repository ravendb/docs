...
See the different methods of [creating custom analyzers](../indexes/using-analyzers.mdx#creating-custom-analyzers).  
</Admonition>
...
3. Adding it [directly to RavenDB's binaries](../indexes/using-analyzers.mdx#adding-an-analyzer-to-the-binaries)  
