...
description: "Set RavenDB database-level configuration options for concurrent operations, document size limits, and database idle timeout behavior."
sidebar_position: 6
---
...
(set by [Databases.MaxConcurrentLoads](../../server/configuration/database-configuration.mdx#databasesmaxconcurrentloads)).  
...
for the period set by [Databases.ConcurrentLoadTimeoutInSec](../../server/configuration/database-configuration.mdx#databasesconcurrentloadtimeoutinsec).
