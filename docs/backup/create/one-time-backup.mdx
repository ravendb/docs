...
* Database backups are typically scheduled using [periodic backup tasks](./periodic-tasks/database-backup.mdx) and created automatically according to the defined schedule.  
...
| Property | Type | Description |
|----------|------|-----------------------------------------------------------------------------|
| **FolderPath** | `string` | Path to a local folder.<br />When set, backups are kept in this path and will [not be deleted](../overview.mdx#upload-mode). |
...
[Triggering a regular backup task to run a backup operation immediately](./periodic-tasks/database-backup.mdx#triggering-an-immediate-backup-operation)  
[Triggering a server-wide derived task to run a backup operation immediately](./periodic-tasks/server-wide-backup.mdx#triggering-an-immediate-backup-operation)  
...
2. **Backup type**  
   Select the type of backup to create:
    - **Backup** - create a [logical backup](../overview.mdx#logical-backup).  
    - **Snapshot** - create a [snapshot image](../overview.mdx#snapshot-image).  
...
[Triggering a regular backup task to run a backup operation immediately](./periodic-tasks/database-backup.mdx#running-a-backup-operation-immediately)  
[Triggering a server-wide derived task to run a backup operation immediately](./periodic-tasks/server-wide-backup.mdx#running-a-backup-operation-immediately)  
