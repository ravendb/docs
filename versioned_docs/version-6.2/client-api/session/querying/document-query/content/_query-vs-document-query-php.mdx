...
* In this page:
   ...
   * [`query `and `documentQuery` equivalents](#queryand-documentquery-equivalents)

</Admonition>
## API support

* `query` and `documentQquery` queries are translated to RQL and sent to the server.  
* Available _query_ methods are listed [here](../../how-to-query.mdx#custom-methods-and-extensions-for-linq).  
* Available _documentQuery_ methods and extensions are listed [here](../what-is-document-query.mdx#custom-methods-and-extensions).  
