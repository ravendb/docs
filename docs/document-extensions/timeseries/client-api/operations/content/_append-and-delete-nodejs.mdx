...
* To Append and Delete multiple time series entries on multiple documents, see [PatchByQueryOperation](../patch.mdx#patchbyqueryoperation).
...
* In this page:  
   ...
   * [Examples](#examples)
       ...
       * [Append & delete entries in the same batch](#append--delete-entries-in-the-same-batch)
   * [Syntax](#syntax)
...
**Note**:
   ...
   * Delete actions are executed **before** Append actions. As seen in [this example](#append--delete-entries-in-the-same-batch).
