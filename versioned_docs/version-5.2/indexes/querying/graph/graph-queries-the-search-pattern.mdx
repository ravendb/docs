...
sidebar_label: The Search Pattern
sidebar_position: 1
---
...
integrated [RQL](../../../client-api/session/querying/what-is-rql.mdx) commands.  
...
* In this page:  
  * [Data Nodes](../../../indexes/querying/graph/graph-queries-the-search-pattern.mdx#data-nodes)  
  * [Edges](../../../indexes/querying/graph/graph-queries-the-search-pattern.mdx#edges)  
     * [Edges Are Directional](../../../indexes/querying/graph/graph-queries-the-search-pattern.mdx#edges-are-directional)  
     * [Complex Edges](../../../indexes/querying/graph/graph-queries-the-search-pattern.mdx#complex-edges)  
  * [Aliases](../../../indexes/querying/graph/graph-queries-the-search-pattern.mdx#aliases)  
     * [What Are Aliases For?](../../../indexes/querying/graph/graph-queries-the-search-pattern.mdx#what-are-aliases-for)  
     * [Aliases Scope](../../../indexes/querying/graph/graph-queries-the-search-pattern.mdx#aliases-scope)  
...
([cluster nodes](../../../glossary/cluster-node.mdx#glossary-ravendb-cluster-node)).  
</Admonition>
...
the non-graph query [from orders](../../../client-api/session/querying/what-is-rql.mdx#from) would:  
`match (Orders)`  

Resulting in this pile of orders:  

![Simple Query: Graphical View](./assets/SearchPattern_001_SimplestQuery.png)

* A data node is a document.  
  Graph queries can locate nodes in 
  a [documents collection](../../../indexes/querying/graph/graph-queries-explicit-and-implicit.mdx#implicit-and-explicit-queries), 
  in the results of an [index query](../../../indexes/querying/graph/graph-queries-and-indexes.mdx#querying-indexes), 
  or in a [selected subset](../../../indexes/querying/graph/graph-queries-filtering.mdx#filtering) of either.  

* A data node clause can include [RQL](../../../client-api/session/querying/what-is-rql.mdx) statements.  
...
`}
    ...
    ![Simple Query: Graphical View](./assets/SearchPattern_002_RestrictUsingRQL_GraphicalView.png)
  
    ![Simple Query: Textual View](./assets/SearchPattern_002_RestrictUsingRQL_TextualView.png)
...
![ShipVia Edge](./assets/SearchPattern_003_ShipVia_Edge.png)
...
An edge always has [a direction](../../../indexes/querying/graph/graph-queries-overview.mdx#the-structure-of-a-basic-query).  
...
![Edges Are Directional](./assets/SearchPattern_004_DirectionalEdge.png)

<Admonition type="note" title="Queries can be directed both to the right and to the left." id="queries-can-be-directed-both-to-the-right-and-to-the-left" href="#queries-can-be-directed-both-to-the-right-and-to-the-left">
...
<Admonition type="info" title="Expanded Queries can be Bi-Directional." id="expanded-queries-can-be-bi-directional" href="#expanded-queries-can-be-bi-directional">
An [expanded query](../../../indexes/querying/graph/graph-queries-expanded-search-patterns.mdx#graph-queries-expanded-search-patterns) 
may include some sections directed to the right, and other sections directed to the left.  
This syntax may create 
[concise, effective queries](../../../indexes/querying/graph/graph-queries-expanded-search-patterns.mdx#bi-directional-queries). 
</Admonition>
#### Complex Edges  
...
* Here is an implementation of a complex edge in a document:  
    ...
    ![Complex Edge in document orders/125-A](./assets/SearchPattern_005_ComplexEdge.png)
...
`}
    ...
    With these results:  
     ...
     ![Retrieved Using Complex Edges](./assets/SearchPattern_006_Lines.png)
...
`}
```
| ![Aliases](./assets/SearchPattern_007_Alias.png) |  

* **Use unique aliases.**  
  Aliases are labels that [data elements](../../../indexes/querying/graph/graph-queries-explicit-and-implicit.mdx#explicitly-declaring-data-elements) 
...
`}
    ...
    ![Employees](./assets/SearchPattern_008_Abstraction.png)
...
* **Projection**  
  To [project](../../../indexes/querying/graph/graph-queries-overview.mdx#projecting-graph-results) 
