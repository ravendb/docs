...
* **Exploration Queries** form an additional layer of filtering that can be applied 
  ...
  or [rawQuery](../../../querying/overview.mdx#sessionadvancedrawquery), 
...
The provided filtering operations resemble those implemented by [where](../../../querying/filtering-query-results/filter-query-results.mdx) 
and can be further enhanced by Javascript functions of your own. 
Read [here](#with-user-defined-javascript-functions-) about creating and using your own Javascript function in your filters.  
...
When using RQL, you can define a JavaScript function using the [declare](../../../querying/rql/what-is-rql.mdx#declare) keyword.  
