...
* In this page:  
  ...
  * [Licensing a RavenDB docker image](../licensing/license-under-docker.mdx#licensing-a-ravendb-docker-image)  
     ...
     * [Providing a License in `settings.json`](../licensing/license-under-docker.mdx#providing-a-license-in-)  
     * [Setting a `RAVEN_License` Environment Variable](../licensing/license-under-docker.mdx#setting-a--environment-variable)  
...
* Add `settings.json` the **full license string** as the value of the "License" key 
  [as explained here](../licensing/configuration.mdx).  
  Mount `settings.json` as [explained above](../licensing/license-under-docker.mdx#passing-a-path-to-the-license-file-via-cli), 
