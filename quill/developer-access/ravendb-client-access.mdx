...
Quill creates a [CDC Sink task](/7.2/server/ongoing-tasks/cdc-sink/overview) in each app database to keep its mapped documents synchronized with the source relational database.
