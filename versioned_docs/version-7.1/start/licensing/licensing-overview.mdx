...
* In this page:
    ...
    * [Manage license view](#manage-license-view)
...
* When you are ready to go into production:  
   * Be sure to choose a license that has all features with which your client was developed.  
     Note that if you use [Let's encrypt](../installation/setup-wizard/choose-security-option.mdx#generate-let-s-encrypt-certificate) 
