...
description: "Install RavenDB on Debian and Ubuntu systems using the DEB package for automated file placement, service registration, and configuration."
sidebar_position: 0
---
...
* [Find Here](../../../start/installation/setup-wizard/overview.mdx) a **step by step guide** 
