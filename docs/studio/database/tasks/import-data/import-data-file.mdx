...
* `.ravendbdump` is RavenDB's format for [exportation of data](../export-database.mdx) 
  into and from files.  
...
* an exported `.ravendbdump` file can be used to migrate the data stored 
  ...
  Learn more about this operation in the [section dedicated to it](../../../../sharding/import-and-export.mdx#import).  

In this page:

* [Import data to destination server from file](#import-data-to-destination-server-from-file)  
* [Import options](#import-options)  
* [Advanced import options](#advanced-import-options)  
    * [Transform Script](#transform-script)  
    * [Customize Configuration and Ongoing Tasks](#customize-configuration-and-ongoing-tasks)  
    * [Copy command as PowerShell](#copy-command-as-powershell)  
...
6. **Documents and Extensions**  
  Select desired [options](#import-options).  
...
1. [Include Documents](../../documents/document-view.mdx)  
   Toggle to include documents and to enable inclusion of the following document related items:  
    ...
    - [Include Legacy Attachments](../../create-new-database/from-legacy-files.mdx)  
    ...
    - [Include Legacy Files](../../create-new-database/from-legacy-files.mdx)  
    - [Include Artificial Documents](../../indexes/create-map-reduce-index.mdx#artificial-documents--vs--regular-documents)  
...
2. [Include Indexes](../../../../indexes/what-are-indexes.mdx)  
    ...
    - [Include Configuration and OngoingTasks](./import-from-ravendb.mdx#customize-configuration-and-ongoing-tasks) 
