...
* Click **Show** to view the current settings of a configuration section,  
  or **Edit** to modify a configuration section using the same [task creation wizard](../../../ai-integration/gen-ai-integration/create-gen-ai-task/create-gen-ai-task_studio.mdx) used to initially define the task.
