...
* To use RavenDB as a PostgreSQL server you need -  
   * a [license](../../start/licensing/licensing-overview.mdx) that enables the PostgreSQL Protocol.  
...
* Visit Studio's [About](../../start/licensing/licensing-overview.mdx#manage-license-view) 
