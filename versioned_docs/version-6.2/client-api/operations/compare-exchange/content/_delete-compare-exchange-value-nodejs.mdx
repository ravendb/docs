...
* Compare-exchange items can also be deleted via [advanced session methods](../../../session/cluster-transaction/compare-exchange.mdx), 
  or from the [Studio](../../../../studio/database/documents/compare-exchange-view.mdx).

* In this page:  
  * [Delete compare exchange item](#delete-compare-exchange-item)
  * [Syntax](#syntax)  
