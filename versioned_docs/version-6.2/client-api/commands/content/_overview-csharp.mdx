...
* Beneath this high-level interface are Operations and Commands:
    ...
    * **Commands**:
        ...
        * All commands can be executed using either the [Store's _Request Executor_](#execute-command---using-the-store)
          or the [Session's _Request Executor_](#execute-command---using-the-session),  
