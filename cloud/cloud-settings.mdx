...
description: "Configure RavenDB Cloud instance settings through Studio, including indexing options and cloud-specific configuration defaults."
sidebar_position: 8
---
...
* In most cases, the cloud configuration settings are similar to the on-premise settings.  
   ...
   * [Client API Configurations](../7.2/client-api/configuration/conventions)
   * [Server Configurations](../7.2/server/configuration/configuration-options)
...
* In this page:  
   * [Setting Cloud Configurations via Studio](../cloud/cloud-settings.mdx#setting-cloud-configurations-via-studio)
   * [Indexing Settings](../cloud/cloud-settings.mdx#indexing-settings)
...
* [Database Configurations](../7.2/studio/database/settings/database-settings)
* [Indexing Configurations](../7.2/studio/database/indexes/create-map-index#configuration)
...
Change [cloud configurations in Studio](../7.2/studio/database/indexes/create-map-index#configuration).
