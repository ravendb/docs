...
* The server-wide Client-Configuration is a set of configuration options that are set __on the server__ and apply to any client when communicating with __any__ database in the cluster.  
  See the available configuration options in the article about [put client-configuration for database](../../../maintenance/configuration/put-client-configuration.mdx#what-can-be-configured).
...
* A Client-Configuration that is set on the server __overrides__ the initial Client-Configuration that is set on the client when creating the Document Store.  
  A Client-Configuration that is set on the server for the [database level](../../../maintenance/configuration/put-client-configuration.mdx)
...
* In this page:
    * [Put client-configuration (server-wide)](#put-client-configuration-server-wide))
    * [Syntax](#syntax)
