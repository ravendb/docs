...
![Figure 5: Setup replication destination](./assets/studio_replicationwalkthrough_5.PNG)
...
![Figure 6: Replication documents](./assets/studio_replicationwalkthrough_6.PNG)
