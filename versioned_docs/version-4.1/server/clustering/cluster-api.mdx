...
- [Promote a watcher node](../../server/clustering/cluster-api.mdx#promote-a-watcher-node)
- [Demote a watcher node](../../server/clustering/cluster-api.mdx#demote-a-watcher-node)
...
* To make a secure call, the Document Store must be supplied with the client certificate ([example](../../client-api/setting-up-authentication-and-authorization.mdx)).
