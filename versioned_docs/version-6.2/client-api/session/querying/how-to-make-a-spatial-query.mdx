...
* Note the following difference between the underlying search engines:
    ...
    * When using **Corax**:  
      ...
      To get this metadata property you must set the [Indexing.Corax.IncludeSpatialDistance](../../../server/configuration/indexing-configuration.mdx#indexing.corax.includespatialdistance) configuration value to _true_.  
