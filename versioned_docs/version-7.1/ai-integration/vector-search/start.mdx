...
* Vector search can be done using:  
  [Dynamic queries](../../ai-integration/vector-search/vector-search-using-dynamic-query.mdx) - suitable for ad-hoc or infrequent searches.  
  [Querying static-indexes that index vector fields](../../ai-integration/vector-search/vector-search-using-static-index.mdx) - suitable for optimized and repeated searches.  
...
* Vector search queries also empower other AI features in RavenDB such as [GenAI](../../ai-integration/gen-ai-integration/start.mdx) and [AI Agents](../../ai-integration/ai-agents/start.mdx).   
...
* On this start page, you'll find:
  * [Use cases](../../ai-integration/vector-search/start.mdx#use-cases)
  * [Technical documentation links](../../ai-integration/vector-search/start.mdx#technical-documentation-links-)
  * [Related in-depth articles](../../ai-integration/vector-search/start.mdx#related-in-depth-articles)
  * [Related lives & videos](../../ai-integration/vector-search/start.mdx#related-lives--videos)
...
* [Vector search - Overview](../../ai-integration/vector-search/overview.mdx) 
...
* [Indexing attachments for vector search](../../ai-integration/vector-search/indexing-attachments-for-vector-search.mdx) 
* [Data types for vector search](../../ai-integration/vector-search/data-types-for-vector-search.mdx) 
* [What affects vector search results](../../ai-integration/vector-search/what-affects-vector-search-results.mdx) 
