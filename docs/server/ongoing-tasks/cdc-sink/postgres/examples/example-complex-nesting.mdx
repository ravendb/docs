---
title: "Server: Ongoing Tasks: CDC Sink: PostgreSQL: Example: Complex Nesting with Linked Tables"
sidebar_label: Complex Nesting
description: "Multi-level embedded table structure combined with linked table references for a product catalog with variants, attributes, and a category reference."
sidebar_position: 3
---
...
# Server: Ongoing Tasks: CDC Sink: PostgreSQL: Example: Complex Nesting with Linked Tables
