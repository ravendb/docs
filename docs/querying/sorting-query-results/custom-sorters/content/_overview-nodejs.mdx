...
* Custom sorters let you **define your own logic for ordering query results**.  
  ...
  If no custom sorter is used, RavenDB orders the results as described in [Sort query results](../../sort-query-results.mdx).
...
Learn how to deploy a database-level custom sorter in: [Database-level custom sorters](../database-level-custom-sorters.mdx).    
Learn how to deploy a server-wide custom sorter in: [Server-wide custom sorters](../server-wide-custom-sorters.mdx).
...
To learn how to test a sorter, see [Test custom sorter](../database-level-custom-sorters.mdx#test-custom-sorter).
