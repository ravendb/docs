...
* In this page:  
  * [PerformanceHints.Documents.HugeDocumentsCollectionSize](../../server/configuration/performance-hints-configuration.mdx#performancehints.documents.hugedocumentscollectionsize)
  * [PerformanceHints.Documents.HugeDocumentSizeInMb](../../server/configuration/performance-hints-configuration.mdx#performancehints.documents.hugedocumentsizeinmb)
  * [PerformanceHints.Indexing.AlertWhenSourceDocumentIncludedInOutput](../../server/configuration/performance-hints-configuration.mdx#performancehints.indexing.alertwhensourcedocumentincludedinoutput)
  * [PerformanceHints.Indexing.MaxDepthOfRecursionInLinqSelect](../../server/configuration/performance-hints-configuration.mdx#performancehints.indexing.maxdepthofrecursioninlinqselect)
  * [PerformanceHints.Indexing.MaxIndexOutputsPerDocument](../../server/configuration/performance-hints-configuration.mdx#performancehints.indexing.maxindexoutputsperdocument)  
  * [PerformanceHints.Indexing.MaxNumberOfLoadsPerReference](../../server/configuration/performance-hints-configuration.mdx#performancehints.indexing.maxnumberofloadsperreference)
  * [PerformanceHints.MaxNumberOfResults](../../server/configuration/performance-hints-configuration.mdx#performancehints.maxnumberofresults)
  * [PerformanceHints.Memory.MinSwapSizeInMb](../../server/configuration/performance-hints-configuration.mdx#performancehints.memory.minswapsizeinmb)
  * [PerformanceHints.TooLongRequestThresholdInSec](../../server/configuration/performance-hints-configuration.mdx#performancehints.toolongrequestthresholdinsec)
