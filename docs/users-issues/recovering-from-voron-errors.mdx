...
* Such exceptions are caused by the corruption of a Voron _data file_, which could occur due to a few reasons:  
  ...
  * In compliance‏ with RavenDB [hardware and OS requirements](#ravendb-hardware-and-os-requirements)  
...
For more information, read this article about [backup configuration](../backup/configuration.mdx).  
