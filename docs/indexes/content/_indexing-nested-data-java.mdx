...
RavenDB will give you a [performance hint](../../monitoring/alerts-and-notifications/performance-hints.mdx#indexing) regarding high fanout ratio using the Studio's [notification center](../../monitoring/alerts-and-notifications/notification-center.mdx).
</Admonition>
