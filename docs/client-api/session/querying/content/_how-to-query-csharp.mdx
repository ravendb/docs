...
* Queries defined with [Query](../../../client-api/session/querying/how-to-query.mdx#sessionquery) or [DocumentQuery](../../../client-api/session/querying/how-to-query.mdx#sessionadvanceddocumentquery) are translated by the RavenDB client to [RQL](../../../../querying/what-is-rql.mdx)  
  when sent to the server.
