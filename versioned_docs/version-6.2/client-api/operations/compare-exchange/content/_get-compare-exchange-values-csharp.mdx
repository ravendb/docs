...
* For an overview of the 'Compare Exchange' feature click: [Compare Exchange Overview](../overview.mdx)

* In this page:  
  * [Syntax](#syntax)  
  * [Example I - Get Values for Specified Keys](#example-i---get-values-for-specified-keys)  
  * [Example II - Get Values for Keys with Common Prefix](#example-ii---get-values-for-keys-with-common-prefix)  
</Admonition>
## Syntax
...
You can also get compare exchange values through the [session cluster transactions](../../../session/cluster-transaction/compare-exchange.mdx#get-compare-exchange) 
at `session.Advanced.ClusterTransaction`.  

This method also exposes methods getting compare exchange [lazily](../../../session/cluster-transaction/compare-exchange.mdx#get-compare-exchange).  
</Admonition>
