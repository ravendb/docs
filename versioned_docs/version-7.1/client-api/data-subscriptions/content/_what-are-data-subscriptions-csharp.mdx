...
* In this page:  
   * [Data subscription consumption](#data-subscription-consumption)  
   * [What defines a data subscription](#what-defines-a-data-subscription)  
   * [Documents processing](#documents-processing)  
   * [Progress Persistence](#progress-persistence)  
   * [How the worker communicates with the server](#how-the-worker-communicates-with-the-server)  
   * [Working with multiple clients](#working-with-multiple-clients)  
   * [Data subscriptions usage example](#data-subscriptions-usage-example)  
...
* You can determine whether workers would be able to connect a subscription 
  [concurrently, or only one at a time](../consumption/how-to-consume-data-subscription.mdx#worker-interplay).  
...
1. [Subscription Creation Options](../creation/api-overview.mdx#subscription-creation-options): The documents that will be sent to the worker, it's filtering and projection.

2. [Subscription Worker Options](../consumption/api-overview.mdx#subscriptionworkeroptions): Worker batch processing logic, batch size, interaction with other connections.
...
Read more here: [revisions support](../advanced-topics/subscription-with-revisioning.mdx)
</Admonition>
...
* The status of the TCP connection is also used to determine the "state" of the worker process.  
  ...
  [One Worker Per Subscription](../consumption/how-to-consume-data-subscription.mdx#worker-interplay) 
...
* **One Worker Per Subscription Strategies**  
   ...
   * Read more about these strategies [here](../consumption/how-to-consume-data-subscription.mdx#one-worker-per-subscription-strategies).  
...
* **Concurrent Subscription Strategy**  
   ...
   * Read more about this strategy [here](../concurrent-subscriptions.mdx).  
