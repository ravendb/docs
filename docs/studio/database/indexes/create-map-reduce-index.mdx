...
* The Map-Reduce results can be visualized in the [Map-Reduce Visualizer](./map-reduce-visualizer.mdx).  
...
* The Map-Reduce results can also be visualized in [Map-Reduce Visualizer](./map-reduce-visualizer.mdx).  
...
* You can set up a [RavenDB ETL Task](../tasks/ongoing-tasks/ravendb-etl-task.mdx) 
