...
6. **Google Credentials Json**  
   ...
   To generate this JSON, see [Create a service account key](https://cloud.google.com/iam/docs/keys-create-delete#creating) in the official Google Cloud documentation.
