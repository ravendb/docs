...
| **load(documentId, collectionName)**                        | `object`     | Returns the document with the given ID.<br>Used in [JavaScript indexes](../../).                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
#### **Functions for counter operations**:
...
#### **Functions for compare-exchange**:
...
#### **Functions for conversion operations**:
