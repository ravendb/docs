...
* __Query limitations:__:  
  ...
  * A streaming query does not wait for indexing by design.  
    So calling [WaitForNonStaleResults](../how-to-customize-query.mdx#waitfornonstaleresults) is Not supported and will result in an exception.   
  
  * Using [Include](../../../how-to/handle-document-relationships.mdx#includes) to load a related document to the session in a streaming query is Not supported.  
    Learn how to __stream related documents__ here [below](#stream-related-documents).
...
* An [Include](../../../how-to/handle-document-relationships.mdx#includes) clause in a non-streamed query loads these related documents to the session  
...
| - | - | - |
| **query** | [IQueryable](../how-to-query.mdx#sessionquery), [IDocumentQuery](../how-to-query.mdx#sessionadvanceddocumentquery) or [IRawDocumentQuery](../how-to-query.mdx#sessionadvancedrawquery) | The query for which to stream results |
