...
* In this page:
  ...
  * [Add Snowflake ETL task](#add-snowflake-etl-task)  
  ...
  * [Add Amazon SQS ETL task](#add-amazon-sqs-etl-task)
  * [Syntax](#syntax)
...
* Learn how to define a connection string for the RavenDB ETL task here: **[Add a RavenDB connection string](../../connection-strings/add-connection-string.mdx#add-a-ravendb-connection-string)**  
...
* Learn how to define a connection string for the SQL ETL task here: **[Add an SQL connection string](../../connection-strings/add-connection-string.mdx#add-an-sql-connection-string)**  
...
* Learn how to define a connection string for the Snowflake ETL task here: **[Add a Snowflake connection string](../../connection-strings/add-connection-string.mdx#add-a-snowflake-connection-string)**  
...
* Learn how to define a connection string for the OLAP ETL task here: **[Add an OLAP connection string](../../connection-strings/add-connection-string.mdx#add-an-olap-connection-string)**  
...
* Learn how to define a connection string for the Elasticsearch ETL task here: **[Add an Elasticsearch connection string](../../connection-strings/add-connection-string.mdx#add-an-elasticsearch-connection-string)**  
