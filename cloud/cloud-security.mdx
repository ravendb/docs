...
description: "Secure RavenDB Cloud instances with TLS 1.2/1.3 encryption, X.509 client certificates, IP allowlisting, and multi-factor authentication."
sidebar_position: 7
---
...
* In this page:
    ...
    * [MFA](../cloud/cloud-security.mdx#mfa)
       - [Enable MFA](../cloud/cloud-security#enable-mfa)  
       - [Disable MFA](../cloud/cloud-security#disable-mfa)  
...
![Download Certificate](./assets/portal-product-list-download-certificate.png)  
...
![Certificate Import Wizard](./assets/os-windows-certificate-import-wizard.png)  
#### Access your product  
...
![Server URLs](./assets/portal-product-list-urls.png)  
...
[management studio](../7.2/studio/overview) will launch.

## Managing allowed IPs

<Admonition type="note" title="Permissions">
Managing client certificates and the **Allowed IPs** list from the Cloud Portal requires [**Security admin** access](./cloud-account.mdx#permission-presets) to the product (the Account Owner always has full access).
</Admonition>
...
**To generate additional [operator](../7.2/server/security/authorization/security-clearance-and-permissions#operator)
...
* Go to the server management studio, and click the `Manage Certificates` button.  
  ![Manage Certificates](./assets/studio-server-dashboard-manage-certificates-link.png)  
* Click **Generate client certificate**  
  ![Generate Client Certificate](./assets/studio-certificates-generate-client-certificate.png)  
...
![Add authenticator app](./assets/profile-enable-mfa.png)

1. Click the **Add authenticator app** button.

![Configure authenticator app](./assets/profile-enable-mfa-configuration.png)
...
![MFA recovery codes](./assets/profile-enable-mfa-recovery-codes.png)
...
To disable Multi-Factor Authentication either visit
the [disable-authenticator](https://cloud.ravendb.net/portal/profile/disable-2fa) page
or open your RavenDB Cloud [Profile](https://cloud.ravendb.net/portal/profile).

![Disable 2FA](./assets/profile-disable-mfa.png)

1. Click the **Disable 2FA** button.

![Disable 2FA confirmation](./assets/profile-disable-mfa-confirmation.png)

2. Type in the 2FA code generated by your authentication app.
3. Click **Disable 2FA**.

<Admonition type="info" title="">
For security reasons you will be logged out once you disable 2FA.
</Admonition>
