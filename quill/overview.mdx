...
* Direct access to [Quill's internal database](overview.mdx#internal-database) requires a client certificate.
* Quill reaches the [LLM provider](overview.mdx#llm) using the access details your provider requires.
