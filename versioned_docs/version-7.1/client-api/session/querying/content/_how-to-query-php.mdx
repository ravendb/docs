...
* Queries defined using `query` or `documentQuery` are translated by the RavenDB client 
  to [RQL](../what-is-rql.mdx) when sent to the server.  
...
* The entities returned by the query are 'loaded' and **tracked** by the [session](../../what-is-a-session-and-how-does-it-work.mdx).  
  Entities will Not be tracked when:  
    ...
    * Tracking is [disabled](../how-to-customize-query.mdx#notracking)  

* Query results are **cached** by default.  
  To disable query caching see [NoCaching](../how-to-customize-query.mdx#nocaching).
...
* In this page:
  ...
  * [Custom methods](#custom-methods-and-extensions-for-linq)  
  * [Syntax](#syntax)  
...
* Queries defined with [query](#sessionquery) 
  or [documentQuery](#sessionadvanceddocumentquery) 
  are translated by the RavenDB client to [RQL](../what-is-rql.mdx)  
...
Available custom methods for session's [query](#sessionquery) method:
