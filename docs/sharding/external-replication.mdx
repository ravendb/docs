...
* **Internal replication** is applied automatically when the replication 
  ...
  Learn more about shards internal replication in the [overview](./overview.mdx#shard-replication) 
  article and administration [Studio](./administration/studio-admin.mdx) 
  and [API](./administration/api-admin.mdx) articles.  
