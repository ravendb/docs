...
* Setting the lock mode can also be done from the [indexes list view](../../../../studio/database/indexes/indexes-list-view.mdx#indexes-list-view---actions) in the Studio.  
...
<TabItem value="set_lock_mode_4" label="set_lock_mode_4">
<CodeBlock language="java">
