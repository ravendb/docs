...
* **Studio**  
  All compare-exchange items can also be managed from the **Compare-Exchange view** in the [Studio](../../compare-exchange/create-cmpxchg-items.mdx#create-item-using-the-studio):  
