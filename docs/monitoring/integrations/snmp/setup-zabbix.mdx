...
* **A running Zabbix instance (version 6.0 or later), with administrative access to the Zabbix web frontend.**  
  If you haven't set up an instance yet, the [Set up Zabbix monitoring for RavenDB Cloud](../../../../guides/zabbix-setup-guide) 
  guide can walk you through setting it up in Docker.

* **RavenDB with SNMP enabled.**  
  SNMP requires a [license](https://ravendb.net/buy) that includes the SNMP feature.  
