...
* When **cloning** an archived document using the `put` method within a patching script  
  (see this [clone document example](../../documents/patching-documents/patch-a-single-document/examples/patch-examples-documents-and-metadata.mdx#clone-document)) the cloned document will Not be archived,  
