...
* The following configuration keys apply to integrating **AI-powered embeddings generation**:
  ...
  * For [Studio AI assistant](../../studio/ai-assistant) configuration keys see the [Studio configuration options](../../studio/configuration) page under the Studio documentation folder.
