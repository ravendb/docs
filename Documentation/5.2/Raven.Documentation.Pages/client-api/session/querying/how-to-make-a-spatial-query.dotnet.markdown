...
{CODE spatial_1@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
...
{CODE spatial_2@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
...
{CODE spatial_3@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
...
{CODE-TABS}
{CODE-TAB:csharp:Sync spatial_4@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
{CODE-TAB:csharp:Async spatial_4_1@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
...
{CODE-TABS}
{CODE-TAB:csharp:Sync spatial_5@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
{CODE-TAB:csharp:Async spatial_5_1@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
{CODE-TAB-BLOCK:sql:RQL}
from Houses
...
{CODE spatial_6@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
...
{CODE-TABS}
{CODE-TAB:csharp:Sync spatial_7@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
{CODE-TAB:csharp:Async spatial_7_1@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
{CODE-TAB-BLOCK:sql:RQL}
from Houses
where spatial.within(spatial.point(Latitude, Longitude), spatial.circle(10, 32.1234, 23.4321))
...
{CODE-TABS}
{CODE-TAB:csharp:Sync spatial_7_2@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
{CODE-TAB:csharp:Async spatial_7_3@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
{CODE-TAB-BLOCK:sql:RQL}
from Houses as h
...
{CODE-TABS}
{CODE-TAB:csharp:Sync spatial_9@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
{CODE-TAB:csharp:Async spatial_9_1@ClientApi\Session\Querying\MakeSpatialQuery.cs /}
{CODE-TAB-BLOCK:sql:RQL}
from Houses
where spatial.within(spatial.point(Latitude, Longitude), spatial.circle(10, 32.1234, 23.4321))
