...
* When scheduling a **Server-Wide Backup Task**, RavenDB creates a 
  [regular ongoing backup task](../database/tasks/backup-task.mdx) 
...
The settings are similar to those of a [regular backup task](../database/tasks/backup-task.mdx#backup-task).  
...
and a [separately created backup](../database/tasks/backup-task.mdx#backup-task).  
In both cases, you can restore the database by 
[Creating a New Database from Backup](../database/create-new-database/from-backup.mdx).  
...
The Server-Wide Backup Tasks can also be viewed in both the database's [Ongoing-Tasks view](../database/tasks/ongoing-tasks/general-info.mdx) 
& [Backups view.](../database/tasks/backup-task.mdx)  
...
* When defining a Server-Wide backup, the user is not given the option to select a 
  ...
  (the [Database Group](../database/settings/manage-database-group.mdx#database-group)).  
...
* Since defining a Server-Wide backup actually creates regular backup tasks, 
  ...
  See [Backup Task - When Cluster or Node are Down](../database/tasks/backup-task.mdx#backup-task---when-cluster-or-node-are-down).  
