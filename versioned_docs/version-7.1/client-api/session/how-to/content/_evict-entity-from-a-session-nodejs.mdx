...
* `evict` cannot be called from within an [beforeStore](../subscribe-to-events.mdx#onbeforestore) or
  [beforeDelete](../subscribe-to-events.mdx#onbeforedelete) event handler.  
