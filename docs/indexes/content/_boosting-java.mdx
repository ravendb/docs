...
Automatic ordering of the results by the score is [configurable](#automatic-score-based-ordering).
...
* [indexing-time boosting](../search-engine/corax.mdx#unsupported-features) 
