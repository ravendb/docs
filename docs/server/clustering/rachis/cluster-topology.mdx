...
* Clusters are typically composed of any odd number of nodes equal or greater than 3, see [Clusters Best Practice](../cluster-best-practice-and-configuration.mdx).  
...
With [Cluster Admin](../../security/authorization/security-clearance-and-permissions.mdx#cluster-admin) privileges, 
...
See the [Cluster API page](../cluster-api.mdx) for usage examples.
...
* [Raft Commands](./consensus-operations.mdx#raft-commands-implementation-details) can't be accepted while there is no Leader or if the Leader is down.  
