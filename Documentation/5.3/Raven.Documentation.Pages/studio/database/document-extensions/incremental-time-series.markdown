...
![Time Series - Document View](images/incremental-time-series/document-time-series.png "Time Series - Document View")
...
![Time Series View](images/incremental-time-series/time-series-view.png "Time Series View")
...
![Add Time Series](images/incremental-time-series/new-time-series.png "Add Time Series")

---

![Add Time Series Entry](images/incremental-time-series/new-entry.png "Add Time Series Entry")
...
4. Add one or more numerical [values](../../../document-extensions/timeseries/overview#values) (up to 32 values).  
   ![Named Values](images/incremental-time-series/named-values.png "Named Values")
...
![Edit Time Series](images/incremental-time-series/edit-time-series.png "Edit Time Series")

---

![Edit Time Series Entry](images/incremental-time-series/edit-time-series-entry.png "Edit Time Series Entry")
...
![Delete Range Button](images/incremental-time-series/delete-range-button.png "Delete Range Button")

---

![Delete Range](images/incremental-time-series/delete-range.png "Delete Range")
...
![Delete Range - Pick Date and Time](images/incremental-time-series/delete-range-2.png "Delete Range - Pick Date and Time")

{PANEL/}

{PANEL: Querying Time Series}

![Time Series Query](images/incremental-time-series/time-series-query.png "Time Series Query")
...
![Time Series Query - Actions](images/incremental-time-series/time-series-query-actions.png "Time Series Query - Actions")

{WARNING: }

1. Click to open a tab with the time series query results shown in a table.  
   ![Time Series Query Results Table](images/incremental-time-series/query-results-table.png "Time Series Query Results Table")
2. Click to open a tab with the time series query results shown in a graph (see below).  
3. Multiple documents selection  
   ![Multiple Selection](images/incremental-time-series/multiple-selection.png "Multiple Selection")
    ...
    * b. Click to view the selected documents' time series results in a unified graph.  
      ![Unified Graph](images/incremental-time-series/unified-graph.png "Unified Graph")
...
![Time series results in a graph](images/incremental-time-series/time-series-graph-info.png "Time series results in a graph")
...
![Time series results in a graph - Actions](images/incremental-time-series/time-series-graph-actions.png "Time series results in a graph - Actions")
