...
* The index errors will be retrieved only from the server node defined by the current [client-configuration](../../../../configuration/load-balance/overview.mdx#client-logic-for-choosing-a-node).

* To learn about clearing index errors, see [delete index errors](../delete-index-errors.mdx). 

* In this page:
    * [Get errors for all indexes](#get-errors-for-all-indexes)
    * [Get errors for specific indexes](#get-errors-for-specific-indexes)
    * [Syntax](#syntax)
