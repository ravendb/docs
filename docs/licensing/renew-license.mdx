---
title: "Renew license"
description: "Renew an expiring or expired RavenDB license to maintain access to licensed features and avoid operating in community mode."
...
* Commercial licenses (Professional, Enterprise, RavenDB AI, and ISV) are automatically renewed as long as your server has an active connection to RavenDB's License server and automatic updates are enabled.  
...
* In this article:
   * [Renew commercial licenses](#renew-commercial-licenses)
     * [Automatic renewal](#automatic-renewal)
     * [Manual renewal](#manual-renewal)
   * [Renew Developer & Community licenses](#renew-developer-community-licenses)

</Admonition>

<Panel heading="Renew commercial licenses">

This section relates to all commercial licenses: **Professional**, **Enterprise**, **RavenDB AI**, and all **ISV licenses**.  
...
* **And** the [DisableAutoUpdate](./configuration.mdx#licensedisableautoupdate) configuration key is set to **false**.  
...
* To register your new license **using Studio**:  
  Follow the procedure described [here](./replace-license.mdx#replace-license-from-studio).

* To register your new license **using a configuration key**:  
   - Set the [DisableAutoUpdateFromApi](./configuration.mdx#licensedisableautoupdatefromapi) configuration key to **true**.
   - Activate the new license using a configuration key as described [here](./activate-license.mdx#activate-your-license-using-a-configuration-key).
