...
The Studio supports configuring Windows Authentication. In this view you can configure authentication settings for single user or user group (read more about Authentication & Authorization [here]()).
