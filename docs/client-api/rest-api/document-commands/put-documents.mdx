...
description: "Store or update a document in RavenDB using the REST API PUT endpoint with JSON body and optional change vector header."
sidebar_position: 3
---
...
When updating an existing document, you'll need to include its [collection](../../faq/what-is-a-collection.mdx) 
