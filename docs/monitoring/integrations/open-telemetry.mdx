---
title: "Integrations: OpenTelemetry"
...
see_also:
  - title: "Increase your RavenDB observability with Grafana Cloud and OpenTelemetry"
    link: "https://ravendb.net/articles/grafana-cloud-configuration-with-opentelemetry"
    source: "external"
  - title: "Leverage RavenDB observability with Datadog"
    link: "https://ravendb.net/articles/leverage-ravendb-observability-with-datadog"
    source: "external"
---
...
* To enable the OpenTelemetry metrics in RavenDB, you must first set the [Monitoring.OpenTelemetry.Enabled](../integrations/configuration.mdx#monitoringopentelemetryenabled) configuration key to `true`.
...
| - | - | - |
| `ravendb.server.cpucredits` | Exposes status of CPU credits (cloud).<br />Default: `false`. | Monitoring.OpenTelemetry.Meters<br/>[.Server.CPUCredits.Enabled](../integrations/configuration.mdx#monitoringopentelemetrymetersservercpucreditsenabled) |
| `ravendb.server.gc` | Exposes detailed information about the Garbage Collector.<br />Default: `false`. | Monitoring.OpenTelemetry.Meters<br/>[.Server.GC.Enabled](../integrations/configuration.mdx#monitoringopentelemetrymetersservergcenabled) |
| `ravendb.server.general` | Exposes general info about the cluster and its licensing.<br />Default: `true`. | Monitoring.OpenTelemetry.Meters<br/>[.Server.General.Enabled](../integrations/configuration.mdx#monitoringopentelemetrymetersservergeneralenabled) |
| `ravendb.server.requests` | Exposes information about requests processed by the server.<br />Default: `true`. | Monitoring.OpenTelemetry.Meters<br/>[.Server.Requests.Enabled](../integrations/configuration.mdx#monitoringopentelemetrymetersserverrequestsenabled) |
| `ravendb.server.resources` | Exposes detailed information about resource usage (e.g. CPU).<br />Default: `true`. | Monitoring.OpenTelemetry.Meters<br/>[.Server.Resources.Enabled](../integrations/configuration.mdx#monitoringopentelemetrymetersserverresourcesenabled) |
| `ravendb.server.storage` | Exposes storage information.<br />Default: `true`. | Monitoring.OpenTelemetry.Meters<br/>[.Server.Storage.Enabled](../integrations/configuration.mdx#monitoringopentelemetrymetersserverstorageenabled) |
| `ravendb.server.totaldatabases` | Exposes aggregated information about databases on the server.<br />Default: `true`. | Monitoring.OpenTelemetry.Meters<br/>[.Server.TotalDatabases.Enabled](../integrations/configuration.mdx#monitoringopentelemetrymetersservertotaldatabasesenabled) |
...
* The server instance identification is determined by the following sequence:
    ...
    1. **Configuration Key**  
       First, attempt to retrieve the [Monitoring.OpenTelemetry.ServiceInstanceId](../integrations/configuration.mdx#monitoringopentelemetryserviceinstanceid) configuration key.  
...
[Monitoring.OpenTelemetry.Enabled](../integrations/configuration.mdx#monitoringopentelemetryenabled) to `true`,  
...
RavenDB offers two metric export options:  
...
* To enable output to the console -  
  set the [Monitoring.OpenTelemetry.ConsoleExporter](../integrations/configuration.mdx#monitoringopentelemetryconsoleexporter) configuration key to `true`.
...
* The [Monitoring.OpenTelemetry.OpenTelemetryProtocol.Enabled](../integrations/configuration.mdx#monitoringopentelemetryopentelemetryprotocolenabled) configuration key is `true` by default,  
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|
| Monitoring.OpenTelemetry.OpenTelemetryProtocol<br/>[.ExportProcessorType](../integrations/configuration.mdx#monitoringopentelemetryopentelemetryprotocolexportprocessortype) | Export processor type                                                                                                                                                      | Simple / Batch       |
| Monitoring.OpenTelemetry.OpenTelemetryProtocol<br/>[.Headers](../integrations/configuration.mdx#monitoringopentelemetryopentelemetryprotocolheaders)                         | Custom headers                                                                                                                                                             | string               |
| Monitoring.OpenTelemetry.OpenTelemetryProtocol<br/>[.Protocol](../integrations/configuration.mdx#monitoringopentelemetryopentelemetryprotocolprotocol)                       | Defines the transport protocol that OpenTelemetry Protocol should use to send data.                                                                                        | gRPC / HttpProtobuf  |
| Monitoring.OpenTelemetry.OpenTelemetryProtocol<br/>[.Endpoint](../integrations/configuration.mdx#monitoringopentelemetryopentelemetryprotocolendpoint)                       | Endpoint where OpenTelemetry Protocol should send data.<br/>See configuration details [below](../integrations/open-telemetry.mdx#configure-endpoint). | string               |
| Monitoring.OpenTelemetry.OpenTelemetryProtocol<br/>[.Timeout](../integrations/configuration.mdx#monitoringopentelemetryopentelemetryprotocoltimeout)                         | Timeout                                                                                                                                                                    | int                  |
...
The defined endpoint must match the receiving endpoint [configured on the collector](../integrations/open-telemetry.mdx#configuring-the-opentelemetry-collector).
...
* The OpenTelemetry Collector is a vendor-agnostic proxy that can receive, process, and export telemetry data (traces, metrics, logs)
  from multiple sources to different backends. It acts as a central collection and processing point for telemetry data.
...
* The `otlp` receiver accepts telemetry data in the OpenTelemetry Protocol (OTLP) format.
...
* The OpenTelemetry Collector can retrieve metrics from a Prometheus endpoint.  
