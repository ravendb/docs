...
* In this page:  
  * [1. Creating New Database From Legacy Files](#1-creating-new-database-from-legacy-files)  
...
1. [Database Name](./general-flow.mdx#2-database-name)
...
<Admonition type="note" title="">
 ...
 Learn more about **Manage group** in : [Manage group](../settings/manage-database-group.mdx)  
</Admonition>
