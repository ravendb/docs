...
* Run RavenDB in the [Embedded+HTTP mode](../../../server/deployment/embedded#http-access)
* Ensure that the Raven.Bundles.Replication.dll is located in the Plugins directory for your embedded RavenDB instance.
