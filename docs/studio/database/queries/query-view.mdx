...
description: "Write and execute RQL queries in RavenDB Studio with syntax highlighting, auto-complete, result pagination, and query plan inspection."
sidebar_position: 0
---
...
* Use the **Query View** to run [RQL](../../../querying/rql/what-is-rql.mdx) queries and view their results.  
...
3. **Syntax Samples**  
   Click to display [RQL](../../../querying/rql/what-is-rql.mdx) syntax samples.  
4. **Query Box**  
