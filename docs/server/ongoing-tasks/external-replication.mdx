...
* The destination server needs the [certificate from the source server](../security/authentication/certificate-management.mdx#enabling-communication-between-servers-importing-and-exporting-certificates) 
