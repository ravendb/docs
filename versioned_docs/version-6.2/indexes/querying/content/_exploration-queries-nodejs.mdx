...
* **Exploration Queries** form an additional layer of filtering that can be applied
  ...
  or [rawQuery](../../../client-api/session/querying/how-to-query.mdx#sessionadvancedrawquery),
...
The provided filtering operations resemble those implemented by [where](../filtering.mdx) 
