...
* RavenDB Queries can be executed via `Query`, `DocumentQuery` or directly using `RQL`.  
  Learn more in [Query Overview](../../overview.mdx).
...
- AddOrder
- [Query] [AfterQueryExecuted](../../customize-query.mdx#afterqueryexecuted)
- [Query] [AfterStreamExecuted](../../customize-query.mdx#afterstreamexecuted)
...
- AndAlso
- [Query] [BeforeQueryExecuted](../../customize-query.mdx#beforequeryexecuted)
...
- [Query] [NoCaching](../../customize-query.mdx#nocaching)
- [Query] [NoTracking](../../customize-query.mdx#notracking)
- OfType
- OpenSubclause
...
- OrElse
- [Query] [Projection](../../customize-query.mdx#projection)
- Proximity
- [Query] [RandomOrdering](../../customize-query.mdx#randomordering)
...
- Take
- [Query] [Timings](../../customize-query.mdx#timings)
- UsingDefaultOperator
- [Query] [WaitForNonStaleResults](../../customize-query.mdx#waitfornonstaleresults)
- Where
- WhereBetween
...
The available `DocumentQuery` overloads are listed in this [Syntax section](../../overview.mdx#syntax) in the [Query Overview](../../overview.mdx).
