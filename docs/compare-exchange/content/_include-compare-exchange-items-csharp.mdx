...
* Use the [include](../querying/what-is-rql#include) keyword followed by `cmpxchg()` to include a compare-exchange item.  
...
* Use `includes.cmpxchg()` In [JavaScript functions](../querying/what-is-rql#declare) within RQL queries. 
